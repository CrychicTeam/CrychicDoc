...
const showBackTop = ref(false);  // Initially hidden
...
.vitepress-backTop-main {
  ...
  height: 50px;
  border-radius: 50%;
  background-color: #007bff; /* 浅色模式下的按钮背景色：亮蓝色 */
  padding: 10px;
...
.vitepress-backTop-main.dark-mode {
  background-color: #ff9800; /* 深色模式下的按钮背景色：亮橙色 */
}

.vitepress-backTop-main:hover {
  background-color: #0056b3; /* 浅色模式下的悬停效果：更深的蓝色 */
  transform: scale(1.1); /* 悬停时的缩放效果，增加交互感 */
}

.vitepress-backTop-main.dark-mode:hover {
  background-color: #e65100; /* 深色模式下的悬停效果：更深的橙色 */
