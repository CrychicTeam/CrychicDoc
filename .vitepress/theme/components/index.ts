...
export const commonComponents = {
    ...
    charts: {
        ...
        MinecraftAdvancedDamageChart:
            components.content.MinecraftAdvancedDamageChart,
    },
};
...
export const registerComponents = (
    ...
    if (!selection) {
        ...
        Object.entries(selection).forEach(([category, componentNames]) => {
            if (
                componentNames &&
                components[category as keyof ComponentRegistry]
            ) {
                componentNames.forEach((name) => {
                    const component =
                        components[category as keyof ComponentRegistry][name as keyof ComponentRegistry[keyof ComponentRegistry]];
                    if (component) {
