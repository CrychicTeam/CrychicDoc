...
declare module "packages/moe/wolfgirl/probejs/generated/schema/custommachinery/CustomMachine" {
import {$CustomMachineRecipeBuilderJS, $CustomMachineRecipeBuilderJS$Type} from "packages/fr/frinn/custommachinery/common/integration/kubejs/$CustomMachineRecipeBuilderJS"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class CustomMachine extends $CustomMachineRecipeBuilderJS {


public "machine"(machine: $ResourceLocation$Type): this
public "time"(time: (number) | (string)): this
public "requirements"(requirements: ($IRequirement$Type)[]): this
public "jei"(jei: ($IRequirement$Type)[]): this
public "priority"(priority: number): this
public "jeiPriority"(jeiPriority: number): this
public "error"(): this
public "hidden"(): this
public "appearance"(appearance: $MachineAppearance$Type): this
public "gui"(gui: ($IGuiElement$Type)[]): this
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
import {CustomMachine, CustomMachine$Type} from "packages/moe/wolfgirl/probejs/generated/schema/custommachinery/CustomMachine"
...
import {CustomCraft, CustomCraft$Type} from "packages/moe/wolfgirl/probejs/generated/schema/custommachinery/CustomCraft"
...
export class DocumentedRecipes {
 ...
 "alexsmobs": {}
 "amendments": {}
 "custommachinery": {custom_craft(machine: $ResourceLocation$Type, output: $OutputItem$Type): CustomCraft, custom_machine(machine: $ResourceLocation$Type, time: (number) | (string)): CustomMachine}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/custommachinery/CustomCraft" {
import {$IRequirement, $IRequirement$Type} from "packages/fr/frinn/custommachinery/api/requirement/$IRequirement"
import {$CustomCraftRecipeJSBuilder, $CustomCraftRecipeJSBuilder$Type} from "packages/fr/frinn/custommachinery/common/integration/kubejs/$CustomCraftRecipeJSBuilder"
import {$ResourceLocation, $ResourceLocation$Type} from "packages/net/minecraft/resources/$ResourceLocation"
import {$OutputItem, $OutputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$OutputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class CustomCraft extends $CustomCraftRecipeJSBuilder {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type CustomCraft$Type = (CustomCraft);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type CustomCraft_ = CustomCraft$Type;
}}
