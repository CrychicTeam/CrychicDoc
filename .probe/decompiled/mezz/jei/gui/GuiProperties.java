...
public class GuiProperties implements IGuiProperties {
    ...
    public static GuiProperties create(AbstractContainerScreen<?> containerScreen) {
        if (containerScreen.f_96543_ > 0 && containerScreen.f_96544_ > 0) {
            ...
            return width > 0 && height > 0 ? new GuiProperties(containerScreen.getClass(), x, y, width, height, containerScreen.f_96543_, containerScreen.f_96544_) : null;
        } else {
            return null;
        }
    }
    ...
    public static boolean areEqual(@Nullable IGuiProperties a, @Nullable IGuiProperties b) {
        return a == b ? true : a != null && b != null && a.getScreenClass().equals(b.getScreenClass()) && a.getGuiLeft() == b.getGuiLeft() && a.getGuiXSize() == b.getGuiXSize() && a.getScreenWidth() == b.getScreenWidth() && a.getScreenHeight() == b.getScreenHeight();
    }
