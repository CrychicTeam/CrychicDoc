...
public class RenderHelper implements IPlatformRenderHelper {
    ...
    public Font getFontRenderer(Minecraft minecraft, ItemStack itemStack) {
        ...
        return fontRenderer != null ? fontRenderer : minecraft.font;
    }
    ...
    @Override
    public void renderTooltip(Screen screen, GuiGraphics guiGraphics, List<Component> textComponents, Optional<TooltipComponent> tooltipComponent, int x, int y, @Nullable Font font, ItemStack stack) {
        if (font == null) {
            font = screen.getMinecraft().font;
        }
        guiGraphics.renderTooltip(font, textComponents, tooltipComponent, stack, x, y);
    }
}