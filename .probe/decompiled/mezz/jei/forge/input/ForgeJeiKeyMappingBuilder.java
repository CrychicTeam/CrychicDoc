...
public class ForgeJeiKeyMappingBuilder extends AbstractJeiKeyMappingBuilder {
    ...
    public IJeiKeyMappingBuilder setContext(JeiKeyConflictContext context) {
        this.keyConflictContext = (IKeyConflictContext) (switch(context) {
            case UNIVERSAL ->
            ...
            case JEI_GUI_HOVER ->
                JeiForgeKeyConflictContexts.JEI_GUI_HOVER;
            case JEI_GUI_HOVER_CHEAT_MODE ->
                JeiForgeKeyConflictContexts.JEI_GUI_HOVER_CHEAT_MODE;
            case JEI_GUI_HOVER_CONFIG_BUTTON ->
                JeiForgeKeyConflictContexts.JEI_GUI_HOVER_CONFIG_BUTTON;
            case JEI_GUI_HOVER_SEARCH ->
                JeiForgeKeyConflictContexts.JEI_GUI_HOVER_SEARCH;
        });
        return this;
    }
