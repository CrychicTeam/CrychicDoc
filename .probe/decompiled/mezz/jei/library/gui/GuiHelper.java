...
public class GuiHelper implements IGuiHelper {
    ...
    public <V> IDrawable createDrawableIngredient(IIngredientType<V> type, V ingredient) {
        ...
        ITypedIngredient<V> typedIngredient = (ITypedIngredient<V>) this.ingredientManager.createTypedIngredient(type, ingredient).orElseThrow(() -> {
            String info = ErrorUtil.getIngredientInfo(ingredient, type, this.ingredientManager);
        ...
        return new DrawableIngredient<>(this.ingredientManager, typedIngredient, ingredientRenderer);
    }
