...
public class GuiHandlerRegistration implements IGuiHandlerRegistration {
    ...
    @Unmodifiable
    private static final List<Class<? extends Screen>> ghostIngredientGuiBlacklist = List.of(Screen.class, InventoryScreen.class, CreativeModeInventoryScreen.class);
