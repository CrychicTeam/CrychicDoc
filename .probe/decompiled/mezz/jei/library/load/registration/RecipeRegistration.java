...
public class RecipeRegistration implements IRecipeRegistration {
    ...
    public RecipeRegistration(IJeiHelpers jeiHelpers, IIngredientManager ingredientManager, IIngredientVisibility ingredientVisibility, IVanillaRecipeFactory vanillaRecipeFactory, RecipeManagerInternal recipeManager) {
    ...
    public <T> void addIngredientInfo(List<T> ingredients, IIngredientType<T> ingredientType, Component... descriptionComponents) {
        ...
        ErrorUtil.checkNotNull(ingredientType, "ingredientType");
        ErrorUtil.checkNotEmpty(descriptionComponents, "descriptionComponents");
        List<IJeiIngredientInfoRecipe> recipes = IngredientInfoRecipe.create(this.ingredientManager, ingredients, ingredientType, descriptionComponents);
