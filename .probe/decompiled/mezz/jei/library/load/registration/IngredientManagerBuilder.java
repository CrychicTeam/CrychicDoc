...
public class IngredientManagerBuilder implements IModIngredientRegistration {
    ...
    public <V> void register(IIngredientType<V> ingredientType, Collection<V> allIngredients, IIngredientHelper<V> ingredientHelper, IIngredientRenderer<V> ingredientRenderer) {
        ...
        Preconditions.checkArgument(ingredientRenderer.getWidth() == 16, "the default ingredient renderer registered here will be used for drawing ingredients in the ingredient list, and it must have a width of 16");
        Preconditions.checkArgument(ingredientRenderer.getHeight() == 16, "the default ingredient renderer registered here will be used for drawing ingredients in the ingredient list, and it must have a height of 16");
        if (this.registeredIngredientSet.contains(ingredientType)) {
            ...
            this.ingredientInfos.add(new IngredientInfo<>(ingredientType, allIngredients, ingredientHelper, ingredientRenderer));
