...
public class RecipeCatalystRegistration implements IRecipeCatalystRegistration {
    ...
    public <T> void addRecipeCatalyst(IIngredientType<T> ingredientType, T ingredient, RecipeType<?>... recipeTypes) {
        ...
        for (RecipeType<?> recipeType : recipeTypes) {
            ...
            ITypedIngredient<T> typedIngredient = (ITypedIngredient<T>) TypedIngredient.createAndFilterInvalid(this.ingredientManager, ingredientType, ingredient).orElseThrow(() -> new IllegalArgumentException("Recipe catalyst must not be empty"));
