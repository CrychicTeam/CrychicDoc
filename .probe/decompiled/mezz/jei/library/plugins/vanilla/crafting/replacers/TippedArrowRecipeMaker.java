...
public final class TippedArrowRecipeMaker {
    ...
    public static List<CraftingRecipe> createRecipes(IStackHelper stackHelper) {
        ...
        return potionRegistry.getValues().map(potion -> {
            ...
            NonNullList<Ingredient> inputs = NonNullList.of(Ingredient.EMPTY, arrowIngredient, arrowIngredient, arrowIngredient, arrowIngredient, potionIngredient, arrowIngredient, arrowIngredient, arrowIngredient, arrowIngredient);
            ResourceLocation id = new ResourceLocation("minecraft", "jei.tipped.arrow." + output.getDescriptionId());
