...
public class BiomeSpawnsEventJS extends EventJS {
    ...
    @HideFromJS
    public final List<BiomeSpawnsEventJS.Addition> additions = new ArrayList();

    @HideFromJS
    public final List<BiomeSpawnsEventJS.Removal> removals = new ArrayList();
    ...
    @Generics({ Entity.class, String.class })
    public void addSpawn(EntityType<?> entityType, List<String> biomes, int weight, int minCount, int maxCount) {
        this.additions.add(new BiomeSpawnsEventJS.Addition(entityType, new MobSpawnSettings.SpawnerData(entityType, Weight.of(weight), minCount, maxCount), processBiomes(biomes)));
    }
    ...
    public void removeSpawn(EntityType<?> entityType, List<String> biomes) {
        this.removals.add(new BiomeSpawnsEventJS.Removal(entityType, processBiomes(biomes)));
    }
    ...
    public static record Addition(EntityType<?> entityType, MobSpawnSettings.SpawnerData spawnData, List<Either<ResourceLocation, TagKey<Biome>>> biomes) {
    }

    public static record Removal(EntityType<?> entityType, List<Either<ResourceLocation, TagKey<Biome>>> biomes) {
    }
}