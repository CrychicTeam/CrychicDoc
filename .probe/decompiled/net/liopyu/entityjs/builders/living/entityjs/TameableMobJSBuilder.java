...
public class TameableMobJSBuilder extends TameableMobBuilder<TameableMobJS> {
    ...
    public AttributeSupplier.Builder getAttributeBuilder() {
        return TameableMobJS.m_21552_().add(Attributes.MAX_HEALTH).add(Attributes.FOLLOW_RANGE).add(Attributes.ATTACK_DAMAGE).add(Attributes.ARMOR).add(Attributes.ARMOR_TOUGHNESS).add(Attributes.ATTACK_SPEED).add(Attributes.ATTACK_KNOCKBACK).add(Attributes.LUCK);
    }
}