...
public class NonAnimatableEntityTypeBuilder<B extends Entity> {
    ...
    public EntityType<B> get() {
        BaseNonAnimatableEntityBuilder<?> js = this.builder;
        EntityType.Builder<?> builder = EntityType.Builder.of(js.factory(), js.mobCategory);
        ...
        return UtilsJS.cast(builder.build(js.id.toString()));
    }
}