...
public class ArrowEntityJSBuilder extends ArrowEntityBuilder<ArrowEntityJS> {
    ...
    public ArrowEntityJSBuilder(ResourceLocation i) {
        super(i);
        this.item = (ArrowItemBuilder) new ArrowItemBuilder(this.id, this).canBePickedup(true).texture(i.getNamespace() + ":item/" + i.getPath()).tag(new ResourceLocation("minecraft:arrows"));
    }
    ...
    @Generics({ ArrowEntityBuilder.class })
