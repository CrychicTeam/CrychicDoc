...
public class ForgeCommand {
    ...
    public ForgeCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) LiteralArgumentBuilder.literal("forge").then(TPSCommand.register())).then(TrackCommand.register())).then(EntityCommand.register())).then(GenerateCommand.register())).then(DimensionsCommand.register())).then(ModListCommand.register())).then(TagsCommand.register()));
    }
}