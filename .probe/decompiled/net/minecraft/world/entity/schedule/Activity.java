...
public class Activity {
    ...
    private Activity(String string0) {
        this.name = string0;
        this.hashCode = string0.hashCode();
    }
    ...
    private static Activity register(String string0) {
        return Registry.register(BuiltInRegistries.ACTIVITY, string0, new Activity(string0));
    }
