...
public class SensorType<U extends Sensor<?>> {
    ...
    private SensorType(Supplier<U> supplierU0) {
        this.factory = supplierU0;
    }
    ...
    private static <U extends Sensor<?>> SensorType<U> register(String string0, Supplier<U> supplierU1) {
        return Registry.register(BuiltInRegistries.SENSOR_TYPE, new ResourceLocation(string0), new SensorType<>(supplierU1));
    }
}