...
public class MemoryModuleType<U> {
    ...
    @VisibleForTesting
    public MemoryModuleType(Optional<Codec<U>> optionalCodecU0) {
        this.codec = optionalCodecU0.map(ExpirableValue::m_26304_);
    }
    ...
    private static <U> MemoryModuleType<U> register(String string0, Codec<U> codecU1) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(string0), new MemoryModuleType<>(Optional.of(codecU1)));
    }

    private static <U> MemoryModuleType<U> register(String string0) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(string0), new MemoryModuleType<>(Optional.empty()));
    }
}