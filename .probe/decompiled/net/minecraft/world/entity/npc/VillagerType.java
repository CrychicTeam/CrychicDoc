...
public final class VillagerType {
    ...
    private VillagerType(String string0) {
        this.name = string0;
    }
    ...
    private static VillagerType register(String string0) {
        return Registry.register(BuiltInRegistries.VILLAGER_TYPE, new ResourceLocation(string0), new VillagerType(string0));
    }

    public static VillagerType byBiome(Holder<Biome> holderBiome0) {
        return (VillagerType) holderBiome0.unwrapKey().map(BY_BIOME::get).orElse(PLAINS);
    }
}