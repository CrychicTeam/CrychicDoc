...
public interface PalettedContainerRO<T> {
    ...
    public static record PackedData<T>(List<T> f_238184_, Optional<LongStream> f_238179_) {

        private final List<T> paletteEntries;

        private final Optional<LongStream> storage;

        public PackedData(List<T> f_238184_, Optional<LongStream> f_238179_) {
            this.paletteEntries = f_238184_;
            this.storage = f_238179_;
        }
    }
