...
public class PiglinWallSkullBlock extends WallSkullBlock {
    ...
    public PiglinWallSkullBlock(BlockBehaviour.Properties blockBehaviourProperties0) {
        super(SkullBlock.Types.PIGLIN, blockBehaviourProperties0);
    }

    @Override
    public VoxelShape getShape(BlockState blockState0, BlockGetter blockGetter1, BlockPos blockPos2, CollisionContext collisionContext3) {
        return (VoxelShape) AABBS.get(blockState0.m_61143_(f_58097_));
    }
}