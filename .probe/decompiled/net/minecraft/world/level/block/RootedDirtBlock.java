...
public class RootedDirtBlock extends Block implements BonemealableBlock {
    ...
    public RootedDirtBlock(BlockBehaviour.Properties blockBehaviourProperties0) {
    ...
    public void performBonemeal(ServerLevel serverLevel0, RandomSource randomSource1, BlockPos blockPos2, BlockState blockState3) {
        serverLevel0.m_46597_(blockPos2.below(), Blocks.HANGING_ROOTS.defaultBlockState());
    }
}