...
public class BarrelBlockEntity extends RandomizableContainerBlockEntity {
    ...
    public BarrelBlockEntity(BlockPos blockPos0, BlockState blockState1) {
        super(BlockEntityType.BARREL, blockPos0, blockState1);
    }
    ...
    void updateBlockState(BlockState blockState0, boolean boolean1) {
        this.f_58857_.setBlock(this.m_58899_(), (BlockState) blockState0.m_61124_(BarrelBlock.OPEN, boolean1), 3);
    }

    void playSound(BlockState blockState0, SoundEvent soundEvent1) {
        Vec3i $$2 = ((Direction) blockState0.m_61143_(BarrelBlock.FACING)).getNormal();
        double $$3 = (double) this.f_58858_.m_123341_() + 0.5 + (double) $$2.getX() / 2.0;
        double $$4 = (double) this.f_58858_.m_123342_() + 0.5 + (double) $$2.getY() / 2.0;
        double $$5 = (double) this.f_58858_.m_123343_() + 0.5 + (double) $$2.getZ() / 2.0;
        this.f_58857_.playSound(null, $$3, $$4, $$5, soundEvent1, SoundSource.BLOCKS, 0.5F, this.f_58857_.random.nextFloat() * 0.1F + 0.9F);
    }
}