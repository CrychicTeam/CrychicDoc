...
public class DecoratedPotPatterns {
    ...
    private static ResourceKey<String> create(String string0) {
        return ResourceKey.create(Registries.DECORATED_POT_PATTERNS, new ResourceLocation(string0));
    }

    public static ResourceLocation location(ResourceKey<String> resourceKeyString0) {
        return resourceKeyString0.location().withPrefix("entity/decorated_pot/");
    }

    @Nullable
    public static ResourceKey<String> getResourceKey(Item item0) {
        return (ResourceKey<String>) ITEM_TO_POT_TEXTURE.get(item0);
    }

    public static String bootstrap(Registry<String> registryString0) {
        Registry.register(registryString0, BRICK, "decorated_pot_side");
        Registry.register(registryString0, ANGLER, "angler_pottery_pattern");
        Registry.register(registryString0, ARCHER, "archer_pottery_pattern");
        Registry.register(registryString0, ARMS_UP, "arms_up_pottery_pattern");
        Registry.register(registryString0, BLADE, "blade_pottery_pattern");
        Registry.register(registryString0, BREWER, "brewer_pottery_pattern");
        Registry.register(registryString0, BURN, "burn_pottery_pattern");
        Registry.register(registryString0, DANGER, "danger_pottery_pattern");
        Registry.register(registryString0, EXPLORER, "explorer_pottery_pattern");
        Registry.register(registryString0, FRIEND, "friend_pottery_pattern");
        Registry.register(registryString0, HEART, "heart_pottery_pattern");
        Registry.register(registryString0, HEARTBREAK, "heartbreak_pottery_pattern");
        Registry.register(registryString0, HOWL, "howl_pottery_pattern");
        Registry.register(registryString0, MINER, "miner_pottery_pattern");
        Registry.register(registryString0, MOURNER, "mourner_pottery_pattern");
        Registry.register(registryString0, PLENTY, "plenty_pottery_pattern");
        Registry.register(registryString0, PRIZE, "prize_pottery_pattern");
        Registry.register(registryString0, SHEAF, "sheaf_pottery_pattern");
        Registry.register(registryString0, SHELTER, "shelter_pottery_pattern");
        Registry.register(registryString0, SKULL, "skull_pottery_pattern");
        Registry.register(registryString0, SNORT, "snort_pottery_pattern");
        return Registry.register(registryString0, BASE, "decorated_pot_base");
    }
}