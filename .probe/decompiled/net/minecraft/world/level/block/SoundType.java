...
public class SoundType {
    ...
    public SoundType(float float0, float float1, SoundEvent soundEvent2, SoundEvent soundEvent3, SoundEvent soundEvent4, SoundEvent soundEvent5, SoundEvent soundEvent6) {
        this.volume = float0;
        this.pitch = float1;
        this.breakSound = soundEvent2;
        this.stepSound = soundEvent3;
        this.placeSound = soundEvent4;
        this.hitSound = soundEvent5;
        this.fallSound = soundEvent6;
    }
