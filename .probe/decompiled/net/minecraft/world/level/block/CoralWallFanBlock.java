...
public class CoralWallFanBlock extends BaseCoralWallFanBlock {
    ...
    protected CoralWallFanBlock(Block block0, BlockBehaviour.Properties blockBehaviourProperties1) {
    ...
    public void tick(BlockState blockState0, ServerLevel serverLevel1, BlockPos blockPos2, RandomSource randomSource3) {
        if (!m_49186_(blockState0, serverLevel1, blockPos2)) {
            serverLevel1.m_7731_(blockPos2, (BlockState) ((BlockState) this.deadBlock.defaultBlockState().m_61124_(f_49158_, false)).m_61124_(f_49192_, (Direction) blockState0.m_61143_(f_49192_)), 2);
        }
    }

    @Override
    public BlockState updateShape(BlockState blockState0, Direction direction1, BlockState blockState2, LevelAccessor levelAccessor3, BlockPos blockPos4, BlockPos blockPos5) {
        if (direction1.getOpposite() == blockState0.m_61143_(f_49192_) && !blockState0.m_60710_(levelAccessor3, blockPos4)) {
