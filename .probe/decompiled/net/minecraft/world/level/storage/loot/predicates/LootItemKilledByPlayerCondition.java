...
public class LootItemKilledByPlayerCondition implements LootItemCondition {
    ...
    public boolean test(LootContext lootContext0) {
        return lootContext0.hasParam(LootContextParams.LAST_DAMAGE_PLAYER);
    }
    ...
    public static class Serializer implements net.minecraft.world.level.storage.loot.Serializer<LootItemKilledByPlayerCondition> {
        ...
        public void serialize(JsonObject jsonObject0, LootItemKilledByPlayerCondition lootItemKilledByPlayerCondition1, JsonSerializationContext jsonSerializationContext2) {
        }

        public LootItemKilledByPlayerCondition deserialize(JsonObject jsonObject0, JsonDeserializationContext jsonDeserializationContext1) {
