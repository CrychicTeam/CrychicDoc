...
public class LootPoolEntries {
    ...
    private static LootPoolEntryType register(String string0, Serializer<? extends LootPoolEntryContainer> serializerExtendsLootPoolEntryContainer1) {
        return Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(string0), new LootPoolEntryType(serializerExtendsLootPoolEntryContainer1));
    }

    public static Object createGsonAdapter() {
        return GsonAdapterFactory.<LootPoolEntryContainer, LootPoolEntryType>builder(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, "entry", "type", LootPoolEntryContainer::m_6751_).build();
    }
}