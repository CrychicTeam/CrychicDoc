...
public interface BlockPredicateType<P extends BlockPredicate> {
    ...
    private static <P extends BlockPredicate> BlockPredicateType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.BLOCK_PREDICATE_TYPE, string0, () -> codecP1);
    }
}