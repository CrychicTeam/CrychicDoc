...
public class Noises {
    ...
    private static ResourceKey<NormalNoise.NoiseParameters> createKey(String string0) {
        return ResourceKey.create(Registries.NOISE, new ResourceLocation(string0));
    }

    public static NormalNoise instantiate(HolderGetter<NormalNoise.NoiseParameters> holderGetterNormalNoiseNoiseParameters0, PositionalRandomFactory positionalRandomFactory1, ResourceKey<NormalNoise.NoiseParameters> resourceKeyNormalNoiseNoiseParameters2) {
        Holder<NormalNoise.NoiseParameters> $$3 = holderGetterNormalNoiseNoiseParameters0.getOrThrow(resourceKeyNormalNoiseNoiseParameters2);
        return NormalNoise.create(positionalRandomFactory1.fromHashOf(((ResourceKey) $$3.unwrapKey().orElseThrow()).location()), $$3.value());
    }
}