...
public class TrunkPlacerType<P extends TrunkPlacer> {
    ...
    private static <P extends TrunkPlacer> TrunkPlacerType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.TRUNK_PLACER_TYPE, string0, new TrunkPlacerType<>(codecP1));
    }

    private TrunkPlacerType(Codec<P> codecP0) {
        this.codec = codecP0;
    }
