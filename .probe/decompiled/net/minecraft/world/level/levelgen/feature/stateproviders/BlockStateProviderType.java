...
public class BlockStateProviderType<P extends BlockStateProvider> {
    ...
    private static <P extends BlockStateProvider> BlockStateProviderType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.BLOCKSTATE_PROVIDER_TYPE, string0, new BlockStateProviderType<>(codecP1));
    }

    private BlockStateProviderType(Codec<P> codecP0) {
        this.codec = codecP0;
    }
