...
public class TreeDecoratorType<P extends TreeDecorator> {
    ...
    private static <P extends TreeDecorator> TreeDecoratorType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.TREE_DECORATOR_TYPE, string0, new TreeDecoratorType<>(codecP1));
    }

    private TreeDecoratorType(Codec<P> codecP0) {
        this.codec = codecP0;
    }
