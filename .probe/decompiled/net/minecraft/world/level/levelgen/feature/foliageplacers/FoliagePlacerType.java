...
public class FoliagePlacerType<P extends FoliagePlacer> {
    ...
    private static <P extends FoliagePlacer> FoliagePlacerType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.FOLIAGE_PLACER_TYPE, string0, new FoliagePlacerType<>(codecP1));
    }

    private FoliagePlacerType(Codec<P> codecP0) {
        this.codec = codecP0;
    }
