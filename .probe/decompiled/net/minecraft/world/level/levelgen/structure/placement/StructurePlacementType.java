...
public interface StructurePlacementType<SP extends StructurePlacement> {
    ...
    private static <SP extends StructurePlacement> StructurePlacementType<SP> register(String string0, Codec<SP> codecSP1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_PLACEMENT, string0, () -> codecSP1);
    }
}