...
public interface PosRuleTestType<P extends PosRuleTest> {
    ...
    static <P extends PosRuleTest> PosRuleTestType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.POS_RULE_TEST, string0, () -> codecP1);
    }
}