...
public interface StructurePieceType {
    ...
    StructurePieceType OCEAN_RUIN = setTemplatePieceId(OceanRuinPieces.OceanRuinPiece::m_277007_, "ORP");
    ...
    private static StructurePieceType setFullContextPieceId(StructurePieceType structurePieceType0, String string1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_PIECE, string1.toLowerCase(Locale.ROOT), structurePieceType0);
    }

    private static StructurePieceType setPieceId(StructurePieceType.ContextlessType structurePieceTypeContextlessType0, String string1) {
        return setFullContextPieceId(structurePieceTypeContextlessType0, string1);
    }

    private static StructurePieceType setTemplatePieceId(StructurePieceType.StructureTemplateType structurePieceTypeStructureTemplateType0, String string1) {
        return setFullContextPieceId(structurePieceTypeStructureTemplateType0, string1);
    }
    ...
    public interface ContextlessType extends StructurePieceType {
        ...
        @Override
        default StructurePiece load(StructurePieceSerializationContext structurePieceSerializationContext0, CompoundTag compoundTag1) {
            return this.load(compoundTag1);
        }
    }
    ...
    public interface StructureTemplateType extends StructurePieceType {
        ...
        @Override
        default StructurePiece load(StructurePieceSerializationContext structurePieceSerializationContext0, CompoundTag compoundTag1) {
            return this.load(structurePieceSerializationContext0.structureTemplateManager(), compoundTag1);
        }
    }
}