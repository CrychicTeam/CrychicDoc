...
public interface StructureType<S extends Structure> {
    ...
    private static <S extends Structure> StructureType<S> register(String string0, Codec<S> codecS1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_TYPE, string0, () -> codecS1);
    }
}