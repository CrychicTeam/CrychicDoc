...
public interface RuleBlockEntityModifierType<P extends RuleBlockEntityModifier> {
    ...
    private static <P extends RuleBlockEntityModifier> RuleBlockEntityModifierType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.RULE_BLOCK_ENTITY_MODIFIER, string0, () -> codecP1);
    }
}