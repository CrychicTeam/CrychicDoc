...
public interface StructurePoolElementType<P extends StructurePoolElement> {
    ...
    static <P extends StructurePoolElement> StructurePoolElementType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_POOL_ELEMENT, string0, () -> codecP1);
    }
}