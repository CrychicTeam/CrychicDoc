...
public interface PlacementModifierType<P extends PlacementModifier> {
    ...
    private static <P extends PlacementModifier> PlacementModifierType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, string0, () -> codecP1);
    }
}