...
public class SnowballItem extends Item {
    ...
    public SnowballItem(Item.Properties itemProperties0) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level0, Player player1, InteractionHand interactionHand2) {
        ...
        level0.playSound(null, player1.m_20185_(), player1.m_20186_(), player1.m_20189_(), SoundEvents.SNOWBALL_THROW, SoundSource.NEUTRAL, 0.5F, 0.4F / (level0.getRandom().nextFloat() * 0.4F + 0.8F));
        if (!level0.isClientSide) {
            Snowball $$4 = new Snowball(level0, player1);
            $$4.m_37446_($$3);
