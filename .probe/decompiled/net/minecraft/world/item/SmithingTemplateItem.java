...
public class SmithingTemplateItem extends Item {
    ...
    public SmithingTemplateItem(Component component0, Component component1, Component component2, Component component3, Component component4, List<ResourceLocation> listResourceLocation5, List<ResourceLocation> listResourceLocation6) {
        super(new Item.Properties());
        this.appliesTo = component0;
        ...
        this.baseSlotEmptyIcons = listResourceLocation5;
        this.additionalSlotEmptyIcons = listResourceLocation6;
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceKey<TrimPattern> resourceKeyTrimPattern0) {
        return createArmorTrimTemplate(resourceKeyTrimPattern0.location());
    }

    public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation resourceLocation0) {
        return new SmithingTemplateItem(ARMOR_TRIM_APPLIES_TO, ARMOR_TRIM_INGREDIENTS, Component.translatable(Util.makeDescriptionId("trim_pattern", resourceLocation0)).withStyle(TITLE_FORMAT), ARMOR_TRIM_BASE_SLOT_DESCRIPTION, ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION, createTrimmableArmorIconList(), createTrimmableMaterialIconList());
    }
    ...
    public void appendHoverText(ItemStack itemStack0, @Nullable Level level1, List<Component> listComponent2, TooltipFlag tooltipFlag3) {
        ...
        listComponent2.add(this.upgradeDescription);
        listComponent2.add(CommonComponents.EMPTY);
        listComponent2.add(APPLIES_TO_TITLE);
        listComponent2.add(CommonComponents.space().append(this.appliesTo));
        listComponent2.add(INGREDIENTS_TITLE);
        listComponent2.add(CommonComponents.space().append(this.ingredients));
    }
