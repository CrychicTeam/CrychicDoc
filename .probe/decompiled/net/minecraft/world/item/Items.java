...
public class Items {
    ...
    public static Item registerBlock(Block block0) {
        return registerBlock(new BlockItem(block0, new Item.Properties()));
    }

    public static Item registerBlock(Block block0, Block... block1) {
        BlockItem $$2 = new BlockItem(block0, new Item.Properties());
        for (Block $$3 : block1) {
            Item.BY_BLOCK.put($$3, $$2);
        }
        return registerBlock($$2);
    }

    public static Item registerBlock(BlockItem blockItem0) {
        return registerBlock(blockItem0.getBlock(), blockItem0);
    }

    public static Item registerBlock(Block block0, Item item1) {
        return registerItem(BuiltInRegistries.BLOCK.getKey(block0), item1);
    }

    public static Item registerItem(String string0, Item item1) {
        return registerItem(new ResourceLocation(string0), item1);
    }

    public static Item registerItem(ResourceLocation resourceLocation0, Item item1) {
        return registerItem(ResourceKey.create(BuiltInRegistries.ITEM.m_123023_(), resourceLocation0), item1);
    }

    public static Item registerItem(ResourceKey<Item> resourceKeyItem0, Item item1) {
        if (item1 instanceof BlockItem) {
            ((BlockItem) item1).registerBlocks(Item.BY_BLOCK, item1);
        }
        return Registry.register(BuiltInRegistries.ITEM, resourceKeyItem0, item1);
    }
}