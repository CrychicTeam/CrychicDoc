...
public class Enchantments {
    ...
    private static Enchantment register(String string0, Enchantment enchantment1) {
        return Registry.register(BuiltInRegistries.ENCHANTMENT, string0, enchantment1);
    }
}