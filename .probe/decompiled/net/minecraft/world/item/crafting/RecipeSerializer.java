...
public interface RecipeSerializer<T extends Recipe<?>> {
    ...
    static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(String string0, S s1) {
        return Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, string0, s1);
    }
}