...
public interface RecipeType<T extends Recipe<?>> {
    ...
    static <T extends Recipe<?>> RecipeType<T> register(final String string0) {
        return Registry.register(BuiltInRegistries.RECIPE_TYPE, new ResourceLocation(string0), new RecipeType<T>() {
