...
public class Potions {
    ...
    private static Potion register(String string0, Potion potion1) {
        return Registry.register(BuiltInRegistries.POTION, string0, potion1);
    }

    private static Potion register(ResourceKey<Potion> resourceKeyPotion0, Potion potion1) {
        return Registry.register(BuiltInRegistries.POTION, resourceKeyPotion0, potion1);
    }
}