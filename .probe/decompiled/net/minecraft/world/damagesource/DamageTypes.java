...
public interface DamageTypes {
    ...
    static void bootstrap(BootstapContext<DamageType> bootstapContextDamageType0) {
        bootstapContextDamageType0.register(IN_FIRE, new DamageType("inFire", 0.1F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(LIGHTNING_BOLT, new DamageType("lightningBolt", 0.1F));
        bootstapContextDamageType0.register(ON_FIRE, new DamageType("onFire", 0.0F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(LAVA, new DamageType("lava", 0.1F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(HOT_FLOOR, new DamageType("hotFloor", 0.1F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(IN_WALL, new DamageType("inWall", 0.0F));
        bootstapContextDamageType0.register(CRAMMING, new DamageType("cramming", 0.0F));
        bootstapContextDamageType0.register(DROWN, new DamageType("drown", 0.0F, DamageEffects.DROWNING));
        bootstapContextDamageType0.register(STARVE, new DamageType("starve", 0.0F));
        bootstapContextDamageType0.register(CACTUS, new DamageType("cactus", 0.1F));
        bootstapContextDamageType0.register(FALL, new DamageType("fall", DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0.0F, DamageEffects.HURT, DeathMessageType.FALL_VARIANTS));
        bootstapContextDamageType0.register(FLY_INTO_WALL, new DamageType("flyIntoWall", 0.0F));
        bootstapContextDamageType0.register(FELL_OUT_OF_WORLD, new DamageType("outOfWorld", 0.0F));
        bootstapContextDamageType0.register(GENERIC, new DamageType("generic", 0.0F));
        bootstapContextDamageType0.register(MAGIC, new DamageType("magic", 0.0F));
        bootstapContextDamageType0.register(WITHER, new DamageType("wither", 0.0F));
        bootstapContextDamageType0.register(DRAGON_BREATH, new DamageType("dragonBreath", 0.0F));
        bootstapContextDamageType0.register(DRY_OUT, new DamageType("dryout", 0.1F));
        bootstapContextDamageType0.register(SWEET_BERRY_BUSH, new DamageType("sweetBerryBush", 0.1F, DamageEffects.POKING));
        bootstapContextDamageType0.register(FREEZE, new DamageType("freeze", 0.0F, DamageEffects.FREEZING));
        bootstapContextDamageType0.register(STALAGMITE, new DamageType("stalagmite", 0.0F));
        bootstapContextDamageType0.register(FALLING_BLOCK, new DamageType("fallingBlock", 0.1F));
        bootstapContextDamageType0.register(FALLING_ANVIL, new DamageType("anvil", 0.1F));
        bootstapContextDamageType0.register(FALLING_STALACTITE, new DamageType("fallingStalactite", 0.1F));
        bootstapContextDamageType0.register(STING, new DamageType("sting", 0.1F));
        bootstapContextDamageType0.register(MOB_ATTACK, new DamageType("mob", 0.1F));
        bootstapContextDamageType0.register(MOB_ATTACK_NO_AGGRO, new DamageType("mob", 0.1F));
        bootstapContextDamageType0.register(PLAYER_ATTACK, new DamageType("player", 0.1F));
        bootstapContextDamageType0.register(ARROW, new DamageType("arrow", 0.1F));
        bootstapContextDamageType0.register(TRIDENT, new DamageType("trident", 0.1F));
        bootstapContextDamageType0.register(MOB_PROJECTILE, new DamageType("mob", 0.1F));
        bootstapContextDamageType0.register(FIREWORKS, new DamageType("fireworks", 0.1F));
        bootstapContextDamageType0.register(UNATTRIBUTED_FIREBALL, new DamageType("onFire", 0.1F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(FIREBALL, new DamageType("fireball", 0.1F, DamageEffects.BURNING));
        bootstapContextDamageType0.register(WITHER_SKULL, new DamageType("witherSkull", 0.1F));
        bootstapContextDamageType0.register(THROWN, new DamageType("thrown", 0.1F));
        bootstapContextDamageType0.register(INDIRECT_MAGIC, new DamageType("indirectMagic", 0.0F));
        bootstapContextDamageType0.register(THORNS, new DamageType("thorns", 0.1F, DamageEffects.THORNS));
        bootstapContextDamageType0.register(EXPLOSION, new DamageType("explosion", DamageScaling.ALWAYS, 0.1F));
        bootstapContextDamageType0.register(PLAYER_EXPLOSION, new DamageType("explosion.player", DamageScaling.ALWAYS, 0.1F));
        bootstapContextDamageType0.register(SONIC_BOOM, new DamageType("sonic_boom", DamageScaling.ALWAYS, 0.0F));
        bootstapContextDamageType0.register(BAD_RESPAWN_POINT, new DamageType("badRespawnPoint", DamageScaling.ALWAYS, 0.1F, DamageEffects.HURT, DeathMessageType.INTENTIONAL_GAME_DESIGN));
        bootstapContextDamageType0.register(OUTSIDE_BORDER, new DamageType("outsideBorder", 0.0F));
        bootstapContextDamageType0.register(GENERIC_KILL, new DamageType("genericKill", 0.0F));
    }
}