...
public class BlockFamilies {
    ...
    private static BlockFamily.Builder familyBuilder(Block block0) {
        BlockFamily.Builder $$1 = new BlockFamily.Builder(block0);
        BlockFamily $$2 = (BlockFamily) MAP.put(block0, $$1.getFamily());
        if ($$2 != null) {
            throw new IllegalStateException("Duplicate family definition for " + BuiltInRegistries.BLOCK.getKey(block0));
        } else {
            return $$1;
        }
    }
