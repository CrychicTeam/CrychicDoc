...
public class ItemModelGenerators {
    ...
    public ItemModelGenerators(BiConsumer<ResourceLocation, Supplier<JsonElement>> biConsumerResourceLocationSupplierJsonElement0) {
        this.output = biConsumerResourceLocationSupplierJsonElement0;
    }

    private void generateFlatItem(Item item0, ModelTemplate modelTemplate1) {
        modelTemplate1.create(ModelLocationUtils.getModelLocation(item0), TextureMapping.layer0(item0), this.output);
    }

    private void generateFlatItem(Item item0, String string1, ModelTemplate modelTemplate2) {
        modelTemplate2.create(ModelLocationUtils.getModelLocation(item0, string1), TextureMapping.layer0(TextureMapping.getItemTexture(item0, string1)), this.output);
    }

    private void generateFlatItem(Item item0, Item item1, ModelTemplate modelTemplate2) {
        modelTemplate2.create(ModelLocationUtils.getModelLocation(item0), TextureMapping.layer0(item1), this.output);
    }

    private void generateCompassItem(Item item0) {
        for (int $$1 = 0; $$1 < 32; $$1++) {
            if ($$1 != 16) {
                this.generateFlatItem(item0, String.format(Locale.ROOT, "_%02d", $$1), ModelTemplates.FLAT_ITEM);
            }
        }
    }

    private void generateClockItem(Item item0) {
        for (int $$1 = 1; $$1 < 64; $$1++) {
            this.generateFlatItem(item0, String.format(Locale.ROOT, "_%02d", $$1), ModelTemplates.FLAT_ITEM);
        }
    }

    private void generateLayeredItem(ResourceLocation resourceLocation0, ResourceLocation resourceLocation1, ResourceLocation resourceLocation2) {
        ModelTemplates.TWO_LAYERED_ITEM.create(resourceLocation0, TextureMapping.layered(resourceLocation1, resourceLocation2), this.output);
    }

    private void generateLayeredItem(ResourceLocation resourceLocation0, ResourceLocation resourceLocation1, ResourceLocation resourceLocation2, ResourceLocation resourceLocation3) {
        ModelTemplates.THREE_LAYERED_ITEM.create(resourceLocation0, TextureMapping.layered(resourceLocation1, resourceLocation2, resourceLocation3), this.output);
    }

    private ResourceLocation getItemModelForTrimMaterial(ResourceLocation resourceLocation0, String string1) {
        return resourceLocation0.withSuffix("_" + string1 + "_trim");
    }

    private JsonObject generateBaseArmorTrimTemplate(ResourceLocation resourceLocation0, Map<TextureSlot, ResourceLocation> mapTextureSlotResourceLocation1, ArmorMaterial armorMaterial2) {
        JsonObject $$3 = ModelTemplates.TWO_LAYERED_ITEM.createBaseTemplate(resourceLocation0, mapTextureSlotResourceLocation1);
        JsonArray $$4 = new JsonArray();
        for (ItemModelGenerators.TrimModelData $$5 : GENERATED_TRIM_MODELS) {
            JsonObject $$6 = new JsonObject();
            JsonObject $$7 = new JsonObject();
            $$7.addProperty(TRIM_TYPE_PREDICATE_ID.getPath(), $$5.itemModelIndex());
            $$6.add("predicate", $$7);
            $$6.addProperty("model", this.getItemModelForTrimMaterial(resourceLocation0, $$5.name(armorMaterial2)).toString());
            $$4.add($$6);
        }
        $$3.add("overrides", $$4);
        return $$3;
    ...
    private void generateArmorTrims(ArmorItem armorItem0) {
        ResourceLocation $$1 = ModelLocationUtils.getModelLocation(armorItem0);
        ResourceLocation $$2 = TextureMapping.getItemTexture(armorItem0);
        ResourceLocation $$3 = TextureMapping.getItemTexture(armorItem0, "_overlay");
        if (armorItem0.getMaterial() == ArmorMaterials.LEATHER) {
            ModelTemplates.TWO_LAYERED_ITEM.create($$1, TextureMapping.layered($$2, $$3), this.output, (p_267902_, p_267903_) -> this.generateBaseArmorTrimTemplate(p_267902_, p_267903_, armorItem0.getMaterial()));
        } else {
            ModelTemplates.FLAT_ITEM.create($$1, TextureMapping.layer0($$2), this.output, (p_267905_, p_267906_) -> this.generateBaseArmorTrimTemplate(p_267905_, p_267906_, armorItem0.getMaterial()));
        }
        for (ItemModelGenerators.TrimModelData $$4 : GENERATED_TRIM_MODELS) {
            String $$5 = $$4.name(armorItem0.getMaterial());
            ResourceLocation $$6 = this.getItemModelForTrimMaterial($$1, $$5);
            String $$7 = armorItem0.getType().getName() + "_trim_" + $$5;
            ResourceLocation $$8 = new ResourceLocation($$7).withPrefix("trims/items/");
            if (armorItem0.getMaterial() == ArmorMaterials.LEATHER) {
                this.generateLayeredItem($$6, $$2, $$3, $$8);
            } else {
                this.generateLayeredItem($$6, $$2, $$8);
            }
        }
    }
    ...
    static record TrimModelData(String f_265890_, float f_265849_, Map<ArmorMaterial, String> f_267444_) {
        ...
        TrimModelData(String f_265890_, float f_265849_, Map<ArmorMaterial, String> f_267444_) {
            this.name = f_265890_;
            this.itemModelIndex = f_265849_;
            this.overrideArmorMaterials = f_267444_;
        }

        public String name(ArmorMaterial p_268105_) {
            return (String) this.overrideArmorMaterials.getOrDefault(p_268105_, this.name);
        }
    }
}