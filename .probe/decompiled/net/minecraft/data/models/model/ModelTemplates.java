...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = (ModelTemplate[]) IntStream.range(0, 8).mapToObj(p_125729_ -> create("stem_growth" + p_125729_, "_stage" + p_125729_, TextureSlot.STEM)).toArray(ModelTemplate[]::new);
    ...
    private static ModelTemplate create(TextureSlot... textureSlot0) {
        return new ModelTemplate(Optional.empty(), Optional.empty(), textureSlot0);
    }

    private static ModelTemplate create(String string0, TextureSlot... textureSlot1) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + string0)), Optional.empty(), textureSlot1);
    }

    private static ModelTemplate createItem(String string0, TextureSlot... textureSlot1) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + string0)), Optional.empty(), textureSlot1);
    }

    private static ModelTemplate create(String string0, String string1, TextureSlot... textureSlot2) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + string0)), Optional.of(string1), textureSlot2);
    }
}