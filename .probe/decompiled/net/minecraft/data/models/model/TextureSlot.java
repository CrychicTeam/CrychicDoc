...
public final class TextureSlot {
    ...
    private static TextureSlot create(String string0) {
        return new TextureSlot(string0, null);
    }

    private static TextureSlot create(String string0, TextureSlot textureSlot1) {
        return new TextureSlot(string0, textureSlot1);
    }

    private TextureSlot(String string0, @Nullable TextureSlot textureSlot1) {
        this.id = string0;
        this.parent = textureSlot1;
    }
