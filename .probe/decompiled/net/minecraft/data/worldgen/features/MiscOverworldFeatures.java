...
public class MiscOverworldFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContextConfiguredFeature0) {
        FeatureUtils.register(bootstapContextConfiguredFeature0, ICE_SPIKE, Feature.ICE_SPIKE);
        FeatureUtils.register(bootstapContextConfiguredFeature0, ICE_PATCH, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.PACKED_ICE), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.MYCELIUM, Blocks.SNOW_BLOCK, Blocks.ICE)), UniformInt.of(2, 3), 1));
        FeatureUtils.register(bootstapContextConfiguredFeature0, FOREST_ROCK, Feature.FOREST_ROCK, new BlockStateConfiguration(Blocks.MOSSY_COBBLESTONE.defaultBlockState()));
        FeatureUtils.register(bootstapContextConfiguredFeature0, ICEBERG_PACKED, Feature.ICEBERG, new BlockStateConfiguration(Blocks.PACKED_ICE.defaultBlockState()));
        FeatureUtils.register(bootstapContextConfiguredFeature0, ICEBERG_BLUE, Feature.ICEBERG, new BlockStateConfiguration(Blocks.BLUE_ICE.defaultBlockState()));
        FeatureUtils.register(bootstapContextConfiguredFeature0, BLUE_ICE, Feature.BLUE_ICE);
        FeatureUtils.register(bootstapContextConfiguredFeature0, LAKE_LAVA, Feature.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(Blocks.LAVA.defaultBlockState()), BlockStateProvider.simple(Blocks.STONE.defaultBlockState())));
        FeatureUtils.register(bootstapContextConfiguredFeature0, DISK_CLAY, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.CLAY), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.CLAY)), UniformInt.of(2, 3), 1));
        FeatureUtils.register(bootstapContextConfiguredFeature0, DISK_GRAVEL, Feature.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.GRAVEL), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 5), 2));
        FeatureUtils.register(bootstapContextConfiguredFeature0, DISK_SAND, Feature.DISK, new DiskConfiguration(new RuleBasedBlockStateProvider(BlockStateProvider.simple(Blocks.SAND), List.of(new RuleBasedBlockStateProvider.Rule(BlockPredicate.matchesBlocks(Direction.DOWN.getNormal(), Blocks.AIR), BlockStateProvider.simple(Blocks.SANDSTONE)))), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.GRASS_BLOCK)), UniformInt.of(2, 6), 2));
        FeatureUtils.register(bootstapContextConfiguredFeature0, FREEZE_TOP_LAYER, Feature.FREEZE_TOP_LAYER);
        ...
        FeatureUtils.register(bootstapContextConfiguredFeature0, BONUS_CHEST, Feature.BONUS_CHEST);
        FeatureUtils.register(bootstapContextConfiguredFeature0, VOID_START_PLATFORM, Feature.VOID_START_PLATFORM);
        FeatureUtils.register(bootstapContextConfiguredFeature0, DESERT_WELL, Feature.DESERT_WELL);
        FeatureUtils.register(bootstapContextConfiguredFeature0, SPRING_LAVA_OVERWORLD, Feature.SPRING, new SpringConfiguration(Fluids.LAVA.m_76145_(), true, 4, 1, HolderSet.direct(Block::m_204297_, Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.CALCITE, Blocks.DIRT)));
        FeatureUtils.register(bootstapContextConfiguredFeature0, SPRING_LAVA_FROZEN, Feature.SPRING, new SpringConfiguration(Fluids.LAVA.m_76145_(), true, 4, 1, HolderSet.direct(Block::m_204297_, Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE)));
        FeatureUtils.register(bootstapContextConfiguredFeature0, SPRING_WATER, Feature.SPRING, new SpringConfiguration(Fluids.WATER.m_76145_(), true, 4, 1, HolderSet.direct(Block::m_204297_, Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.DEEPSLATE, Blocks.TUFF, Blocks.CALCITE, Blocks.DIRT, Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE)));
    }
}