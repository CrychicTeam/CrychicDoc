...
public class TreeFeatures {
    ...
    private static TreeConfiguration.TreeConfigurationBuilder createStraightBlobTree(Block block0, Block block1, int int2, int int3, int int4, int int5) {
        return new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(block0), new StraightTrunkPlacer(int2, int3, int4), BlockStateProvider.simple(block1), new BlobFoliagePlacer(ConstantInt.of(int5), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1));
    }
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapContextConfiguredFeature0) {
        HolderGetter<Block> $$1 = bootstapContextConfiguredFeature0.lookup(Registries.BLOCK);
        BlockPredicate $$2 = BlockPredicate.matchesBlocks(Blocks.OAK_SAPLING, Blocks.SPRUCE_SAPLING, Blocks.BIRCH_SAPLING, Blocks.JUNGLE_SAPLING, Blocks.ACACIA_SAPLING, Blocks.CHERRY_SAPLING, Blocks.DARK_OAK_SAPLING, Blocks.MANGROVE_PROPAGULE, Blocks.DANDELION, Blocks.TORCHFLOWER, Blocks.POPPY, Blocks.BLUE_ORCHID, Blocks.ALLIUM, Blocks.AZURE_BLUET, Blocks.RED_TULIP, Blocks.ORANGE_TULIP, Blocks.WHITE_TULIP, Blocks.PINK_TULIP, Blocks.OXEYE_DAISY, Blocks.CORNFLOWER, Blocks.WITHER_ROSE, Blocks.LILY_OF_THE_VALLEY, Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.WHEAT, Blocks.SUGAR_CANE, Blocks.ATTACHED_PUMPKIN_STEM, Blocks.ATTACHED_MELON_STEM, Blocks.PUMPKIN_STEM, Blocks.MELON_STEM, Blocks.LILY_PAD, Blocks.NETHER_WART, Blocks.COCOA, Blocks.CARROTS, Blocks.POTATOES, Blocks.CHORUS_PLANT, Blocks.CHORUS_FLOWER, Blocks.TORCHFLOWER_CROP, Blocks.PITCHER_CROP, Blocks.BEETROOTS, Blocks.SWEET_BERRY_BUSH, Blocks.WARPED_FUNGUS, Blocks.CRIMSON_FUNGUS, Blocks.WEEPING_VINES, Blocks.WEEPING_VINES_PLANT, Blocks.TWISTING_VINES, Blocks.TWISTING_VINES_PLANT, Blocks.CAVE_VINES, Blocks.CAVE_VINES_PLANT, Blocks.SPORE_BLOSSOM, Blocks.AZALEA, Blocks.FLOWERING_AZALEA, Blocks.MOSS_CARPET, Blocks.PINK_PETALS, Blocks.BIG_DRIPLEAF, Blocks.BIG_DRIPLEAF_STEM, Blocks.SMALL_DRIPLEAF);
        FeatureUtils.register(bootstapContextConfiguredFeature0, CRIMSON_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, false));
        FeatureUtils.register(bootstapContextConfiguredFeature0, CRIMSON_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.CRIMSON_NYLIUM.defaultBlockState(), Blocks.CRIMSON_STEM.defaultBlockState(), Blocks.NETHER_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, true));
        FeatureUtils.register(bootstapContextConfiguredFeature0, WARPED_FUNGUS, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, false));
        FeatureUtils.register(bootstapContextConfiguredFeature0, WARPED_FUNGUS_PLANTED, Feature.HUGE_FUNGUS, new HugeFungusConfiguration(Blocks.WARPED_NYLIUM.defaultBlockState(), Blocks.WARPED_STEM.defaultBlockState(), Blocks.WARPED_WART_BLOCK.defaultBlockState(), Blocks.SHROOMLIGHT.defaultBlockState(), $$2, true));
        FeatureUtils.register(bootstapContextConfiguredFeature0, HUGE_BROWN_MUSHROOM, Feature.HUGE_BROWN_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState) ((BlockState) Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().m_61124_(HugeMushroomBlock.UP, true)).m_61124_(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState) ((BlockState) Blocks.MUSHROOM_STEM.defaultBlockState().m_61124_(HugeMushroomBlock.UP, false)).m_61124_(HugeMushroomBlock.DOWN, false)), 3));
        FeatureUtils.register(bootstapContextConfiguredFeature0, HUGE_RED_MUSHROOM, Feature.HUGE_RED_MUSHROOM, new HugeMushroomFeatureConfiguration(BlockStateProvider.simple((BlockState) Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().m_61124_(HugeMushroomBlock.DOWN, false)), BlockStateProvider.simple((BlockState) ((BlockState) Blocks.MUSHROOM_STEM.defaultBlockState().m_61124_(HugeMushroomBlock.UP, false)).m_61124_(HugeMushroomBlock.DOWN, false)), 2));
        ...
        FeatureUtils.register(bootstapContextConfiguredFeature0, CHERRY, Feature.TREE, cherry().build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, CHERRY_BEES_005, Feature.TREE, cherry().decorators(List.of($$6)).build());
        ...
        FeatureUtils.register(bootstapContextConfiguredFeature0, JUNGLE_TREE, Feature.TREE, createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2F), TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25F))).ignoreVines().build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, FANCY_OAK, Feature.TREE, createFancyOak().build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, JUNGLE_TREE_NO_VINE, Feature.TREE, createJungleTree().ignoreVines().build());
        ...
        FeatureUtils.register(bootstapContextConfiguredFeature0, SUPER_BIRCH_BEES_0002, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$3)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, SUPER_BIRCH_BEES, Feature.TREE, createSuperBirch().decorators(ImmutableList.of($$7)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, SWAMP_OAK, Feature.TREE, createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(new LeaveVineDecorator(0.25F))).build());
        ...
        FeatureUtils.register(bootstapContextConfiguredFeature0, MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5F, UniformInt.of(0, 1), $$1.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(1, 3), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5F)), new MangroveRootPlacement($$1.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::m_204297_, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2F))), new TwoLayersFeatureSize(2, 0, 2)).decorators(List.of(new LeaveVineDecorator(0.125F), new AttachedToLeavesDecorator(0.14F, 1, 0, new RandomizedIntStateProvider(BlockStateProvider.simple((BlockState) Blocks.MANGROVE_PROPAGULE.defaultBlockState().m_61124_(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), $$4)).ignoreVines().build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, TALL_MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5F, UniformInt.of(0, 1), $$1.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(3, 7), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5F)), new MangroveRootPlacement($$1.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::m_204297_, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2F))), new TwoLayersFeatureSize(3, 0, 2)).decorators(List.of(new LeaveVineDecorator(0.125F), new AttachedToLeavesDecorator(0.14F, 1, 0, new RandomizedIntStateProvider(BlockStateProvider.simple((BlockState) Blocks.MANGROVE_PROPAGULE.defaultBlockState().m_61124_(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), $$4)).ignoreVines().build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, OAK_BEES_0002, Feature.TREE, createOak().decorators(List.of($$3)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, OAK_BEES_002, Feature.TREE, createOak().decorators(List.of($$5)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, OAK_BEES_005, Feature.TREE, createOak().decorators(List.of($$6)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, BIRCH_BEES_0002, Feature.TREE, createBirch().decorators(List.of($$3)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, BIRCH_BEES_002, Feature.TREE, createBirch().decorators(List.of($$5)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, BIRCH_BEES_005, Feature.TREE, createBirch().decorators(List.of($$6)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, FANCY_OAK_BEES_0002, Feature.TREE, createFancyOak().decorators(List.of($$3)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, FANCY_OAK_BEES_002, Feature.TREE, createFancyOak().decorators(List.of($$5)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, FANCY_OAK_BEES_005, Feature.TREE, createFancyOak().decorators(List.of($$6)).build());
        FeatureUtils.register(bootstapContextConfiguredFeature0, FANCY_OAK_BEES, Feature.TREE, createFancyOak().decorators(List.of($$7)).build());
    }
}