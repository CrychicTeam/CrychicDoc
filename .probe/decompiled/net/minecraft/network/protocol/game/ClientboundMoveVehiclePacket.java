...
public class ClientboundMoveVehiclePacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundMoveVehiclePacket(Entity entity0) {
        this.x = entity0.getX();
        this.y = entity0.getY();
        this.z = entity0.getZ();
    ...
    public ClientboundMoveVehiclePacket(FriendlyByteBuf friendlyByteBuf0) {
    ...
    public void handle(ClientGamePacketListener clientGamePacketListener0) {
        clientGamePacketListener0.handleMoveVehicle(this);
    }
