...
public class Resource {
    ...
    public Resource(PackResources packResources0, IoSupplier<InputStream> ioSupplierInputStream1, IoSupplier<ResourceMetadata> ioSupplierResourceMetadata2) {
        this.source = packResources0;
        this.streamSupplier = ioSupplierInputStream1;
        this.metadataSupplier = ioSupplierResourceMetadata2;
    }

    public Resource(PackResources packResources0, IoSupplier<InputStream> ioSupplierInputStream1) {
        this.source = packResources0;
        this.streamSupplier = ioSupplierInputStream1;
