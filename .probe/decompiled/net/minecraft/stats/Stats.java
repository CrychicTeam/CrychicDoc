...
public class Stats {
    ...
    private static ResourceLocation makeCustomStat(String string0, StatFormatter statFormatter1) {
        ResourceLocation $$2 = new ResourceLocation(string0);
        Registry.register(BuiltInRegistries.CUSTOM_STAT, string0, $$2);
        CUSTOM.get($$2, statFormatter1);
        return $$2;
    }

    private static <T> StatType<T> makeRegistryStatType(String string0, Registry<T> registryT1) {
        return Registry.register(BuiltInRegistries.STAT_TYPE, string0, new StatType<>(registryT1));
    }
}