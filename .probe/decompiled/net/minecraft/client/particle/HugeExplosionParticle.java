...
public class HugeExplosionParticle extends TextureSheetParticle {
    ...
    protected HugeExplosionParticle(ClientLevel clientLevel0, double double1, double double2, double double3, double double4, SpriteSet spriteSet5) {
        ...
        this.f_107228_ = $$6;
        this.f_107229_ = $$6;
        this.f_107663_ = 2.0F * (1.0F - (float) double4 * 0.5F);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType0, ClientLevel clientLevel1, double double2, double double3, double double4, double double5, double double6, double double7) {
            return new HugeExplosionParticle(clientLevel1, double2, double3, double4, double5, this.sprites);
        }
    }
}