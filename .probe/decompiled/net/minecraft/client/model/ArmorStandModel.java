...
public class ArmorStandModel extends ArmorStandArmorModel {
    ...
    public ArmorStandModel(ModelPart modelPart0) {
        super(modelPart0);
    ...
    public void prepareMobModel(ArmorStand armorStand0, float float1, float float2, float float3) {
        this.basePlate.xRot = 0.0F;
        this.basePlate.yRot = (float) (Math.PI / 180.0) * -Mth.rotLerp(float3, armorStand0.f_19859_, armorStand0.m_146908_());
    ...
    public void setupAnim(ArmorStand armorStand0, float float1, float float2, float float3, float float4, float float5) {
        super.setupAnim(armorStand0, float1, float2, float3, float4, float5);
        this.f_102812_.visible = armorStand0.isShowArms();
        this.f_102811_.visible = armorStand0.isShowArms();
        this.basePlate.visible = !armorStand0.isNoBasePlate();
        this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getX();
        this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getY();
        this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getZ();
        this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getX();
        this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getY();
        this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getZ();
        this.shoulderStick.xRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getX();
        this.shoulderStick.yRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getY();
        this.shoulderStick.zRot = (float) (Math.PI / 180.0) * armorStand0.getBodyPose().getZ();
    }
