...
public class ModelLayers {
    ...
    private static ModelLayerLocation register(String string0) {
        return register(string0, "main");
    }

    private static ModelLayerLocation register(String string0, String string1) {
        ModelLayerLocation $$2 = createLocation(string0, string1);
        if (!ALL_MODELS.add($$2)) {
    ...
    private static ModelLayerLocation createLocation(String string0, String string1) {
        return new ModelLayerLocation(new ResourceLocation("minecraft", string0), string1);
    }

    private static ModelLayerLocation registerInnerArmor(String string0) {
        return register(string0, "inner_armor");
    }

    private static ModelLayerLocation registerOuterArmor(String string0) {
        return register(string0, "outer_armor");
    }

    public static ModelLayerLocation createRaftModelName(Boat.Type boatType0) {
        return createLocation("raft/" + boatType0.getName(), "main");
    }

    public static ModelLayerLocation createChestRaftModelName(Boat.Type boatType0) {
        return createLocation("chest_raft/" + boatType0.getName(), "main");
    }

    public static ModelLayerLocation createBoatModelName(Boat.Type boatType0) {
        return createLocation("boat/" + boatType0.getName(), "main");
    }

    public static ModelLayerLocation createChestBoatModelName(Boat.Type boatType0) {
        return createLocation("chest_boat/" + boatType0.getName(), "main");
    }

    public static ModelLayerLocation createSignModelName(WoodType woodType0) {
        return createLocation("sign/" + woodType0.name(), "main");
    }

    public static ModelLayerLocation createHangingSignModelName(WoodType woodType0) {
        return createLocation("hanging_sign/" + woodType0.name(), "main");
    }
