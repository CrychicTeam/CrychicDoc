...
public class EvokerRenderer<T extends SpellcasterIllager> extends IllagerRenderer<T> {
    ...
    public EvokerRenderer(EntityRendererProvider.Context entityRendererProviderContext0) {
        super(entityRendererProviderContext0, new IllagerModel<>(entityRendererProviderContext0.bakeLayer(ModelLayers.EVOKER)), 0.5F);
        this.m_115326_(new ItemInHandLayer<T, IllagerModel<T>>(this, entityRendererProviderContext0.getItemInHandRenderer()) {
