...
public class EnterBlockTrigger extends SimpleCriterionTrigger<EnterBlockTrigger.TriggerInstance> {
    ...
    public EnterBlockTrigger.TriggerInstance createInstance(JsonObject jsonObject0, ContextAwarePredicate contextAwarePredicate1, DeserializationContext deserializationContext2) {
        ...
        return new EnterBlockTrigger.TriggerInstance(contextAwarePredicate1, $$3, $$4);
    }
    ...
    public void trigger(ServerPlayer serverPlayer0, BlockState blockState1) {
        this.m_66234_(serverPlayer0, p_31277_ -> p_31277_.matches(blockState1));
    }
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(ContextAwarePredicate contextAwarePredicate0, @Nullable Block block1, StatePropertiesPredicate statePropertiesPredicate2) {
            super(EnterBlockTrigger.ID, contextAwarePredicate0);
            this.block = block1;
            this.state = statePropertiesPredicate2;
        }

        public static EnterBlockTrigger.TriggerInstance entersBlock(Block block0) {
