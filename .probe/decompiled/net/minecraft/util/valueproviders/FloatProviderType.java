...
public interface FloatProviderType<P extends FloatProvider> {
    ...
    static <P extends FloatProvider> FloatProviderType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.FLOAT_PROVIDER_TYPE, string0, () -> codecP1);
    }
}