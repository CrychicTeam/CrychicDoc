...
public interface IntProviderType<P extends IntProvider> {
    ...
    static <P extends IntProvider> IntProviderType<P> register(String string0, Codec<P> codecP1) {
        return Registry.register(BuiltInRegistries.INT_PROVIDER_TYPE, string0, () -> codecP1);
    }
}