...
public class NetworkSummaryEvent extends Event {
    ...
    public NetworkSummaryEvent(String string0) {
        this.remoteAddress = string0;
    }
    ...
    public static final class SumAggregation {
        ...
        public SumAggregation(String string0) {
            this.event = new NetworkSummaryEvent(string0);
            this.event.begin();
        }

        public void trackSentPacket(int int0) {
            this.sentPackets.incrementAndGet();
            this.sentBytes.addAndGet((long) int0);
        }

        public void trackReceivedPacket(int int0) {
            this.receivedPackets.incrementAndGet();
            this.receivedBytes.addAndGet((long) int0);
        }
