...
public class ChunkGenerationEvent extends Event {
    ...
    public ChunkGenerationEvent(ChunkPos chunkPos0, ResourceKey<Level> resourceKeyLevel1, String string2) {
        this.targetStatus = string2;
        this.level = resourceKeyLevel1.toString();
        this.chunkPosX = chunkPos0.x;
        this.chunkPosZ = chunkPos0.z;
        this.worldPosX = chunkPos0.getMinBlockX();
        this.worldPosZ = chunkPos0.getMinBlockZ();
    }
