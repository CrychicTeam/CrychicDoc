...
public class CommonLinks {
    ...
    public static String extendRealms(String string0, String string1, boolean boolean2) {
        return extendRealms(string0, string1) + "&ref=" + (boolean2 ? "expiredTrial" : "expiredRealm");
    }

    public static String extendRealms(String string0, String string1) {
        return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + string0 + "&profileId=" + string1;
    }
}