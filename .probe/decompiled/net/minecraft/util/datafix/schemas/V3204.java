...
public class V3204 extends NamespacedSchema {
    ...
    public V3204(int int0, Schema schema1) {
        super(int0, schema1);
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema0) {
        ...
        schema0.register($$1, "minecraft:chiseled_bookshelf", () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema0))));
        return $$1;
    }
}