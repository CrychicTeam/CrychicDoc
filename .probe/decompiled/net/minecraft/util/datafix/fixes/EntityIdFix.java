...
public class EntityIdFix extends DataFix {
    ...
    private static final Map<String, String> ID_MAP = (Map<String, String>) DataFixUtils.make(Maps.newHashMap(), p_15465_ -> {
    ...
    public EntityIdFix(Schema schema0, boolean boolean1) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", $$2, $$3), this.fixTypeEverywhere("EntityIdFix", $$0, $$1, p_15461_ -> p_145282_ -> p_145282_.mapFirst(p_145284_ -> (String) ID_MAP.getOrDefault(p_145284_, p_145284_))));
    }
}