...
public class ItemPotionFix extends DataFix {
    ...
    private static final String[] POTIONS = (String[]) DataFixUtils.make(new String[128], p_15997_ -> {
    ...
    public ItemPotionFix(Schema schema0, boolean boolean1) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", $$0, p_15995_ -> {
            Optional<Pair<String, String>> $$3 = p_15995_.getOptional($$1);
            if ($$3.isPresent() && Objects.equals(((Pair) $$3.get()).getSecond(), "minecraft:potion")) {
                Dynamic<?> $$4 = (Dynamic<?>) p_15995_.get(DSL.remainderFinder());
                Optional<? extends Typed<?>> $$5 = p_15995_.getOptionalTyped($$2);
