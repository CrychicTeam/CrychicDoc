...
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    private static final Map<String, String> MAP = (Map<String, String>) DataFixUtils.make(Maps.newHashMap(), p_16126_ -> {
    ...
    private static final Set<String> IDS = (Set<String>) MAP.keySet().stream().map(p_16121_ -> p_16121_.substring(0, p_16121_.indexOf(46))).collect(Collectors.toSet());
    ...
    public ItemStackTheFlatteningFix(Schema schema0, boolean boolean1) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, p_16119_ -> {
            Optional<Pair<String, String>> $$3 = p_16119_.getOptional($$1);
            if (!$$3.isPresent()) {
                return p_16119_;
            } else {
                Typed<?> $$4 = p_16119_;
                Dynamic<?> $$5 = (Dynamic<?>) p_16119_.get(DSL.remainderFinder());
                int $$6 = $$5.get("Damage").asInt(0);
                String $$7 = updateItem((String) ((Pair) $$3.get()).getSecond(), $$6);
                if ($$7 != null) {
                    $$4 = p_16119_.set($$1, Pair.of(References.ITEM_NAME.typeName(), $$7));
                }
                if (DAMAGE_IDS.contains(((Pair) $$3.get()).getSecond())) {
                    Typed<?> $$8 = p_16119_.getOrCreateTyped($$2);
    ...
    @Nullable
    public static String updateItem(@Nullable String string0, int int1) {
        if (IDS.contains(string0)) {
            String $$2 = (String) MAP.get(string0 + "." + int1);
            return $$2 == null ? (String) MAP.get(string0 + ".0") : $$2;
        } else {
            return null;
        }
    }
