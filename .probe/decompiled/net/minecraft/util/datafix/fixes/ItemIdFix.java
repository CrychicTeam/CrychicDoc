...
public class ItemIdFix extends DataFix {
    ...
    private static final Int2ObjectMap<String> ITEM_NAMES = (Int2ObjectMap<String>) DataFixUtils.make(new Int2ObjectOpenHashMap(), p_15953_ -> {
    ...
    public ItemIdFix(Schema schema0, boolean boolean1) {
        super(schema0, boolean1);
    }

    public static String getItem(int int0) {
        return (String) ITEM_NAMES.get(int0);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), p_15947_ -> p_15947_.update($$2, $$1, p_145386_ -> (Pair) p_145386_.map(p_145390_ -> Pair.of(References.ITEM_NAME.typeName(), getItem(p_145390_)), p_145388_ -> p_145388_)));
    }
}