...
public class EntityTheRenameningFix extends SimplestEntityRenameFix {
    ...
    public EntityTheRenameningFix(Schema schema0, boolean boolean1) {
        super("EntityTheRenameningBlock", schema0, boolean1);
    }

    @Override
    protected String rename(String string0) {
        if (string0.startsWith("minecraft:bred_")) {
            string0 = "minecraft:" + string0.substring("minecraft:bred_".length());
        }
