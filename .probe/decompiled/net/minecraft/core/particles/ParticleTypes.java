...
public class ParticleTypes {
    ...
    public static final ParticleType<BlockParticleOption> BLOCK = register("block", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::m_123634_);

    public static final ParticleType<BlockParticleOption> BLOCK_MARKER = register("block_marker", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::m_123634_);
    ...
    public static final ParticleType<DustParticleOptions> DUST = register("dust", false, DustParticleOptions.DESERIALIZER, p_123819_ -> DustParticleOptions.CODEC);

    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, p_175841_ -> DustColorTransitionOptions.CODEC);
    ...
    public static final ParticleType<BlockParticleOption> FALLING_DUST = register("falling_dust", false, BlockParticleOption.DESERIALIZER, BlockParticleOption::m_123634_);
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, p_175839_ -> SculkChargeParticleOptions.CODEC);
    ...
    public static final ParticleType<ItemParticleOption> ITEM = register("item", false, ItemParticleOption.DESERIALIZER, ItemParticleOption::m_123710_);

    public static final ParticleType<VibrationParticleOption> VIBRATION = register("vibration", true, VibrationParticleOption.DESERIALIZER, p_235911_ -> VibrationParticleOption.CODEC);
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register("shriek", false, ShriekParticleOption.DESERIALIZER, p_235904_ -> ShriekParticleOption.CODEC);

    public static final SimpleParticleType EGG_CRACK = register("egg_crack", false);

    public static final Codec<ParticleOptions> CODEC = BuiltInRegistries.PARTICLE_TYPE.byNameCodec().dispatch("type", ParticleOptions::m_6012_, ParticleType::m_7652_);

    private static SimpleParticleType register(String string0, boolean boolean1) {
        return Registry.register(BuiltInRegistries.PARTICLE_TYPE, string0, new SimpleParticleType(boolean1));
    }

    private static <T extends ParticleOptions> ParticleType<T> register(String string0, boolean boolean1, ParticleOptions.Deserializer<T> particleOptionsDeserializerT2, final Function<ParticleType<T>, Codec<T>> functionParticleTypeTCodecT3) {
        return Registry.register(BuiltInRegistries.PARTICLE_TYPE, string0, new ParticleType<T>(boolean1, particleOptionsDeserializerT2) {

            @Override
            public Codec<T> codec() {
                return (Codec<T>) functionParticleTypeTCodecT3.apply(this);
            }
        });
    }
}