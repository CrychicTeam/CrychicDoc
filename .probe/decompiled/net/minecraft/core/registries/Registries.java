...
public class Registries {
    ...
    public static ResourceKey<Level> levelStemToLevel(ResourceKey<LevelStem> resourceKeyLevelStem0) {
        return ResourceKey.create(DIMENSION, resourceKeyLevelStem0.location());
    }

    public static ResourceKey<LevelStem> levelToLevelStem(ResourceKey<Level> resourceKeyLevel0) {
        return ResourceKey.create(LEVEL_STEM, resourceKeyLevel0.location());
    }

    private static <T> ResourceKey<Registry<T>> createRegistryKey(String string0) {
        return ResourceKey.createRegistryKey(new ResourceLocation(string0));
    }
}