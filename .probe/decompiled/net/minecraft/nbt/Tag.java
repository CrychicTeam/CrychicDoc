...
public interface Tag {
    ...
    default void acceptAsRoot(StreamTagVisitor streamTagVisitor0) {
        StreamTagVisitor.ValueResult $$1 = streamTagVisitor0.visitRootEntry(this.getType());
        if ($$1 == StreamTagVisitor.ValueResult.CONTINUE) {
            this.accept(streamTagVisitor0);
        }
    }
}