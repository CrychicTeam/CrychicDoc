...
public class SharedConstants {
    ...
    public static boolean isAllowedChatCharacter(char char0) {
        return char0 != 167 && char0 >= ' ' && char0 != 127;
    }

    public static String filterText(String string0) {
        return filterText(string0, false);
    }

    public static String filterText(String string0, boolean boolean1) {
        StringBuilder $$2 = new StringBuilder();
        for (char $$3 : string0.toCharArray()) {
    ...
    public static void setVersion(WorldVersion worldVersion0) {
        if (CURRENT_VERSION == null) {
            CURRENT_VERSION = worldVersion0;
        } else if (worldVersion0 != CURRENT_VERSION) {
    ...
    public static boolean debugVoidTerrain(ChunkPos chunkPos0) {
        int $$1 = chunkPos0.getMinBlockX();
        int $$2 = chunkPos0.getMinBlockZ();
        return !debugGenerateSquareTerrainWithoutNoise ? false : $$1 > 8192 || $$1 < 0 || $$2 > 1024 || $$2 < 0;
    }
