...
public enum ChatFormatting implements StringRepresentable {
    ...
    private static final Map<String, ChatFormatting> FORMATTING_BY_NAME = (Map<String, ChatFormatting>) Arrays.stream(values()).collect(Collectors.toMap(p_126660_ -> cleanName(p_126660_.name), p_126652_ -> p_126652_));
    ...
    public static ChatFormatting getByName(@Nullable String p_126658_) {
        return p_126658_ == null ? null : (ChatFormatting) FORMATTING_BY_NAME.get(cleanName(p_126658_));
    }
    ...
    public static Collection<String> getNames(boolean p_126654_, boolean p_126655_) {
        ...
        for (ChatFormatting $$3 : values()) {
            if ((!$$3.isColor() || p_126654_) && (!$$3.isFormat() || p_126655_)) {
                $$2.add($$3.getName());
            }
        }
        return $$2;
