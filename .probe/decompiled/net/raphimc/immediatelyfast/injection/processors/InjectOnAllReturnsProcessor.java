                ...
                for (AnnotationNode annotationNode : methodNode.visibleAnnotations) {
                    if (annotationNode.desc.equals(Type.getDescriptor(InjectOnAllReturns.class))) {
                        ...
                        for (MethodNode methodNode2 : classNode.methods) {
                            ...
                            if (shouldInject) {
                                for (AbstractInsnNode insnNodex : methodNode2.instructions.toArray()) {
                                    if (insnNodex.getOpcode() >= 172 && insnNodex.getOpcode() <= 177) {
                                        ...
                                        methodNode2.instructions.insertBefore(insnNodex, inject);
                                    }
                                }
                            }
                        }
