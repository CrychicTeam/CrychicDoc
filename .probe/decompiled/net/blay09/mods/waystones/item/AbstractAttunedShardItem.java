...
public abstract class AbstractAttunedShardItem extends Item implements IAttunementItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> list, TooltipFlag flag) {
        ...
        if (attunedWarpPlate != null && attunedWarpPlate.isValid()) {
            ...
            MutableComponent textComponent = Component.translatable("tooltip.waystones.attuned_shard.attunement_lost");
    ...
    public IWaystone getWaystoneAttunedTo(MinecraftServer server, ItemStack itemStack) {
        ...
        return compound != null && compound.contains("AttunedToWaystone", 11) ? new WaystoneProxy(server, NbtUtils.loadUUID((Tag) Objects.requireNonNull(compound.get("AttunedToWaystone")))) : null;
    }
