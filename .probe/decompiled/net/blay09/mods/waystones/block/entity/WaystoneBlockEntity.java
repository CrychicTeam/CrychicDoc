...
public class WaystoneBlockEntity extends WaystoneBlockEntityBase {
    ...
    public BalmMenuProvider getMenuProvider() {
        return new BalmMenuProvider() {
            ...
            public void writeScreenOpeningData(ServerPlayer player, FriendlyByteBuf buf) {
                ...
                buf.writeBlockPos(WaystoneBlockEntity.this.f_58858_);
            }
        };
    }
    ...
    public BalmMenuProvider getSettingsMenuProvider() {
        return new BalmMenuProvider() {
            ...
            @Override
            public AbstractContainerMenu createMenu(int i, Inventory playerInventory, Player playerEntity) {
                return new WaystoneSettingsMenu(ModMenus.waystoneSettings.get(), WaystoneBlockEntity.this.getWaystone(), i);
            }
