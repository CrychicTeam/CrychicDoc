...
public class ModBlockEntities {
    ...
    public static void initialize(BalmBlockEntities blockEntities) {
        ...
        sharestone = blockEntities.registerBlockEntity(id("sharestone"), SharestoneBlockEntity::new, () -> (Block[]) ArrayUtils.add(ModBlocks.scopedSharestones, ModBlocks.sharestone));
