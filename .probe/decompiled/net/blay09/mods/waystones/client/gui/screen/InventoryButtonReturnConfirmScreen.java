...
public class InventoryButtonReturnConfirmScreen extends ConfirmScreen {
    ...
    private static String getWaystoneName(String targetWaystone) {
        if (!targetWaystone.isEmpty()) {
            ...
            return nearestWaystone != null ? ChatFormatting.GRAY + I18n.get("gui.waystones.inventory.confirm_return_bound_to", nearestWaystone.getName()) : ChatFormatting.GRAY + I18n.get("gui.waystones.inventory.confirm_return.noWaystoneActive");
        }
    }
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        guiGraphics.drawCenteredString(font, this.waystoneName, this.f_96543_ / 2, 100, 16777215);
    }
}