...
public class WaystonesConfigData implements BalmConfigData {
    ...
    public WaystonesConfigData.XpCost xpCost = new WaystonesConfigData.XpCost();

    public WaystonesConfigData.Restrictions restrictions = new WaystonesConfigData.Restrictions();

    public WaystonesConfigData.Cooldowns cooldowns = new WaystonesConfigData.Cooldowns();

    public WaystonesConfigData.InventoryButton inventoryButton = new WaystonesConfigData.InventoryButton();

    public WaystonesConfigData.WorldGen worldGen = new WaystonesConfigData.WorldGen();

    public WaystonesConfigData.Client client = new WaystonesConfigData.Client();

    public WaystonesConfigData.Compatibility compatibility = new WaystonesConfigData.Compatibility();
