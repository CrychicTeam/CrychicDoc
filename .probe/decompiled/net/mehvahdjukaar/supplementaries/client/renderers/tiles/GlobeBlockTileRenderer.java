...
public class GlobeBlockTileRenderer implements BlockEntityRenderer<GlobeBlockTile> {
    ...
    public static LayerDefinition createBaseMesh() {
        ...
        root.addOrReplaceChild("globe", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -28.0F, -4.0F, 8.0F, 8.0F, 8.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
    ...
    public static LayerDefinition createSpecialMesh() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        root.addOrReplaceChild("flat", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -28.0F, -4.0F, 8.0F, 4.0F, 8.0F).texOffs(0, 13).addBox(-4.0F, -24.0F, -4.0F, 8.0F, 2.0F, 8.0F).texOffs(4, 23).addBox(-3.0F, -22.0F, -3.0F, 6.0F, 1.0F, 6.0F).texOffs(8, 24).addBox(-2.0F, -21.0F, -2.0F, 4.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
        root.addOrReplaceChild("sheared", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -28.0F, -4.0F, 8.0F, 8.0F, 4.0F).texOffs(0, 12).addBox(0.0F, -28.0F, 0.0F, 4.0F, 8.0F, 4.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
        PartDefinition snow = root.addOrReplaceChild("snow", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -28.0F, -4.0F, 8.0F, 5.0F, 8.0F).texOffs(0, 14).addBox(-4.0F, -23.0F, -4.0F, 8.0F, 1.0F, 8.0F).texOffs(4, 16).addBox(-3.0F, -22.0F, -3.0F, 6.0F, 1.0F, 6.0F).texOffs(0, 17).addBox(-2.0F, -24.0F, -2.0F, 4.0F, 1.0F, 4.0F).texOffs(0, 28).addBox(-1.0F, -25.975F, -1.0F, 2.0F, 2.0F, 2.0F).texOffs(12, 20).addBox(-1.0F, -21.0F, -1.0F, 2.0F, 1.0F, 2.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
        snow.addOrReplaceChild("roof_l", CubeListBuilder.create().texOffs(11, 27).addBox(0.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -25.9F, 0.0F, 0.0F, 0.0F, 0.7854F));
        snow.addOrReplaceChild("roof_r", CubeListBuilder.create().texOffs(0, 27).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -25.9F, 0.0F, 0.0F, 0.0F, -0.7854F));
    ...
    public void render(GlobeBlockTile tile, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        this.renderGlobe(tile.getRenderData(), matrixStackIn, bufferIn, combinedLightIn, combinedOverlayIn, tile.isSepia(), tile.m_58904_());
    ...
    public void renderGlobe(Pair<GlobeManager.Model, ResourceLocation> data, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay, boolean isSepia, Level level) {
        if (data != null) {
            ...
            ResourceLocation texture = ClientConfigs.Blocks.GLOBE_RANDOM.get() ? (ResourceLocation) data.getSecond() : GlobeManager.Type.EARTH.texture;
            ModelPart model = (ModelPart) this.models.get(data.getFirst());
            VertexConsumer builder;
            if (texture == null) {
                if (this.noise) {
                    double si = Math.sin((double) System.currentTimeMillis() / 8000.0) * 30.0;
                    float v = (float) Mth.clamp(si, -0.5, 0.5);
                    float c = (float) Mth.clamp(si, -2.0, 2.0);
                    SuppClientPlatformStuff.getNoiseShader().getUniform("Intensity").set(Mth.cos((float) Math.PI * c / 4.0F));
            ...
            model.render(poseStack, builder, light, overlay, 1.0F, 1.0F, 1.0F, 1.0F);
            poseStack.popPose();
        }
    }
}