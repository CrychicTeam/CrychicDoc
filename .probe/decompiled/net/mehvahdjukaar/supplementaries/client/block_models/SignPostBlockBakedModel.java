...
public class SignPostBlockBakedModel implements CustomBakedModel {
    ...
    public List<BakedQuad> getBlockQuads(BlockState state, Direction side, RandomSource rand, RenderType renderType, ExtraModelData data) {
        ...
        if (mimic != null && !mimic.m_60795_()) {
            if (framed) {
                ExtraModelData data2 = FramedBlocksCompat.getModelData(mimic);
                mimic = FramedBlocksCompat.getFramedFence();
            } else {
                ExtraModelData data2 = ExtraModelData.EMPTY;
            }
            ...
            if (up != null && down != null) {
                ...
                SignPostBlockTileRenderer.renderSigns(new PoseStack(), builder, 0, 0, up, down, slim);
            }
            return quads;
        } else {
