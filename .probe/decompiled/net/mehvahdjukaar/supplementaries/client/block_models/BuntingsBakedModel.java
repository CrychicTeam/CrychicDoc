    ...
    public List<BakedQuad> getBlockQuads(BlockState state, Direction side, RandomSource rand, RenderType renderType, ExtraModelData data) {
        ...
        try {
            if (!data.get(BuntingBlockTile.IS_FANCY)) {
                ...
                if (north != null) {
                    BuntingBlockTileRenderer.renderBunting(north, Direction.NORTH, 0.0F, poseStack, builder, null, 0, OverlayTexture.NO_OVERLAY, BlockPos.ZERO, 0L);
                }
                if (south != null) {
                    BuntingBlockTileRenderer.renderBunting(south, Direction.SOUTH, 0.0F, poseStack, builder, null, 0, OverlayTexture.NO_OVERLAY, BlockPos.ZERO, 0L);
                }
                if (east != null) {
                    BuntingBlockTileRenderer.renderBunting(east, Direction.EAST, 0.0F, poseStack, builder, null, 0, OverlayTexture.NO_OVERLAY, BlockPos.ZERO, 0L);
                }
                if (west != null) {
                    BuntingBlockTileRenderer.renderBunting(west, Direction.WEST, 0.0F, poseStack, builder, null, 0, OverlayTexture.NO_OVERLAY, BlockPos.ZERO, 0L);
                }
            }
