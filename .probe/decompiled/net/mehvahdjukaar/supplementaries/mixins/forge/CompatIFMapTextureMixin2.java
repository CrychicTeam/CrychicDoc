...
public class CompatIFMapTextureMixin2 {
    ...
    public void supplementaries_IFupdateColoredTexture(NativeImage instance, int level, int xOffset, int yOffset, int unpackSkipPixels, int unpackSkipRows, int width, int height, boolean mipmap, boolean autoClose, Operation<Void> operation) {
        ...
        operation.call(new Object[] { instance, level, xOffset, yOffset, unpackSkipPixels, unpackSkipRows, width, height, mipmap, autoClose });
