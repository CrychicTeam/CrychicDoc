...
public class ClockDisplaySource extends SingleLineDisplaySource {
    ...
    protected MutableComponent provideLine(DisplayLinkContext context, DisplayTargetStats stats) {
        if (context.level() instanceof ServerLevel sLevel && context.getSourceBlockEntity() instanceof ClockBlockTile tile) {
            boolean c12 = context.sourceConfig().getInt("Cycle") == 0;
            boolean isNatural = sLevel.m_6042_().natural();
    ...
    public void initConfigurationWidgets(DisplayLinkContext context, ModularGuiLineBuilder builder, boolean isFirstLine) {
        ...
        if (!isFirstLine) {
            builder.addSelectionScrollInput(0, 60, (si, l) -> si.forOptions(Lang.translatedOptions("display_source.time", "12_hour", "24_hour")).titled(Lang.translateDirect("display_source.time.format")), "Cycle");
        }
    }
