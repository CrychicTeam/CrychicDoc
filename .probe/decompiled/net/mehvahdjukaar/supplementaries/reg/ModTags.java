...
public class ModTags {
    ...
    public static final Map<DyeColor, TagKey<Item>> BLACKBOARD_TAGS = (Map<DyeColor, TagKey<Item>>) Arrays.stream(DyeColor.values()).collect(Collectors.toUnmodifiableMap(d -> d, d -> itemTag("blackboard_" + d.getName())));
