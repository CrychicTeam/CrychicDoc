...
public class ModSounds {
    ...
    public static final ModSoundType JAR = new ModSoundType(1.0F, 1.0F, JAR_BREAK, () -> SoundEvents.GLASS_STEP, JAR_PLACE, () -> SoundEvents.GLASS_HIT, () -> SoundEvents.GLASS_FALL);

    public static final ModSoundType BUBBLE_BLOCK = new ModSoundType(1.0F, 1.0F, BUBBLE_POP, () -> SoundEvents.HONEY_BLOCK_STEP, BUBBLE_PLACE, () -> SoundEvents.HONEY_BLOCK_HIT, () -> SoundEvents.HONEY_BLOCK_FALL);

    public static final ModSoundType BOOKS = new ModSoundType(1.0F, 1.0F, () -> SoundEvents.CHISELED_BOOKSHELF_PICKUP, () -> SoundEvents.BOOK_PUT, () -> SoundEvents.CHISELED_BOOKSHELF_INSERT, () -> SoundEvents.BOOK_PUT, () -> SoundEvents.BOOK_PUT);

    public static final ModSoundType PRESENT = new ModSoundType(1.0F, 1.0F, PRESENT_BREAK, () -> SoundEvents.WOOL_STEP, PRESENT_PLACE, () -> SoundEvents.WOOL_HIT, () -> SoundEvents.WOOL_FALL);

    public static final ModSoundType SACK = new ModSoundType(1.0F, 1.0F, SACK_BREAK, () -> SoundEvents.WOOL_STEP, SACK_PLACE, () -> SoundEvents.WOOL_HIT, () -> SoundEvents.WOOL_FALL);

    public static final ModSoundType ROPE = new ModSoundType(1.0F, 1.0F, ROPE_BREAK, ROPE_STEP, ROPE_PLACE, ROPE_STEP, () -> SoundEvents.WOOL_FALL);
