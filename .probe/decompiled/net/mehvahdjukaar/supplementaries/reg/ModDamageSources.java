...
public class ModDamageSources {
    ...
    private static final ResourceKey<DamageType> SPIKE_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE, Supplementaries.res("bamboo_spikes"));

    private static final ResourceKey<DamageType> BOTTLING_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE, Supplementaries.res("xp_extracting"));

    private static final ResourceKey<DamageType> BOMB_EXPLOSION = ResourceKey.create(Registries.DAMAGE_TYPE, Supplementaries.res("bomb_explosion"));

    private static final ResourceKey<DamageType> PLAYER_BOMB_EXPLOSION = ResourceKey.create(Registries.DAMAGE_TYPE, Supplementaries.res("bomb_explosion"));
    ...
    public static DamageSource spikePlayer(Player player) {
        return new ModDamageSources.SpikePlayerDamageSource(spike.getHolder(), player);
    }
    ...
    public static class SpikePlayerDamageSource extends DamageSource {
        ...
        public Component getLocalizedDeathMessage(LivingEntity livingEntity) {
            ...
            String string = "death.attack." + this.m_269415_().msgId();
            String string2 = string + ".player";
            return livingEntity2 != null ? Component.translatable(string2, livingEntity.m_5446_(), livingEntity2.m_5446_()) : Component.translatable(string, livingEntity.m_5446_());
        }
    }
}