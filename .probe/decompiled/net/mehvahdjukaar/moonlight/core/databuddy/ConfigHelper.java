...
public class ConfigHelper {
    ...
    public static <T> ConfigHelper.ConfigObject<T> defineObject(ForgeConfigSpec.Builder builder, String name, Codec<T> codec, Supplier<T> defaultSupplier) {
        ...
        ForgeConfigSpec.ConfigValue<Object> value = builder.define(name, lazyDefaultValue, o -> o != null && lazyDefaultValue.get().getClass().isAssignableFrom(o.getClass()));
        return new ConfigHelper.ConfigObject<>(value, codec, defaultSupplier);
    }

    public static class ConfigObject<T> implements java.util.function.Supplier<T> {
