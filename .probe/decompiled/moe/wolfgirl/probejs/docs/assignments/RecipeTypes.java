...
public class RecipeTypes extends ProbeJSPlugin {
    ...
    public void assignType(ScriptDump scriptDump) {
        ...
        scriptDump.assignType(RecipeFilter.class, Types.object().member("or?", Types.type(RecipeFilter.class)).member("not?", Types.type(RecipeFilter.class)).member("id?", Types.primitive("Special.RecipeId")).member("type?", Types.primitive("Special.RecipeType")).member("group?", Types.STRING).member("mod?", Types.primitive("Special.Mod")).member("input?", Types.type(InputItem.class)).member("output?", Types.type(OutputItem.class)).build());
        ...
        scriptDump.assignType(IngredientActionFilter.class, Types.object().member("item?", Types.type(Ingredient.class)).member("index?", Primitives.INTEGER).build());
    }
