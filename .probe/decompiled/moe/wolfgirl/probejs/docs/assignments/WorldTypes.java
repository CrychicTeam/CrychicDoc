...
public class WorldTypes extends ProbeJSPlugin {
    ...
    public void assignType(ScriptDump scriptDump) {
        ...
        scriptDump.assignType(BlockStatePredicate.class, Types.object().member("or?", Types.type(BlockStatePredicate.class)).member("not?", Types.type(BlockStatePredicate.class)).build());
        ...
        scriptDump.assignType(BiomeFilter.class, Types.object().member("or?", Types.type(BiomeFilter.class)).member("not?", Types.type(BiomeFilter.class)).member("id?", Types.primitive("Special.Biome")).member("type?", Types.primitive("Special.Biome")).member("tag", Types.primitive("Special.BiomeTag")).build());
        ...
        scriptDump.assignType(MobFilter.class, Types.object().member("or?", Types.type(MobFilter.class)).member("not?", Types.type(MobFilter.class)).member("id?", Types.primitive("Special.EntityType")).member("type?", Types.primitive("Special.EntityType")).member("category", Types.STRING).build());
        ...
        scriptDump.assignType(NotificationBuilder.class, Types.lambda().param("builder", Types.type(NotificationBuilder.class)).build());
        ...
        scriptDump.assignType(ItemTintFunction.class, Types.lambda().param("stack", Types.type(ItemStack.class)).param("index", Primitives.INTEGER).build());
        ...
        scriptDump.assignType(BlockTintFunction.class, Types.lambda().param("state", Types.type(ItemStack.class)).param("level", Types.type(BlockAndTintGetter.class)).param("pos", Types.type(BlockPos.class)).param("index", Primitives.INTEGER).returnType(Types.type(Color.class)).build());
        scriptDump.assignType(Component.class, Types.STRING);
        scriptDump.assignType(Component.class, Types.object().member("text?", Types.STRING).member("translate?", Types.primitive("Special.LangKey")).member("with?", Types.ANY.asArray()).member("color?", Types.type(Color.class)).member("bold?", Types.BOOLEAN).member("italic?", Types.BOOLEAN).member("underlined?", Types.BOOLEAN).member("strikethrough?", Types.BOOLEAN).member("obfuscated?", Types.BOOLEAN).member("insertion?", Types.STRING).member("font?", Types.STRING).member("click?", Types.type(ClickEvent.class)).member("hover?", Types.type(Component.class)).member("extra?", Types.type(Component.class).asArray()).build());
        ...
        scriptDump.assignType(MutableComponent.class, Types.object().member("text?", Types.STRING).member("translate?", Types.primitive("Special.LangKey")).member("with?", Types.ANY.asArray()).member("color?", Types.type(Color.class)).member("bold?", Types.BOOLEAN).member("italic?", Types.BOOLEAN).member("underlined?", Types.BOOLEAN).member("strikethrough?", Types.BOOLEAN).member("obfuscated?", Types.BOOLEAN).member("insertion?", Types.STRING).member("font?", Types.STRING).member("click?", Types.type(ClickEvent.class)).member("hover?", Types.type(MutableComponent.class)).member("extra?", Types.type(MutableComponent.class).asArray()).build());
        scriptDump.assignType(MutableComponent.class, Types.type(MutableComponent.class).asArray());
        BaseType[] predefinedColors = (BaseType[]) ColorWrapper.MAP.keySet().stream().map(Types::literal).toArray(BaseType[]::new);
        ...
        BaseType[] actions = new BaseType[] { Types.literal("open_url"), Types.literal("open_file"), Types.literal("run_command"), Types.literal("suggest_command"), Types.literal("change_page"), Types.literal("copy_to_clipboard") };
        scriptDump.assignType(ClickEvent.class, Types.object().member("action", Types.or(actions)).member("value", Types.STRING).build());
    }
}