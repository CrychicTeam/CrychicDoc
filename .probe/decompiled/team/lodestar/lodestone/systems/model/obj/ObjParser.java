...
public class ObjParser {
        ...
        while ((line = reader.readLine()) != null) {
            if (line.startsWith("v ")) {
                ...
                for (int i = 1; i < tokens.length; i++) {
                    ...
                    Vector3f position = (Vector3f) this.vertices.get(vertexIndex);
                    Vector3f normal = (Vector3f) this.normals.get(normalIndex);
                    Vec2 uv = (Vec2) this.uvs.get(textureIndex);
    ...
    public ArrayList<Face> getFaces() {
        return (ArrayList<Face>) this.faces;
    }
}