...
public abstract class FireEffectRenderer<T extends FireEffectInstance> {
    ...
    public void renderScreen(T instance, Minecraft pMinecraft, PoseStack pPoseStack) {
        ...
        TextureAtlasSprite textureatlassprite = this.getFirstFlame().sprite();
        ...
        for (int i = 0; i < 2; i++) {
            pPoseStack.pushPose();
            pPoseStack.translate((double) ((float) (-(i * 2 - 1)) * 0.24F), -0.3F, 0.0);
            pPoseStack.translate(0.0, -ClientConfig.FIRE_OVERLAY_OFFSET.getConfigValue() * 0.3F, 0.0);
            ...
            bufferbuilder.m_252986_(matrix4f, -0.5F, -0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).uv(f8, f10).endVertex();
            bufferbuilder.m_252986_(matrix4f, 0.5F, -0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).uv(f7, f10).endVertex();
            bufferbuilder.m_252986_(matrix4f, 0.5F, 0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).uv(f7, f9).endVertex();
            bufferbuilder.m_252986_(matrix4f, -0.5F, 0.5F, -0.5F).color(1.0F, 1.0F, 1.0F, 0.9F).uv(f8, f9).endVertex();
    ...
    public void renderWorld(T instance, PoseStack pMatrixStack, MultiBufferSource pBuffer, Camera camera, Entity pEntity) {
        TextureAtlasSprite textureAtlasSprite0 = this.getFirstFlame().sprite();
        TextureAtlasSprite textureAtlasSprite1 = this.getSecondFlame().sprite();
        ...
        pMatrixStack.translate(0.0, 0.0, (double) (-0.3F + (float) ((int) f3) * 0.02F));
        float f5 = 0.0F;
        int i = 0;
