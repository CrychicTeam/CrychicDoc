...
public class LodestoneAxeItem extends AxeItem {
    ...
    public LodestoneAxeItem(Tier material, float damage, float speed, Item.Properties properties) {
        super(material, damage + 6.0F, speed - 3.2F, properties.durability(material.getUses()));
    }
