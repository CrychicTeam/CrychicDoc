...
public class RenderTypeData {
    ...
    public RenderTypeData(String name, LodestoneRenderType type) {
        this(name, type.m_110508_(), type.m_173186_(), type.state.shaderState, type.state.transparencyState, type.state.textureState, type.state.cullState, type.state.lightmapState);
    }

    public RenderTypeData(LodestoneRenderType type) {
        this(type.f_110133_, type);
    }
}