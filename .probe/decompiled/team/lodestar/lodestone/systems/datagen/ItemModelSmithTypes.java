...
public class ItemModelSmithTypes {
    ...
    public static Function<String, ItemModelSmith> AFFIXED_BLOCK_TEXTURE_MODEL = Util.memoize((Function<String, ItemModelSmith>) (affix -> new ItemModelSmith((item, provider) -> {
        String name = provider.getItemName(item);
    ...
    public static Function<String, ItemModelSmith> AFFIXED_BLOCK_MODEL = Util.memoize((Function<String, ItemModelSmith>) (affix -> new ItemModelSmith((item, provider) -> {
        String name = provider.getItemName(item);
    ...
    public static ItemModelSmith BUTTON_ITEM = (ItemModelSmith) AFFIXED_BLOCK_MODEL.apply("_inventory");

    public static ItemModelSmith TRAPDOOR_ITEM = (ItemModelSmith) AFFIXED_BLOCK_MODEL.apply("_bottom");
}