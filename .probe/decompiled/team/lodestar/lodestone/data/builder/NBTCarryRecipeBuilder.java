...
public class NBTCarryRecipeBuilder {
    ...
    public NBTCarryRecipeBuilder patternLine(String patternIn) {
        if (!this.pattern.isEmpty() && patternIn.length() != ((String) this.pattern.get(0)).length()) {
    ...
    public void build(Consumer<FinishedRecipe> consumerIn, ResourceLocation id) {
        ...
        consumerIn.accept(new NBTCarryRecipeBuilder.Result(id, this.nbtCarry, this.result, this.count, this.group == null ? "" : this.group, this.pattern, this.key, this.advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + id.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject json) {
            ...
            json.add("nbtCarry", this.nbtCarry.toJson());
