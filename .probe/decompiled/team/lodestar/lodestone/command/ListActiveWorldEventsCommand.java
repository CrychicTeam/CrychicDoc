...
public class ListActiveWorldEventsCommand {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> register() {
        return (LiteralArgumentBuilder<CommandSourceStack>) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("list").requires(cs -> cs.hasPermission(2))).then(Commands.literal("all").executes(context -> {
            ...
            return 1;
        }))).then(Commands.literal("type").then(Commands.argument("worldEventType", WorldEventTypeArgument.worldEventType()).executes(ctx -> {
            WorldEventType worldEventType = WorldEventTypeArgument.getEventType(ctx, "worldEventType");
            CommandSourceStack source = (CommandSourceStack) ctx.getSource();
            ServerLevel level = source.getLevel();
            ListActiveWorldEventsCommand.ActiveWorldEventReport report = new ListActiveWorldEventsCommand.ActiveWorldEventReport(level, worldEventType);
            report.buildInteractiveMessage(component -> source.sendSuccess(() -> component, true), 0);
            return 1;
        })))).then(Commands.literal("page").then(Commands.argument("page", IntegerArgumentType.integer(0)).executes(ctx -> {
    ...
    protected static class ActiveWorldEventReport {
        ...
        private void buildInteractiveIndexPage(Consumer<Component> consumer, int page) {
            ...
            for (int i = startIndex; i < endIndex; i++) {
                WorldEventInstance event = (WorldEventInstance) this.activeWorldEvents.get(i);
                MutableComponent eventComponent = Component.literal(String.format("%02d. | %s | ", i + 1, event.type.id.toString())).withStyle(Style.EMPTY.withColor(i % 2 == 1 ? ChatFormatting.GRAY : ChatFormatting.WHITE).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal(event.toString()))));
                MutableComponent detailsButton = Component.literal("[>]").withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent get " + event.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to see details"))));
                MutableComponent freezeButton = Component.literal("[F]").withStyle(Style.EMPTY.withColor(ChatFormatting.AQUA).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent freeze single " + event.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to freeze"))));
                MutableComponent unfreezeButton = Component.literal("[U]").withStyle(Style.EMPTY.withColor(ChatFormatting.DARK_AQUA).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent unfreeze single " + event.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to unfreeze"))));
                MutableComponent removeButton = Component.literal("[X]").withStyle(Style.EMPTY.withColor(ChatFormatting.RED).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent remove single " + event.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to remove"))));
        ...
        protected void buildInstanceDetailsPage(Consumer<Component> consumer, WorldEventInstance worldEventInstance) {
            ...
            MutableComponent worldEventUUID = Component.literal("UUID: ").withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)).append(Component.literal(worldEventInstance.uuid.toString()).withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, worldEventInstance.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to copy")))));
            MutableComponent worldEventType = Component.literal("Type: ").withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)).append(Component.literal(worldEventInstance.type.id.toString()).withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent list type " + worldEventInstance.type.id.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Click to filter by type")))));
            MutableComponent frozenStatus = Component.literal("Frozen: ").withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)).append(Component.literal(worldEventInstance.isFrozen() ? "Yes" : "No").withStyle(Style.EMPTY.withColor(worldEventInstance.isFrozen() ? ChatFormatting.DARK_AQUA : ChatFormatting.GREEN)));
        ...
        private void buildInteractiveFooter(Consumer<Component> consumer, WorldEventInstance instance) {
            MutableComponent backButton = Component.literal("[Back]").withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent list page 0")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Back to World Event List"))));
            MutableComponent freezeButton = Component.literal("[Freeze]").withStyle(Style.EMPTY.withColor(ChatFormatting.DARK_BLUE).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent freeze single " + instance.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Freeze this World Event"))));
            ...
            MutableComponent removeButton = Component.literal("[Remove]").withStyle(Style.EMPTY.withColor(ChatFormatting.RED).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent remove single " + instance.uuid.toString())).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Remove this World Event"))));
        ...
        private void buildHeader(Consumer<Component> consumer) {
            this.buildWhitespace(consumer);
            consumer.accept(Component.translatable("There are %s active World Events", this.instanceCount).withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)));
            consumer.accept(Component.translatable("%s events are frozen", this.frozenCount).withStyle(Style.EMPTY.withColor(ChatFormatting.AQUA)));
            consumer.accept(getDashedLine().withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)));
        }

        private void buildInteractiveFooter(Consumer<Component> consumer, int page) {
            consumer.accept(getDashedLine().withStyle(Style.EMPTY.withColor(ChatFormatting.GOLD)));
            MutableComponent previousPage = Component.literal("[<]").withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent list page " + (page - 1))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Previous Page"))));
            MutableComponent nextPage = Component.literal("[>]").withStyle(Style.EMPTY.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent list page " + (page + 1))).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Next Page"))));
            MutableComponent removeAll = Component.literal("[Remove All]").withStyle(Style.EMPTY.withColor(ChatFormatting.RED).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent remove all")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Remove all active World Events"))));
            MutableComponent freezeAll = Component.literal("[Freeze All]").withStyle(Style.EMPTY.withColor(ChatFormatting.DARK_BLUE).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent freeze all")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Freeze all active World Events"))));
            MutableComponent unfreezeAll = Component.literal("[Unfreeze All]").withStyle(Style.EMPTY.withColor(ChatFormatting.DARK_AQUA).withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/lodestone worldevent unfreeze all")).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.literal("Unfreeze all active World Events"))));
