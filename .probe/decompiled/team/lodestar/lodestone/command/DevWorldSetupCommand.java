...
public class DevWorldSetupCommand {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> register() {
        return (LiteralArgumentBuilder<CommandSourceStack>) ((LiteralArgumentBuilder) Commands.literal("devsetup").requires(cs -> cs.hasPermission(2))).executes(context -> {
            ...
            source.getLevel().setDayTime(16000L);
