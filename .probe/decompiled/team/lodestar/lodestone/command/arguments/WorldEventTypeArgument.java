...
public class WorldEventTypeArgument implements ArgumentType<WorldEventType> {
    ...
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_WORLD_EVENT_TYPE = new DynamicCommandExceptionType(object -> Component.translatable("argument.lodestone.id.invalid", object.toString()));
    ...
    public WorldEventType parse(StringReader reader) throws CommandSyntaxException {
        ...
        WorldEventType worldEventType = (WorldEventType) LodestoneWorldEventTypeRegistry.EVENT_TYPES.get(resourceLocation);
