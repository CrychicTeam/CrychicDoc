...
public class Services {
    ...
    public static final ExplorationMapFunctionLogicHelper EXPLORATION_MAP_FUNCTION_LOGIC = load(ExplorationMapFunctionLogicHelper.class);

    private static <T> T load(Class<T> clazz) {
        T service = (T) ServiceLoader.load(clazz).findFirst().orElseThrow(() -> new NullPointerException("Failed to load service for " + clazz.getName()));
