...
public abstract class AbstractFrame extends AbstractWidget implements ContainerEventHandler {
    ...
    public void applyScissor(int x, int y, int width, int height, Runnable action) {
        ...
        RenderSystem.enableScissor((int) ((double) x * scale), (int) ((double) Minecraft.getInstance().getWindow().getHeight() - (double) (y + height) * scale), (int) ((double) width * scale), (int) ((double) height * scale));
        action.run();
