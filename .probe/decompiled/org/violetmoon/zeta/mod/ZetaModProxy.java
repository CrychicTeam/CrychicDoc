...
public class ZetaModProxy {
    ...
    public void registerEvents(Zeta zeta) {
        zeta.loadBus.subscribe(RecipeCrawlHandler.class).subscribe(ToolInteractionHandler.class).subscribe(EntitySpawnHandler.class).subscribe(WorldGenHandler.class).subscribe(ZetaGeneralConfig.class);
