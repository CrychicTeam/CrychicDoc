...
enum GolemTabType {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("modulargolems", "textures/gui/tabs.png");
    ...
    private GolemTabType(int tx, int ty, int w, int h, int max) {
        this.textureX = tx;
        this.textureY = ty;
        this.width = w;
        this.height = h;
