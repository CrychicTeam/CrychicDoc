...
public class FluidWrapper {
    ...
    public static List<String> getTypes() {
        ...
        for (Entry<ResourceKey<Fluid>, Fluid> entry : RegistryInfo.FLUID.entrySet()) {
            types.add(((ResourceKey) entry.getKey()).location().toString());
        }
        return types;
    }
