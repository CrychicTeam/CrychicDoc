...
public interface ItemEvents {
    ...
    EventHandler FIRST_RIGHT_CLICKED = GROUP.common("firstRightClicked", () -> ItemClickedEventJS.class).extra(SUPPORTS_ITEM);

    EventHandler FIRST_LEFT_CLICKED = GROUP.common("firstLeftClicked", () -> ItemClickedEventJS.class).extra(SUPPORTS_ITEM);
