...
public abstract class Unit {
    ...
    public abstract double get(UnitVariables var1);
    ...
    public int getInt(UnitVariables variables) {
        double d = this.get(variables);
        int i = (int) d;
        return d < (double) i ? i - 1 : i;
    }

    public boolean getBoolean(UnitVariables variables) {
        return this.get(variables) != 0.0;
    }
    ...
    public Unit add(double value) {
        return this.add(FixedNumberUnit.of(value));
    }
    ...
    public Unit sub(double value) {
        return this.sub(FixedNumberUnit.of(value));
    }
    ...
    public Unit mod(double value) {
        return this.mod(FixedNumberUnit.of(value));
    }
    ...
    public Unit addSet(Unit unit) {
        return new SetUnit(UnitSymbol.ADD_SET, this, this.add(unit));
    }

    public Unit subSet(Unit unit) {
        return new SetUnit(UnitSymbol.SUB_SET, this, this.sub(unit));
    }

    public Unit mulSet(Unit unit) {
        return new SetUnit(UnitSymbol.MUL_SET, this, this.mul(unit));
    }

    public Unit divSet(Unit unit) {
        return new SetUnit(UnitSymbol.DIV_SET, this, this.div(unit));
    }

    public Unit modSet(Unit unit) {
        return new SetUnit(UnitSymbol.MOD_SET, this, this.mod(unit));
    }
}