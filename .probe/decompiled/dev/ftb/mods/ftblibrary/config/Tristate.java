...
public enum Tristate {
    ...
    FALSE("false", "false", InteractionResult.FAIL, Color4I.rgb(13969460), 1, Icons.ACCEPT_GRAY), TRUE("true", "true", InteractionResult.SUCCESS, Color4I.rgb(3385907), 0, Icons.ACCEPT), DEFAULT("default", "Default", InteractionResult.PASS, Color4I.rgb(38143), 2, Icons.SETTINGS);
    ...
    private Tristate(String n, String dn, InteractionResult r, Color4I c, int o, Icon i) {
        this.name = n;
        this.displayName = dn;
        this.result = r;
        this.color = c;
    ...
    public void write(CompoundTag nbt, String key) {
        if (!this.isDefault()) {
            nbt.putBoolean(key, this.isTrue());
        }
    }
