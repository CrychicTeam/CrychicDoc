...
public class ChangeProgressArgument implements ArgumentType<ChangeProgress> {
    ...
    private static final DynamicCommandExceptionType INVALID_TYPE = new DynamicCommandExceptionType(type -> Component.translatable("commands.ftbquests.change_progress.invalid_type", type));
