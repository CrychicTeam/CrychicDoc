...
public class SyncQuestsMessage extends BaseS2CMessage {
    ...
    SyncQuestsMessage(FriendlyByteBuf buffer) {
        this.file = FTBQuestsClient.createClientQuestFile();
        this.file.readNetDataFull(buffer);
    }
    ...
    public void write(FriendlyByteBuf buffer) {
        this.file.writeNetDataFull(buffer);
    }

    @Override
    public void handle(NetworkManager.PacketContext context) {
        ClientQuestFile.syncFromServer(this.file);
