...
import dev.ftb.mods.ftbquests.net.forge.FTBQuestsNetHandlerImpl;
import net.minecraft.network.FriendlyByteBuf;
import net.minecraft.world.item.ItemStack;

public interface FTBQuestsNetHandler {

    SimpleNetworkManager NET = SimpleNetworkManager.create("ftbquests");
    ...
    static void writeItemType(FriendlyByteBuf buffer, ItemStack stack) {
        FTBQuestsNetHandlerImpl.writeItemType(buffer, stack);
    }

    @ExpectPlatform
    @Transformed
    static ItemStack readItemType(FriendlyByteBuf buffer) {
        return FTBQuestsNetHandlerImpl.readItemType(buffer);
    }
}