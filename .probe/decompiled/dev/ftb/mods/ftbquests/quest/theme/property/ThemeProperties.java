...
public interface ThemeProperties {
    ...
    IconProperty CHECK_ICON = new IconProperty("check_icon", new ThemeProperties.CheckIcon(SYMBOL_OUT, SYMBOL_IN));
    ...
    IconProperty ADD_ICON = new IconProperty("add_icon", new Icon() {
        ...
        public void draw(GuiGraphics graphics, int x, int y, int w, int h) {
            ...
            float dw = (float) w / 16.0F;
            float dh = (float) h / 16.0F;
            Color4I out = ThemeProperties.SYMBOL_OUT.get();
            int r = out.redi();
            int g = out.greeni();
            int b = out.bluei();
            int a = out.alphai();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 2.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 14.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 10.0F, (float) y + dh * 14.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 10.0F, (float) y + dh * 2.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 2.0F, (float) y + dh * 6.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 2.0F, (float) y + dh * 10.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 14.0F, (float) y + dh * 10.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 14.0F, (float) y + dh * 6.0F, 0.0F).color(r, g, b, a).endVertex();
            Color4I in = ThemeProperties.SYMBOL_IN.get();
            r = in.redi();
            g = in.greeni();
            b = in.bluei();
            a = in.alphai();
            buffer.m_252986_(m, (float) x + dw * 7.0F, (float) y + dh * 3.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 7.0F, (float) y + dh * 13.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 9.0F, (float) y + dh * 13.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 9.0F, (float) y + dh * 3.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 3.0F, (float) y + dh * 7.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 3.0F, (float) y + dh * 9.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 13.0F, (float) y + dh * 9.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 13.0F, (float) y + dh * 7.0F, 0.0F).color(r, g, b, a).endVertex();
            tesselator.end();
        }
    ...
    DoubleProperty DEPENDENCY_LINE_SELECTED_SPEED = new DoubleProperty("dependency_line_selected_speed", 0.0, 1000.0);

    DoubleProperty DEPENDENCY_LINE_UNSELECTED_SPEED = new DoubleProperty("dependency_line_unselected_speed", 0.0, 1000.0);

    DoubleProperty DEPENDENCY_LINE_THICKNESS = new DoubleProperty("dependency_line_thickness", 0.0, 3.0);

    DoubleProperty QUEST_SPACING = new DoubleProperty("quest_spacing", 0.0, 8.0);

    DoubleProperty PINNED_QUEST_SIZE = new DoubleProperty("pinned_quest_size", 0.0, 3.0);
    ...
    public static class CheckIcon extends Icon {
        ...
        public void draw(GuiGraphics graphics, int x, int y, int w, int h) {
            ...
            float dw = (float) w / 16.0F;
            float dh = (float) h / 16.0F;
            Color4I cOut = (Color4I) this.out.map(col -> col, ThemeProperty::get);
            int r = cOut.redi();
            int g = cOut.greeni();
            int b = cOut.bluei();
            int a = cOut.alphai();
            buffer.m_252986_(m, (float) x + dw * 0.0F, (float) y + dh * 8.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 14.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 8.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 3.0F, (float) y + dh * 5.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 8.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 14.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 16.0F, (float) y + dh * 4.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 13.0F, (float) y + dh * 1.0F, 0.0F).color(r, g, b, a).endVertex();
            Color4I cIn = (Color4I) this.in.map(col -> col, ThemeProperty::get);
            r = cIn.redi();
            g = cIn.greeni();
            b = cIn.bluei();
            a = cIn.alphai();
            buffer.m_252986_(m, (float) x + dw * 0.0F + dw, (float) y + dh * 8.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 14.0F - dh, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 8.0F + dh, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 3.0F, (float) y + dh * 5.0F + dh, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 8.0F + dh, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 6.0F, (float) y + dh * 14.0F - dh, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 16.0F - dw, (float) y + dh * 4.0F, 0.0F).color(r, g, b, a).endVertex();
            buffer.m_252986_(m, (float) x + dw * 13.0F, (float) y + dh * 1.0F + dh, 0.0F).color(r, g, b, a).endVertex();
            tesselator.end();
        }
