...
public enum DependencyRequirement {
    ...
    ALL_COMPLETED("all_completed", false, true), ONE_COMPLETED("one_completed", true, true), ALL_STARTED("all_started", false, false), ONE_STARTED("one_started", true, false);
    ...
    private DependencyRequirement(String id, boolean needOne, boolean completed) {
        this.id = id;
