...
public class Wing extends EntityModel<AbstractClientPlayer> implements IWingModel {
    ...
    public void render(PoseStack stack, MultiBufferSource buf, int packedLightIn, AbstractClientPlayer player, float partialTicks, ResourceLocation texture, PlayerModel<AbstractClientPlayer> model) {
        if (!player.m_20145_()) {
            ...
            if (player.m_6844_(EquipmentSlot.CHEST).getItem() instanceof ArmorItem) {
            ...
            this.renderToBuffer(stack, buf.getBuffer(RenderType.entityTranslucent(texture)), packedLightIn, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
        }
    }
    ...
    public static LayerDefinition createLayer() {
        ...
        partdefinition.getChild("bb_main").addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, CubeDeformation.NONE.extend(0.001F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, 0.3491F, 0.0F));
        partdefinition.getChild("bb_main").addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, CubeDeformation.NONE.extend(0.001F)), PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
