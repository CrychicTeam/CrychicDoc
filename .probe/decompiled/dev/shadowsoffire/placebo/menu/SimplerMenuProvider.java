...
public class SimplerMenuProvider<M extends AbstractContainerMenu> implements MenuProvider {
    ...
    public SimplerMenuProvider(Level level, BlockPos pos, MenuUtil.PosFactory<M> factory) {
        this.menuConstructor = (id, inv, player) -> factory.create(id, inv, pos);
        this.title = Component.translatable(level.getBlockState(pos).m_60734_().getDescriptionId());
    }
