...
public class StackLootEntry extends LootPoolSingletonContainer {
    ...
    public static final StackLootEntry.Serializer SERIALIZER = new StackLootEntry.Serializer();

    public static final LootPoolEntryType STACKLOOTENTRYTYPE = Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation("placebo", "stack_entry"), new LootPoolEntryType(SERIALIZER));
    ...
    public static class Serializer extends LootPoolSingletonContainer.Serializer<StackLootEntry> {
        ...
        protected StackLootEntry deserialize(JsonObject jsonObject, JsonDeserializationContext context, int weight, int quality, LootItemCondition[] lootConditions, LootItemFunction[] lootFunctions) {
            ...
            ItemStack stack = (ItemStack) ((Pair) ItemAdapter.CODEC.decode(JsonOps.INSTANCE, GsonHelper.getAsJsonObject(jsonObject, "stack")).getOrThrow(false, Placebo.LOGGER::error)).getFirst();
        ...
        public void serializeCustom(JsonObject object, StackLootEntry e, JsonSerializationContext conditions) {
            ...
            object.add("stack", (JsonElement) ItemAdapter.CODEC.encodeStart(JsonOps.INSTANCE, e.stack).getOrThrow(false, Placebo.LOGGER::error));
        }
    }
}