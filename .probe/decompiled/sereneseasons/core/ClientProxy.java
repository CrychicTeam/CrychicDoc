...
public class ClientProxy extends CommonProxy {
    ...
    void registerItemModelsProperties() {
        ItemProperties.register(SSItems.CALENDAR.get(), new ResourceLocation("sereneseasons", "time"), new ItemPropertyFunction() {
            ...
            public float call(ItemStack stack, ClientLevel clientWorld, LivingEntity entity, int seed) {
                ...
                if (clientWorld == null && holder != null) {
                    world = holder.level();
                }
                if (world == null) {
                    return 0.0F;
                    ...
                    double d0 = (double) ((float) seasonCycleTicks / (float) SeasonTime.ZERO.getCycleDuration());
                    return Mth.positiveModulo((float) d0, 1.0F);
                }
            }
        });
        ItemProperties.register(SSItems.CALENDAR.get(), new ResourceLocation("sereneseasons", "seasontype"), new ItemPropertyFunction() {
