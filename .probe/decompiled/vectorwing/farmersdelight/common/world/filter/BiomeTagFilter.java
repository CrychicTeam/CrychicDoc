...
public class BiomeTagFilter extends PlacementFilter {
    ...
    public static final Codec<BiomeTagFilter> CODEC = RecordCodecBuilder.create(builder -> builder.group(TagKey.codec(ForgeRegistries.BIOMES.getRegistryKey()).fieldOf("tag").forGetter(instance -> instance.biomeTag)).apply(builder, BiomeTagFilter::new));
    ...
    protected boolean shouldPlace(PlacementContext context, RandomSource random, BlockPos pos) {
        Holder<Biome> biome = context.getLevel().m_204166_(pos);
