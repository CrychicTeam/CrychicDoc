...
public class ModRecipeSerializers {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, "farmersdelight");
    ...
    public static final RegistryObject<SimpleCraftingRecipeSerializer<?>> FOOD_SERVING = RECIPE_SERIALIZERS.register("food_serving", () -> new SimpleCraftingRecipeSerializer(FoodServingRecipe::new));
}