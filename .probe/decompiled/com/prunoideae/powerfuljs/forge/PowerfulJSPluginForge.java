...
public class PowerfulJSPluginForge extends PowerfulJSPlugin {
    ...
    public void registerBindings(BindingsEvent event) {
        ...
        if (Platform.isModLoaded("curios")) {
            ...
            ((PowerfulJSCommon) PowerfulJS.PROXY.get()).runOnClient(() -> event.add("CuriosRenderer", ICurioRenderer.class));
        }
    ...
    public void afterInit() {
        ...
        if (Platform.isModLoaded("curios")) {
            ((PowerfulJSCommon) PowerfulJS.PROXY.get()).runOnClient(() -> EventCurios.REGISTER_RENDERER.post(ScriptType.STARTUP, new RegisterCuriosRendererEventJS()));
        }
    }
}