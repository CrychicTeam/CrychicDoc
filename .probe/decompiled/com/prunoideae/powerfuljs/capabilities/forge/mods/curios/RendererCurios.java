...
public class RendererCurios implements ICurioRenderer {
    ...
    private final Consumer<RendererCurios.RenderContext> renderer;

    public RendererCurios(Consumer<RendererCurios.RenderContext> renderer) {
        this.renderer = renderer;
    }

    @Override
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        this.renderer.accept(new RendererCurios.RenderContext(stack, slotContext, matrixStack, renderLayerParent, renderTypeBuffer, light, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch));
    }
