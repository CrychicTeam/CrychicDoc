...
public class DurationModifier extends ModifierEnchantment {

    public DurationModifier() {
        super(Attribute.DURATION, 1, Enchantment.Rarity.COMMON, EnchantmentCategory.WEAPON, new EquipmentSlot[] { EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND });
    }
