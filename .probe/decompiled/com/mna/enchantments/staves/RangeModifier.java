...
public class RangeModifier extends ModifierEnchantment {

    public RangeModifier() {
        super(Attribute.RANGE, 1, Enchantment.Rarity.COMMON, EnchantmentCategory.WEAPON, new EquipmentSlot[] { EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND });
    }
