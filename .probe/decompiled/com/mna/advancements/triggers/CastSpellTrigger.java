...
public class CastSpellTrigger extends SimpleCriterionTrigger<CastSpellTrigger.Instance> {
    ...
    public CastSpellTrigger.Instance createInstance(JsonObject json, ContextAwarePredicate entityPredicate, DeserializationContext conditionsParser) {
        ...
        return new CastSpellTrigger.Instance(entityPredicate, predicate);
    }
    ...
    public static class Instance extends AbstractCriterionTriggerInstance {
        ...
        public Instance(ContextAwarePredicate player, CraftSpellPredicate predicate) {
            super(CastSpellTrigger.ID, player);
