...
public class ConstructPartCasterArmRight extends ItemConstructPart implements ICanContainSpell {

    public ConstructPartCasterArmRight(ConstructMaterial material) {
        super(material, ConstructSlot.RIGHT_ARM, 128);
    }
