...
public class ConstructPartManaCannonLeft extends ChargeableConstructPart {

    public ConstructPartManaCannonLeft(ConstructMaterial material) {
        super(material, ConstructSlot.LEFT_ARM, 16);
    }
