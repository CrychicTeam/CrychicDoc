...
public class ConstructPartFluidNozzleLeft extends ItemConstructPart {

    public ConstructPartFluidNozzleLeft(ConstructMaterial material) {
        super(material, ConstructSlot.LEFT_ARM, 64);
    }
