...
public class ItemEnderguardAmulet extends ChargeableItem implements IPreEnchantedItem<ItemEnderguardAmulet> {

    public ItemEnderguardAmulet(Item.Properties properties, float maxMana) {
