...
public class SpellModifierRing extends ChargeableItem implements IPreEnchantedItem<SpellModifierRing> {

    public SpellModifierRing(Item.Properties properties, float maxMana) {
