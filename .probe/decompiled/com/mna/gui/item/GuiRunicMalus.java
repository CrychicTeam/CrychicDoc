...
public class GuiRunicMalus extends GuiBagBase<ContainerRunicMalus> {
    ...
    public GuiRunicMalus(ContainerRunicMalus inventorySlotsIn, Inventory inv, Component comp) {
    ...
    protected void renderBg(GuiGraphics pGuiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        int i = this.f_97735_ + this.f_97726_ / 2 - 53;
        int j = this.f_97736_;
        pGuiGraphics.blit(this.texture(), i, j, 0, 0, 106, 114);
        i = this.f_97735_;
        j = this.f_97736_ + 119;
