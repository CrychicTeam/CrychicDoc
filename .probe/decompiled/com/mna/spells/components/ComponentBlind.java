...
public class ComponentBlind extends PotionEffectComponent {

    public ComponentBlind(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.BLINDNESS, new AttributeValuePair(Attribute.DURATION, 30.0F, 30.0F, 600.0F, 30.0F, 2.0F));
    }
