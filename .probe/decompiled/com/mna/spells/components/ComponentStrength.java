...
public class ComponentStrength extends PotionEffectComponent {

    public ComponentStrength(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.DAMAGE_BOOST, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 4.0F));
    }
    ...
    public List<Affinity> getValidTinkerAffinities() {
        return Arrays.asList(Affinity.ARCANE, Affinity.EARTH, Affinity.WATER, Affinity.ICE, Affinity.LIGHTNING, Affinity.FIRE);
    }
}