...
public class ComponentGravityWell extends PotionEffectComponent {
    ...
    public ComponentGravityWell(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.GRAVITY_WELL, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 2.0F));
    }
