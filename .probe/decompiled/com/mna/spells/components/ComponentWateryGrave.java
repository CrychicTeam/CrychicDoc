...
public class ComponentWateryGrave extends PotionEffectComponent {

    public ComponentWateryGrave(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.WATERY_GRAVE, new AttributeValuePair(Attribute.DURATION, 1.0F, 1.0F, 15.0F, 1.0F, 2.0F));
    }
