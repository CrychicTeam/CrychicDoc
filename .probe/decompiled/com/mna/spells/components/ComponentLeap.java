...
public class ComponentLeap extends PotionEffectComponent {

    public ComponentLeap(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.JUMP, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 2.0F), new AttributeValuePair(Attribute.LESSER_MAGNITUDE, 1.0F, 1.0F, 10.0F, 1.0F, 10.0F));
        this.addPermanencyReagent(new ItemStack(Items.SLIME_BALL), new IFaction[0]);
    }
