...
public class ComponentHaste extends PotionEffectComponent {

    public ComponentHaste(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.MOVEMENT_SPEED, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 2.0F), new AttributeValuePair(Attribute.LESSER_MAGNITUDE, 1.0F, 1.0F, 5.0F, 1.0F, 10.0F));
    }

    @Override
    public SoundEvent SoundEffect() {
        return SFX.Spell.Buff.FIRE;
    }
    ...
    public List<Affinity> getValidTinkerAffinities() {
        return Arrays.asList(Affinity.ARCANE, Affinity.FIRE, Affinity.WIND, Affinity.LIGHTNING);
    }
}