...
public class ComponentFireShield extends PotionEffectComponent {

    public ComponentFireShield(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.FIRE_SHIELD, new AttributeValuePair(Attribute.DURATION, 15.0F, 15.0F, 180.0F, 5.0F, 2.0F), new AttributeValuePair(Attribute.LESSER_MAGNITUDE, 1.0F, 1.0F, 3.0F, 1.0F, 4.0F));
    }
