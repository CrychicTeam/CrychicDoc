...
public class ComponentEntangle extends PotionEffectComponent {

    public ComponentEntangle(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.ENTANGLE, new AttributeValuePair(Attribute.DURATION, 5.0F, 5.0F, 30.0F, 5.0F, 12.0F));
    }
