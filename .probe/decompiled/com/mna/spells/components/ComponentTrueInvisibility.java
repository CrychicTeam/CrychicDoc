...
public class ComponentTrueInvisibility extends PotionEffectComponent {

    public ComponentTrueInvisibility(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.TRUE_INVISIBILITY, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 4.0F));
    }
