...
public class ComponentWeakness extends PotionEffectComponent {

    public ComponentWeakness(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.WEAKNESS, new AttributeValuePair(Attribute.DURATION, 15.0F, 15.0F, 180.0F, 15.0F, 4.0F));
    }
