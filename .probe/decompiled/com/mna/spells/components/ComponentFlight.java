...
public class ComponentFlight extends PotionEffectComponent {

    public ComponentFlight(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.SOAR, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 35.0F));
    }
