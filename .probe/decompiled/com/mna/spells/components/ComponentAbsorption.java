...
public class ComponentAbsorption extends PotionEffectComponent {

    public ComponentAbsorption(ResourceLocation guiIcon) {
        super(guiIcon, MobEffects.ABSORPTION, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 2.0F), new AttributeValuePair(Attribute.MAGNITUDE, 1.0F, 1.0F, 3.0F, 1.0F, 4.0F));
    }
    ...
    public List<Affinity> getValidTinkerAffinities() {
        return Arrays.asList(Affinity.ARCANE, Affinity.ENDER, Affinity.WATER, Affinity.FIRE, Affinity.ICE, Affinity.EARTH);
    }
