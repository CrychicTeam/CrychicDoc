...
public class ComponentWaterWalking extends PotionEffectComponent {

    public ComponentWaterWalking(ResourceLocation guiIcon) {
        super(guiIcon, EffectInit.WATER_WALKING, new AttributeValuePair(Attribute.DURATION, 120.0F, 30.0F, 600.0F, 30.0F, 4.0F));
        this.addPermanencyReagent(new ItemStack(BlockInit.WAKEBLOOM.get()), new IFaction[0]);
    }
