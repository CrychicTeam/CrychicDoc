...
public class MilkmadeHatLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, T livingEntity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (stackBySlot.getItem() instanceof MilkmadeHatItem) {
            this.m_117386_().copyPropertiesTo(this.milkmadeHatModel);
            ...
            this.milkmadeHatModel.m_7695_(poseStack, vertexConsumer, packedLight, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 1.0F);
        }
    }
}