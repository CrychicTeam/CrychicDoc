...
public final class CrockPotItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, "crockpot");
    ...
    public static final RegistryObject<Item> AVAJ = ITEMS.register("avaj", () -> new CrockPotFoodBlockItem(CrockPotBlocks.AVAJ.get(), CrockPotFoodProperties.builder(2, 3.6F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(MobEffects.MOVEMENT_SPEED, 38800, 2).rarity(Rarity.EPIC).build()));
    ...
    public static final RegistryObject<Item> BONE_SOUP = ITEMS.register("bone_soup", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BONE_SOUP.get(), CrockPotFoodProperties.builder(10, 0.6F).effect(MobEffects.ABSORPTION, 2400, 1).meat().build()));
    ...
    public static final RegistryObject<Item> BUNNY_STEW = ITEMS.register("bunny_stew", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BUNNY_STEW.get(), CrockPotFoodProperties.builder(6, 0.8F).effect(MobEffects.REGENERATION, 100).effect(CrockPotEffects.WELL_FED, 2400).meat().build()));

    public static final RegistryObject<Item> CALIFORNIA_ROLL = ITEMS.register("california_roll", () -> new CrockPotFoodBlockItem(CrockPotBlocks.CALIFORNIA_ROLL.get(), CrockPotFoodProperties.builder(10, 0.6F).heal(4.0F).effect(MobEffects.ABSORPTION, 1200).meat().build()));

    public static final RegistryObject<Item> CANDY = ITEMS.register("candy", CandyItem::new);

    public static final RegistryObject<Item> CEVICHE = ITEMS.register("ceviche", () -> new CrockPotFoodBlockItem(CrockPotBlocks.CEVICHE.get(), CrockPotFoodProperties.builder(7, 0.7F).alwaysEat().effect(MobEffects.DAMAGE_RESISTANCE, 400, 1).effect(MobEffects.ABSORPTION, 400, 1).meat().build()));

    public static final RegistryObject<Item> FISH_STICKS = ITEMS.register("fish_sticks", () -> new CrockPotFoodBlockItem(CrockPotBlocks.FISH_STICKS.get(), CrockPotFoodProperties.builder(7, 0.7F).effect(MobEffects.REGENERATION, 600).meat().build()));
    ...
    public static final RegistryObject<Item> FRUIT_MEDLEY = ITEMS.register("fruit_medley", () -> new CrockPotFoodBlockItem(CrockPotBlocks.FRUIT_MEDLEY.get(), CrockPotFoodProperties.builder(8, 0.4F).effect(MobEffects.MOVEMENT_SPEED, 3600).build()));

    public static final RegistryObject<Item> GAZPACHO = ITEMS.register("gazpacho", () -> new CrockPotFoodBlockItem(CrockPotBlocks.GAZPACHO.get(), CrockPotFoodProperties.builder(6, 0.4F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(MobEffects.FIRE_RESISTANCE, 12000).build()));

    public static final RegistryObject<Item> GLOW_BERRY_MOUSSE = ITEMS.register("glow_berry_mousse", () -> new CrockPotFoodBlockItem(CrockPotBlocks.GLOW_BERRY_MOUSSE.get(), CrockPotFoodProperties.builder(6, 0.6F).duration(FoodUseDuration.FAST).effect(MobEffects.GLOWING, 200).build()));

    public static final RegistryObject<Item> HONEY_HAM = ITEMS.register("honey_ham", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HONEY_HAM.get(), CrockPotFoodProperties.builder(12, 0.8F).effect(MobEffects.REGENERATION, 400).effect(MobEffects.ABSORPTION, 1200, 1).heal(6.0F).meat().build()));

    public static final RegistryObject<Item> HONEY_NUGGETS = ITEMS.register("honey_nuggets", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HONEY_NUGGETS.get(), CrockPotFoodProperties.builder(8, 0.3F).effect(MobEffects.REGENERATION, 200).effect(MobEffects.ABSORPTION, 1200).heal(4.0F).meat().build()));

    public static final RegistryObject<Item> HOT_CHILI = ITEMS.register("hot_chili", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HOT_CHILI.get(), CrockPotFoodProperties.builder(9, 0.8F).effect(MobEffects.DAMAGE_BOOST, 1800).effect(MobEffects.DIG_SPEED, 1800).meat().build()));

    public static final RegistryObject<Item> HOT_COCOA = ITEMS.register("hot_cocoa", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HOT_COCOA.get(), CrockPotFoodProperties.builder(2, 0.1F).alwaysEat().drink().effect(MobEffects.MOVEMENT_SPEED, 9600, 1).removeEffect(MobEffects.MOVEMENT_SLOWDOWN).removeEffect(MobEffects.DIG_SLOWDOWN).build()));

    public static final RegistryObject<Item> ICE_CREAM = ITEMS.register("ice_cream", IceCreamItem::new);

    public static final RegistryObject<Item> ICED_TEA = ITEMS.register("iced_tea", () -> new CrockPotFoodBlockItem(CrockPotBlocks.ICED_TEA.get(), CrockPotFoodProperties.builder(3, 0.1F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(MobEffects.MOVEMENT_SPEED, 12000, 1).effect(MobEffects.JUMP, 6000, 1).build()));
    ...
    public static final RegistryObject<Item> MASHED_POTATOES = ITEMS.register("mashed_potatoes", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MASHED_POTATOES.get(), CrockPotFoodProperties.builder(9, 0.6F).effect(MobEffects.DAMAGE_RESISTANCE, 4800).build()));
    ...
    public static final RegistryObject<Item> MONSTER_LASAGNA = ITEMS.register("monster_lasagna", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MONSTER_LASAGNA.get(), CrockPotFoodProperties.builder(7, 0.2F).effect(MobEffects.HUNGER, 300).effect(MobEffects.POISON, 40).damage(CrockPotDamageTypes.MONSTER_FOOD, 6.0F).meat().build()));

    public static final RegistryObject<Item> MONSTER_TARTARE = ITEMS.register("monster_tartare", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MONSTER_TARTARE.get(), CrockPotFoodProperties.builder(8, 0.7F).effect(MobEffects.DAMAGE_BOOST, 2400, 1).meat().build()));

    public static final RegistryObject<Item> MOQUECA = ITEMS.register("moqueca", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MOQUECA.get(), CrockPotFoodProperties.builder(14, 0.7F).duration(FoodUseDuration.SLOW).effect(MobEffects.HEALTH_BOOST, 1800, 2).heal(6.0F).meat().build()));

    public static final RegistryObject<Item> MUSHY_CAKE = ITEMS.register("mushy_cake", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MUSHY_CAKE.get(), CrockPotFoodProperties.builder(6, 0.4F).duration(FoodUseDuration.FAST).alwaysEat().effect(CrockPotEffects.WITHER_RESISTANCE, 1200).build()));

    public static final RegistryObject<Item> NETHEROSIA = ITEMS.register("netherosia", NetherosiaItem::new);

    public static final RegistryObject<Item> PEPPER_POPPER = ITEMS.register("pepper_popper", () -> new CrockPotFoodBlockItem(CrockPotBlocks.PEPPER_POPPER.get(), CrockPotFoodProperties.builder(8, 0.8F).effect(MobEffects.DAMAGE_BOOST, 1200, 1).meat().build()));
    ...
    public static final RegistryObject<Item> POTATO_SOUFFLE = ITEMS.register("potato_souffle", () -> new CrockPotFoodBlockItem(CrockPotBlocks.POTATO_SOUFFLE.get(), CrockPotFoodProperties.builder(8, 0.7F).effect(MobEffects.DAMAGE_RESISTANCE, 1800, 1).build()));
    ...
    public static final RegistryObject<Item> SALSA = ITEMS.register("salsa", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SALSA.get(), CrockPotFoodProperties.builder(7, 0.8F).duration(FoodUseDuration.FAST).effect(MobEffects.DIG_SPEED, 7200).build()));
    ...
    public static final RegistryObject<Item> SEAFOOD_GUMBO = ITEMS.register("seafood_gumbo", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SEAFOOD_GUMBO.get(), CrockPotFoodProperties.builder(9, 0.7F).effect(MobEffects.REGENERATION, 2400).meat().build()));
    ...
    public static final RegistryObject<Item> SURF_N_TURF = ITEMS.register("surf_n_turf", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SURF_N_TURF.get(), CrockPotFoodProperties.builder(8, 1.2F).alwaysEat().effect(MobEffects.REGENERATION, 600, 1).heal(8.0F).meat().build()));

    public static final RegistryObject<Item> TAFFY = ITEMS.register("taffy", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TAFFY.get(), CrockPotFoodProperties.builder(5, 0.4F).duration(FoodUseDuration.FAST).alwaysEat().effect(MobEffects.LUCK, 9600).damage(CrockPotDamageTypes.TAFFY, 1.0F).removeEffect(MobEffects.POISON).build()));

    public static final RegistryObject<Item> TEA = ITEMS.register("tea", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TEA.get(), CrockPotFoodProperties.builder(3, 0.6F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(MobEffects.MOVEMENT_SPEED, 12000, 1).effect(MobEffects.DIG_SPEED, 6000, 1).build()));

    public static final RegistryObject<Item> TROPICAL_BOUILLABAISSE = ITEMS.register("tropical_bouillabaisse", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TROPICAL_BOUILLABAISSE.get(), CrockPotFoodProperties.builder(7, 0.6F).alwaysEat().effect(CrockPotEffects.OCEAN_AFFINITY, 3000).meat().build()));

    public static final RegistryObject<Item> TURKEY_DINNER = ITEMS.register("turkey_dinner", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TURKEY_DINNER.get(), CrockPotFoodProperties.builder(12, 0.8F).effect(MobEffects.HEALTH_BOOST, 3600).meat().build()));

    public static final RegistryObject<Item> VEG_STINGER = ITEMS.register("veg_stinger", () -> new CrockPotFoodBlockItem(CrockPotBlocks.VEG_STINGER.get(), CrockPotFoodProperties.builder(6, 0.3F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(MobEffects.NIGHT_VISION, 12000).build()));

    public static final RegistryObject<Item> VOLT_GOAT_JELLY = ITEMS.register("volt_goat_jelly", () -> new CrockPotFoodBlockItem(CrockPotBlocks.VOLT_GOAT_JELLY.get(), CrockPotFoodProperties.builder(4, 0.6F).alwaysEat().effect(CrockPotEffects.CHARGE.get(), 7200).meat().build()));

    public static final RegistryObject<Item> WATERMELON_ICLE = ITEMS.register("watermelon_icle", () -> new CrockPotFoodBlockItem(CrockPotBlocks.WATERMELON_ICLE.get(), CrockPotFoodProperties.builder(5, 0.4F).duration(FoodUseDuration.FAST).effect(MobEffects.MOVEMENT_SPEED, 3600).effect(MobEffects.JUMP, 3600).removeEffect(MobEffects.MOVEMENT_SLOWDOWN).build()));

    public static final RegistryObject<Item> WET_GOOP = ITEMS.register("wet_goop", () -> new CrockPotFoodBlockItem(CrockPotBlocks.WET_GOOP.get(), CrockPotFoodProperties.builder().duration(FoodUseDuration.SUPER_SLOW).alwaysEat().effect(MobEffects.CONFUSION, 200).tooltip("wet_goop", ChatFormatting.DARK_AQUA).build()));

    public static final Supplier<List<Item>> FOODS_WITHOUT_AVAJ = Suppliers.memoize(() -> List.of(ASPARAGUS_SOUP.get(), BACON_EGGS.get(), BONE_SOUP.get(), BONE_STEW.get(), BREAKFAST_SKILLET.get(), BUNNY_STEW.get(), CALIFORNIA_ROLL.get(), CANDY.get(), CEVICHE.get(), FISH_STICKS.get(), FISH_TACOS.get(), FLOWER_SALAD.get(), FROGGLE_BUNWICH.get(), FRUIT_MEDLEY.get(), GAZPACHO.get(), GLOW_BERRY_MOUSSE.get(), HONEY_HAM.get(), HONEY_NUGGETS.get(), HOT_CHILI.get(), HOT_COCOA.get(), ICE_CREAM.get(), ICED_TEA.get(), JAMMY_PRESERVES.get(), KABOBS.get(), MASHED_POTATOES.get(), MEAT_BALLS.get(), MONSTER_LASAGNA.get(), MONSTER_TARTARE.get(), MOQUECA.get(), MUSHY_CAKE.get(), PEPPER_POPPER.get(), PEROGIES.get(), PLAIN_OMELETTE.get(), POTATO_SOUFFLE.get(), POTATO_TORNADO.get(), POW_CAKE.get(), PUMPKIN_COOKIE.get(), RATATOUILLE.get(), SALMON_SUSHI.get(), SALSA.get(), SCOTCH_EGG.get(), SEAFOOD_GUMBO.get(), STUFFED_EGGPLANT.get(), SURF_N_TURF.get(), TAFFY.get(), TEA.get(), TROPICAL_BOUILLABAISSE.get(), TURKEY_DINNER.get(), VEG_STINGER.get(), VOLT_GOAT_JELLY.get(), WATERMELON_ICLE.get()));
