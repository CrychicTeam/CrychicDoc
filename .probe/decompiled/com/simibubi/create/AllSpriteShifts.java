...
public class AllSpriteShifts {
    ...
    public static final SpriteShiftEntry BURNER_FLAME = get("block/blaze_burner_flame", "block/blaze_burner_flame_scroll");

    public static final SpriteShiftEntry SUPER_BURNER_FLAME = get("block/blaze_burner_flame", "block/blaze_burner_flame_superheated_scroll");
    ...
    public static final CTSpriteShiftEntry FRAMED_GLASS = getCT(AllCTTypes.OMNIDIRECTIONAL, "palettes/framed_glass", "palettes/framed_glass");

    public static final CTSpriteShiftEntry HORIZONTAL_FRAMED_GLASS = getCT(AllCTTypes.HORIZONTAL_KRYPPERS, "palettes/framed_glass", "palettes/horizontal_framed_glass");

    public static final CTSpriteShiftEntry VERTICAL_FRAMED_GLASS = getCT(AllCTTypes.VERTICAL, "palettes/framed_glass", "palettes/vertical_framed_glass");
    ...
    public static final CTSpriteShiftEntry ANDESITE_ENCASED_COGWHEEL_OTHERSIDE = horizontal("andesite_encased_cogwheel_side");
    ...
    public static final Couple<CTSpriteShiftEntry> VAULT_TOP = vault("top");

    public static final Couple<CTSpriteShiftEntry> VAULT_FRONT = vault("front");

    public static final Couple<CTSpriteShiftEntry> VAULT_SIDE = vault("side");

    public static final Couple<CTSpriteShiftEntry> VAULT_BOTTOM = vault("bottom");

    public static final SpriteShiftEntry ELEVATOR_BELT = get("block/elevator_pulley_belt", "block/elevator_pulley_belt_scroll");

    public static final SpriteShiftEntry ELEVATOR_COIL = get("block/elevator_pulley_coil", "block/elevator_pulley_coil_scroll");
    ...
    public static final SpriteShiftEntry ANDESIDE_BELT_CASING = get("block/belt/brass_belt_casing", "block/belt/andesite_belt_casing");

    public static final SpriteShiftEntry CRAFTER_THINGIES = get("block/crafter_thingies", "block/crafter_thingies");

    private static void populateMaps() {
        WoodType[] supportedWoodTypes = new WoodType[] { WoodType.OAK, WoodType.SPRUCE, WoodType.BIRCH, WoodType.ACACIA, WoodType.JUNGLE, WoodType.DARK_OAK, WoodType.MANGROVE, WoodType.CRIMSON, WoodType.WARPED };
    ...
    private static Couple<CTSpriteShiftEntry> vault(String name) {
        ...
        return Couple.createWithContext(medium -> CTSpriteShifter.getCT(AllCTTypes.RECTANGLE, Create.asResource(prefixed + "_small"), Create.asResource(medium ? prefixed + "_medium" : prefixed + "_large")));
    }
    ...
    public static CTSpriteShiftEntry getWoodenWindow(WoodType woodType) {
        return (CTSpriteShiftEntry) WOODEN_WINDOWS.get(woodType);
    }
