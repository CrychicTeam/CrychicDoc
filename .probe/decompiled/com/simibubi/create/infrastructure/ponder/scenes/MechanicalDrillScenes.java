...
public class MechanicalDrillScenes {
    ...
    public static void breaker(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.setKineticSpeed(util.select.layer(0), -8.0F);
        ...
        ElementLink<EntityElement> plankEntity = scene.world.createItemEntity(util.vector.centerOf(breakingPos), util.vector.of(0.0, 0.1F, 0.0), new ItemStack(Items.OAK_PLANKS));
        scene.idle(20);
        scene.idle(15);
        scene.world.modifyEntity(plankEntity, Entity::m_146870_);
        scene.world.modifyKineticSpeed(util.select.everywhere(), f -> 4.0F * f);
        ...
        scene.world.createItemEntity(util.vector.centerOf(breakingPos), util.vector.of(0.0, 0.1F, 0.0), new ItemStack(Items.OAK_PLANKS));
        scene.idle(50);
    }
    ...
    public static void contraption(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.setKineticSpeed(drills, 16.0F);
        ...
        scene.idle(20);
        scene.world.setKineticSpeed(drills, 64.0F);
        ...
        Vec3 m = util.vector.of(-0.1, 0.0, 0.0);
        ...
        scene.world.moveSection(contraption, util.vector.of(-1.0, 0.0, 0.0), 20);
        scene.idle(20);
        scene.world.setKineticSpeed(drills, 0.0F);
        scene.idle(20);
