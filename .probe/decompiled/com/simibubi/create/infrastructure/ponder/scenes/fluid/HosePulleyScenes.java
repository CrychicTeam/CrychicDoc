...
public class HosePulleyScenes {
    ...
    public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlockEntity(util.grid.at(1, 5, 1), HosePulleyBlockEntity.class, be -> be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(ifh -> ((HosePulleyFluidHandler) ifh).fill(new FluidStack(Fluids.WATER, 100), IFluidHandler.FluidAction.EXECUTE)));
        scene.idle(20);
        scene.world.modifyBlock(util.grid.at(3, 2, 1), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.DOWN), true);
    ...
    public static void level(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(55);
        scene.world.modifyBlock(util.grid.at(3, 2, 1), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.DOWN), false);
        ...
        scene.world.showSectionAndMerge(cogs, Direction.NORTH, hoselink);
        scene.world.showSectionAndMerge(pipes, Direction.WEST, hoselink);
        scene.world.modifyBlockEntity(util.grid.at(1, 6, 1), HosePulleyBlockEntity.class, be -> be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(fh -> ((HosePulleyFluidHandler) fh).fill(new FluidStack(Fluids.WATER, 100), IFluidHandler.FluidAction.EXECUTE)));
        scene.world.propagatePipeChange(util.grid.at(3, 2, 1));
        Vec3 surface = util.vector.topOf(1, 3, 1).subtract(0.0, 0.25, 0.0);
        AABB bb = new AABB(surface, surface).inflate(1.5, 0.0, 1.5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, bb, bb, 3);
        scene.idle(3);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, bb, bb.expandTowards(0.0, -2.0, 0.0), 70);
        scene.idle(20);
        Collections.reverse(blocks);
        int i = 0;
        for (BlockPos blockPos : blocks) {
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, bb, bb.move(0.0, -2.0, 0.0), 60);
        ...
        scene.idle(15);
        scene.world.setKineticSpeed(kinetics, -32.0F);
        scene.world.modifyBlock(util.grid.at(3, 2, 1), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.UP), true);
        scene.world.propagatePipeChange(util.grid.at(3, 2, 1));
        scene.idle(16);
        scene.world.setKineticSpeed(kinetics, 0.0F);
        ...
        scene.idle(10);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, bb, bb.move(0.0, -2.75, 0.0), 3);
        scene.idle(3);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, bb, bb.expandTowards(0.0, -2.75, 0.0), 120);
        scene.idle(20);
    ...
    public static void infinite(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(40);
        scene.world.modifyBlockEntity(util.grid.at(1, 3, 2), HosePulleyBlockEntity.class, be -> be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(fh -> ((HosePulleyFluidHandler) fh).fill(new FluidStack(Fluids.WATER, 1000), IFluidHandler.FluidAction.EXECUTE)));
        scene.world.setKineticSpeed(hose, 0.0F);
        scene.world.modifyBlock(pumpPos, s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.DOWN), true);
        ...
        scene.idle(60);
        scene.world.modifyBlockEntity(util.grid.at(4, 1, 1), FluidTankBlockEntity.class, be -> be.getTankInventory().fill(new FluidStack(Fluids.WATER, 24000), IFluidHandler.FluidAction.EXECUTE));
        scene.idle(20);
