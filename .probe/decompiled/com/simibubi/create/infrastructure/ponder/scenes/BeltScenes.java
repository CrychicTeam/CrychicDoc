...
public class BeltScenes {
    ...
    public static void beltConnector(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        AABB shaftBB = ((BlockState) AllBlocks.SHAFT.getDefaultState().m_61124_(ShaftBlock.AXIS, Direction.Axis.Z)).m_60808_(null, null).bounds();
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.BLACK, backEndCenter, connectBB.expandTowards(-4.0, 0.0, 0.0), 20);
        scene.idle(20);
        ...
        scene.idle(7);
        scene.world.modifyBlock(shaftLocation, s -> (BlockState) s.m_61124_(BeltBlock.PART, BeltPart.PULLEY), true);
        scene.idle(10);
        ...
        scene.idle(7);
        scene.world.modifyBlock(shaftLocation, s -> (BlockState) s.m_61124_(BeltBlock.PART, BeltPart.MIDDLE), true);
        scene.idle(10);
        ...
        scene.idle(7);
        scene.world.modifyBlockEntityNBT(util.select.fromTo(0, 1, 2, 4, 1, 2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Dye", DyeColor.BLUE));
        scene.idle(20);
    ...
    public static void transport(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(13);
        scene.world.modifyEntity(item, Entity::m_146870_);
        BlockPos beltEnd = util.grid.at(0, 1, 2);
        scene.world.createItemOnBelt(beltEnd, Direction.DOWN, stack);
        scene.idle(20);
        ElementLink<ParrotElement> parrot = scene.special.createBirb(util.vector.topOf(0, 1, 2).add(0.0, -0.1875, 0.0), ParrotElement.FacePointOfInterestPose::new);
    ...
    public static void beltsCanBeEncased(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(beltPos), Pointing.DOWN).rightClick().withItem(brassCasingItem), 20);
        scene.idle(7);
        scene.world.modifyBlock(beltPos, s -> (BlockState) s.m_61124_(BeltBlock.CASING, true), true);
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(beltPos2), Pointing.DOWN).rightClick().withItem(andesiteCasingItem), 20);
        scene.idle(7);
        scene.world.modifyBlock(beltPos2, s -> (BlockState) s.m_61124_(BeltBlock.CASING, true), true);
        scene.world.modifyBlockEntityNBT(util.select.position(beltPos2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.ANDESITE));
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(beltPos3, Direction.EAST), Pointing.RIGHT).rightClick().withItem(brassCasingItem), 20);
        scene.idle(7);
        scene.world.modifyBlock(beltPos3, s -> (BlockState) s.m_61124_(BeltBlock.CASING, true), true);
        scene.idle(20);
        ...
        for (BlockPos pos : andesiteBelts) {
            scene.idle(4);
            scene.world.modifyBlock(pos, s -> (BlockState) s.m_61124_(BeltBlock.CASING, true), true);
            scene.world.modifyBlockEntityNBT(util.select.position(pos), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.ANDESITE));
        }
        ...
        scene.idle(30);
        scene.addKeyframe();
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(beltPos.south()), Pointing.DOWN).rightClick().withWrench(), 40);
        scene.idle(7);
        scene.world.modifyBlock(beltPos.south(), s -> (BlockState) s.m_61124_(BeltBlock.CASING, false), true);
