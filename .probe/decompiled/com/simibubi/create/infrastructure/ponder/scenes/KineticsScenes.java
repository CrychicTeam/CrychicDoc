...
public class KineticsScenes {
    ...
    public static void shaftsCanBeEncased(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(7);
        scene.world.setBlocks(andesite, (BlockState) andesiteEncased.getDefaultState().m_61124_(EncasedShaftBlock.AXIS, Direction.Axis.X), true);
        ...
        scene.idle(7);
        scene.world.setBlocks(brass, (BlockState) brassEncased.getDefaultState().m_61124_(EncasedShaftBlock.AXIS, Direction.Axis.X), true);
        scene.world.setKineticSpeed(shaft, 32.0F);
        scene.idle(10);
    ...
    public static void cogAsRelay(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.overlay.showText(100).text("Neighbouring shafts connected like this will rotate in opposite directions").placeNearTarget().attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(1, 1, 2), Direction.NORTH));
        scene.idle(70);
    }
    ...
    public static void largeCogAsRelay(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.setBlock(util.grid.at(4, 2, 3), (BlockState) AllBlocks.LARGE_COGWHEEL.getDefaultState().m_61124_(CogWheelBlock.AXIS, Direction.Axis.X), false);
        scene.showBasePlate();
        scene.idle(5);
        ...
        scene.idle(15);
        scene.world.modifyBlock(util.grid.at(3, 2, 3), s -> (BlockState) s.m_61124_(ShaftBlock.AXIS, Direction.Axis.X), false);
        ...
        scene.idle(5);
        scene.overlay.showText(90).text("It will help relaying conveyed speed to other axes of rotation").placeNearTarget().pointAt(util.vector.blockSurface(util.grid.at(1, 2, 3), Direction.WEST));
    ...
    public static void cogsSpeedUp(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        BlockState largeCogState = (BlockState) AllBlocks.LARGE_COGWHEEL.getDefaultState().m_61124_(CogWheelBlock.AXIS, Direction.Axis.X);
        BlockState smallCogState = (BlockState) AllBlocks.COGWHEEL.getDefaultState().m_61124_(CogWheelBlock.AXIS, Direction.Axis.X);
        ...
        scene.overlay.showText(80).text("Shifting from large to small cogs, the conveyed speed will be doubled").colored(PonderPalette.GREEN).attachKeyFrame().placeNearTarget().pointAt(util.vector.blockSurface(util.grid.at(1, 2, 3), Direction.NORTH));
        scene.idle(30);
    ...
    public static void cogwheelsCanBeEncased(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(7);
        scene.world.setBlocks(util.select.position(3, 1, 2), (BlockState) ((BlockState) andesiteEncased.getDefaultState().m_61124_(EncasedCogwheelBlock.AXIS, Direction.Axis.Y)).m_61124_(EncasedCogwheelBlock.TOP_SHAFT, true), true);
        ...
        scene.idle(7);
        scene.world.setBlocks(small2, (BlockState) andesiteEncased.getDefaultState().m_61124_(EncasedCogwheelBlock.AXIS, Direction.Axis.Y), true);
        ...
        scene.idle(7);
        scene.world.setBlocks(util.select.position(1, 1, 3), (BlockState) brassEncased.getDefaultState().m_61124_(EncasedCogwheelBlock.AXIS, Direction.Axis.Y), true);
        ...
        scene.idle(90);
        scene.world.moveSection(shaftLink, new Vec3(0.0, 0.5, 0.0), 10);
        scene.idle(10);
        scene.addKeyframe();
        Vec3 wrenchHere = util.vector.topOf(2, 1, 2).add(0.25, 0.0, -0.25);
        ...
        scene.idle(20);
        scene.overlay.showText(90).placeNearTarget().colored(PonderPalette.GREEN).text("The Wrench can be used to toggle connections").pointAt(wrenchHere.add(-0.5, 0.0, 0.5));
        scene.idle(40);
        scene.overlay.showControls(new InputWindowElement(wrenchHere, Pointing.RIGHT).rightClick().withWrench(), 25);
        scene.idle(7);
        scene.world.cycleBlockProperty(util.grid.at(2, 1, 2), EncasedCogwheelBlock.TOP_SHAFT);
    ...
    public static void gearbox(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.setBlock(largeCogBack, (BlockState) defaultState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.Z), false);
        scene.world.setBlock(largeCogFront, (BlockState) defaultState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.Z), false);
        scene.world.setBlock(largeCogRight, (BlockState) defaultState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.X), false);
        scene.world.setBlock(largeCogLeft, (BlockState) defaultState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.X), false);
        ...
        scene.idle(90);
        scene.world.setBlock(largeCogFront.north(), (BlockState) cogState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.Z), true);
        scene.world.setBlock(largeCogRight.west(), (BlockState) cogState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.X), true);
        scene.idle(10);
        ...
        scene.world.setBlock(largeCogBack.south(), (BlockState) cogState.m_61124_(CogWheelBlock.AXIS, Direction.Axis.Z), true);
        scene.idle(10);
        scene.effects.rotationDirectionIndicator(largeCogFront.north());
    ...
    public static void creativeMotor(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(70);
        Vec3 blockSurface = util.vector.blockSurface(motor, Direction.NORTH).add(0.0625, 0.0, 0.1875);
        ...
        scene.idle(10);
        scene.idle(50);
        scene.world.modifyKineticSpeed(util.select.fromTo(1, 1, 2, 3, 1, 2), f -> 4.0F * f);
        scene.idle(10);
        scene.effects.rotationSpeedIndicator(motor);
    }
    ...
    public static void waterWheel(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        AABB bb = new AABB(wheel).inflate(0.0625, 0.0, 0.0);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 1.0, 0.0).contract(0.0, 0.75, 0.0), 80);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 0.0, -1.0).contract(0.0, 0.0, -0.75), 75);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, -1.0, 0.0).contract(0.0, -0.75, 0.0), 70);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 0.0, 1.0).contract(0.0, 0.0, 0.75), 65);
        scene.idle(75);
        scene.addKeyframe();
        ...
        scene.idle(10);
        scene.overlay.showText(50).text("Covering additional sides will not improve its kinetic output further").colored(PonderPalette.RED).placeNearTarget().pointAt(util.vector.blockSurface(wheel, Direction.NORTH));
        scene.idle(80);
        scene.addKeyframe();
    ...
    public static void largeWaterWheel(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        ElementLink<WorldSectionElement> strip = scene.world.showIndependentSection(util.select.fromTo(1, 0, 0, 1, 0, 4), Direction.UP);
        ...
        scene.idle(10);
        AABB bb = new AABB(wheel).inflate(0.125, 1.0, 1.0);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 3.0, 0.0).contract(0.0, 2.75, 0.0), 80);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 0.0, -3.0).contract(0.0, 0.0, -2.75), 75);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, -3.0, 0.0).contract(0.0, -2.75, 0.0), 70);
        scene.idle(5);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.MEDIUM, new Object(), bb.move(0.0, 0.0, 3.0).contract(0.0, 0.0, 2.75), 65);
        scene.idle(75);
        scene.addKeyframe();
    ...
    public static void handCrank(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        Vec3 sideOf = centerOf.add(-0.5, 0.0, 0.0);
        ...
        scene.world.modifyKineticSpeed(util.select.column(1, 3), f -> f * -2.0F);
    ...
    public static void valveHandle(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        Vec3 sideOf = centerOf.add(-0.5, 0.0, 0.0);
        Vec3 topOf = centerOf.add(0.0, 0.5, 0.0);
        ...
        scene.idle(3);
        ElementLink<WorldSectionElement> valve = scene.world.showIndependentSection(util.select.position(valvePos), Direction.SOUTH);
        ...
        scene.world.setKineticSpeed(util.select.everywhere(), 0.0F);
        scene.idle(60);
        Vec3 blockSurface = util.vector.centerOf(valvePos).add(0.0, 0.0, 0.25);
        AABB point = new AABB(blockSurface, blockSurface);
        AABB expanded = point.inflate(0.125, 0.125, 0.0625);
        ...
        scene.world.setKineticSpeed(util.select.everywhere(), 0.0F);
        scene.idle(25);
        scene.overlay.showControls(new InputWindowElement(topOf, Pointing.DOWN).rightClick().whileSneaking(), 40);
        scene.idle(7);
        scene.world.rotateSection(valve, 0.0, 0.0, -90.0, 30);
        scene.world.rotateSection(contraption, 0.0, 0.0, -90.0, 30);
        scene.world.rotateBearing(bearing, -90.0F, 30);
        ...
        scene.world.setKineticSpeed(util.select.everywhere(), 0.0F);
        scene.idle(40);
        blockSurface = util.vector.topOf(bearing).add(0.0, 0.0, -0.125);
        point = new AABB(blockSurface, blockSurface);
        expanded = point.inflate(0.125, 0.0, 0.125);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, blockSurface, point, 1);
        scene.idle(1);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.WHITE, blockSurface, expanded, 80);
        scene.idle(10);
        ...
        scene.idle(90);
        scene.addKeyframe();
        scene.overlay.showControls(new InputWindowElement(topOf, Pointing.DOWN).rightClick().withItem(new ItemStack(Items.BLUE_DYE)), 40);
        scene.idle(7);
        scene.world.modifyBlock(valvePos, s -> (BlockState) AllBlocks.DYED_VALVE_HANDLES.get(DyeColor.BLUE).getDefaultState().m_61124_(ValveHandleBlock.FACING, Direction.NORTH), true);
        scene.idle(10);
    ...
    public static void sequencedGearshift(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.cycleBlockProperty(util.grid.at(4, 1, 0), NixieTubeBlock.f_54117_);
        scene.world.cycleBlockProperty(util.grid.at(4, 1, 0), NixieTubeBlock.f_54117_);
        ...
        scene.world.cycleBlockProperty(gearshiftPos, SequencedGearshiftBlock.STATE);
        scene.world.cycleBlockProperty(gearshiftPos, SequencedGearshiftBlock.STATE);
        scene.world.modifyBlock(wire, s -> (BlockState) s.m_61124_(RedStoneWireBlock.POWER, 0), false);
        scene.world.toggleRedstonePower(util.select.position(5, 1, 1));
    ...
    public static void speedController(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(100);
        Vec3 inputVec = util.vector.of(1.5, 1.6875, 1.0);
    ...
    private static void gauge(SceneBuilder scene, SceneBuildingUtil util, boolean speed) {
        ...
        scene.idle(10);
        scene.world.setBlock(gaugePos, (BlockState) (speed ? AllBlocks.SPEEDOMETER : AllBlocks.STRESSOMETER).getDefaultState().m_61124_(GaugeBlock.FACING, Direction.UP), true);
        ...
        if (speed) {
            ...
            BlockState state = (BlockState) AllBlocks.CRUSHING_WHEEL.getDefaultState().m_61124_(CrushingWheelBlock.AXIS, Direction.Axis.X);
            scene.world.setBlock(util.grid.at(5, 1, 3), state, true);
            scene.world.setKineticSpeed(util.select.position(5, 1, 3), 32.0F);
            scene.world.modifyBlockEntityNBT(util.select.position(gaugePos), StressGaugeBlockEntity.class, nbt -> nbt.putFloat("Value", 0.5F));
            ...
            scene.world.modifyBlockEntityNBT(util.select.position(gaugePos), StressGaugeBlockEntity.class, nbt -> nbt.putFloat("Value", 0.9F));
            scene.effects.indicateRedstone(gaugePos);
            scene.idle(10);
        }
        scene.idle(30);
        ...
        scene.idle(20);
        scene.overlay.showText(120).text("Comparators can emit analog Restone Signals relative to the " + component + "'s measurements").attachKeyFrame().colored(PonderPalette.RED).pointAt(util.vector.centerOf(2, 1, 2).add(0.0, -0.35, 0.0)).placeNearTarget();
        scene.idle(130);
        scene.markAsFinished();
    }
    ...
    public static void creativeMotorMojang(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(3);
        scene.world.showSection(util.select.fromTo(6, 3, 7, 9, 3, 7).add(util.select.fromTo(6, 3, 8, 6, 3, 10)).add(util.select.fromTo(7, 3, 10, 9, 3, 10)).add(util.select.fromTo(9, 3, 7, 9, 3, 9)), Direction.DOWN);
        scene.idle(3);
