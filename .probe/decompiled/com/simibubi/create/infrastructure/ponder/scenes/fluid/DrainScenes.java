...
public class DrainScenes {
    ...
    public static void emptying(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlockEntity(drainPos, ItemDrainBlockEntity.class, be -> {
            ...
            be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(fh -> fh.fill(new FluidStack(Fluids.LAVA, 1000), IFluidHandler.FluidAction.EXECUTE));
        });
        scene.idle(10);
        ...
        scene.idle(60);
        scene.world.modifyBlockEntity(drainPos, ItemDrainBlockEntity.class, be -> be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(fh -> fh.drain(500, IFluidHandler.FluidAction.EXECUTE)));
