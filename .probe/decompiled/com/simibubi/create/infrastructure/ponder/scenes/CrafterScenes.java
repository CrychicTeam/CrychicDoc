...
public class CrafterScenes {
    ...
    public static void setup(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlocks(crafters, s -> (BlockState) s.m_61124_(MechanicalCrafterBlock.POINTING, Pointing.DOWN), false);
        ...
        scene.overlay.showText(100).text("For a valid setup, all paths have to converge into one exit at any side").pointAt(util.vector.blockSurface(util.grid.at(1, 1, 2), Direction.WEST).add(0.0, 0.0, -0.5)).colored(PonderPalette.GREEN).attachKeyFrame().placeNearTarget();
        scene.idle(60);
        for (Couple<BlockPos> c : ImmutableList.of(Couple.create(util.grid.at(3, 3, 2), util.grid.at(3, 2, 2)), Couple.create(util.grid.at(3, 2, 2), util.grid.at(3, 1, 2)), Couple.create(util.grid.at(2, 3, 2), util.grid.at(1, 3, 2)), Couple.create(util.grid.at(3, 1, 2), util.grid.at(2, 1, 2)), Couple.create(util.grid.at(1, 3, 2), util.grid.at(1, 2, 2)), Couple.create(util.grid.at(2, 2, 2), util.grid.at(2, 1, 2)), Couple.create(util.grid.at(1, 2, 2), util.grid.at(1, 1, 2)), Couple.create(util.grid.at(2, 1, 2), util.grid.at(1, 1, 2)), Couple.create(util.grid.at(1, 1, 2), util.grid.at(0, 1, 2)))) {
            scene.idle(5);
            Vec3 p1 = util.vector.blockSurface(c.getFirst(), Direction.NORTH).add(0.0, 0.0, -0.125);
            Vec3 p2 = util.vector.blockSurface(c.getSecond(), Direction.NORTH).add(0.0, 0.0, -0.125);
        ...
        scene.world.modifyBlockEntity(util.grid.at(1, 3, 2), type, mct -> mct.getInventory().insertItem(0, planks.copy(), false));
        scene.idle(10);
        ...
        scene.world.modifyBlockEntity(util.grid.at(2, 3, 2), type, mct -> mct.getInventory().insertItem(0, planks.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(3, 3, 2), type, mct -> mct.getInventory().insertItem(0, planks.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(3, 2, 2), type, mct -> mct.getInventory().insertItem(0, cobble.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(2, 2, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(1, 2, 2), type, mct -> mct.getInventory().insertItem(0, cobble.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(1, 1, 2), type, mct -> mct.getInventory().insertItem(0, cobble.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(2, 1, 2), type, mct -> mct.getInventory().insertItem(0, redstoneDust.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(3, 1, 2), type, mct -> mct.getInventory().insertItem(0, cobble.copy(), false));
        ...
        scene.world.modifyBlockEntity(util.grid.at(1, 3, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(2);
        scene.world.modifyBlockEntity(util.grid.at(2, 3, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(2);
        scene.world.modifyBlockEntity(util.grid.at(3, 3, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(2);
        scene.world.modifyBlockEntity(util.grid.at(2, 2, 2), type, mct -> mct.getInventory().insertItem(0, stick.copy(), false));
        scene.idle(2);
        scene.world.modifyBlockEntity(util.grid.at(2, 1, 2), type, mct -> mct.getInventory().insertItem(0, stick.copy(), false));
    ...
    public static void connect(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(22);
        scene.world.modifyBlockEntity(util.grid.at(2, 2, 2), type, mct -> mct.getInventory().insertItem(0, planks.copy(), false));
        ...
        AABB bb = new AABB(v, v).inflate(0.125, 0.5, 0.5);
        v = v.add(0.0, 0.0, 0.5);
        ...
        scene.idle(80);
        scene.overlay.showControls(new InputWindowElement(v.add(0.0, 1.0, 0.0), Pointing.LEFT).rightClick().withWrench(), 20);
        scene.idle(7);
        ...
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(v.add(0.5, -0.5, 0.0), Pointing.LEFT).rightClick().withWrench(), 20);
        scene.idle(7);
        ...
        for (BlockPos pos : positions) {
            scene.world.modifyBlockEntity(pos, type, mct -> mct.getInventory().insertItem(0, planks.copy(), false));
            scene.idle(1);
        }
    }
    ...
    public static void covers(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        ItemStack iron = new ItemStack(Items.IRON_INGOT);
        Class<MechanicalCrafterBlockEntity> type = MechanicalCrafterBlockEntity.class;
        scene.world.modifyBlockEntity(util.grid.at(3, 2, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(2, 1, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(5);
        scene.world.modifyBlockEntity(util.grid.at(1, 2, 2), type, mct -> mct.getInventory().insertItem(0, iron.copy(), false));
        scene.idle(5);
        ...
        scene.idle(100);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(2, 2, 2), Direction.NORTH).add(0.5, 0.0, 0.0), Pointing.RIGHT).withItem(AllItems.CRAFTER_SLOT_COVER.asStack()).rightClick(), 50);
        scene.idle(7);
