...
public class ItemVaultScenes {
    ...
    public static void storage(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.moveSection(chestLink, util.vector.of(-3.0, -2.0, 0.0), 0);
        scene.idle(10);
        scene.overlay.showOutline(PonderPalette.GREEN, "chestOutline", util.select.fromTo(1, 1, 2, 0, 2, 3), 40);
        scene.idle(10);
        scene.overlay.showLine(PonderPalette.GREEN, util.vector.of(2.0, 1.0, 2.0), util.vector.of(3.0, 1.0, 1.0), 30);
        scene.overlay.showLine(PonderPalette.GREEN, util.vector.of(2.0, 3.0, 2.0), util.vector.of(3.0, 3.0, 1.0), 30);
        scene.overlay.showLine(PonderPalette.GREEN, util.vector.of(2.0, 3.0, 4.0), util.vector.of(3.0, 3.0, 4.0), 30);
        ...
        ItemStack[] junk = new ItemStack[] { new ItemStack(Items.APPLE), new ItemStack(Items.GOLD_INGOT, 8), new ItemStack(Items.TUFF, 32) };
    ...
    public static void sizes(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.moveSection(s1, util.vector.of(0.0, -3.0, 0.0), 0);
        scene.idle(10);
        ...
        scene.world.moveSection(d, util.vector.of(0.0, -3.0, -1.0), 0);
        ...
        scene.world.moveSection(s1, util.vector.of(2.0, -3.0, 0.0), 0);
        scene.idle(3);
        s2 = scene.world.showIndependentSection(single, Direction.DOWN);
        scene.world.moveSection(s2, util.vector.of(2.0, -2.0, 0.0), 0);
        scene.idle(3);
        s3 = scene.world.showIndependentSection(single, Direction.DOWN);
        scene.world.moveSection(s3, util.vector.of(2.0, -1.0, 0.0), 0);
        scene.idle(3);
        s4 = scene.world.showIndependentSection(single, Direction.DOWN);
        scene.world.moveSection(s4, util.vector.of(1.0, -1.0, 0.0), 0);
        scene.idle(3);
        ElementLink<WorldSectionElement> s5 = scene.world.showIndependentSection(single, Direction.DOWN);
        scene.world.moveSection(s5, util.vector.of(0.0, -1.0, 0.0), 0);
        scene.idle(10);
        ...
        scene.world.moveSection(t, util.vector.of(0.0, -3.0, -2.0), 0);
        for (int i = 1; i < 4; i++) {
            for (int j = 2; j < 5; j++) {
