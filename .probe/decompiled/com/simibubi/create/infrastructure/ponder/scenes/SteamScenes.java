...
public class SteamScenes {
    ...
    public static void engine(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.moveSection(fakeGroundElement, util.vector.of(1.0, 0.0, 1.0), 0);
        ...
        scene.world.modifyBlock(util.grid.at(4, 2, 7), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.SOUTH), false);
        scene.world.modifyBlock(util.grid.at(1, 2, 7), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.SOUTH), false);
        scene.world.modifyBlock(util.grid.at(2, 3, 7), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.SOUTH), false);
        scene.idle(15);
        ElementLink<WorldSectionElement> tankElement = scene.world.showIndependentSection(tank, Direction.DOWN);
        scene.world.moveSection(tankElement, util.vector.of(0.0, -1.0, 0.0), 0);
        scene.idle(10);
        ElementLink<WorldSectionElement> engineElement = scene.world.showIndependentSection(engine, Direction.EAST);
        scene.world.moveSection(engineElement, util.vector.of(1.0, -1.0, 0.0), 0);
        scene.idle(15);
        scene.world.moveSection(tankElement, util.vector.of(0.0, -1000.0, 0.0), 0);
        scene.world.hideIndependentSection(tankElement, null);
        ElementLink<WorldSectionElement> boilerElement = scene.world.showIndependentSectionImmediately(boiler1);
        scene.world.moveSection(boilerElement, util.vector.of(0.0, -3.0, 2.0), 0);
        ...
        scene.idle(25);
        scene.overlay.showText(50).attachKeyFrame().text("Steam Engines can be placed on a Fluid Tank").pointAt(util.vector.blockSurface(util.grid.at(3, 1, 3), Direction.WEST)).placeNearTarget();
        scene.idle(60);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(3, 1, 3), Direction.UP), Pointing.DOWN).withItem(AllBlocks.SHAFT.asStack()).rightClick(), 60);
        scene.idle(10);
        scene.world.setBlock(engine1ShaftPos, (BlockState) AllBlocks.SHAFT.getDefaultState().m_61124_(ShaftBlock.AXIS, Direction.Axis.Z), false);
        ElementLink<WorldSectionElement> engineShaftElement = scene.world.showIndependentSection(engine1Shaft, null);
        scene.world.moveSection(engineShaftElement, util.vector.of(0.0, -3.0, 2.0), 0);
        scene.idle(5);
        scene.world.moveSection(engineElement, util.vector.of(0.0, -1000.0, 0.0), 0);
        scene.world.hideIndependentSection(engineElement, null);
        engineElement = scene.world.showIndependentSectionImmediately(engine1);
        scene.world.moveSection(engineElement, util.vector.of(0.0, -3.0, 2.0), 0);
        scene.world.setBlock(engine1ShaftPos, (BlockState) AllBlocks.POWERED_SHAFT.getDefaultState().m_61124_(ShaftBlock.AXIS, Direction.Axis.Z), false);
        scene.effects.indicateSuccess(util.grid.at(1, 1, 3));
        scene.idle(40);
        scene.overlay.showText(80).attachKeyFrame().colored(PonderPalette.BLUE).text("Clicking the engine with a Shaft creates the Kinetic Output").pointAt(util.vector.centerOf(util.grid.at(1, 1, 3))).placeNearTarget();
        scene.idle(90);
        scene.world.multiplyKineticSpeed(largeCog, -1.0F);
        scene.world.multiplyKineticSpeed(pumpCogs, -1.0F);
        scene.world.multiplyKineticSpeed(pump1, -1.0F);
        scene.world.multiplyKineticSpeed(pump2, -1.0F);
        scene.world.moveSection(boilerElement, util.vector.of(0.0, 1.0, 0.0), 15);
        scene.world.moveSection(engineElement, util.vector.of(0.0, 1.0, 0.0), 15);
        scene.world.moveSection(engineShaftElement, util.vector.of(0.0, 1.0, 0.0), 15);
        scene.idle(10);
        ...
        scene.idle(25);
        scene.overlay.showText(60).attachKeyFrame().text("With sufficient Heat, Water and Boiler space...").pointAt(util.vector.blockSurface(util.grid.at(4, 2, 4), Direction.UP)).placeNearTarget();
        scene.idle(30);
        scene.world.setKineticSpeed(engine1Shaft, 16.0F);
        scene.effects.createRedstoneParticles(util.grid.at(3, 2, 3), 16777215, 10);
        scene.idle(40);
        scene.overlay.showText(60).text("...they will generate Rotational Force").pointAt(util.vector.blockSurface(util.grid.at(1, 2, 3), Direction.NORTH)).placeNearTarget();
        scene.idle(70);
        scene.overlay.showSelectionWithText(util.select.fromTo(5, 2, 3, 4, 2, 4), 50).attachKeyFrame().text("The minimal setup requires 4 Fluid Tanks").pointAt(util.vector.blockSurface(util.grid.at(4, 2, 4), Direction.UP)).placeNearTarget();
        scene.idle(60);
        ...
        scene.world.moveSection(burnersElement, util.vector.of(2.0, 0.0, 0.0), 0);
        scene.idle(25);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(4, 1, 3), Direction.EAST), Pointing.RIGHT).withItem(new ItemStack(Items.OAK_LOG)).rightClick(), 60);
        scene.idle(10);
        scene.world.setBlocks(burners, (BlockState) AllBlocks.BLAZE_BURNER.getDefaultState().m_61124_(BlazeBurnerBlock.HEAT_LEVEL, BlazeBurnerBlock.HeatLevel.KINDLED), false);
        scene.idle(5);
        scene.world.setKineticSpeed(engine1Shaft, 64.0F);
        scene.effects.createRedstoneParticles(util.grid.at(3, 2, 3), 16777215, 10);
        scene.idle(40);
        scene.overlay.showText(80).text("With the help of Blaze Burners, the power output can be increased").attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(4, 1, 3), Direction.WEST)).placeNearTarget();
        scene.idle(90);
        ...
        scene.world.moveSection(boilerElement, util.vector.of(0.0, -2.0, -2.0), 0);
        scene.idle(10);
        ElementLink<WorldSectionElement> pumpElement = scene.world.showIndependentSection(pump2, Direction.DOWN);
        scene.world.moveSection(pumpElement, util.vector.of(0.0, 0.0, -5.0), 0);
        scene.idle(20);
        ...
        scene.idle(90);
        scene.overlay.showControls(new InputWindowElement(target.add(0.0, 0.0, 0.5), Pointing.DOWN).withItem(AllItems.GOGGLES.asStack()), 60);
        scene.idle(6);
        scene.overlay.showText(80).text("The boiler's current power level can be inspected with Engineer's Goggles").attachKeyFrame().colored(PonderPalette.BLUE).pointAt(target.add(0.0, 0.0, 0.5)).placeNearTarget();
        scene.idle(90);
        scene.world.showSectionAndMerge(util.select.fromTo(3, 4, 6, 1, 4, 6), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world.setKineticSpeed(util.select.position(1, 4, 6), 64.0F);
        scene.world.showSectionAndMerge(util.select.fromTo(3, 5, 6, 1, 5, 6), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world.setKineticSpeed(util.select.position(1, 5, 6), -64.0F);
        scene.world.showSectionAndMerge(util.select.fromTo(3, 5, 5, 1, 5, 5), Direction.EAST, boilerElement);
        scene.idle(5);
        scene.world.setKineticSpeed(util.select.position(1, 5, 5), -64.0F);
        scene.world.showSectionAndMerge(util.select.fromTo(1, 4, 7, 1, 5, 7), Direction.NORTH, boilerElement);
        scene.idle(5);
        scene.world.setKineticSpeed(util.select.position(1, 5, 7), -64.0F);
        scene.world.setKineticSpeed(util.select.position(1, 4, 7), 64.0F);
        scene.idle(20);
        scene.overlay.showText(100).text("With each added power level, an additional Engine can output at full capacity").attachKeyFrame().colored(PonderPalette.GREEN).pointAt(util.vector.blockSurface(util.grid.at(1, 3, 3), Direction.NORTH)).placeNearTarget();
        scene.idle(110);
        scene.overlay.showText(30).text("Lvl 4").colored(PonderPalette.BLUE).pointAt(util.vector.blockSurface(util.grid.at(4, 4, 4), Direction.WEST)).placeNearTarget();
        scene.idle(40);
        scene.overlay.showSelectionWithText(util.select.fromTo(3, 2, 3, 3, 3, 4), 30).text("4 Engines").colored(PonderPalette.BLUE).pointAt(util.vector.blockSurface(util.grid.at(3, 3, 4), Direction.UP)).placeNearTarget();
        scene.idle(30);
        ...
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.of(5.0, 2.0, 4.0), Pointing.DOWN).withItem(AllItems.BLAZE_CAKE.asStack()).rightClick(), 10);
        scene.idle(6);
        scene.world.setBlocks(burners, (BlockState) AllBlocks.BLAZE_BURNER.getDefaultState().m_61124_(BlazeBurnerBlock.HEAT_LEVEL, BlazeBurnerBlock.HeatLevel.SEETHING), false);
        scene.idle(15);
        boilerElement = scene.world.showIndependentSection(boiler3, Direction.SOUTH);
        scene.world.moveSection(boilerElement, util.vector.of(0.0, -2.0, 0.0), 0);
        scene.idle(10);
        pumpElement = scene.world.showIndependentSection(pump3, Direction.DOWN);
        scene.world.moveSection(pumpElement, util.vector.of(3.0, 0.0, -5.0), 0);
        scene.idle(20);
        ...
        scene.world.moveSection(cogsElement, util.vector.of(0.0, -2.0, -2.0), 0);
        ...
        for (int y = 4; y < 9; y++) {
            if (y != 6) {
                for (boolean left : Iterate.trueAndFalse) {
                    ...
                    if (previous != null) {
                        scene.world.setKineticSpeed(previous, previousForward ? 64.0F : -64.0F);
                    }
            ...
            scene.world.setKineticSpeed(util.select.position(1, y, 7), y % 2 == 0 ? 64.0F : -64.0F);
        }
        scene.world.setKineticSpeed(previous, 64.0F);
        scene.overlay.showText(30).text("Lvl 8").colored(PonderPalette.BLUE).pointAt(util.vector.blockSurface(util.grid.at(4, 4, 3), Direction.NORTH)).placeNearTarget();
        scene.idle(40);
        scene.overlay.showSelectionWithText(util.select.fromTo(3, 2, 3, 3, 6, 4), 30).text("8 Engines").colored(PonderPalette.BLUE).pointAt(util.vector.blockSurface(util.grid.at(3, 3, 4), Direction.UP)).placeNearTarget();
        scene.idle(30);
    }
}