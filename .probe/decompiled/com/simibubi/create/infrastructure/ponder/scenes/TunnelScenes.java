...
public class TunnelScenes {
    ...
    public static void andesite(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            scene.world.moveSection((ElementLink<WorldSectionElement>) tunnels.get(i), util.vector.of(0.0, 0.0, -2.0), 0);
            scene.idle(4);
        }
        for (int i = 0; i < 3; i++) {
            scene.world.cycleBlockProperty(util.grid.at(1 + i, 1, 2), BeltBlock.CASING);
            scene.world.modifyBlockEntityNBT(util.select.position(1 + i, 1, 2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.ANDESITE), true);
            scene.idle(4);
        }
        ...
        for (int i = 0; i < 3; i++) {
            scene.world.cycleBlockProperty(util.grid.at(1 + i, 1, 2), BeltBlock.CASING);
            scene.world.hideIndependentSection((ElementLink<WorldSectionElement>) tunnels.get(i), Direction.UP);
            scene.idle(4);
        }
        scene.idle(10);
    ...
    public static void brass(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            scene.world.modifyBlockEntityNBT(util.select.position(2 + i, 1, 2), BeltBlockEntity.class, nbt -> NBTHelper.writeEnum(nbt, "Casing", BeltBlockEntity.CasingType.BRASS), true);
            scene.idle(4);
        }
        ...
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.EAST, copper));
        ...
        scene.idle(20);
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.EAST, ItemStack.EMPTY));
        ...
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, copper));
        scene.idle(4);
        tunnelFilterVec = getTunnelFilterVec(tunnelPos, Direction.NORTH);
        scene.overlay.showControls(new InputWindowElement(tunnelFilterVec, Pointing.RIGHT).withItem(zinc), 30);
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.NORTH, zinc));
        ...
        scene.idle(30);
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.NORTH, ItemStack.EMPTY));
        scene.world.modifyBlockEntity(tunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, ItemStack.EMPTY));
        scene.idle(10);
        ...
        scene.overlay.showControls(new InputWindowElement(tunnelFilterVec.add(0.0, 0.0, -1.0), Pointing.RIGHT).withItem(item1), 20);
        scene.world.modifyBlockEntity(newTunnelPos.north(), tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, item1));
        scene.idle(4);
        scene.overlay.showControls(new InputWindowElement(tunnelFilterVec, Pointing.DOWN).withItem(item2), 20);
        scene.world.modifyBlockEntity(newTunnelPos, tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, item2));
        scene.idle(4);
        scene.overlay.showControls(new InputWindowElement(tunnelFilterVec.add(0.0, 0.0, 1.0), Pointing.LEFT).withItem(item3), 20);
        scene.world.modifyBlockEntity(newTunnelPos.south(), tunnelClass, be -> be.getBehaviour(SidedFilteringBehaviour.TYPE).setFilter(Direction.WEST, item3));
        scene.idle(30);
    ...
    protected static Vec3 getTunnelFilterVec(BlockPos pos, Direction d) {
        return VecHelper.getCenterOf(pos).add(Vec3.atLowerCornerOf(d.getNormal()).scale(0.5)).add(0.0, 0.3, 0.0);
    }
    ...
    public static void brassModes(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 32; i++) {
            ...
            if (i == 4) {
                ...
                scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.FORCED_SPLIT.ordinal()));
            }
            if (i == 5) {
            ...
            if (i == 7) {
                scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.ROUND_ROBIN.ordinal()));
            ...
            if (i == 15) {
                ...
                scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.FORCED_ROUND_ROBIN.ordinal()));
            }
            if (i == 16) {
            ...
            if (i == 19) {
                ...
                scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.PREFER_NEAREST.ordinal()));
                scene.world.moveSection(blockage, util.vector.of(1.0, 0.0, 0.0), 10);
                scene.world.setBlock(util.grid.at(1, 1, 0), barrier, false);
            ...
            if (i == 26) {
                ...
                scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.RANDOMIZE.ordinal()));
            }
            if (i == 27) {
        ...
        scene.world.modifyBlockEntity(util.grid.at(1, 2, 3), tunnelClass, be -> be.getBehaviour(ScrollOptionBehaviour.TYPE).setValue(BrassTunnelBlockEntity.SelectionMode.SYNCHRONIZE.ordinal()));
        scene.idle(30);
