...
public class ChassisScenes {
    ...
    public static void linearGroup(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.moveSection(chassis, util.vector.of(0.0, -9.765625E-4, 0.0), 0);
        scene.world.configureCenterOfRotation(chassis, util.vector.centerOf(bearingPos));
        scene.world.rotateBearing(bearingPos, 360.0F, 80);
        scene.world.rotateSection(chassis, 0.0, 360.0, 0.0, 80);
        scene.idle(20);
    ...
    public static void linearAttachement(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, s -> (BlockState) s.m_61124_(LinearChassisBlock.STICKY_BOTTOM, true), false);
        ...
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, s -> (BlockState) s.m_61124_(LinearChassisBlock.STICKY_TOP, true), false);
        ...
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, s -> (BlockState) s.m_61124_(LinearChassisBlock.STICKY_BOTTOM, false), false);
        scene.effects.superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        ...
        scene.world.moveSection(glassSection, util.vector.of(0.0, -1.0, 0.0), 0);
        scene.idle(25);
        scene.addKeyframe();
        ...
        scene.world.moveSection(topGlassSection, util.vector.of(0.0, -1.0, 0.0), 0);
        scene.idle(30);
        ...
        scene.world.rotateSection(glassSection, 0.0, 180.0, 0.0, 40);
        scene.world.rotateSection(topGlassSection, 0.0, 180.0, 0.0, 40);
        scene.idle(50);
        ...
        scene.overlay.showControls(new InputWindowElement(blockSurface, Pointing.UP).rightClick().withWrench(), 50);
        scene.idle(10);
        ...
        scene.world.rotateSection(glassSection, 0.0, 180.0, 0.0, 40);
        scene.idle(50);
        scene.world.rotateSection(topGlassSection, 0.0, 180.0, 0.0, 0);
        ...
        scene.idle(20);
        scene.overlay.showCenteredScrollInput(chassisPos, Direction.NORTH, 50);
        scene.overlay.showControls(new InputWindowElement(blockSurface, Pointing.UP).whileCTRL().rightClick().withWrench(), 50);
        ...
        scene.idle(10);
        scene.overlay.showText(80).pointAt(blockSurface).text("Holding CTRL adjusts the range of all connected Chassis Blocks").placeNearTarget();
        scene.idle(90);
        scene.world.rotateBearing(bearingPos, 180.0F, 40);
        scene.world.rotateSection(glassSection, 0.0, 180.0, 0.0, 40);
        scene.world.rotateSection(topGlassSection, 0.0, 180.0, 0.0, 40);
        ...
        scene.idle(7);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, glueSurface, new AABB(util.grid.at(1, 2, 2)).expandTowards(0.0, 0.0, -1.0), 40);
        scene.idle(20);
        ElementLink<WorldSectionElement> gluedPlank = scene.world.showIndependentSection(util.select.position(3, 3, 1), Direction.SOUTH);
        scene.world.moveSection(gluedPlank, util.vector.of(-2.0, -1.0, 0.0), 0);
        scene.idle(15);
        ...
        scene.world.moveSection(chain, util.vector.of(0.0, -5.0, 0.0), 0);
        scene.idle(10);
        ...
        scene.idle(30);
        scene.world.rotateBearing(bearingPos, 720.0F, 160);
        scene.world.rotateSection(chain, 0.0, 720.0, 0.0, 160);
    }
    ...
    public static void radial(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(60);
        BlockPos bearingPos = util.grid.at(2, 1, 2);
        scene.world.moveSection(contraption, util.vector.of(0.0, -9.765625E-4, 0.0), 0);
        scene.world.configureCenterOfRotation(contraption, util.vector.centerOf(bearingPos));
        scene.world.rotateBearing(bearingPos, 360.0F, 80);
        scene.world.rotateSection(contraption, 0.0, 360.0, 0.0, 80);
        scene.world.rotateSection(top, 0.0, 360.0, 0.0, 80);
        scene.idle(20);
        ...
        scene.overlay.showControls(input, 30);
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, sx -> (BlockState) sx.m_61124_(RadialChassisBlock.STICKY_WEST, true), false);
        scene.effects.superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        ...
        scene.overlay.showControls(input, 15);
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, sx -> (BlockState) ((BlockState) ((BlockState) sx.m_61124_(RadialChassisBlock.STICKY_EAST, true)).m_61124_(RadialChassisBlock.STICKY_NORTH, true)).m_61124_(RadialChassisBlock.STICKY_SOUTH, true), false);
        scene.effects.superGlue(chassisPos, Direction.EAST, false);
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(chassisPos, Direction.WEST), Pointing.LEFT).rightClick().whileSneaking(), 30);
        scene.idle(7);
        scene.world.modifyBlock(chassisPos, sx -> (BlockState) sx.m_61124_(RadialChassisBlock.STICKY_WEST, false), false);
        scene.effects.superGlue(chassisPos, Direction.WEST, false);
        scene.idle(30);
        scene.overlay.showText(60).text("Sneak and Right-Click with an empty hand to remove the slime").placeNearTarget().pointAt(util.vector.blockSurface(chassisPos, Direction.WEST));
        scene.idle(70);
        ...
        scene.idle(10);
        Vec3 blockSurface = util.vector.blockSurface(chassisPos, Direction.NORTH);
        AABB bb = new AABB(blockSurface, blockSurface).inflate(0.501, 0.501, 0.0);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, bb, bb, 60);
        scene.overlay.showOutline(PonderPalette.WHITE, s, s, 80);
        scene.overlay.showText(40).text("Whenever a Block is next to a sticky face...").placeNearTarget().pointAt(blockSurface.add(0.0, 0.5, 0.0));
        scene.idle(60);
        MutableObject<Selection> obj = new MutableObject(growing);
        r2.forEach(pos -> {
            scene.idle(1);
            Selection add = ((Selection) obj.getValue()).copy().add(util.select.position(pos));
            scene.overlay.showOutline(PonderPalette.WHITE, s, add, 3);
            obj.setValue(add);
        });
        scene.overlay.showSelectionWithText((Selection) obj.getValue(), 60).colored(PonderPalette.GREEN).text("...it will attach all reachable blocks within a radius on that layer");
        scene.idle(70);
        scene.world.configureCenterOfRotation(outer, util.vector.centerOf(bearingPos));
        scene.world.rotateBearing(bearingPos, 360.0F, 80);
        scene.world.rotateSection(contraption, 0.0, 360.0, 0.0, 80);
        scene.world.rotateSection(outer, 0.0, 360.0, 0.0, 80);
        scene.idle(90);
        scene.addKeyframe();
        blockSurface = util.vector.topOf(chassisPos);
        scene.overlay.showCenteredScrollInput(chassisPos, Direction.UP, 50);
        scene.overlay.showControls(new InputWindowElement(blockSurface, Pointing.DOWN).rightClick().withWrench(), 50);
        scene.idle(10);
    ...
    public static void superGlue(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.overlay.showText(80).text("Super Glue groups blocks together into moving contraptions").placeNearTarget().attachKeyFrame().pointAt(util.vector.topOf(util.grid.at(2, 1, 2)));
        scene.idle(70);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(2, 2, 3), Pointing.DOWN).withItem(AllItems.SUPER_GLUE.asStack()).rightClick(), 40);
        scene.idle(6);
        scene.effects.indicateSuccess(util.grid.at(2, 2, 3));
        scene.idle(45);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(1, 1, 2), Direction.DOWN), Pointing.UP).withItem(AllItems.SUPER_GLUE.asStack()).rightClick(), 40);
        scene.idle(6);
        AABB bb = new AABB(util.grid.at(2, 2, 3));
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, lever, bb, 1);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, lever, bb.expandTowards(-1.0, -1.0, -1.0), 285);
        scene.idle(25);
        scene.overlay.showText(70).text("Clicking two endpoints creates a new 'glued' area").placeNearTarget().colored(PonderPalette.GREEN).attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(1, 1, 2), Direction.WEST));
        scene.idle(80);
        bb = new AABB(util.grid.at(3, 1, 3));
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, crankPos, bb, 1);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, crankPos, bb.expandTowards(0.0, 0.0, -2.0), 66);
        scene.idle(20);
        scene.overlay.showText(70).text("To remove a box, punch it with the glue item in hand").placeNearTarget().attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(3, 1, 1), Direction.WEST));
        scene.idle(40);
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(util.grid.at(3, 1, 1), Direction.UP), Pointing.DOWN).withItem(AllItems.SUPER_GLUE.asStack()).leftClick(), 40);
        scene.idle(50);
        Selection toMove = util.select.fromTo(1, 1, 2, 2, 1, 2).add(util.select.fromTo(2, 2, 3, 2, 1, 3));
        scene.overlay.showSelectionWithText(toMove, 70).text("Adjacent blocks sharing an area will pull each other along").placeNearTarget().attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(1, 1, 2), Direction.WEST));
        scene.idle(50);
        scene.world.showSection(pulley, Direction.DOWN);
        scene.idle(10);
        scene.world.showSection(util.select.position(crankPos), Direction.EAST);
        scene.idle(20);
        scene.world.movePulley(pulleyPos, -1.0F, 20);
        scene.world.setKineticSpeed(kinetics, -24.0F);
        ElementLink<WorldSectionElement> contraption = scene.world.makeSectionIndependent(toMove);
        scene.world.moveSection(contraption, util.vector.of(0.0, 1.0, 0.0), 20);
        scene.idle(20);
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, "0", bb.expandTowards(-1.0, -1.0, -1.0), 70);
        scene.idle(15);
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, "1", bb.expandTowards(2.0, 0.0, 0.0), 55);
        scene.idle(15);
        bb = new AABB(util.grid.at(1, 2, 2));
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, "2", bb, 1);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, "2", bb.expandTowards(-1.0, 0.0, 0.0), 40);
        scene.overlay.showText(70).text("Overlapping glue volumes will move together").placeNearTarget().colored(PonderPalette.GREEN).attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(0, 2, 2), Direction.WEST));
        scene.idle(40);
        ElementLink<WorldSectionElement> cogs = scene.world.makeSectionIndependent(util.select.fromTo(4, 1, 2, 3, 1, 2).add(util.select.fromTo(1, 2, 2, 0, 2, 2)));
        scene.world.movePulley(pulleyPos, -1.0F, 20);
        scene.world.setKineticSpeed(kinetics, -24.0F);
        scene.world.moveSection(contraption, util.vector.of(0.0, 1.0, 0.0), 20);
        scene.world.moveSection(cogs, util.vector.of(0.0, 1.0, 0.0), 20);
        scene.idle(20);
        scene.world.setKineticSpeed(kinetics, 0.0F);
        scene.idle(10);
        scene.overlay.showOutline(PonderPalette.GREEN, cogs, util.select.fromTo(4, 2, 2, 1, 2, 2).add(util.select.fromTo(2, 3, 3, 2, 2, 3)).add(util.select.fromTo(1, 3, 2, 0, 3, 2)), 70);
        ElementLink<WorldSectionElement> brittles = scene.world.showIndependentSection(lever, Direction.SOUTH);
        scene.world.moveSection(brittles, util.vector.of(0.0, 1.0, 0.0), 0);
        scene.idle(5);
        ...
        scene.idle(25);
        scene.overlay.showText(80).text("Blocks hanging on others usually do not require glue").placeNearTarget().colored(PonderPalette.BLUE).attachKeyFrame().pointAt(util.vector.blockSurface(util.grid.at(1, 2, 2), Direction.NORTH));
        scene.idle(80);
        scene.world.movePulley(pulleyPos, 1.0F, 20);
        scene.world.setKineticSpeed(kinetics, 24.0F);
        scene.world.moveSection(cogs, util.vector.of(0.0, -1.0, 0.0), 20);
        scene.world.moveSection(brittles, util.vector.of(0.0, -1.0, 0.0), 20);
        scene.world.moveSection(contraption, util.vector.of(0.0, -1.0, 0.0), 20);
        scene.idle(20);
        scene.world.setKineticSpeed(kinetics, 0.0F);
        scene.idle(10);
