...
public class TrainStationScenes {
    ...
    public static void assembly(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, bb, bb.inflate(0.45F, 0.0625, 0.45F), 100);
        scene.idle(10);
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.RED, bb, bb.inflate(0.45F, 0.0625, 0.45F), 80);
        scene.idle(10);
    ...
    public static void autoSchedule(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb, bb.inflate(0.45F, 0.0, 0.45F), 40);
        scene.idle(15);
        ...
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.OUTPUT, bb2, bb2.expandTowards(4.0, 0.0, 0.0), 20);
        scene.idle(15);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.RED, bb, bb.inflate(0.45F, 0.0, 0.45F), 45);
