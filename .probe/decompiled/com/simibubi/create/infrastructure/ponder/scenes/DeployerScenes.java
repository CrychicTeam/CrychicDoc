...
public class DeployerScenes {
    ...
    public static void filter(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        Vec3 frontVec = util.vector.blockSurface(deployerPos, Direction.WEST).add(-0.125, 0.0, 0.0);
        ...
        scene.world.modifyBlockEntityNBT(deployerSelection, teType, nbt -> nbt.put("HeldItem", ItemStack.EMPTY.serializeNBT()));
        scene.world.moveDeployer(deployerPos, -1.0F, 25);
        scene.idle(20);
        ...
        scene.idle(20);
        Vec3 filterSlot = util.vector.topOf(deployerPos).add(0.125, 0.0, 0.0);
        ...
        ElementLink<EntityElement> sheep = scene.world.createEntity(w -> {
            ...
            animation.update(-animation.position(), 1.0F);
        ...
        scene.effects.emitParticles(util.vector.topOf(deployerPos.west(2)).add(0.0, -0.25, 0.0), EmitParticlesInstruction.Emitter.withinBlockSpace(new BlockParticleOption(ParticleTypes.BLOCK, Blocks.PINK_WOOL.defaultBlockState()), util.vector.of(0.0, 0.0, 0.0)), 25.0F, 1);
        scene.world.moveDeployer(deployerPos, -1.0F, 25);
        ...
        scene.world.createItemEntity(util.vector.centerOf(deployerPos.north()).subtract(0.0, 0.45, 0.0), util.vector.of(0.0, 0.0, -0.1), new ItemStack(Items.PINK_WOOL));
    ...
    public static void modes(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(7);
        scene.world.modifyBlockEntityNBT(deployerSelection, DeployerBlockEntity.class, nbt -> nbt.put("HeldItem", tool.serializeNBT()));
        scene.idle(45);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            scene.world.moveDeployer(deployerPos, -1.0F, 25);
            if (i == 3) {
                scene.world.createItemEntity(util.vector.centerOf(breakingPos), util.vector.of(0.0, 0.0, 0.0), new ItemStack(Blocks.DIRT));
            }
            scene.idle(26);
            if (i == 0) {
                scene.markAsFinished();
    ...
    public static void processing(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showControls(new InputWindowElement(util.vector.blockSurface(pressPos.below(), Direction.EAST).add(0.0, 0.15, 0.0), Pointing.RIGHT).withItem(tool), 30);
        scene.idle(7);
        ...
        scene.idle(80);
        scene.overlay.showText(60).pointAt(pressSide.subtract(0.0, 2.0, 0.0)).placeNearTarget().text("The Input items can be dropped or placed on a Depot under the Deployer");
        scene.idle(50);
        ...
        scene.idle(10);
        Vec3 targetV = util.vector.centerOf(pressPos).subtract(0.0, 1.65, 0.0);
    ...
    public static void contraption(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        Vec3 filterSlot = util.vector.blockSurface(deployerPos.west(3), Direction.WEST).add(0.0, 0.0, 0.125);
