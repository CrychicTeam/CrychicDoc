...
public class PumpScenes {
    ...
    public static void flow(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay.showText(60).text("Their arrow indicates the direction of flow").attachKeyFrame().placeNearTarget().pointAt(util.vector.topOf(pumpPos).subtract(0.5, 0.125, 0.0));
        AABB bb1 = new AABB(Vec3.ZERO, Vec3.ZERO).inflate(0.25, 0.25, 0.0).move(0.0, 0.0, 0.25);
        ...
        scene.idle(60);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.OUTPUT, out, bb1.move(util.vector.centerOf(1, 1, 1).add(0.0, 0.0, -0.5)), 3);
        scene.idle(2);
        ...
        scene.world.propagatePipeChange(pumpPos);
        scene.idle(15);
        scene.overlay.showText(60).text("The pumps direction is unaffected by the input rotation").colored(PonderPalette.RED).placeNearTarget().attachKeyFrame().pointAt(util.vector.topOf(pumpPos).subtract(0.5, 0.125, 0.0));
        scene.idle(25);
        ...
        scene.idle(7);
        scene.world.modifyBlock(pumpPos, s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.EAST), true);
    ...
    public static void speed(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.world.modifyBlock(pumpPos, s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.WEST), false);
        ...
        scene.world.setBlock(east, (BlockState) AllBlocks.GLASS_FLUID_PIPE.getDefaultState().m_61124_(GlassFluidPipeBlock.f_55923_, Direction.Axis.X), false);
        scene.world.setBlock(pumpPos.south(), (BlockState) AllBlocks.COGWHEEL.getDefaultState().m_61124_(CogWheelBlock.AXIS, Direction.Axis.X), false);
        ...
        scene.idle(60);
        BlockState pipeState = (BlockState) ((BlockState) AllBlocks.FLUID_PIPE.getDefaultState().m_61124_(FluidPipeBlock.f_55153_, false)).m_61124_(FluidPipeBlock.f_55152_, false);
        ...
        scene.world.setBlock(east.north(), (BlockState) ((BlockState) pipeState.m_61124_(FluidPipeBlock.f_55148_, false)).m_61124_(FluidPipeBlock.f_55149_, false), false);
        scene.world.setBlock(east.south(), (BlockState) ((BlockState) pipeState.m_61124_(FluidPipeBlock.f_55150_, false)).m_61124_(FluidPipeBlock.f_55149_, false), false);
        ...
        scene.world.setBlock(west.north(), (BlockState) ((BlockState) pipeState.m_61124_(FluidPipeBlock.f_55148_, false)).m_61124_(FluidPipeBlock.f_55151_, false), false);
        scene.world.setBlock(west.south(), (BlockState) ((BlockState) pipeState.m_61124_(FluidPipeBlock.f_55150_, false)).m_61124_(FluidPipeBlock.f_55151_, false), false);
        ...
        scene.world.modifyBlock(pumpPos.south(), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.WEST), true);
        scene.world.setKineticSpeed(util.select.everywhere(), 0.0F);
        scene.world.showSection(northPump, Direction.DOWN);
        scene.world.modifyBlock(pumpPos.north(), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.EAST), false);
        scene.idle(4);
        ...
        scene.idle(7);
        scene.world.modifyBlock(pumpPos.north(), s -> (BlockState) s.m_61124_(PumpBlock.FACING, Direction.WEST), true);
        scene.idle(30);
        scene.overlay.showText(70).attachKeyFrame().pointAt(util.vector.topOf(pumpPos.north()).subtract(0.5, 0.125, 0.0)).placeNearTarget().text("Ensure that all of them are facing in the same direction");
        scene.idle(40);
