...
public class TrainScenes {
    ...
    public static void controls(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay.showText(70).pointAt(util.vector.of(3.35F, 3.75, 5.0)).placeNearTarget().attachKeyFrame().text("Train Controls are required on every train contraption");
        scene.idle(60);
        scene.world.cycleBlockProperty(stationPos, StationBlock.ASSEMBLING);
        ...
        scene.idle(20);
        scene.overlay.showControls(new InputWindowElement(util.vector.topOf(initialControlsPos), Pointing.DOWN).rightClick(), 70);
        scene.idle(20);
        scene.overlay.showText(60).pointAt(util.vector.of(3.35F, 3.75, 5.0)).placeNearTarget().attachKeyFrame().text("Once assembled, right-click the block to start driving");
        scene.idle(60);
        ...
        scene.idle(30);
        scene.overlay.showText(60).pointAt(util.vector.of(7.35F, 3.75, 5.0)).placeNearTarget().text("Accelerate and steer the Train using movement keybinds");
        scene.idle(60);
        ...
        scene.idle(20);
        scene.overlay.showText(90).pointAt(util.vector.of(3.35F, 3.75, 5.0)).placeNearTarget().text("If desired, the top speed can be fine-tuned using the mouse wheel");
        scene.idle(90);
        ...
        scene.idle(70);
        scene.overlay.showText(50).pointAt(util.vector.of(2.35F, 3.75, 5.0)).placeNearTarget().attachKeyFrame().text("Hold space to approach a nearby Station");
        scene.idle(40);
        ...
        scene.world.toggleControls(initialControlsPos);
        scene.idle(20);
        scene.overlay.showText(70).pointAt(util.vector.of(4.95F, 3.75, 5.0)).placeNearTarget().attachKeyFrame().text("Assembled Whistles can be activated with the sprint key");
        scene.idle(40);
        scene.world.toggleRedstonePower(whistle);
        scene.idle(20);
        scene.world.toggleRedstonePower(whistle);
        scene.idle(20);
        scene.overlay.showText(70).pointAt(util.vector.of(3.35F, 3.75, 5.0)).placeNearTarget().attachKeyFrame().text("Sneak or click again to stop controlling the Train");
        scene.idle(60);
    }
