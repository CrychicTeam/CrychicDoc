...
public class TrackScenes {
    ...
    public static void placement(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showText(60).pointAt(util.vector.topOf(5, 0, 9)).placeNearTarget().text("A new type of rail designed for Train Contraptions");
        scene.idle(50);
        ...
        scene.idle(6);
        AABB bb = new AABB(util.grid.at(3, 1, 5)).contract(0.0, 0.75, 0.0).inflate(0.0, 0.0, 0.85F);
        ...
        bb = new AABB(util.grid.at(5, 1, 5)).contract(0.0, 0.75, 0.0).inflate(3.0, 0.0, 3.0).expandTowards(0.85F, 0.0, 0.85F);
        scene.overlay.chaseBoundingBoxOutline(PonderPalette.GREEN, startTrack, bb, 32);
        scene.idle(20);
    ...
    public static void portal(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.idle(15);
        scene.overlay.showText(60).pointAt(util.vector.topOf(4, 0, 6)).placeNearTarget().attachKeyFrame().text("Tracks placed up against a nether portal...");
        scene.idle(50);
        scene.world.showSection(util.select.position(4, 1, 6), Direction.DOWN);
        scene.idle(20);
        scene.overlay.showText(70).pointAt(util.vector.topOf(4, 0, 6)).placeNearTarget().text("...will attempt to create a paired track on the other side");
        scene.idle(40);
        ...
        ElementLink<ParrotElement> birb = scene.special.createBirb(util.vector.centerOf(4, 3, 2), ParrotElement.FacePointOfInterestPose::new);
        ...
        for (ElementLink<WorldSectionElement> e : List.of(t1, t2, t3)) {
            scene.world.moveSection(e, util.vector.of(0.0, 0.0, 6.0), 30);
        }
        scene.special.moveParrot(birb, util.vector.of(0.0, 0.0, 5.6), 28);
        scene.world.animateBogey(util.grid.at(4, 2, 3), -6.0F, 30);
        ...
        scene.world.moveSection(nether, util.vector.of(0.0, -7.0, 0.0), 0);
        scene.special.moveParrot(birb, util.vector.of(0.0, 0.0, -0.1F), 1);
        scene.idle(25);
        ElementLink<WorldSectionElement> s1 = scene.world.showIndependentSection(util.select.fromTo(5, 2, 1, 3, 3, 5), null);
        scene.world.rotateSection(s1, 0.0, 180.0, 0.0, 0);
        scene.world.moveSection(s1, util.vector.of(0.0, 0.0, 3.5), 0);
        scene.world.moveSection(s1, util.vector.of(0.0, 0.0, -3.5), 18);
        scene.special.moveParrot(birb, util.vector.of(0.0, 0.0, -3.5), 18);
        scene.world.animateBogey(util.grid.at(4, 2, 3), -3.5F, 18);
        scene.idle(30);
        scene.overlay.showText(70).pointAt(util.vector.topOf(util.grid.at(3, 2, 3))).attachKeyFrame().placeNearTarget().text("Trains on this track are now able to travel across dimensions");
        scene.idle(40);
    }
