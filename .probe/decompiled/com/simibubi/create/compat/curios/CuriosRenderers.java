...
public class CuriosRenderers {
    ...
    public static void register() {
        CuriosRendererRegistry.register((Item) AllItems.GOGGLES.get(), () -> new GogglesCurioRenderer(Minecraft.getInstance().getEntityModels().bakeLayer(GogglesCurioRenderer.LAYER)));
    }
