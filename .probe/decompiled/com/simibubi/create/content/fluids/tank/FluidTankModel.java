...
public class FluidTankModel extends CTModel {
    ...
    protected static final ModelProperty<FluidTankModel.CullData> CULL_PROPERTY = new ModelProperty<>();
    ...
    protected ModelData.Builder gatherModelData(ModelData.Builder builder, BlockAndTintGetter world, BlockPos pos, BlockState state, ModelData blockEntityData) {
        ...
        FluidTankModel.CullData cullData = new FluidTankModel.CullData();
    ...
    private static class CullData {
        ...
        boolean isCulled(Direction face) {
            return face.getAxis().isVertical() ? false : this.culledFaces[face.get2DDataValue()];
        }
    }
}