...
public class KineticStressDisplaySource extends PercentOrProgressBarDisplaySource {
    ...
    protected MutableComponent formatNumeric(DisplayLinkContext context, Float currentLevel) {
        ...
        if (mode == 1) {
            ...
            LangBuilder builder = Lang.number((double) currentLevel.floatValue());
    ...
    protected Float getProgress(DisplayLinkContext context) {
        if (context.getSourceBlockEntity() instanceof StressGaugeBlockEntity stressGauge) {
            float var5 = stressGauge.getNetworkCapacity();
    ...
    public void initConfigurationWidgets(DisplayLinkContext context, ModularGuiLineBuilder builder, boolean isFirstLine) {
        ...
        if (!isFirstLine) {
            builder.addSelectionScrollInput(0, 120, (si, l) -> si.forOptions(Lang.translatedOptions("display_source.kinetic_stress", "progress_bar", "percent", "current", "max", "remaining")).titled(Lang.translateDirect("display_source.kinetic_stress.display")), "Mode");
        }
    }
