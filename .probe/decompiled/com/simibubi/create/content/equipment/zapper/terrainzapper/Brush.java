...
public abstract class Brush {
    ...
    Component getParamLabel(int paramIndex) {
        return Lang.translateDirect(paramIndex == 0 ? "generic.width" : (paramIndex == 1 ? "generic.height" : "generic.length"));
    }

    public int get(int paramIndex) {
        return paramIndex == 0 ? this.param0 : (paramIndex == 1 ? this.param1 : this.param2);
    }
    ...
    public abstract Collection<BlockPos> addToGlobalPositions(LevelAccessor var1, BlockPos var2, Direction var3, Collection<BlockPos> var4, TerrainTools var5);
}