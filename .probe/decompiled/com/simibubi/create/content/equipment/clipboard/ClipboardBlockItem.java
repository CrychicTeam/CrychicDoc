...
public class ClipboardBlockItem extends BlockItem {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player == null) {
            ...
            return player.m_6144_() ? super.useOn(context) : this.use(context.getLevel(), player, context.getHand()).getResult();
        }
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        ...
        if (hand == InteractionHand.OFF_HAND) {
            ...
            if (world.isClientSide) {
                DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> this.openScreen(player, heldItem));
            }
