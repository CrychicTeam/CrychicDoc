...
public class CubeParticleData implements ParticleOptions, ICustomParticleData<CubeParticleData> {
    ...
    @Override
    public ParticleOptions.Deserializer<CubeParticleData> getDeserializer() {
        return DESERIALIZER;
    }
    ...
    public String writeToString() {
        return String.format(Locale.ROOT, "%s %f %f %f %f %d %s", AllParticleTypes.CUBE.parameter(), this.r, this.g, this.b, this.scale, this.avgAge, this.hot);
    }
}