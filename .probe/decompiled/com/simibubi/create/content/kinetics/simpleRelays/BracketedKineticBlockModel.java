...
public class BracketedKineticBlockModel extends BakedModelWrapper<BakedModel> {
    ...
    private static final ModelProperty<BracketedKineticBlockModel.BracketedModelData> BRACKET_PROPERTY = new ModelProperty<>();
    ...
    public ModelData getModelData(BlockAndTintGetter world, BlockPos pos, BlockState state, ModelData blockEntityData) {
        if (ModelUtil.isVirtual(blockEntityData)) {
            ...
            BracketedKineticBlockModel.BracketedModelData data = new BracketedKineticBlockModel.BracketedModelData();
    ...
    public List<BakedQuad> getQuads(BlockState state, Direction side, RandomSource rand, ModelData data, RenderType renderType) {
        if (!ModelUtil.isVirtual(data)) {
            if (data.has(BRACKET_PROPERTY)) {
                BracketedKineticBlockModel.BracketedModelData pipeData = data.get(BRACKET_PROPERTY);
