...
public class ArmItem extends BlockItem {
    ...
    public InteractionResult useOn(UseOnContext ctx) {
        ...
        return ArmInteractionPoint.isInteractable(world, pos, world.getBlockState(pos)) ? InteractionResult.SUCCESS : super.useOn(ctx);
    }
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos pos, Level world, Player player, ItemStack p_195943_4_, BlockState p_195943_5_) {
        if (!world.isClientSide && player instanceof ServerPlayer sp) {
            AllPackets.getChannel().send(PacketDistributor.PLAYER.with(() -> sp), new ArmPlacementPacket.ClientBoundRequest(pos));
        }
