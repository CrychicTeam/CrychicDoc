...
public class SteamJetParticleData implements ParticleOptions, ICustomParticleDataWithSprite<SteamJetParticleData> {
    ...
    public static final Codec<SteamJetParticleData> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.FLOAT.fieldOf("speed").forGetter(p -> p.speed)).apply(i, SteamJetParticleData::new));
    ...
    public String writeToString() {
        return String.format(Locale.ROOT, "%s %f", AllParticleTypes.STEAM_JET.parameter(), this.speed);
    }
