...
public class EjectorItem extends BlockItem {
    ...
    public InteractionResult useOn(UseOnContext ctx) {
        ...
        return player != null && player.m_6144_() ? InteractionResult.SUCCESS : super.useOn(ctx);
    }

    @Override
    protected BlockState getPlacementState(BlockPlaceContext p_195945_1_) {
        return super.getPlacementState(p_195945_1_);
    }
    ...
    protected boolean updateCustomBlockEntityTag(BlockPos pos, Level world, Player player, ItemStack p_195943_4_, BlockState p_195943_5_) {
        if (!world.isClientSide && player instanceof ServerPlayer sp) {
            AllPackets.getChannel().send(PacketDistributor.PLAYER.with(() -> sp), new EjectorPlacementPacket.ClientBoundRequest(pos));
        }
