...
public class ModelSwapper {
    ...
    public void onModelBake(ModelEvent.ModifyBakingResult event) {
        ...
        this.customItemModels.forEach((item, modelFunc) -> swapModels(modelRegistry, getItemModelLocation(item), modelFunc));
    ...
    public static <T extends BakedModel> void swapModels(Map<ResourceLocation, BakedModel> modelRegistry, ModelResourceLocation location, Function<BakedModel, T> factory) {
        modelRegistry.put(location, (BakedModel) factory.apply((BakedModel) modelRegistry.get(location)));
    }
