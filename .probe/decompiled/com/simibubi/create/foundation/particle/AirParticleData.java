...
public class AirParticleData implements ParticleOptions, ICustomParticleDataWithSprite<AirParticleData> {
    ...
    public static final Codec<AirParticleData> CODEC = RecordCodecBuilder.create(i -> i.group(Codec.FLOAT.fieldOf("drag").forGetter(p -> p.drag), Codec.FLOAT.fieldOf("speed").forGetter(p -> p.speed)).apply(i, AirParticleData::new));
    ...
    public String writeToString() {
        return String.format(Locale.ROOT, "%s %f %f", AllParticleTypes.AIR.parameter(), this.drag, this.speed);
    }
