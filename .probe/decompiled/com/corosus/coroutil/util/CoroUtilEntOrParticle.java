...
public class CoroUtilEntOrParticle {
    ...
    public static double getPosX(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getX() : getPosXParticle(obj);
    }
    ...
    public static double getPosY(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getY() : getPosYParticle(obj);
    }
    ...
    public static double getPosZ(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getZ() : getPosZParticle(obj);
    }
    ...
    public static double getMotionX(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getDeltaMovement().x : getMotionXParticle(obj);
    }
    ...
    public static double getMotionY(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getDeltaMovement().y : getMotionYParticle(obj);
    }
    ...
    public static double getMotionZ(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).getDeltaMovement().z : getMotionZParticle(obj);
    }
    ...
    public static Level getWorld(Object obj) {
        return obj instanceof Entity ? ((Entity) obj).level() : CoroUtilParticle.getWorldParticle(obj);
    }
}