...
public class MaxCountFeaturePoolElement extends FeaturePoolElement implements IMaxCountJigsawPoolElement {
    ...
    public static final Codec<MaxCountFeaturePoolElement> CODEC = RecordCodecBuilder.create(builder -> builder.group(PlacedFeature.CODEC.fieldOf("feature").forGetter(featurePoolElement -> ((FeaturePoolElementAccessor) featurePoolElement).getFeature()), m_210538_(), Codec.STRING.fieldOf("name").forGetter(MaxCountFeaturePoolElement::getName), Codec.INT.fieldOf("max_count").forGetter(MaxCountFeaturePoolElement::getMaxCount)).apply(builder, MaxCountFeaturePoolElement::new));
