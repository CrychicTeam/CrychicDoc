...
public class MaxCountListPoolElement extends ListPoolElement implements IMaxCountJigsawPoolElement {
    ...
    public static final Codec<MaxCountListPoolElement> CODEC = RecordCodecBuilder.create(builder -> builder.group(StructurePoolElement.CODEC.listOf().fieldOf("elements").forGetter(listPiece -> ((ListPoolElementAccessor) listPiece).getElements()), m_210538_(), Codec.STRING.fieldOf("name").forGetter(MaxCountListPoolElement::getName), Codec.INT.fieldOf("max_count").forGetter(MaxCountListPoolElement::getMaxCount)).apply(builder, MaxCountListPoolElement::new));
    ...
    public String toString() {
        return "MaxCountList[" + this.name + "][" + (String) ((ListPoolElementAccessor) this).getElements().stream().map(Object::toString).collect(Collectors.joining(", ")) + "][" + this.maxCount + "]";
    }
}