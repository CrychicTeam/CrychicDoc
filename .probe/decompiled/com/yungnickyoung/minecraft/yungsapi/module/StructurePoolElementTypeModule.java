...
public class StructurePoolElementTypeModule {
    ...
    public static StructurePoolElementType<MaxCountSinglePoolElement> MAX_COUNT_SINGLE_ELEMENT = () -> MaxCountSinglePoolElement.CODEC;

    @AutoRegister("max_count_legacy_single_element")
    public static StructurePoolElementType<MaxCountLegacySinglePoolElement> MAX_COUNT_LEGACY_SINGLE_ELEMENT = () -> MaxCountLegacySinglePoolElement.CODEC;

    @AutoRegister("max_count_feature_element")
    public static StructurePoolElementType<MaxCountFeaturePoolElement> MAX_COUNT_FEATURE_ELEMENT = () -> MaxCountFeaturePoolElement.CODEC;

    @AutoRegister("max_count_list_element")
    public static StructurePoolElementType<MaxCountListPoolElement> MAX_COUNT_LIST_ELEMENT = () -> MaxCountListPoolElement.CODEC;

    @AutoRegister("yung_single_element")
    public static StructurePoolElementType<YungJigsawSinglePoolElement> YUNG_SINGLE_ELEMENT = () -> YungJigsawSinglePoolElement.CODEC;

    @AutoRegister("yung_feature_element")
    public static StructurePoolElementType<YungJigsawFeatureElement> YUNG_FEATURE_ELEMENT = () -> YungJigsawFeatureElement.CODEC;
}