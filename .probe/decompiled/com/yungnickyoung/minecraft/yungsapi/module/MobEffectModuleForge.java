...
public class MobEffectModuleForge {
    ...
    private static void register(RegisterEvent event) {
        event.register(ForgeRegistries.MOB_EFFECTS.getRegistryKey(), helper -> AutoRegistrationManager.MOB_EFFECTS.stream().filter(data -> !data.processed()).forEach(data -> registerMobEffect(data, helper)));
    }
