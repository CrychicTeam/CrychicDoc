...
public class ACMusics {
    ...
    public static final ACMusics.ForgeMusic LUXTRUCTOSAURUS_BOSS_MUSIC = new ACMusics.ForgeMusic(ACSoundRegistry.LUXTRUCTOSAURUS_BOSS_MUSIC, 0, 0, true);
    ...
    private static class ForgeMusic extends Music {
        ...
        public Holder<SoundEvent> getEvent() {
            return (Holder<SoundEvent>) this.registryObject.getHolder().get();
        }
    }
}