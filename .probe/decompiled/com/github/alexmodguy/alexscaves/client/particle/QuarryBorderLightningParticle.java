...
public class QuarryBorderLightningParticle extends Particle {
    ...
    public QuarryBorderLightningParticle(ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
        ...
        this.f_107225_ = 5;
        int sections = (int) (4.0 * lightningTo.length());
        ...
        LightningBoltData bolt = new LightningBoltData(boltData, Vec3.ZERO, lightningTo, sections).size(0.1F + this.f_107223_.nextFloat() * 0.1F).lifespan(this.f_107225_).spawn(LightningBoltData.SpawnFunction.NO_DELAY);
