...
public class GrottoceratopsRenderer extends MobRenderer<GrottoceratopsEntity, GrottoceratopsModel> {
    ...
    public ResourceLocation getTextureLocation(GrottoceratopsEntity entity) {
        return entity.getAltSkin() == 1 ? (entity.m_6162_() ? TEXTURE_RETRO_BABY : TEXTURE_RETRO) : (entity.getAltSkin() == 2 ? (entity.m_6162_() ? TEXTURE_TECTONIC_BABY : TEXTURE_TECTONIC) : (entity.m_6162_() ? TEXTURE_BABY : TEXTURE));
    }
}