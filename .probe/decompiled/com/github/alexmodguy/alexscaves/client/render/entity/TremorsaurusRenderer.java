...
public class TremorsaurusRenderer extends MobRenderer<TremorsaurusEntity, TremorsaurusModel> {
    ...
    public TremorsaurusRenderer(EntityRendererProvider.Context renderManagerIn) {
        ...
        this.m_115326_(new TremorsaurusRiderLayer(this));
        this.m_115326_(new TremorsaurusHeldMobLayer(this));
    }
    ...
    public ResourceLocation getTextureLocation(TremorsaurusEntity entity) {
        return entity.m_8077_() && "princess".equalsIgnoreCase(entity.m_7755_().getString()) ? TEXTURE_PRINCESS : (entity.getAltSkin() == 1 ? TEXTURE_RETRO : (entity.getAltSkin() == 2 ? TEXTURE_TECTONIC : TEXTURE));
    }
}