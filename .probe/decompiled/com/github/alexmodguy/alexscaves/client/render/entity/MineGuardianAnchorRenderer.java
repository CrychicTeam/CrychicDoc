...
public class MineGuardianAnchorRenderer extends EntityRenderer<MineGuardianAnchorEntity> {
    ...
    public void render(MineGuardianAnchorEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
        poseStack.translate(0.0, 1.35F, 0.0);
        poseStack.mulPose(Axis.YP.rotationDegrees(Mth.lerp(partialTicks, entity.f_19859_, entity.m_146908_())));
        poseStack.mulPose(Axis.XP.rotationDegrees(Mth.lerp(partialTicks, entity.f_19860_, entity.m_146909_()) + 180.0F));
        ...
        Vec3 modelOffset = MODEL.getChainPosition(new Vec3(0.0, 0.1F, 0.0));
