...
public class QuarryBlockRenderer<T extends QuarryBlockEntity> implements BlockEntityRenderer<T> {
    ...
    private static final ResourceLocation GRINDER_TEXTURE = new ResourceLocation("alexscaves", "textures/entity/quarry_grinder.png");
    ...
    public void render(T valve, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        poseStack.pushPose();
        BlockState state = valve.m_58900_();
        Direction dir = (Direction) state.m_61143_(QuarryBlock.FACING);
        ...
        GRINDER_MODEL.setupAnim(null, spin, 0.0F, 0.0F, 0.0F, 0.0F);
        GRINDER_MODEL.m_7695_(poseStack, bufferIn.getBuffer(RenderType.entityCutoutNoCull(GRINDER_TEXTURE)), combinedLightIn, combinedOverlayIn, 1.0F, 1.0F, 1.0F, 1.0F);
        poseStack.popPose();
    }
}