...
public class CopperValveBlockRenderer<T extends CopperValveBlockEntity> implements BlockEntityRenderer<T> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("alexscaves", "textures/entity/copper_valve.png");
    ...
    public void render(T valve, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        Direction dir = (Direction) state.m_61143_(CopperValveBlock.FACING);
        if (dir == Direction.UP) {
        ...
        MODEL.setupAnim(null, 0.0F, 0.0F, valve.getDownAmount(partialTicks), 0.0F, 0.0F);
