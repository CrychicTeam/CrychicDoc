...
public class DivingArmorModel extends HumanoidModel {
    ...
    public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
        ...
        head.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(0, 32).addBox(4.0F, -5.0F, -3.0F, 2.0F, 4.0F, 4.0F, deformation).texOffs(0, 32).mirror().addBox(-6.0F, -5.0F, -3.0F, 2.0F, 4.0F, 4.0F, deformation).mirror(false).texOffs(24, 0).addBox(-3.0F, -7.01F, -5.0F, 6.0F, 6.0F, 2.0F, deformation).texOffs(14, 37).addBox(-4.5F, -1.0F, -4.5F, 9.0F, 2.0F, 9.0F, deformation), PartPose.offset(0.0F, 0.0F, 0.0F));
        body.addOrReplaceChild("chestplate", CubeListBuilder.create().texOffs(40, 4).addBox(-2.0F, 2.0F, 2.0F, 4.0F, 8.0F, 4.0F, deformation), PartPose.offset(0.0F, 0.0F, 0.0F));
