...
public class PrimordialArmorModel extends HumanoidModel {
    ...
    public PrimordialArmorModel withAnimations(LivingEntity entity) {
        ...
        float minLeg = Math.min(this.f_102813_.xRot, this.f_102814_.xRot);
        float maxLeg = Math.max(this.f_102813_.xRot, this.f_102814_.xRot);
        this.frontFlap.xRot = minLeg - (float) ((double) limbSwingAmount * Math.toRadians(25.0));
        this.frontFlap.y = 12.0F - limbSwingAmount * 1.2F;
        this.backFlap.xRot = maxLeg + (float) ((double) limbSwingAmount * Math.toRadians(25.0));
