...
public class HazmatArmorModel extends HumanoidModel {
    ...
    public HazmatArmorModel withAnimations(LivingEntity entity) {
        ...
        float fromRads = (float) Mth.wrapDegrees(Math.toDegrees((double) (this.f_102808_.yRot - this.f_102810_.yRot)));
        this.mask.yRot = (float) (-Math.toRadians((double) fromRads) * 0.3F);
        float breathScale1 = (float) (Math.sin((double) (f * 0.05F)) + 1.0) * 0.1F + 1.0F;
        float breathScale2 = (float) (Math.cos((double) (f * 0.05F)) + 1.0) * 0.25F + 0.75F;
