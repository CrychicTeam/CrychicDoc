...
public class ACRecipeMaker {
    ...
    public static List<CraftingRecipe> createCaveMapRecipes() {
        ...
        for (ResourceKey<Biome> biome : ACBiomeRegistry.ALEXS_CAVES_BIOMES) {
            ...
            ResourceLocation id = new ResourceLocation("alexscaves", "jei.cave_map_" + biome.location().getPath());
            Ingredient paper = Ingredient.of(Items.PAPER);
            NonNullList<Ingredient> inputs = NonNullList.of(Ingredient.EMPTY, paper, paper, paper, paper, Ingredient.of(scroll), paper, paper, paper, paper);
