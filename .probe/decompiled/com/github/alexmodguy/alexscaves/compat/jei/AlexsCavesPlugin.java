...
public class AlexsCavesPlugin implements IModPlugin {
    ...
    public static final ResourceLocation MOD = new ResourceLocation("alexscaves", "alexscaves");

    public static final RecipeType<SpelunkeryTableRecipe> SPELUNKERY_TABLE_RECIPE_TYPE = RecipeType.create("alexscaves", "spelunkery_table", SpelunkeryTableRecipe.class);

    public static final RecipeType<AbstractCookingRecipe> NUCLEAR_FURNACE_RECIPE_TYPE = RecipeType.create("alexscaves", "nuclear_furnace", AbstractCookingRecipe.class);
