...
public class LuxtructosaurusLegSolver {
    ...
    public final LuxtructosaurusLegSolver.Leg backLeft;

    public final LuxtructosaurusLegSolver.Leg backRight;

    public final LuxtructosaurusLegSolver.Leg frontLeft;

    public final LuxtructosaurusLegSolver.Leg frontRight;

    public final LuxtructosaurusLegSolver.Leg[] legs;
    ...
    public LuxtructosaurusLegSolver(float forwardCenter, float forward, float sideBack, float sideFront, float range) {
        this.legs = new LuxtructosaurusLegSolver.Leg[] { new LuxtructosaurusLegSolver.Leg(forwardCenter - forward, sideBack, range, false), new LuxtructosaurusLegSolver.Leg(forwardCenter - forward, -sideBack, range, false), new LuxtructosaurusLegSolver.Leg(forwardCenter + forward, sideFront, range, true), new LuxtructosaurusLegSolver.Leg(forwardCenter + forward, -sideFront, range, true) };
    ...
    public final void update(LivingEntity entity, float yaw, float scale) {
        ...
        for (LuxtructosaurusLegSolver.Leg leg : this.legs) {
