...
public class SauropodPartEntity extends PartEntity<SauropodBaseEntity> {
    ...
    public EntityDimensions getDimensions(Pose pose) {
        ...
        return parent == null ? this.size : this.size.scale(parent.m_6134_());
    }
    ...
    public boolean isInvulnerableTo(DamageSource damageSource) {
        SauropodBaseEntity parent = this.getParent();
        return super.m_6673_(damageSource) || parent != null && parent.isInvulnerableTo(damageSource) || damageSource.getEntity() != null && this.getParent().m_20365_(damageSource.getEntity());
    }
    ...
    public float calculateAnimationAngle(float partialTicks, boolean pitch) {
        ...
        if (this.connectedTo == parent && parent != null) {
            connection = connection.add(0.0, (double) (-parent.getLegSolverBodyOffset()), 0.0);
        }
        if (parent != null && this == parent.neckPart1) {
            connection = connection.add(0.0, (double) (2.0F * parent.m_6134_()), 0.0);
        }
        if (parent != null) {
