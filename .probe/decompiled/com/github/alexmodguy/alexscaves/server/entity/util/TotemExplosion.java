    ...
    public void finalizeExplosion(boolean particles) {
        ...
        if (particles && !this.level.isClientSide && this.level instanceof ServerLevel serverLevel) {
            for (int i = 0; (float) i < 5.0F + this.radius * 10.0F; i++) {
                ...
                serverLevel.sendParticles(ACParticleRegistry.TOTEM_EXPLOSION.get(), this.x + (double) particleX, this.y + (double) particleY, this.z + (double) particleZ, 0, 0.0, 0.0, 0.0, 1.0);
            }
        }
    }
