    ...
    public InteractionResult interact(Player player, InteractionHand hand) {
        ...
        if (parent == null) {
            ...
            if (player.m_9236_().isClientSide) {
                AlexsCaves.sendMSGToServer(new MultipartEntityMessage(parent.getId(), player.m_19879_(), 0, 0.0));
            }
    ...
    public boolean hurt(DamageSource source, float amount) {
        ...
        if (!this.m_6673_(source) && parent != null) {
            ...
            if (player != null && player.level().isClientSide) {
                AlexsCaves.sendMSGToServer(new MultipartEntityMessage(parent.getId(), player.getId(), 1, (double) amount));
            }
        }
        return false;
    }
