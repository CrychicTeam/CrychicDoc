...
public class ForlornCanyonStructure extends AbstractCaveGenerationStructure {
    ...
    public static final Codec<ForlornCanyonStructure> CODEC = m_226607_(settings -> new ForlornCanyonStructure(settings));

    public ForlornCanyonStructure(Structure.StructureSettings settings) {
