...
public class FloatingOrbFeatureConfig implements FeatureConfiguration {
    ...
    public static final Codec<FloatingOrbFeatureConfig> CODEC = RecordCodecBuilder.create(config -> config.group(BlockStateProvider.CODEC.fieldOf("orb_made_of").forGetter(otherConfig -> otherConfig.orbBlock), Codec.INT.fieldOf("min_radius").forGetter(otherConfig -> otherConfig.minRadius), Codec.INT.fieldOf("max_radius").forGetter(otherConfig -> otherConfig.maxRadius)).apply(config, FloatingOrbFeatureConfig::new));
