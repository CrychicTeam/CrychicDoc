...
public class GalenaHexagonFeatureConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<GalenaHexagonFeatureConfiguration> CODEC = RecordCodecBuilder.create(config -> config.group(BlockStateProvider.CODEC.fieldOf("hexagon_made_of").forGetter(otherConfig -> otherConfig.hexBlock), Codec.BOOL.fieldOf("ceiling").forGetter(otherConfig -> otherConfig.ceiling)).apply(config, GalenaHexagonFeatureConfiguration::new));
