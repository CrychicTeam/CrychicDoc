...
public class ACSurfaceRules {
    ...
    public static SurfaceRules.RuleSource createPrimordialCavesRules() {
        ...
        SurfaceRules.RuleSource dirtOrPackedMud = SurfaceRules.sequence(SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.GRAVEL, -0.12, 0.2), packedMud), dirt);
    ...
    private static SurfaceRules.RuleSource createSandstoneBands(int layers, int layerThickness, int layerDistance) {
        ...
        for (int i = 1; i <= layers; i++) {
            ...
            ruleSources[i - 1] = SurfaceRules.ifTrue(layer1, SurfaceRules.ifTrue(SurfaceRules.not(layer2), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.ICE, -0.7, 0.8), sandstone)));
        }
