...
public class MagneticNodeFeatureConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<MagneticNodeFeatureConfiguration> CODEC = RecordCodecBuilder.create(config -> config.group(BlockStateProvider.CODEC.fieldOf("pillar").forGetter(otherConfig -> otherConfig.pillarBlock), BlockStateProvider.CODEC.fieldOf("node").forGetter(otherConfig -> otherConfig.nodeBlock)).apply(config, MagneticNodeFeatureConfiguration::new));
