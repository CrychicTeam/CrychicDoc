...
public class FillBiomeAboveConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<FillBiomeAboveConfiguration> CODEC = RecordCodecBuilder.create(config -> config.group(Biome.CODEC.fieldOf("replacing").forGetter(otherConfig -> otherConfig.replacing), Biome.CODEC.fieldOf("new_biome").forGetter(otherConfig -> otherConfig.newBiome), Codec.INT.fieldOf("y_above_sea_level").forGetter(otherConfig -> otherConfig.yAboveSeaLevel)).apply(config, FillBiomeAboveConfiguration::new));
