...
public class AbyssalFloraFeatureConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<AbyssalFloraFeatureConfiguration> CODEC = RecordCodecBuilder.create(config -> config.group(BlockStateProvider.CODEC.fieldOf("flora").forGetter(otherConfig -> otherConfig.floraBlock)).apply(config, AbyssalFloraFeatureConfiguration::new));
