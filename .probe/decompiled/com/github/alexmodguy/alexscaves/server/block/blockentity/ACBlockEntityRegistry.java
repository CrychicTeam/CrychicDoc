...
public class ACBlockEntityRegistry {
    ...
    public static final DeferredRegister<BlockEntityType<?>> DEF_REG = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, "alexscaves");
    ...
    public static void expandVanillaDefinitions() {
        Builder<Block> validSignBlocks = new Builder();
        ...
        Builder<Block> validHangingSignBlocks = new Builder();
