...
public class ACEnchantmentRegistry {
    ...
    public static final DeferredRegister<Enchantment> DEF_REG = DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, "alexscaves");
    ...
    public static boolean areCompatible(ACWeaponEnchantment enchantment1, Enchantment enchantment2) {
        if (enchantment1 == X_RAY.get() && enchantment2 == GAMMA_RAY.get()) {
            return false;
        } else if (enchantment1 == GAMMA_RAY.get() && enchantment2 == X_RAY.get()) {
            return false;
        } else if (enchantment1 == SECOND_WAVE.get() && enchantment2 == TSUNAMI.get()) {
            return false;
        } else if (enchantment1 == TSUNAMI.get() && enchantment2 == SECOND_WAVE.get()) {
            return false;
        } else if (enchantment1 != TAXING_BELLOW.get() || enchantment2 != Enchantments.UNBREAKING && enchantment2 != Enchantments.MENDING) {
            if ((enchantment1 == Enchantments.UNBREAKING || enchantment1 == Enchantments.MENDING) && enchantment2 == TAXING_BELLOW.get()) {
                return false;
            } else if (enchantment1 == BOUNCING_BOLT.get() && enchantment2 == TRIPLE_SPLASH.get()) {
                return false;
            } else if (enchantment1 == TRIPLE_SPLASH.get() && enchantment2 == BOUNCING_BOLT.get()) {
                return false;
            } else if (enchantment1 == DETONATING_DEATH.get() && enchantment2 == ASTRAL_TRANSFERRING.get()) {
                return false;
            } else if (enchantment1 == ASTRAL_TRANSFERRING.get() && enchantment2 == DETONATING_DEATH.get()) {
                return false;
            } else if (enchantment1 == IMPENDING_STAB.get() && enchantment2 == DOUBLE_STAB.get()) {
                return false;
            } else if (enchantment1 == DOUBLE_STAB.get() && enchantment2 == IMPENDING_STAB.get()) {
                return false;
            } else {
                return enchantment1 != RELENTLESS_DARKNESS.get() || enchantment2 != PRECISE_VOLLEY.get() && enchantment2 != DARK_NOCK.get() && enchantment2 != TWILIGHT_PERFECTION.get() ? enchantment1 != PRECISE_VOLLEY.get() && enchantment1 != DARK_NOCK.get() && enchantment1 != TWILIGHT_PERFECTION.get() || enchantment2 != RELENTLESS_DARKNESS.get() : false;
            }
        } else {
            return false;
        }
