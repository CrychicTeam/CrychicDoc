...
public class ItemFlutterPot extends Item implements DispensibleContainerItem {
    ...
    @Override
    public boolean emptyContents(@org.jetbrains.annotations.Nullable Player player0, Level level1, BlockPos blockPos2, @org.jetbrains.annotations.Nullable BlockHitResult blockHitResult3) {
        return false;
    }
}