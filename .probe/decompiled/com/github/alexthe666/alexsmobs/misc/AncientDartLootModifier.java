...
public class AncientDartLootModifier implements IGlobalLootModifier {
    ...
    public static final Supplier<Codec<AncientDartLootModifier>> CODEC = () -> RecordCodecBuilder.create(inst -> inst.group(LOOT_CONDITIONS_CODEC.fieldOf("conditions").forGetter(lm -> lm.conditions)).apply(inst, AncientDartLootModifier::new));
