...
public class BananaLootModifier implements IGlobalLootModifier {
    ...
    public static final Supplier<Codec<BananaLootModifier>> CODEC = () -> RecordCodecBuilder.create(inst -> inst.group(LOOT_CONDITIONS_CODEC.fieldOf("conditions").forGetter(lm -> lm.conditions)).apply(inst, BananaLootModifier::new));
