...
public class RenderIceShard extends EntityRenderer<EntityIceShard> {
    ...
    public void render(EntityIceShard p_225623_1_, float p_225623_2_, float p_225623_3_, PoseStack p_225623_4_, MultiBufferSource p_225623_5_, int p_225623_6_) {
        ...
        p_225623_4_.mulPose(Axis.YP.rotationDegrees(Mth.lerp(p_225623_3_, p_225623_1_.f_19859_, p_225623_1_.m_146908_()) - 90.0F));
        p_225623_4_.mulPose(Axis.ZP.rotationDegrees(Mth.lerp(p_225623_3_, p_225623_1_.f_19860_, p_225623_1_.m_146909_())));
