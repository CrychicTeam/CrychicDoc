...
public class RenderPotoo extends MobRenderer<EntityPotoo, ModelPotoo> {
    ...
    public boolean shouldRender(EntityPotoo bird, Frustum p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
        return bird.m_20159_() && bird.m_20202_() instanceof Player && Minecraft.getInstance().player == bird.m_20202_() && Minecraft.getInstance().options.getCameraType() == CameraType.FIRST_PERSON ? false : super.shouldRender(bird, p_225626_2_, p_225626_3_, p_225626_5_, p_225626_7_);
    }
