...
public class ModelNoveltyHat extends HumanoidModel {
    ...
    public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
        ...
        PartDefinition hat = head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 30).addBox(-4.5F, -5.0F, -4.5F, 9.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(31, 55).addBox(4.5F, -2.0F, -2.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(31, 55).mirror().addBox(-8.5F, -2.0F, -2.5F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 46).addBox(-5.5F, 1.0F, -9.5F, 11.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.0F, 0.0F));
