...
public class OrcaAIJump extends JumpGoal {
    ...
    public boolean canUse() {
        if (this.dolphin.m_217043_().nextInt(this.interval) == 0 && this.dolphin.m_5448_() == null && this.dolphin.jumpCooldown == 0) {
    ...
    private boolean canJumpTo(BlockPos pos, int dx, int dz, int scale) {
        ...
        return this.dolphin.m_9236_().getFluidState(blockpos).is(FluidTags.WATER) && !this.dolphin.m_9236_().getBlockState(blockpos).m_280555_();
    }
    ...
    public void start() {
        ...
        this.dolphin.jumpCooldown = this.dolphin.m_217043_().nextInt(256) + 256;
    }
