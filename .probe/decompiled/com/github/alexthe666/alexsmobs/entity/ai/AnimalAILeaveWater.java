...
public class AnimalAILeaveWater extends Goal {
    ...
    public boolean canUse() {
        if (this.creature.m_9236_().getFluidState(this.creature.m_20183_()).is(FluidTags.WATER) && (this.creature.m_5448_() != null || this.creature.m_217043_().nextInt(30) == 0) && this.creature instanceof ISemiAquatic && ((ISemiAquatic) this.creature).shouldLeaveWater()) {
    ...
    public boolean canContinueToUse() {
        if (this.creature instanceof ISemiAquatic && !((ISemiAquatic) this.creature).shouldLeaveWater()) {
            ...
            return !this.creature.m_21573_().isDone() && this.targetPos != null && !this.creature.m_9236_().getFluidState(this.targetPos).is(FluidTags.WATER);
        }
    }
