...
public class EntityHemolymph extends Entity {
    ...
    public EntityHemolymph(Level worldIn, EntityWarpedMosco p_i47273_2_) {
        ...
        this.m_6034_(p_i47273_2_.m_20185_() - (double) (p_i47273_2_.m_20205_() + 1.0F) * 0.35 * (double) Mth.sin(p_i47273_2_.f_20883_ * (float) (Math.PI / 180.0)), p_i47273_2_.m_20188_() + 0.2F, p_i47273_2_.m_20189_() + (double) (p_i47273_2_.m_20205_() + 1.0F) * 0.35 * (double) Mth.cos(p_i47273_2_.f_20883_ * (float) (Math.PI / 180.0)));
    }
    ...
    public void tick() {
        ...
        if (this.m_9236_().isClientSide) {
            ...
            this.m_9236_().addParticle(AMParticleRegistry.HEMOLYMPH.get(), this.m_20185_() + (double) r1, this.m_20186_() + (double) r2, this.m_20189_() + (double) r3, (double) (r1 * 0.1F), (double) (r2 * 0.1F), (double) (r3 * 0.1F));
        }
        super.tick();
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity) {
            p_213868_1_.getEntity().hurt(this.m_269291_().mobProjectile(this, (LivingEntity) entity), 7.0F);
        }
    }
