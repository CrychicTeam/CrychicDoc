...
public class Platform {
    ...
    public static <T> T newInstance(Class<T> clazz, Object[] params) {
        try {
            return (T) clazz.getConstructor(classes(params)).newInstance(params);
    ...
    public static <T> T[] copyOfRangeO(T[] original, int from, int to) {
        return (T[]) Arrays.copyOfRange(original, from, to);
    }
    ...
    public static <T> T[] copyOfObj(T[] original, int newLength) {
        return (T[]) Arrays.copyOf(original, newLength);
    }
    ...
    public static boolean isAssignableFrom(Class class1, Class class2) {
        return class1 != class2 && !class1.equals(class2) ? class1.isAssignableFrom(class2) : true;
    }
