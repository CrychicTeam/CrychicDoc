...
public class VP8Util {
    ...
    public static int[] pickDefaultPrediction(int intra_bmode) {
        return intra_bmode != 1 && intra_bmode != 0 && intra_bmode != 2 && intra_bmode != 3 && intra_bmode != 6 && intra_bmode != 5 && intra_bmode != 8 ? PRED_BLOCK_127 : PRED_BLOCK_129;
    }

    public static int[] predictHU(int[] left) {
        int[] p = new int[16];
        p[0] = avg2(left[0], left[1]);
        p[1] = avg3(left[0], left[1], left[2]);
        p[2] = p[4] = avg2(left[1], left[2]);
        p[3] = p[5] = avg3(left[1], left[2], left[3]);
        p[6] = p[8] = avg2(left[2], left[3]);
        p[7] = p[9] = avg3(left[2], left[3], left[3]);
        p[10] = p[11] = p[12] = p[13] = p[14] = p[15] = left[3];
        return p;
    }
    ...
    public static int[] predictHD(int[] above, int[] left, int aboveLeft) {
        ...
        p[8] = p[14] = avg2(edge[1], edge[2]);
        p[9] = p[15] = avg3(edge[1], edge[2], edge[3]);
        p[10] = p[4] = avg2(edge[2], edge[3]);
        p[11] = p[5] = avg3(edge[2], edge[3], edge[4]);
        p[6] = p[0] = avg2(edge[3], edge[4]);
        p[7] = p[1] = avg3(edge[3], edge[4], edge[5]);
    ...
    public static int[] predictVL(int[] above, int[] aboveRight) {
        int[] p = new int[16];
        p[0] = avg2(above[0], above[1]);
        p[4] = avg3(above[0], above[1], above[2]);
        p[8] = p[1] = avg2(above[1], above[2]);
        p[5] = p[12] = avg3(above[1], above[2], above[3]);
        p[9] = p[2] = avg2(above[2], above[3]);
        p[13] = p[6] = avg3(above[2], above[3], aboveRight[0]);
        p[10] = p[3] = avg2(above[3], aboveRight[0]);
        p[14] = p[7] = avg3(above[3], aboveRight[0], aboveRight[1]);
    ...
    public static int[] predictVR(int[] above, int[] left, int aboveLeft) {
        ...
        p[13] = p[4] = avg3(edge[3], edge[4], edge[5]);
        p[9] = p[0] = avg2(edge[4], edge[5]);
        p[14] = p[5] = avg3(edge[4], edge[5], edge[6]);
        p[10] = p[1] = avg2(edge[5], edge[6]);
        p[15] = p[6] = avg3(edge[5], edge[6], edge[7]);
        p[11] = p[2] = avg2(edge[6], edge[7]);
    ...
    public static int[] predictRD(int[] above, int[] left, int aboveLeft) {
        ...
        p[13] = p[8] = avg3(edge[1], edge[2], edge[3]);
        p[14] = p[9] = p[4] = avg3(edge[2], edge[3], edge[4]);
        p[15] = p[10] = p[5] = p[0] = avg3(edge[3], edge[4], edge[5]);
        p[11] = p[6] = p[1] = avg3(edge[4], edge[5], edge[6]);
        p[7] = p[2] = avg3(edge[5], edge[6], edge[7]);
    ...
    public static int[] predictLD(int[] above, int[] aboveRight) {
        int[] p = new int[16];
        p[0] = avg3(above[0], above[1], above[2]);
        p[1] = p[4] = avg3(above[1], above[2], above[3]);
        p[2] = p[5] = p[8] = avg3(above[2], above[3], aboveRight[0]);
        p[3] = p[6] = p[9] = p[12] = avg3(above[3], aboveRight[0], aboveRight[1]);
        p[7] = p[10] = p[13] = avg3(aboveRight[0], aboveRight[1], aboveRight[2]);
        p[11] = p[14] = avg3(aboveRight[1], aboveRight[2], aboveRight[3]);
    ...
    public static int[] predictHE(int[] left, int aboveLeft) {
        ...
        p[12] = p[13] = p[14] = p[15] = avg3(left[2], left[3], left[3]);
        p[8] = p[9] = p[10] = p[11] = avg3(left[1], left[2], left[3]);
        p[4] = p[5] = p[6] = p[7] = avg3(left[0], left[1], left[2]);
        p[0] = p[1] = p[2] = p[3] = avg3(aboveLeft, left[0], left[1]);
        return p;
    }

    public static int[] predictVE(int[] above, int aboveLeft, int[] aboveRight) {
        int[] p = new int[16];
        p[0] = p[4] = p[8] = p[12] = avg3(aboveLeft, above[0], above[1]);
        p[1] = p[5] = p[9] = p[13] = avg3(above[0], above[1], above[2]);
        p[2] = p[6] = p[10] = p[14] = avg3(above[1], above[2], above[3]);
        p[3] = p[7] = p[11] = p[15] = avg3(above[2], above[3], aboveRight[0]);
        return p;
    }
