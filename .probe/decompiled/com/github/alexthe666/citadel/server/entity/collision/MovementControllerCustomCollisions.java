...
public class MovementControllerCustomCollisions extends MoveControl {
    ...
    private boolean isWalkable(float p_234024_1_, float p_234024_2_) {
        ...
        if (pathnavigator == null) {
            ...
            return nodeprocessor == null || nodeprocessor.getBlockPathType(this.f_24974_.m_9236_(), Mth.floor(this.f_24974_.m_20185_() + (double) p_234024_1_), Mth.floor(this.f_24974_.m_20186_()), Mth.floor(this.f_24974_.m_20189_() + (double) p_234024_2_)) == BlockPathTypes.WALKABLE;
        }
    }
}