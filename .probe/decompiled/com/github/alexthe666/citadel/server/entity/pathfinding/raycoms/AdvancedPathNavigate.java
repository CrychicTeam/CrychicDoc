...
public class AdvancedPathNavigate extends AbstractAdvancedPathNavigate {
    ...
    public void tick() {
        if (this.overrideDefaultDimensions) {
            this.f_26508_.entityWidth = Mth.floor(this.width + 1.0F);
            this.f_26508_.entityHeight = Mth.floor(this.height + 1.0F);
            this.f_26508_.entityDepth = Mth.floor(this.width + 1.0F);
        } else {
            this.f_26508_.entityWidth = Mth.floor(this.ourEntity.m_20205_() + 1.0F);
            this.f_26508_.entityHeight = Mth.floor(this.ourEntity.m_20206_() + 1.0F);
            this.f_26508_.entityDepth = Mth.floor(this.ourEntity.m_20205_() + 1.0F);
        }
        ...
        if (this.handleLadders(oldIndex)) {
            ...
            if (this.f_26494_ instanceof TamableAnimal tamableAnimal && tamableAnimal.isInSittingPose()) {
                return;
            }
            if (this.f_26494_ instanceof IAdvancedPathingMob advancedPathingMob && advancedPathingMob.stopTickingPathing()) {
                return;
            }
            this.stuckHandler.checkStuck(this);
        }
