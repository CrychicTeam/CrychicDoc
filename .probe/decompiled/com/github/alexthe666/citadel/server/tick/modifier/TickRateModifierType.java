...
public enum TickRateModifierType {
    ...
    GLOBAL(GlobalTickRateModifier.class, false, 0), CELESTIAL(CelestialTickRateModifier.class, false, 1), LOCAL_POSITION(LocalPositionTickRateModifier.class, true, 2), LOCAL_ENTITY(LocalEntityTickRateModifier.class, true, 3);
    ...
    public static TickRateModifierType fromId(int id) {
        for (TickRateModifierType type : values()) {
            if (type.id == id) {
                return type;
            }
        }
