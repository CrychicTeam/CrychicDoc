...
public class BookBlit {
    ...
    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation resourceLocation0, int int1, int int2, int int3, int int4, int int5, int int6, int r, int g, int b, int a) {
        blitWithColor(guiGraphics, resourceLocation0, int1, int2, 0, (float) int3, (float) int4, int5, int6, 256, 256, r, g, b, a);
    }

    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation resourceLocation0, int int1, int int2, int int3, float float4, float float5, int int6, int int7, int int8, int int9, int r, int g, int b, int a) {
        blitWithColor(guiGraphics, resourceLocation0, int1, int1 + int6, int2, int2 + int7, int3, int6, int7, float4, float5, int8, int9, r, g, b, a);
    }

    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation resourceLocation0, int int1, int int2, int int3, int int4, float float5, float float6, int int7, int int8, int int9, int int10, int r, int g, int b, int a) {
        blitWithColor(guiGraphics, resourceLocation0, int1, int1 + int3, int2, int2 + int4, 0, int7, int8, float5, float6, int9, int10, r, g, b, a);
    }

    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation resourceLocation0, int int1, int int2, float float3, float float4, int int5, int int6, int int7, int int8, int r, int g, int b, int a) {
        blitWithColor(guiGraphics, resourceLocation0, int1, int2, int5, int6, float3, float4, int5, int6, int7, int8, r, g, b, a);
    }

    private static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation resourceLocation0, int int1, int int2, int int3, int int4, int int5, int int6, int int7, float float8, float float9, int int10, int int11, int r, int g, int b, int a) {
