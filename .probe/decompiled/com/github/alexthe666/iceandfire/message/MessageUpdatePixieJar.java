...
public class MessageUpdatePixieJar {
    ...
    public static class Handler {
        ...
        public static void handle(MessageUpdatePixieJar message, Supplier<NetworkEvent.Context> contextSupplier) {
            ...
            context.enqueueWork(() -> {
                ...
                if (player != null) {
                    ...
                    if (player.m_9236_().getBlockEntity(pos) instanceof TileEntityJar jar) {
