...
public class ModelIceDragonScaleArmor extends ArmorModelBase {
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation, float offset) {
        ...
        partdefinition.getChild("head").addOrReplaceChild("HornR", CubeListBuilder.create().texOffs(48, 44).addBox(-1.0F, -0.5F, 0.0F, 2.0F, 3.0F, 5.0F), PartPose.offsetAndRotation(-3.6F, -8.0F, 1.0F, (float) (Math.PI / 10), -0.33161256F, -0.19198622F));
        partdefinition.getChild("head").addOrReplaceChild("HornL", CubeListBuilder.create().texOffs(48, 44).mirror().addBox(-1.0F, -0.5F, 0.0F, 2.0F, 3.0F, 5.0F), PartPose.offsetAndRotation(3.6F, -8.0F, 1.0F, (float) (Math.PI / 10), 0.33161256F, 0.19198622F));
        partdefinition.getChild("head").addOrReplaceChild("HornR3", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(-4.0F, -4.0F, 0.7F, -0.06981317F, -0.4886922F, -0.08726646F));
        partdefinition.getChild("head").addOrReplaceChild("HornL3", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(4.0F, -4.0F, 0.7F, -0.06981317F, 0.4886922F, 0.08726646F));
        partdefinition.getChild("head").addOrReplaceChild("HornR4", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(-1.0F, -7.5F, 1.9F, 0.4537856F, (float) (-Math.PI / 10), -0.034906585F));
        partdefinition.getChild("head").addOrReplaceChild("HornL4", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(1.0F, -7.5F, 1.9F, 0.4537856F, (float) (Math.PI / 10), 0.034906585F));
        ...
        partdefinition.getChild("head").getChild("HornR").addOrReplaceChild("HornR2", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 0.3F, 4.5F, -0.075049154F, 0.0F, 0.0F));
        partdefinition.getChild("head").getChild("HornL").addOrReplaceChild("HornL2", CubeListBuilder.create().texOffs(46, 36).mirror().addBox(-0.5F, -0.8F, 0.0F, 1.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 0.3F, 4.5F, -0.075049154F, 0.0F, 0.0F));
        partdefinition.getChild("head").getChild("Jaw").addOrReplaceChild("Teeth1", CubeListBuilder.create().texOffs(6, 34).addBox(-3.6F, 0.1F, -8.9F, 4.0F, 1.0F, 5.0F), PartPose.offset(0.0F, 3.0F, 1.4F));
        partdefinition.getChild("head").getChild("Jaw").addOrReplaceChild("Teeth2", CubeListBuilder.create().texOffs(6, 34).mirror().addBox(-0.4F, 0.1F, -8.9F, 4.0F, 1.0F, 5.0F), PartPose.offset(0.0F, 3.0F, 1.4F));
