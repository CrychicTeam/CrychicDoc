...
public class ModelDreadBeast extends ModelDragonBase<EntityDreadBeast> {
    ...
    public ModelDreadBeast() {
        ...
        this.setRotateAngle(this.Jaw, 0.27314404F, 0.0F, (float) -Math.PI);
    ...
    public void setupAnim(EntityDreadBeast entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.chainWave(NECK, speed_idle, degree_idle * 0.15F, -1.0, f2, 1.0F);
        ...
        this.chainSwing(TAIL, speed_idle, degree_idle * 0.75F, -2.0, f2, 1.0F);
        this.chainWave(TAIL, speed_idle, degree_idle * 0.15F, 0.0, f2, 1.0F);
        this.chainWave(NECK, speed_walk, degree_walk * 0.15F, -1.0, f, f1);
        this.chainWave(TAIL, speed_walk, degree_walk * 0.15F, 2.0, f, f1);
