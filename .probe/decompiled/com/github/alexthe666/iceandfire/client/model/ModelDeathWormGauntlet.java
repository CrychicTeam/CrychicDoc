    ...
    public void animate(ItemStack stack, float partialTick) {
        ...
        if (holder instanceof LivingEntity) {
            EntityDataProvider.getCapability(holder).ifPresent(data -> {
                ...
                this.progressRotation(this.TopJaw, lungeTicks, (float) Math.toRadians(-30.0), 0.0F, 0.0F);
                this.progressRotation(this.BottomJaw, lungeTicks, (float) Math.toRadians(30.0), 0.0F, 0.0F);
