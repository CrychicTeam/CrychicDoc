...
public class ModelTroll extends ModelDragonBase<EntityTroll> {
    ...
    public ModelTroll() {
        ...
        this.setRotateAngle(this.hornL, -0.59184116F, 2.6406832F, (float) (-Math.PI / 18));
        ...
        this.setRotateAngle(this.leftleg2, (float) (Math.PI / 9), 0.0F, 0.08726646F);
        ...
        this.setRotateAngle(this.leftleg, (float) (-Math.PI / 12), 0.0F, -0.08726646F);
        ...
        this.setRotateAngle(this.rightleg2, (float) (Math.PI / 9), 0.0F, -0.08726646F);
        ...
        this.setRotateAngle(this.leftarm, -0.13665928F, 0.0F, (float) (-Math.PI / 18));
        ...
        this.setRotateAngle(this.rightleg, (float) (-Math.PI / 12), 0.0F, 0.08726646F);
        ...
        this.setRotateAngle(this.blade2_2, (float) Math.PI, 0.0F, 0.0F);
    ...
    public void setupAnim(EntityTroll entity, float limbSwing, float limbSwingAmount, float ageInTicks, float f3, float f4) {
        ...
        this.progressRotation(this.head, entity.stoneProgress, (float) Math.toRadians(-31.0), 0.0F, 0.0F);
        this.progressRotation(this.jaw, entity.stoneProgress, (float) Math.toRadians(54.0), 0.0F, 0.0F);
        this.progressRotation(this.leftarm, entity.stoneProgress, (float) Math.toRadians(10.0), (float) Math.toRadians(-73.0), (float) Math.toRadians(-60.0));
        this.progressRotation(this.leftarm2, entity.stoneProgress, (float) Math.toRadians(-80.0), 0.0F, 0.0F);
        this.progressRotation(this.rightarm, entity.stoneProgress, (float) Math.toRadians(-101.0), (float) Math.toRadians(70.0), 0.0F);
        this.progressRotation(this.rightarm2, entity.stoneProgress, (float) Math.toRadians(-40.0), 0.0F, 0.0F);
    ...
    public void animateStatue(EntityTroll troll) {
        this.progressRotation(this.head, 20.0F, (float) Math.toRadians(-31.0), 0.0F, 0.0F);
        this.progressRotation(this.jaw, 20.0F, (float) Math.toRadians(54.0), 0.0F, 0.0F);
        this.progressRotation(this.leftarm, 20.0F, (float) Math.toRadians(10.0), (float) Math.toRadians(-73.0), (float) Math.toRadians(-60.0));
        this.progressRotation(this.leftarm2, 20.0F, (float) Math.toRadians(-80.0), 0.0F, 0.0F);
        this.progressRotation(this.rightarm, 20.0F, (float) Math.toRadians(-101.0), (float) Math.toRadians(70.0), 0.0F);
        this.progressRotation(this.rightarm2, 20.0F, (float) Math.toRadians(-40.0), 0.0F, 0.0F);
    }
