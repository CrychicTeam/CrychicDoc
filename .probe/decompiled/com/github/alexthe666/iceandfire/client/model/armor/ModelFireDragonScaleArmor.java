...
public class ModelFireDragonScaleArmor extends ArmorModelBase {
    ...
    public static MeshDefinition createMesh(CubeDeformation deformation, float offset) {
        ...
        partdefinition.getChild("head").getChild("HeadFront").addOrReplaceChild("Teeth1", CubeListBuilder.create().texOffs(6, 34).addBox(-3.6F, 0.1F, -8.9F, 4.0F, 1.0F, 5.0F), PartPose.offset(0.0F, -1.0F, 0.0F));
