...
public class RenderDeathWormGauntlet extends BlockEntityWithoutLevelRenderer {
    ...
    public RenderDeathWormGauntlet(BlockEntityRenderDispatcher blockEntityRenderDispatcher0, EntityModelSet entityModelSet1) {
    ...
    public void renderByItem(ItemStack stack, @NotNull ItemDisplayContext type, @NotNull PoseStack stackIn, @NotNull MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        MODEL.m_7695_(stackIn, bufferIn.getBuffer(texture), combinedLightIn, combinedOverlayIn, 1.0F, 1.0F, 1.0F, 1.0F);
        stackIn.popPose();
        stackIn.popPose();
        stackIn.popPose();
    }
