...
@EventBusSubscriber(value = { Dist.CLIENT }, bus = Bus.MOD, modid = "iceandfire")
public class IafClientSetup {
    ...
    public static void setupShaders(RegisterShadersEvent event) throws IOException {
        ...
        event.registerShader(new ShaderInstance(provider, new ResourceLocation("iceandfire", "rendertype_dread_portal"), DefaultVertexFormat.POSITION_COLOR), p_172782_ -> rendertypeDreadPortalShader = p_172782_);
    }
    ...
    public static void setupClient(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(IafItemRegistry.DRAGON_HORN.get(), new ResourceLocation("iceorfire"), (stack, level, entity, p) -> (float) ItemDragonHorn.getDragonType(stack) * 0.25F);
            ItemProperties.register(IafItemRegistry.SUMMONING_CRYSTAL_FIRE.get(), new ResourceLocation("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
            ItemProperties.register(IafItemRegistry.SUMMONING_CRYSTAL_ICE.get(), new ResourceLocation("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
            ItemProperties.register(IafItemRegistry.SUMMONING_CRYSTAL_LIGHTNING.get(), new ResourceLocation("has_dragon"), (stack, level, entity, p) -> ItemSummoningCrystal.hasDragon(stack) ? 1.0F : 0.0F);
            ItemProperties.register(IafItemRegistry.TIDE_TRIDENT.get(), new ResourceLocation("throwing"), (stack, level, entity, p) -> entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F);
        });
    }
}