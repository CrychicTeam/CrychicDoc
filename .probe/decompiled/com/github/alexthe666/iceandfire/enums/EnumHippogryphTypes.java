...
public enum EnumHippogryphTypes {
    ...
    private EnumHippogryphTypes(boolean developer) {
        ...
        this.TEXTURE = new ResourceLocation("iceandfire:textures/models/hippogryph/" + this.name().toLowerCase(Locale.ROOT) + ".png");
        this.TEXTURE_BLINK = new ResourceLocation("iceandfire:textures/models/hippogryph/" + this.name().toLowerCase(Locale.ROOT) + "_blink.png");
    }
