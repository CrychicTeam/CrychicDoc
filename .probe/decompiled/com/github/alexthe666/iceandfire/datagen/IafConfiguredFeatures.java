...
public final class IafConfiguredFeatures {
    ...
    private static Function<Block, RandomPatchConfiguration> flowerConf = block -> FeatureUtils.simpleRandomPatchConfiguration(8, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(block.defaultBlockState().m_60734_()))));
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        context.register(FIRE_LILY, new ConfiguredFeature<>(Feature.FLOWER, (FeatureConfiguration) flowerConf.apply(IafBlockRegistry.FIRE_LILY.get())));
        context.register(FROST_LILY, new ConfiguredFeature<>(Feature.FLOWER, (FeatureConfiguration) flowerConf.apply(IafBlockRegistry.FROST_LILY.get())));
        context.register(LIGHTNING_LILY, new ConfiguredFeature<>(Feature.FLOWER, (FeatureConfiguration) flowerConf.apply(IafBlockRegistry.LIGHTNING_LILY.get())));
    }
}