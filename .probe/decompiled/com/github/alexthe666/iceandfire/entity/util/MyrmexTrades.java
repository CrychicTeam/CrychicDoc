...
public class MyrmexTrades {
    ...
    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> DESERT_WORKER = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.DesertResinForItemsTrade(Items.DIRT, 64, 1, 5), new MyrmexTrades.DesertResinForItemsTrade(Items.SAND, 64, 1, 5), new MyrmexTrades.ItemsForDesertResinTrade(Items.DEAD_BUSH, 2, 8, 5, 2), new MyrmexTrades.DesertResinForItemsTrade(Items.BONE, 10, 1, 1) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(Items.IRON_ORE, 1, 6, 3, 2), new MyrmexTrades.DesertResinForItemsTrade(Items.SUGAR, 15, 2, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.STICK, 1, 64, 5, 2), new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.COPPER_NUGGET.get(), 1, 4, 10) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> JUNGLE_WORKER = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.JungleResinForItemsTrade(Items.DIRT, 64, 1, 5), new MyrmexTrades.ItemsForJungleResinTrade(Items.MELON_SLICE, 1, 20, 3, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.JUNGLE_LEAVES, 1, 64, 5, 1), new MyrmexTrades.JungleResinForItemsTrade(Items.BONE, 10, 1, 5) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(Items.GOLD_ORE, 2, 15, 3, 2), new MyrmexTrades.JungleResinForItemsTrade(Items.SUGAR, 15, 2, 3), new MyrmexTrades.ItemsForJungleResinTrade(Items.STICK, 1, 64, 5, 2), new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.COPPER_NUGGET.get(), 1, 4, 10) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> DESERT_SOLDIER = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.DesertResinForItemsTrade(Items.BONE, 7, 1, 3), new MyrmexTrades.DesertResinForItemsTrade(Items.FEATHER, 16, 3, 3), new MyrmexTrades.DesertResinForItemsTrade(Items.GUNPOWDER, 5, 1, 4), new MyrmexTrades.ItemsForDesertResinTrade(Items.RABBIT, 1, 3, 6, 2), new MyrmexTrades.DesertResinForItemsTrade(Items.IRON_NUGGET, 4, 1, 4), new MyrmexTrades.ItemsForDesertResinTrade(Items.CHICKEN, 2, 2, 7), new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.SILVER_NUGGET.get(), 4, 1, 15) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(Items.CACTUS, 1, 15, 6, 2), new MyrmexTrades.ItemsForDesertResinTrade(Items.GOLD_NUGGET, 1, 4, 6, 2), new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.TROLL_TUSK.get(), 6, 1, 4, 2), new MyrmexTrades.DesertResinForItemsTrade(IafItemRegistry.DRAGON_BONE.get(), 6, 2, 3) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> JUNGLE_SOLDIER = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.JungleResinForItemsTrade(Items.BONE, 7, 1, 3), new MyrmexTrades.JungleResinForItemsTrade(Items.FEATHER, 16, 3, 3), new MyrmexTrades.JungleResinForItemsTrade(Items.GUNPOWDER, 5, 1, 4), new MyrmexTrades.ItemsForJungleResinTrade(Items.EGG, 1, 4, 6, 2), new MyrmexTrades.JungleResinForItemsTrade(Items.IRON_NUGGET, 4, 1, 4), new MyrmexTrades.ItemsForJungleResinTrade(Items.CHICKEN, 2, 2, 7), new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.SILVER_NUGGET.get(), 1, 4, 15) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(Items.ROTTEN_FLESH, 1, 15, 6, 2), new MyrmexTrades.ItemsForJungleResinTrade(Items.GOLD_NUGGET, 1, 4, 6, 2), new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.TROLL_TUSK.get(), 6, 1, 4, 2), new MyrmexTrades.JungleResinForItemsTrade(IafItemRegistry.DRAGON_BONE.get(), 6, 2, 3) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> DESERT_SENTINEL = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.DesertResinForItemsTrade(Items.SPIDER_EYE, 10, 2, 3), new MyrmexTrades.DesertResinForItemsTrade(Items.POISONOUS_POTATO, 2, 1, 2), new MyrmexTrades.DesertResinForItemsTrade(Items.PUFFERFISH, 4, 2, 4) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(Items.REDSTONE, 2, 5, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.PORKCHOP, 2, 3, 4), new MyrmexTrades.ItemsForDesertResinTrade(Items.BEEF, 2, 3, 4), new MyrmexTrades.ItemsForDesertResinTrade(Items.MUTTON, 2, 3, 4), new MyrmexTrades.ItemsForDesertResinTrade(Items.SKELETON_SKULL, 15, 1, 2, 1) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> JUNGLE_SENTINEL = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.JungleResinForItemsTrade(Items.SPIDER_EYE, 10, 2, 3), new MyrmexTrades.JungleResinForItemsTrade(Items.POISONOUS_POTATO, 2, 1, 2), new MyrmexTrades.JungleResinForItemsTrade(Items.PUFFERFISH, 4, 2, 4) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(Items.REDSTONE, 2, 5, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.PORKCHOP, 2, 3, 4), new MyrmexTrades.ItemsForJungleResinTrade(Items.BEEF, 2, 3, 4), new MyrmexTrades.ItemsForJungleResinTrade(Items.MUTTON, 2, 3, 4), new MyrmexTrades.ItemsForJungleResinTrade(Items.SKELETON_SKULL, 15, 1, 2, 1) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> DESERT_ROYAL = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.MANUSCRIPT.get(), 1, 3, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.WITHER_SHARD.get(), 3, 1, 3, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.EMERALD, 10, 1, 3, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.QUARTZ, 2, 4, 3, 1) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(Items.GOLDEN_CARROT, 3, 1, 2, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.MAGMA_CREAM, 5, 1, 3, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.GOLD_INGOT, 3, 1, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(IafItemRegistry.SILVER_INGOT.get(), 3, 1, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.COPPER_INGOT, 2, 2, 3, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.ENDER_PEARL, 8, 1, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.RABBIT_FOOT, 3, 1, 5, 1) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> JUNGLE_ROYAL = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.MANUSCRIPT.get(), 1, 3, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.WITHER_SHARD.get(), 3, 1, 3, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.EMERALD, 10, 1, 3, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.QUARTZ, 2, 4, 3, 1) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(Items.GOLDEN_CARROT, 3, 1, 2, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.MAGMA_CREAM, 5, 1, 3, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.GOLD_INGOT, 3, 1, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(IafItemRegistry.SILVER_INGOT.get(), 3, 1, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.COPPER_INGOT, 2, 2, 3, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.ENDER_PEARL, 8, 1, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(Items.RABBIT_FOOT, 3, 1, 5, 1) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> DESERT_QUEEN = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(createEgg(false, 0), 10, 1, 10, 1), new MyrmexTrades.ItemsForDesertResinTrade(createEgg(false, 1), 20, 1, 8, 1), new MyrmexTrades.ItemsForDesertResinTrade(createEgg(false, 2), 30, 1, 5, 1), new MyrmexTrades.ItemsForDesertResinTrade(createEgg(false, 3), 40, 1, 3, 1) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForDesertResinTrade(createEgg(false, 4), 60, 1, 2, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.EMERALD, 15, 1, 9, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.DIAMOND, 25, 1, 9, 1) }));

    public static final Int2ObjectMap<VillagerTrades.ItemListing[]> JUNGLE_QUEEN = createTrades(ImmutableMap.of(1, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(createEgg(true, 0), 10, 1, 10, 1), new MyrmexTrades.ItemsForJungleResinTrade(createEgg(true, 1), 20, 1, 8, 1), new MyrmexTrades.ItemsForJungleResinTrade(createEgg(true, 2), 30, 1, 5, 1), new MyrmexTrades.ItemsForJungleResinTrade(createEgg(true, 3), 40, 1, 3, 1) }, 2, new VillagerTrades.ItemListing[] { new MyrmexTrades.ItemsForJungleResinTrade(createEgg(true, 4), 60, 1, 2, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.EMERALD, 15, 1, 9, 1), new MyrmexTrades.ItemsForDesertResinTrade(Items.DIAMOND, 25, 1, 9, 1) }));
    ...
    static class ItemWithPotionForDesertResinAndItemsTrade implements VillagerTrades.ItemListing {
        ...
        public MerchantOffer getOffer(@NotNull Entity trader, RandomSource rand) {
            ...
            List<Potion> lvt_4_1_ = (List<Potion>) BuiltInRegistries.POTION.m_123024_().filter(potion -> !potion.getEffects().isEmpty() && PotionBrewing.isBrewablePotion(potion)).collect(Collectors.toList());
