...
public class ServerConfig {
    ...
    public ServerConfig(ForgeConfigSpec.Builder builder) {
        ...
        this.dragonBlockBreakingDropChance = buildDouble(builder, "Dragon Block Breaking Drop Chance", "all", 0.1F, 0.0, 1.0, "The percentage chance for a block to drop as an item when a dragon breaks it.");
        builder.pop();
        ...
        this.dragonHealth = buildDouble(builder, "Dragon Health", "all", 500.0, 1.0, 100000.0, "Max dragon health. Health is scaled to this");
        ...
        this.dragonAttackDamageFire = buildDouble(builder, "Dragon Attack Damage(Fire breath)", "all", 2.0, 0.0, 10000.0, "Damage dealt from a successful fire breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
        this.dragonAttackDamageIce = buildDouble(builder, "Dragon Attack Damage(Ice breath)", "all", 2.5, 0.0, 10000.0, "Damage dealt from a successful ice breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
        this.dragonAttackDamageLightning = buildDouble(builder, "Dragon Attack Damage(Lightning breath)", "all", 3.5, 0.0, 10000.0, "Damage dealt from a successful lightning breath attack. Attack Damage is scaled to by age, so a stage 5 dragon will deal 5x as much as this number");
        this.dragonFlightSpeedMod = buildDouble(builder, "Dragon Flight Speed Modifier", "all", 1.0, 0.0, 2.0, "Change this to slow down or speed up dragon or amphithere flight.");
        ...
        this.cyclopsMaxHealth = buildDouble(builder, "Cyclops Max Health", "all", 150.0, 1.0, 10000.0, "Maximum cyclops health");
        ...
        this.cyclopsAttackStrength = buildDouble(builder, "Cyclops Attack Strength", "all", 15.0, 1.0, 10000.0, "Cyclops attack strength");
        this.cyclopsBiteStrength = buildDouble(builder, "Cyclops Bite Strength", "all", 40.0, 1.0, 10000.0, "Amount of damage done with cyclops bite attack.");
        ...
        builder.pop();
        builder.push("Sirens");
        this.sirenMaxHealth = buildDouble(builder, "Siren Max Health", "all", 50.0, 1.0, 10000.0, "Maximum siren health");
        ...
        this.deathWormMaxHealth = buildDouble(builder, "Death Worm Base Health", "all", 10.0, 1.0, 10000.0, "Default deathworm health, this is scaled to the worm's particular size");
        this.deathWormAttackStrength = buildDouble(builder, "Death Worm Base Attack Strength", "all", 3.0, 1.0, 10000.0, "Default deathworm attack strength, this is scaled to the worm's particular size");
        ...
        this.cockatriceMaxHealth = buildDouble(builder, "Cockatrice Health", "all", 40.0, 1.0, 10000.0, "Maximum cockatrice health");
        ...
        this.stymphalianBirdFeatherAttackStength = buildDouble(builder, "Stymphalian Bird Feather Attack Strength", "all", 1.0, 0.0, 10000.0, "Stymphalian bird feather attack strength.");
        ...
        this.trollMaxHealth = buildDouble(builder, "Troll Max Health", "all", 50.0, 1.0, 10000.0, "Maximum troll health");
        this.trollAttackStrength = buildDouble(builder, "Troll Attack Strength", "all", 10.0, 1.0, 10000.0, "Troll attack strength");
        builder.pop();
        builder.push("Myrmex");
        ...
        this.myrmexBaseAttackStrength = buildDouble(builder, "Myrmex Base Attack Strength", "all", 3.0, 1.0, 10000.0, "Base Myrmex(worker) attack strength");
        ...
        this.amphithereFlightSpeed = buildDouble(builder, "Amphithere Flight Speed", "all", 1.75, 0.0, 3.0, "How fast amphitheres fly.");
        this.amphithereMaxHealth = buildDouble(builder, "Amphithere Max Health", "all", 50.0, 1.0, 10000.0, "Maximum amphithere health");
        this.amphithereAttackStrength = buildDouble(builder, "Amphithere Attack Strength", "all", 7.0, 1.0, 10000.0, "Amphithere attack strength");
        builder.pop();
        ...
        this.seaSerpentBaseHealth = buildDouble(builder, "Sea Serpent Base Health", "all", 20.0, 1.0, 10000.0, "Default sea serpent health, this is scaled to the sea serpent's particular size");
        this.seaSerpentAttackStrength = buildDouble(builder, "Sea Serpent Base Attack Strength", "all", 4.0, 1.0, 10000.0, "Default sea serpent attack strength, this is scaled to the sea serpent's particular size");
        builder.pop();
        ...
        this.hippocampusSwimSpeedMod = buildDouble(builder, "Hippocampus Swim Speed Modifier", "all", 1.0, 0.0, 2.0, "Change this to slow down or speed up hippocampus swimming.");
        builder.pop();
        ...
        this.hippogryphFlightSpeedMod = buildDouble(builder, "Hippogryph Flight Speed Modifier", "all", 1.0, 0.0, 2.0, "Change this to slow down or speed up hippogryph flight.");
        builder.pop();
        builder.push("Gorgons");
        this.gorgonMaxHealth = buildDouble(builder, "Gorgon Max Health", "all", 100.0, 1.0, 10000.0, "Maximum gorgon health");
        builder.pop();
        builder.push("Others");
        ...
        this.hydraMaxHealth = buildDouble(builder, "Hydra Max Health", "all", 250.0, 1.0, 10000.0, "Maximum hydra health");
        ...
        this.ghostMaxHealth = buildDouble(builder, "Ghost Max Health", "all", 30.0, 1.0, 10000.0, "Maximum ghost health.");
        this.ghostAttackStrength = buildDouble(builder, "Ghost Attack Strength", "all", 3.0, 0.0, 10000.0, "Maximum ghost attack strength.");
        ...
        builder.pop();
        builder.push("Items");
        this.dragonsteelBaseDamage = buildDouble(builder, "Dragonsteel Sword Base Attack Strength", "all", 25.0, 5.0, 2.147483647E9, "Default attack strength of a dragonsteel sword.");
        ...
        this.dragonsteelBaseArmorToughness = buildDouble(builder, "Dragonsteel Base Armor Toughness", "all", 6.0, 0.0, Double.MAX_VALUE, "Default armor toughness value of dragonsteel.");
        ...
        this.weezerTinkersDisarmChance = buildDouble(builder, "Easter Egg Tinkers Tool Disarm chance", "all", 0.2F, 0.0, 1.0, "Percentage of critical strike that will disarm with easter egg tinkers material.");
