...
public class MausoleumStructure extends IafStructure {
    ...
    protected Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext pContext) {
        if (!IafConfig.generateMausoleums) {
            ...
            return !this.isBiomeValid(pContext, BiomeConfig.mausoleumBiomes, blockpos) ? Optional.empty() : JigsawPlacement.addPieces(pContext, this.startPool, this.startJigsawName, this.size, blockpos, false, this.projectStartToHeightmap, this.maxDistanceFromCenter);
        }
    }
