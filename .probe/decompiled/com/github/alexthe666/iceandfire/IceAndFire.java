...
public class IceAndFire {
    ...
    public IceAndFire() {
        ...
        DeferredRegister<Codec<? extends BiomeModifier>> biomeModifiers = DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, "iceandfire");
    ...
    static {
        ...
        NETWORK_WRAPPER = channel.serverAcceptedVersions(version::equals).networkProtocolVersion(() -> IceAndFire.PROTOCOL_VERSION).simpleChannel();
    }
}