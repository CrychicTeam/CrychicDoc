...
public class IafConfig {
    ...
    public static double dragonHealth = 500.0;

    public static int dragonAttackDamage = 17;

    public static double dragonAttackDamageFire = 2.0;

    public static double dragonAttackDamageIce = 2.5;

    public static double dragonAttackDamageLightning = 3.5;
    ...
    public static double gorgonMaxHealth = 100.0;
    ...
    public static double cyclopsMaxHealth = 150.0;

    public static double cyclopsAttackStrength = 15.0;

    public static double cyclopsBiteStrength = 40.0;

    public static boolean cyclopsGriefing = true;

    public static double sirenMaxHealth = 50.0;
    ...
    public static double deathWormMaxHealth = 10.0;

    public static double deathWormAttackStrength = 3.0;
    ...
    public static double cockatriceMaxHealth = 40.0;
    ...
    public static double stymphalianBirdFeatherAttackStength = 1.0;
    ...
    public static double trollMaxHealth = 50.0;

    public static double trollAttackStrength = 10.0;
    ...
    public static double myrmexBaseAttackStrength = 3.0;
    ...
    public static double amphithereFlightSpeed = 1.75;

    public static double amphithereMaxHealth = 50.0;

    public static double amphithereAttackStrength = 7.0;

    public static int seaSerpentSpawnChance = 250;

    public static boolean seaSerpentGriefing = true;

    public static double seaSerpentBaseHealth = 20.0;

    public static double seaSerpentAttackStrength = 4.0;

    public static double dragonsteelBaseDamage = 25.0;
    ...
    public static double dragonBlockBreakingDropChance = 0.1;

    public static boolean dragonAuto3rdPerson = true;

    public static double dreadQueenMaxHealth = 750.0;
    ...
    public static double hydraMaxHealth = 250.0;
    ...
    public static double dangerousWorldGenDistanceLimit = 1000.0;

    public static double dangerousWorldGenSeparationLimit = 300.0;

    public static double dragonFlightSpeedMod = 1.0;

    public static double hippogryphFlightSpeedMod = 1.0;

    public static double hippocampusSwimSpeedMod = 1.0;

    public static boolean generateGraveyards = true;

    public static double ghostMaxHealth = 30.0;

    public static double ghostAttackStrength = 3.0;
    ...
    public static void bakeServer(ModConfig config) {
        try {
            ...
            amphithereVillagerSearchLength = (float) ConfigHolder.SERVER.amphithereVillagerSearchLength.get().intValue();
            ...
            dangerousWorldGenDistanceLimit = (double) ConfigHolder.SERVER.dangerousWorldGenDistanceLimit.get().intValue();
            dangerousWorldGenSeparationLimit = (double) ConfigHolder.SERVER.dangerousWorldGenSeparationLimit.get().intValue();
