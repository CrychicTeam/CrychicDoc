...
public class IafItemRegistry {
    ...
    public static CustomArmorMaterial SILVER_ARMOR_MATERIAL = new IafArmorMaterial("silver", 15, new int[] { 1, 4, 5, 2 }, 20, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F);

    public static CustomArmorMaterial COPPER_ARMOR_MATERIAL = new IafArmorMaterial("copper", 10, new int[] { 1, 3, 4, 2 }, 15, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F);

    public static CustomArmorMaterial BLINDFOLD_ARMOR_MATERIAL = new IafArmorMaterial("blindfold", 5, new int[] { 1, 1, 1, 1 }, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F);

    public static CustomArmorMaterial SHEEP_ARMOR_MATERIAL = new IafArmorMaterial("sheep", 5, new int[] { 1, 3, 2, 1 }, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F);

    public static CustomArmorMaterial MYRMEX_DESERT_ARMOR_MATERIAL = new IafArmorMaterial("myrmexdesert", 20, new int[] { 3, 5, 8, 4 }, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F);

    public static CustomArmorMaterial MYRMEX_JUNGLE_ARMOR_MATERIAL = new IafArmorMaterial("myrmexjungle", 20, new int[] { 3, 5, 8, 4 }, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F);

    public static CustomArmorMaterial EARPLUGS_ARMOR_MATERIAL = new IafArmorMaterial("earplugs", 5, new int[] { 1, 1, 1, 1 }, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F);
    ...
    public static CustomArmorMaterial TROLL_MOUNTAIN_ARMOR_MATERIAL = new IafArmorMaterial("mountain troll", 20, new int[] { 2, 5, 7, 3 }, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F);

    public static CustomArmorMaterial TROLL_FOREST_ARMOR_MATERIAL = new IafArmorMaterial("forest troll", 20, new int[] { 2, 5, 7, 3 }, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F);

    public static CustomArmorMaterial TROLL_FROST_ARMOR_MATERIAL = new IafArmorMaterial("frost troll", 20, new int[] { 2, 5, 7, 3 }, 10, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F);

    public static CustomArmorMaterial DRAGONSTEEL_FIRE_ARMOR_MATERIAL = new DragonsteelArmorMaterial("dragonsteel_fire", (int) (0.02 * (double) IafConfig.dragonsteelBaseDurabilityEquipment), new int[] { IafConfig.dragonsteelBaseArmor - 6, IafConfig.dragonsteelBaseArmor - 3, IafConfig.dragonsteelBaseArmor, IafConfig.dragonsteelBaseArmor - 5 }, 30, SoundEvents.ARMOR_EQUIP_DIAMOND, IafConfig.dragonsteelBaseArmorToughness);

    public static CustomArmorMaterial DRAGONSTEEL_ICE_ARMOR_MATERIAL = new DragonsteelArmorMaterial("dragonsteel_ice", (int) (0.02 * (double) IafConfig.dragonsteelBaseDurabilityEquipment), new int[] { IafConfig.dragonsteelBaseArmor - 6, IafConfig.dragonsteelBaseArmor - 3, IafConfig.dragonsteelBaseArmor, IafConfig.dragonsteelBaseArmor - 5 }, 30, SoundEvents.ARMOR_EQUIP_DIAMOND, IafConfig.dragonsteelBaseArmorToughness);

    public static CustomArmorMaterial DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL = new DragonsteelArmorMaterial("dragonsteel_lightning", (int) (0.02 * (double) IafConfig.dragonsteelBaseDurabilityEquipment), new int[] { IafConfig.dragonsteelBaseArmor - 6, IafConfig.dragonsteelBaseArmor - 3, IafConfig.dragonsteelBaseArmor, IafConfig.dragonsteelBaseArmor - 5 }, 30, SoundEvents.ARMOR_EQUIP_DIAMOND, IafConfig.dragonsteelBaseArmorToughness);
    ...
    public static CustomToolMaterial FIRE_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("FireDragonbone", 3, 2000, 5.5F, 10.0F, 22);

    public static CustomToolMaterial ICE_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("IceDragonbone", 3, 2000, 5.5F, 10.0F, 22);

    public static CustomToolMaterial LIGHTNING_DRAGONBONE_TOOL_MATERIAL = new CustomToolMaterial("LightningDragonbone", 3, 2000, 5.5F, 10.0F, 22);

    public static CustomToolMaterial TROLL_WEAPON_TOOL_MATERIAL = new CustomToolMaterial("trollWeapon", 2, 300, 1.0F, 10.0F, 1);

    public static CustomToolMaterial MYRMEX_CHITIN_TOOL_MATERIAL = new CustomToolMaterial("MyrmexChitin", 3, 600, 1.0F, 6.0F, 8);

    public static CustomToolMaterial HIPPOGRYPH_SWORD_TOOL_MATERIAL = new CustomToolMaterial("HippogryphSword", 2, 500, 2.5F, 10.0F, 10);

    public static CustomToolMaterial STYMHALIAN_SWORD_TOOL_MATERIAL = new CustomToolMaterial("StymphalianSword", 2, 500, 2.0F, 10.0F, 10);

    public static CustomToolMaterial AMPHITHERE_SWORD_TOOL_MATERIAL = new CustomToolMaterial("AmphithereSword", 2, 500, 1.0F, 10.0F, 10);

    public static CustomToolMaterial HIPPOCAMPUS_SWORD_TOOL_MATERIAL = new CustomToolMaterial("HippocampusSword", 0, 500, -2.0F, 0.0F, 50);

    public static CustomToolMaterial DREAD_SWORD_TOOL_MATERIAL = new CustomToolMaterial("DreadSword", 0, 100, 1.0F, 10.0F, 0);

    public static CustomToolMaterial DREAD_KNIGHT_TOOL_MATERIAL = new CustomToolMaterial("DreadKnightSword", 0, 1200, 13.0F, 0.0F, 10);

    public static CustomToolMaterial GHOST_SWORD_TOOL_MATERIAL = new CustomToolMaterial("GhostSword", 2, 3000, 5.0F, 10.0F, 25);

    public static DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, "iceandfire");
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SWORD = registerItem("dragonsteel_fire_sword", () -> new ItemModSword(DragonSteelTier.DRAGONSTEEL_TIER_FIRE));

    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_PICKAXE = registerItem("dragonsteel_fire_pickaxe", () -> new ItemModPickaxe(DragonSteelTier.DRAGONSTEEL_TIER_FIRE));

    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_AXE = registerItem("dragonsteel_fire_axe", () -> new ItemModAxe(DragonSteelTier.DRAGONSTEEL_TIER_FIRE));

    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SHOVEL = registerItem("dragonsteel_fire_shovel", () -> new ItemModShovel(DragonSteelTier.DRAGONSTEEL_TIER_FIRE));

    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_HOE = registerItem("dragonsteel_fire_hoe", () -> new ItemModHoe(DragonSteelTier.DRAGONSTEEL_TIER_FIRE));
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SWORD = registerItem("dragonsteel_ice_sword", () -> new ItemModSword(DragonSteelTier.DRAGONSTEEL_TIER_ICE));

    public static final RegistryObject<Item> DRAGONSTEEL_ICE_PICKAXE = registerItem("dragonsteel_ice_pickaxe", () -> new ItemModPickaxe(DragonSteelTier.DRAGONSTEEL_TIER_ICE));

    public static final RegistryObject<Item> DRAGONSTEEL_ICE_AXE = registerItem("dragonsteel_ice_axe", () -> new ItemModAxe(DragonSteelTier.DRAGONSTEEL_TIER_ICE));

    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SHOVEL = registerItem("dragonsteel_ice_shovel", () -> new ItemModShovel(DragonSteelTier.DRAGONSTEEL_TIER_ICE));

    public static final RegistryObject<Item> DRAGONSTEEL_ICE_HOE = registerItem("dragonsteel_ice_hoe", () -> new ItemModHoe(DragonSteelTier.DRAGONSTEEL_TIER_ICE));
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_SWORD = registerItem("dragonsteel_lightning_sword", () -> new ItemModSword(DragonSteelTier.DRAGONSTEEL_TIER_LIGHTNING));

    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_PICKAXE = registerItem("dragonsteel_lightning_pickaxe", () -> new ItemModPickaxe(DragonSteelTier.DRAGONSTEEL_TIER_LIGHTNING));

    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_AXE = registerItem("dragonsteel_lightning_axe", () -> new ItemModAxe(DragonSteelTier.DRAGONSTEEL_TIER_LIGHTNING));

    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_SHOVEL = registerItem("dragonsteel_lightning_shovel", () -> new ItemModShovel(DragonSteelTier.DRAGONSTEEL_TIER_LIGHTNING));

    public static final RegistryObject<Item> DRAGONSTEEL_LIGHTNING_HOE = registerItem("dragonsteel_lightning_hoe", () -> new ItemModHoe(DragonSteelTier.DRAGONSTEEL_TIER_LIGHTNING));
    ...
    public static final RegistryObject<Item> DREAD_QUEEN_SWORD = registerItem("dread_queen_sword", () -> new ItemModSword(DragonSteelTier.DRAGONSTEEL_TIER_DREAD_QUEEN));
    ...
    public static void registerItems(NewRegistryEvent event) {
        registerItem("spawn_egg_fire_dragon", () -> new ForgeSpawnEggItem(IafEntityRegistry.FIRE_DRAGON, 3407872, 10823977, new Item.Properties()));
        registerItem("spawn_egg_ice_dragon", () -> new ForgeSpawnEggItem(IafEntityRegistry.ICE_DRAGON, 11918843, 8305392, new Item.Properties()));
        registerItem("spawn_egg_lightning_dragon", () -> new ForgeSpawnEggItem(IafEntityRegistry.LIGHTNING_DRAGON, 4334439, 7493265, new Item.Properties()));
        registerItem("spawn_egg_hippogryph", () -> new ForgeSpawnEggItem(IafEntityRegistry.HIPPOGRYPH, 14211288, 13743453, new Item.Properties()));
        registerItem("spawn_egg_gorgon", () -> new ForgeSpawnEggItem(IafEntityRegistry.GORGON, 13687199, 6833456, new Item.Properties()));
        registerItem("spawn_egg_pixie", () -> new ForgeSpawnEggItem(IafEntityRegistry.PIXIE, 16744329, 14863586, new Item.Properties()));
        registerItem("spawn_egg_cyclops", () -> new ForgeSpawnEggItem(IafEntityRegistry.CYCLOPS, 11567726, 3809039, new Item.Properties()));
        registerItem("spawn_egg_siren", () -> new ForgeSpawnEggItem(IafEntityRegistry.SIREN, 9365194, 15917000, new Item.Properties()));
        registerItem("spawn_egg_hippocampus", () -> new ForgeSpawnEggItem(IafEntityRegistry.HIPPOCAMPUS, 4493767, 5227883, new Item.Properties()));
        registerItem("spawn_egg_death_worm", () -> new ForgeSpawnEggItem(IafEntityRegistry.DEATH_WORM, 13749667, 4340282, new Item.Properties()));
        registerItem("spawn_egg_cockatrice", () -> new ForgeSpawnEggItem(IafEntityRegistry.COCKATRICE, 9392133, 5200419, new Item.Properties()));
        registerItem("spawn_egg_stymphalian_bird", () -> new ForgeSpawnEggItem(IafEntityRegistry.STYMPHALIAN_BIRD, 7622455, 10382411, new Item.Properties()));
        registerItem("spawn_egg_troll", () -> new ForgeSpawnEggItem(IafEntityRegistry.TROLL, 4014397, 5784378, new Item.Properties()));
        registerItem("spawn_egg_myrmex_worker", () -> new ForgeSpawnEggItem(IafEntityRegistry.MYRMEX_WORKER, 10575910, 5850400, new Item.Properties()));
        registerItem("spawn_egg_myrmex_soldier", () -> new ForgeSpawnEggItem(IafEntityRegistry.MYRMEX_SOLDIER, 10575910, 8217133, new Item.Properties()));
        registerItem("spawn_egg_myrmex_sentinel", () -> new ForgeSpawnEggItem(IafEntityRegistry.MYRMEX_SENTINEL, 10575910, 10649402, new Item.Properties()));
        registerItem("spawn_egg_myrmex_royal", () -> new ForgeSpawnEggItem(IafEntityRegistry.MYRMEX_ROYAL, 10575910, 13081416, new Item.Properties()));
        registerItem("spawn_egg_myrmex_queen", () -> new ForgeSpawnEggItem(IafEntityRegistry.MYRMEX_QUEEN, 10575910, 15513685, new Item.Properties()));
        registerItem("spawn_egg_amphithere", () -> new ForgeSpawnEggItem(IafEntityRegistry.AMPHITHERE, 5862709, 43672, new Item.Properties()));
        registerItem("spawn_egg_sea_serpent", () -> new ForgeSpawnEggItem(IafEntityRegistry.SEA_SERPENT, 33433, 12969703, new Item.Properties()));
        registerItem("spawn_egg_dread_thrall", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_THRALL, 14739174, 65535, new Item.Properties()));
        registerItem("spawn_egg_dread_ghoul", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_GHOUL, 14739174, 8094602, new Item.Properties()));
        registerItem("spawn_egg_dread_beast", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_BEAST, 14739174, 3684156, new Item.Properties()));
        registerItem("spawn_egg_dread_scuttler", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_SCUTTLER, 14739174, 5068391, new Item.Properties()));
        registerItem("spawn_egg_lich", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_LICH, 14739174, 2574432, new Item.Properties()));
        registerItem("spawn_egg_dread_knight", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_KNIGHT, 14739174, 4877422, new Item.Properties()));
        registerItem("spawn_egg_dread_horse", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_HORSE, 14739174, 11316396, new Item.Properties()));
        registerItem("spawn_egg_hydra", () -> new ForgeSpawnEggItem(IafEntityRegistry.HYDRA, 9145208, 3028779, new Item.Properties()));
        registerItem("spawn_egg_ghost", () -> new ForgeSpawnEggItem(IafEntityRegistry.GHOST, 12185016, 7582326, new Item.Properties()));
    }
    ...
    public static void setRepairMaterials(RegisterEvent event) {
        if (event.getRegistryKey() == Registries.ITEM) {
            BLINDFOLD_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(Tags.Items.STRING));
            SILVER_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(IafItemTags.INGOTS_SILVER));
            SILVER_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(IafItemTags.INGOTS_SILVER));
            DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DRAGON_BONE.get()));
            FIRE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DRAGON_BONE.get()));
            ICE_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DRAGON_BONE.get()));
            LIGHTNING_DRAGONBONE_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DRAGON_BONE.get()));
            for (EnumDragonArmor armor : EnumDragonArmor.values()) {
                armor.armorMaterial.setRepairMaterial(Ingredient.of(EnumDragonArmor.getScaleItem(armor)));
            }
            DRAGONSTEEL_FIRE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DRAGONSTEEL_FIRE_INGOT.get()));
            DRAGONSTEEL_ICE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DRAGONSTEEL_ICE_INGOT.get()));
            DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DRAGONSTEEL_LIGHTNING_INGOT.get()));
            SHEEP_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(Blocks.WHITE_WOOL));
            EARPLUGS_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(Blocks.OAK_BUTTON));
            DEATHWORM_0_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DEATH_WORM_CHITIN_YELLOW.get()));
            DEATHWORM_1_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DEATH_WORM_CHITIN_RED.get()));
            DEATHWORM_2_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(DEATH_WORM_CHITIN_WHITE.get()));
            TROLL_WEAPON_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(Tags.Items.STONE));
            TROLL_MOUNTAIN_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of((ItemLike) EnumTroll.MOUNTAIN.leather.get()));
            TROLL_FOREST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of((ItemLike) EnumTroll.FOREST.leather.get()));
            TROLL_FROST_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of((ItemLike) EnumTroll.FROST.leather.get()));
            HIPPOGRYPH_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(HIPPOGRYPH_TALON.get()));
            HIPPOCAMPUS_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(SHINY_SCALES.get()));
            AMPHITHERE_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(AMPHITHERE_FEATHER.get()));
            STYMHALIAN_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(STYMPHALIAN_BIRD_FEATHER.get()));
            MYRMEX_CHITIN_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(MYRMEX_DESERT_CHITIN.get()));
            MYRMEX_DESERT_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(MYRMEX_DESERT_CHITIN.get()));
            MYRMEX_JUNGLE_ARMOR_MATERIAL.setRepairMaterial(Ingredient.of(MYRMEX_JUNGLE_CHITIN.get()));
            DREAD_SWORD_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DREAD_SHARD.get()));
            DREAD_KNIGHT_TOOL_MATERIAL.setRepairMaterial(Ingredient.of(DREAD_SHARD.get()));
