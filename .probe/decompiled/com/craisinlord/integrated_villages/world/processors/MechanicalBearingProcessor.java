...
public class MechanicalBearingProcessor extends StructureProcessor {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader worldView, BlockPos pos, BlockPos blockPos, StructureTemplate.StructureBlockInfo structureBlockInfoLocal, StructureTemplate.StructureBlockInfo structureBlockInfoWorld, StructurePlaceSettings structurePlacementData) {
        if (structureBlockInfoWorld.state().m_60734_().getDescriptionId().equals("block.create.mechanical_bearing") && IntegratedVillages.CONFIG.general.activateCreateContraptions) {
    ...
    protected StructureProcessorType<?> getType() {
        return IntegratedVilagesProcessors.MECHANICAL_BEARING_PROCESSOR.get();
    }
}