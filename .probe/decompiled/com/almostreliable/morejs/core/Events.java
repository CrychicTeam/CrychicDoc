...
public interface Events {
    ...
    EventHandler ENCHANTMENT_TABLE_ENCHANT = GROUP.server("enchantmentTableEnchant", () -> PlayerEnchantEventJS.class).hasResult();
    ...
    EventHandler POTION_BREWING_REGISTER = GROUP.startup("registerPotionBrewing", () -> PotionBrewingRegisterEvent.class);
}