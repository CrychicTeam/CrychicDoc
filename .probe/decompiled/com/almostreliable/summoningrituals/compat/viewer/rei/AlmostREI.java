...
public class AlmostREI implements REIClientPlugin {
    ...
    public String getPluginProviderName() {
        return "Summoning Rituals".replace(" ", "");
    }
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(AltarCategoryREI.ID, new EntryStack[] { EntryStacks.of(Registration.ALTAR_ITEM.get()) });
        registry.addWorkstations(AltarCategoryREI.ID, new EntryStack[] { EntryStacks.of(Registration.INDESTRUCTIBLE_ALTAR_ITEM.get()) });
    }

    public void registerDisplays(DisplayRegistry registry) {
        registry.registerRecipeFiller(AltarRecipe.class, Registration.ALTAR_RECIPE.type().get(), AltarCategoryREI.AltarDisplay::new);
    }
}