...
public class PlaneCollider extends Collider {
    ...
    public boolean isCollide(Entity entity) {
        ...
        Vec3 pos = new Vec3(planeNorm.x >= 0.0 ? opponent.maxX : opponent.minX, planeNorm.y >= 0.0 ? opponent.maxY : opponent.minY, planeNorm.z >= 0.0 ? opponent.maxZ : opponent.minZ);
        Vec3 neg = new Vec3(planeNorm.x >= 0.0 ? opponent.minX : opponent.maxX, planeNorm.y >= 0.0 ? opponent.minY : opponent.maxY, planeNorm.z >= 0.0 ? opponent.minZ : opponent.maxZ);
