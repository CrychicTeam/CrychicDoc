...
public class JointMaskEntry {
    ...
    public static final List<JointMask> BIPED_UPPER_JOINTS_WITH_ROOT = new ArrayList(Arrays.asList(JointMask.of("Root", JointMask.KEEP_CHILD_LOCROT), JointMask.of("Torso"), JointMask.of("Chest"), JointMask.of("Head"), JointMask.of("Shoulder_R"), JointMask.of("Arm_R"), JointMask.of("Hand_R"), JointMask.of("Elbow_R"), JointMask.of("Tool_R"), JointMask.of("Shoulder_L"), JointMask.of("Arm_L"), JointMask.of("Hand_L"), JointMask.of("Elbow_L"), JointMask.of("Tool_L")));

    public static final List<JointMask> BIPED_LOWER_JOINTS_WITH_ROOT = new ArrayList(Arrays.asList(JointMask.of("Root", JointMask.KEEP_CHILD_LOCROT), JointMask.of("Thigh_R"), JointMask.of("Leg_R"), JointMask.of("Knee_R"), JointMask.of("Thigh_L"), JointMask.of("Leg_L"), JointMask.of("Knee_L"), JointMask.of("Torso"), JointMask.of("Head")));
    ...
    public static final List<JointMask> BIPED_RIGHT_ARMS = new ArrayList(Arrays.asList(JointMask.of("Shoulder_R"), JointMask.of("Arm_R"), JointMask.of("Hand_R"), JointMask.of("Elbow_R"), JointMask.of("Tool_R")));

    public static final List<JointMask> BIPED_BODY_AND_RIGHT_ARMS = new ArrayList(Arrays.asList(JointMask.of("Shoulder_R"), JointMask.of("Arm_R"), JointMask.of("Hand_R"), JointMask.of("Elbow_R"), JointMask.of("Tool_R"), JointMask.of("Head"), JointMask.of("Chest")));

    public static final List<JointMask> BIPED_LEFT_ARMS = new ArrayList(Arrays.asList(JointMask.of("Shoulder_L"), JointMask.of("Arm_L"), JointMask.of("Hand_L"), JointMask.of("Elbow_L"), JointMask.of("Tool_L")));

    public static final List<JointMask> BIPED_BODY_AND_LEFT_ARMS = new ArrayList(Arrays.asList(JointMask.of("Shoulder_L"), JointMask.of("Arm_L"), JointMask.of("Hand_L"), JointMask.of("Elbow_L"), JointMask.of("Tool_L"), JointMask.of("Head"), JointMask.of("Chest")));

    public static final List<JointMask> WINGS = new ArrayList(Arrays.asList(JointMask.of("Wing_L"), JointMask.of("Wing_R")));

    public static final List<JointMask> ALL = new ArrayList(Arrays.asList(JointMask.of("Root"), JointMask.of("Thigh_R"), JointMask.of("Leg_R"), JointMask.of("Knee_R"), JointMask.of("Thigh_L"), JointMask.of("Leg_L"), JointMask.of("Knee_L"), JointMask.of("Torso"), JointMask.of("Chest"), JointMask.of("Head"), JointMask.of("Shoulder_R"), JointMask.of("Arm_R"), JointMask.of("Hand_R"), JointMask.of("Elbow_R"), JointMask.of("Tool_R"), JointMask.of("Shoulder_L"), JointMask.of("Arm_L"), JointMask.of("Hand_L"), JointMask.of("Elbow_L"), JointMask.of("Tool_L")));
    ...
    public JointMaskEntry(List<JointMask> defaultMask, List<Pair<LivingMotion, List<JointMask>>> masks) {
        ...
        for (Pair<LivingMotion, List<JointMask>> mask : masks) {
            this.masks.put((LivingMotion) mask.getLeft(), (List) mask.getRight());
        }
    }

    public List<JointMask> getMask(LivingMotion livingmotion) {
        return (List<JointMask>) this.masks.getOrDefault(livingmotion, this.defaultMask);
    }

    public boolean isMasked(LivingMotion livingmotion, String jointName) {
        for (JointMask mask : (List) this.masks.getOrDefault(livingmotion, this.defaultMask)) {
