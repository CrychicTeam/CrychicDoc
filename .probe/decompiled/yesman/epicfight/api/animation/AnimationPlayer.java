...
public class AnimationPlayer {
    ...
    public void tick(LivingEntityPatch<?> entitypatch) {
        ...
        this.elapsedTime = this.elapsedTime + 0.05F * playbackSpeed * (this.isReversed() && this.getAnimation().canBePlayedReverse() ? -1.0F : 1.0F);
        ...
        if (this.elapsedTime >= this.play.getTotalTime()) {
            if (this.play.isRepeat()) {
                ...
                this.elapsedTime = this.elapsedTime % this.play.getTotalTime();
            } else {
