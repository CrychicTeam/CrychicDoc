...
public class EnderDragonActionAnimation extends ActionAnimation implements ProceduralAnimation {
    ...
    public void loadAnimation(ResourceManager resourceManager) {
        ...
        this.setIKInfo(this.ikInfos, this.getTransfroms(), this.tipPointTransforms, this.getArmature(), (Boolean) this.getProperty(AnimationProperty.ActionAnimationProperty.MOVE_VERTICAL).orElse(false), true);
        this.onLoaded();
    }
    ...
    public void begin(LivingEntityPatch<?> entitypatch) {
        ...
        if (entitypatch instanceof EnderDragonPatch enderdragonpatch) {
            ...
            for (IKInfo ikInfo : this.ikInfos) {
                TransformSheet tipAnim = this.getFirstPart((TransformSheet) this.tipPointTransforms.get(ikInfo.endJoint.getName()));
                ...
                if (ikInfo.clipAnimation) {
                    ...
                    if (startTime <= elapsedTime && elapsedTime < endTime) {
                        ...
                        if (tipAnim.isOnWorking()) {
                            ...
                            this.startPartAnimation(ikInfo, tipAnim, this.clipAnimation((TransformSheet) this.tipPointTransforms.get(ikInfo.endJoint.getName()), ikInfo), finalTargetpos);
                        }
                    }
                }
            }
