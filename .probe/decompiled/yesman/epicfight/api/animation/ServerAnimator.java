...
public class ServerAnimator extends Animator {
    ...
    public void tick() {
        if (this.pause) {
            ...
            if (this.animationPlayer.isEnd()) {
                DynamicAnimation nextAnimation = (DynamicAnimation) (this.nextPlaying == null ? Animations.DUMMY_ANIMATION : this.nextPlaying);
    ...
    public <T> Pair<AnimationPlayer, T> findFor(Class<T> animationType) {
        return animationType.isAssignableFrom(this.animationPlayer.getAnimation().getClass()) ? Pair.of(this.animationPlayer, this.animationPlayer.getAnimation()) : null;
    }
