...
public class ValueModifier {
    ...
    public void merge(ValueModifier valueCorrector) {
        this.adders = this.adders + valueCorrector.adders;
        this.multipliers = this.multipliers * valueCorrector.multipliers;
        this.setters = this.setters + valueCorrector.setters;
    }
    ...
    public String toString() {
        return this.setters == 0.0F ? String.format("%.0f%%", this.multipliers * 100.0F) + (this.adders == 0.0F ? "" : String.format(" + %.1f", this.adders)) : String.format("%.0f", this.setters);
    }
