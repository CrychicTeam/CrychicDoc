...
public class EpicFightMod {
    ...
    public static final Logger LOGGER = LogManager.getLogger("epicfight");
    ...
    public EpicFightMod() {
        instance = this;
        ModLoadingContext.get().registerConfig(Type.CLIENT, ConfigManager.CLIENT_CONFIG);
        ...
        LivingMotion.ENUM_MANAGER.registerEnumCls("epicfight", LivingMotions.class);
        SkillCategory.ENUM_MANAGER.registerEnumCls("epicfight", SkillCategories.class);
        SkillSlot.ENUM_MANAGER.registerEnumCls("epicfight", SkillSlots.class);
        Style.ENUM_MANAGER.registerEnumCls("epicfight", CapabilityItem.Styles.class);
        WeaponCategory.ENUM_MANAGER.registerEnumCls("epicfight", CapabilityItem.WeaponCategories.class);
        ...
        ConfigManager.loadConfig(ConfigManager.COMMON_CONFIG, FMLPaths.CONFIGDIR.get().resolve("epicfight.toml").toString());
    ...
    private void newRegistry(NewRegistryEvent event) {
        RegistryBuilder<StaticAnimation> registryBuilder = RegistryBuilder.of("epicfightanimation");
    ...
    public static Animator getAnimator(LivingEntityPatch<?> entitypatch) {
        return (Animator) getInstance().animatorProvider.apply(entitypatch);
    }
