...
public class EverlastingAllegiance extends WeaponInnateSkill {
    ...
    private AnimationProvider callingAnimation = () -> Animations.EVERLASTING_ALLEGIANCE_CALL;
    ...
    public void executeOnServer(ServerPlayerPatch executer, FriendlyByteBuf args) {
        ...
        if (executer.getOriginal().m_9236_().getEntity(executer.getSkill(this).getDataManager().getDataValue(SkillDataKeys.THROWN_TRIDENT_ENTITY_ID.get())) instanceof ThrownTrident trident) {
    ...
    public List<Component> getTooltipOnItem(ItemStack itemStack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        this.generateTooltipforPhase(list, itemStack, cap, playerCap, (Map<AnimationProperty.AttackPhaseProperty<?>, Object>) this.properties.get(0), "Returning Trident:");
        return list;
    }
