...
public class WrathfulLightingSkill extends SimpleWeaponInnateSkill {
    ...
    public List<Component> getTooltipOnItem(ItemStack itemStack, CapabilityItem itemCap, PlayerPatch<?> playerpatch) {
        ...
        this.generateTooltipforPhase(list, itemStack, itemCap, playerpatch, (Map<AnimationProperty.AttackPhaseProperty<?>, Object>) this.properties.get(1), "Thunder:");
        return list;
    }
    ...
    public WeaponInnateSkill registerPropertiesToAnimation() {
        ...
        for (AttackAnimation.Phase phase : anim.phases) {
            ...
            phase.addProperties(((Map) this.properties.get(1)).entrySet());
        }
        return this;
    }
}