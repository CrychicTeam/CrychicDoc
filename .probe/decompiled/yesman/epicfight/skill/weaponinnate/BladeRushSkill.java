...
public class BladeRushSkill extends WeaponInnateSkill {
    ...
    public static BladeRushSkill.Builder createBladeRushBuilder() {
        return new BladeRushSkill.Builder().setCategory(SkillCategories.WEAPON_INNATE).setResource(Skill.Resource.WEAPON_INNATE_ENERGY).putTryAnimation(EntityType.ZOMBIE, Animations.BLADE_RUSH_TRY).putTryAnimation(EntityType.HUSK, Animations.BLADE_RUSH_TRY).putTryAnimation(EntityType.DROWNED, Animations.BLADE_RUSH_TRY).putTryAnimation(EntityType.SKELETON, Animations.BLADE_RUSH_TRY).putTryAnimation(EntityType.STRAY, Animations.BLADE_RUSH_TRY).putTryAnimation(EntityType.CREEPER, Animations.BLADE_RUSH_TRY);
    }
    ...
    public void onInitiate(SkillContainer container) {
        ...
        container.getExecuter().getEventListener().addEventListener(PlayerEventListener.EventType.DEALT_DAMAGE_EVENT_POST, EVENT_UUID, event -> {
            if (event.getDamageSource().getAnimation().between(Animations.BLADE_RUSH_COMBO1, Animations.BLADE_RUSH_COMBO3) && event.getTarget().isAlive() && this.tryAnimations.containsKey(event.getTarget().m_6095_())) {
    ...
    public List<Component> getTooltipOnItem(ItemStack itemStack, CapabilityItem cap, PlayerPatch<?> playerCap) {
        ...
        this.generateTooltipforPhase(list, itemStack, cap, playerCap, (Map<AnimationProperty.AttackPhaseProperty<?>, Object>) this.properties.get(1), "Execution:");
        return list;
    }
    ...
    public static class Builder extends Skill.Builder<BladeRushSkill> {
        ...
        public BladeRushSkill.Builder putTryAnimation(EntityType<?> entityType, StaticAnimation tryAnimation) {
            this.tryAnimations.put(entityType, tryAnimation);
            return this;
        }

        public BladeRushSkill.Builder setCategory(SkillCategory category) {
            this.category = category;
            return this;
        }

        public BladeRushSkill.Builder setActivateType(Skill.ActivateType activateType) {
            this.activateType = activateType;
            return this;
        }

        public BladeRushSkill.Builder setResource(Skill.Resource resource) {
            this.resource = resource;
            return this;
        }

        public BladeRushSkill.Builder setCreativeTab(CreativeModeTab tab) {
            this.tab = tab;
            return this;
        }
    }
