...
public class DodgeSkill extends Skill {
    ...
    public List<Object> getTooltipArgsOfScreen(List<Object> list) {
        list.add(ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format((double) this.consumption));
        return list;
    }
    ...
    public boolean isExecutableState(PlayerPatch<?> executer) {
        ...
        return !executer.isUnstable() && playerState.canUseSkill() && !executer.getOriginal().m_20069_() && !executer.getOriginal().m_6147_() && executer.getOriginal().m_20202_() == null;
    }
    ...
    public static class Builder extends Skill.Builder<DodgeSkill> {
        ...
        public DodgeSkill.Builder setCategory(SkillCategory category) {
            this.category = category;
            return this;
        }

        public DodgeSkill.Builder setActivateType(Skill.ActivateType activateType) {
            this.activateType = activateType;
            return this;
        }

        public DodgeSkill.Builder setResource(Skill.Resource resource) {
            this.resource = resource;
            return this;
        }

        public DodgeSkill.Builder setCreativeTab(CreativeModeTab tab) {
            this.tab = tab;
            return this;
        }

        public DodgeSkill.Builder setAnimations(ResourceLocation... animations) {
