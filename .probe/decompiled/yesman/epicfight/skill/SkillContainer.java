...
public class SkillContainer {
    ...
    public boolean setSkill(Skill skill, boolean initialize) {
        if (this.containingSkill == skill && !initialize) {
            return false;
        } else if (skill != null && skill.category != this.slot.category()) {
            return false;
        } else {
            ...
            if (skill != null) {
                ...
                Set<SkillDataKey<?>> datakeys = (Set<SkillDataKey<?>>) SkillDataKey.getSkillDataKeyMap().get(skill.getClass());
                if (datakeys != null) {
    ...
    public boolean canExecute(PlayerPatch<?> executer, SkillExecuteEvent event) {
        if (this.containingSkill == null) {
            return false;
        } else if (!executer.isChargingSkill(this.containingSkill) || !(this.containingSkill instanceof ChargeableSkill chargingSkill)) {
            ...
            return executer.isLogicalClient() ? true : executer.getSkillChargingTicks() >= chargingSkill.getMinChargingTicks();
        }
    }
    ...
    public boolean equals(Object object) {
        return object instanceof SkillContainer skillContainer ? this.slot.equals(skillContainer.slot) : false;
    }
}