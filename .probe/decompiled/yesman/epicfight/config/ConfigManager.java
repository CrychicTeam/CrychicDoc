...
public class ConfigManager {
    ...
    static {
        CommentedFileConfig file = (CommentedFileConfig) CommentedFileConfig.builder(new File(FMLPaths.CONFIGDIR.get().resolve("epicfight.toml").toString())).sync().autosave().writingMode(WritingMode.REPLACE).build();
        file.load();
