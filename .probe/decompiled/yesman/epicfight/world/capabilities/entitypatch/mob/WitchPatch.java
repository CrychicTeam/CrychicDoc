...
public class WitchPatch extends HumanoidMobPatch<Witch> {
    ...
    public void setAIAsInfantry(boolean holdingRanedWeapon) {
        this.original.f_21345_.addGoal(0, new AnimatedAttackGoal<>(this, MobCombatBehaviors.WITCH.build(this)));
        this.original.f_21345_.addGoal(1, new TargetChasingGoal(this, this.getOriginal(), 1.0, true, 10.0));
    }
    ...
    public OpenMatrix4f getHeadMatrix(float partialTicks) {
        return this.original.isDrinkingPotion() ? new OpenMatrix4f() : super.getHeadMatrix(partialTicks);
    }
}