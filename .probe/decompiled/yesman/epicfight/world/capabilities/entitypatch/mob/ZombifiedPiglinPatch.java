...
public class ZombifiedPiglinPatch extends HumanoidMobPatch<ZombifiedPiglin> {
    ...
    public void setAIAsInfantry(boolean holdingRanedWeapon) {
        ...
        if (builder != null) {
            this.original.f_21345_.addGoal(1, new AnimatedAttackGoal<>(this, builder.build(this)));
            this.original.f_21345_.addGoal(1, new TargetChasingGoal(this, this.getOriginal(), 1.2, true));
        }
    }

    @Override
    public AttackResult tryHurt(DamageSource damageSource, float amount) {
        return damageSource.getEntity() instanceof ZombifiedPiglin ? AttackResult.blocked(amount) : super.tryHurt(damageSource, amount);
    }
}