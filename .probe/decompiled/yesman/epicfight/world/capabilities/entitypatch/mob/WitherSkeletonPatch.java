...
public class WitherSkeletonPatch<T extends PathfinderMob> extends SkeletonPatch<T> {
    ...
    protected void initAttributes() {
        ...
        this.original.m_21051_(EpicFightAttributes.STUN_ARMOR.get()).setBaseValue(6.0);
    }

    @Override
    protected void setWeaponMotions() {
        super.setWeaponMotions();
        this.weaponLivingMotions.put(CapabilityItem.WeaponCategories.SWORD, ImmutableMap.of(CapabilityItem.Styles.ONE_HAND, Set.of(Pair.of(LivingMotions.CHASE, Animations.WITHER_SKELETON_CHASE), Pair.of(LivingMotions.WALK, Animations.WITHER_SKELETON_WALK), Pair.of(LivingMotions.IDLE, Animations.WITHER_SKELETON_IDLE))));
