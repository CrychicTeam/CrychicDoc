...
public class PiglinPatch extends HumanoidMobPatch<Piglin> {
    ...
    public void initAnimator(ClientAnimator clientAnimator) {
        ...
        clientAnimator.addLivingAnimation(LivingMotions.CELEBRATE, EpicFightMod.getInstance().animationManager.findAnimationById("epicfight".hashCode(), Animations.PIGLIN_CELEBRATE1.getId() + this.original.m_217043_().nextInt(3)));
    ...
    public void updateMotion(boolean considerInaction) {
        if (this.getOriginal().m_21206_().is(ItemTags.PIGLIN_LOVED)) {
    ...
    public void setAIAsInfantry(boolean holdingRanedWeapon) {
        ...
        BrainRecomposer.replaceBehavior(this.original.getBrain(), Activity.FIGHT, 11, OneShot.class, BehaviorBuilder.triggerIf(entity -> entity.m_21093_(is -> is.getItem() instanceof CrossbowItem), BackUpIfTooCloseStopInaction.create(5, 0.75F)));
