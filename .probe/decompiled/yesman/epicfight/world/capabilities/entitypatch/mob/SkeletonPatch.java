...
public class SkeletonPatch<T extends PathfinderMob> extends HumanoidMobPatch<T> {
    ...
    protected void setWeaponMotions() {
        ...
        this.weaponLivingMotions.put(CapabilityItem.WeaponCategories.SWORD, ImmutableMap.of(CapabilityItem.Styles.ONE_HAND, Set.of(Pair.of(LivingMotions.CHASE, Animations.WITHER_SKELETON_CHASE))));
    ...
    public void setAIAsInfantry(boolean holdingRanedWeapon) {
        if (!holdingRanedWeapon) {
            ...
            if (builder != null) {
                ...
                this.original.f_21345_.addGoal(1, new TargetChasingGoal(this, this.original, 1.2, true));
            }
        }
    }
}