...
public class RavagerPatch extends MobPatch<Ravager> {
    ...
    protected void initAttributes() {
        ...
        this.original.m_21051_(EpicFightAttributes.MAX_STRIKES.get()).setBaseValue(8.0);
    ...
    protected void initAI() {
        super.initAI();
        this.original.f_21345_.addGoal(0, new AnimatedAttackGoal<>(this, MobCombatBehaviors.RAVAGER.build(this)));
