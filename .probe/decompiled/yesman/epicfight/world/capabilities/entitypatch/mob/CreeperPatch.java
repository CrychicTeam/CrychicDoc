...
public class CreeperPatch extends MobPatch<Creeper> {
    ...
    protected void initAttributes() {
        ...
        this.original.m_21051_(EpicFightAttributes.STUN_ARMOR.get()).setBaseValue(1.0);
    }
    ...
    protected void initAI() {
        super.initAI();
        this.original.f_21345_.addGoal(2, new CreeperSwellStoppableGoal(this, this.original));
    }
    ...
    public void serverTick(LivingEvent.LivingTickEvent event) {
        ...
        if (this.getEntityState().inaction()) {
            for (WrappedGoal goal : this.original.f_21345_.getAvailableGoals()) {
