...
public class SPSetSkillValue {
    ...
    private SPSetSkillValue.Target target;
    ...
    public SPSetSkillValue(SPSetSkillValue.Target target, int slot, float amount, boolean boolset) {
        this.target = target;
    ...
    public static SPSetSkillValue fromBytes(FriendlyByteBuf buf) {
        return new SPSetSkillValue(SPSetSkillValue.Target.values()[buf.readInt()], buf.readInt(), buf.readFloat(), buf.readBoolean());
    }
