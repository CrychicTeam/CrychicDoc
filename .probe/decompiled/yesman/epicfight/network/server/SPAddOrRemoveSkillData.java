...
public class SPAddOrRemoveSkillData {
    ...
    private SPAddOrRemoveSkillData.AddRemove workType;
    ...
    public SPAddOrRemoveSkillData(SkillDataKey<?> key, int slot, Object value, SPAddOrRemoveSkillData.AddRemove type, int entityId) {
    ...
    public static SPAddOrRemoveSkillData fromBytes(FriendlyByteBuf buf) {
        ...
        return new SPAddOrRemoveSkillData(SkillDataKey.byId(id), slot, value, SPAddOrRemoveSkillData.AddRemove.values()[buf.readInt()], buf.readInt());
    }
    ...
    public static void handle(SPAddOrRemoveSkillData msg, Supplier<NetworkEvent.Context> ctx) {
        ((NetworkEvent.Context) ctx.get()).enqueueWork(() -> {
            ...
            if (entity.getCapability(EpicFightCapabilities.CAPABILITY_ENTITY).orElse(null) instanceof PlayerPatch<?> playerpatch) {
                ...
                if (msg.workType == SPAddOrRemoveSkillData.AddRemove.ADD) {
