...
public abstract class TexturedCustomModelParticle extends CustomModelParticle<Mesh.RawMesh> {
    ...
    public TexturedCustomModelParticle(ClientLevel level, double x, double y, double z, double xd, double yd, double zd, Mesh.RawMesh particleMesh, ResourceLocation texture) {
