...
public class OverlayManager {
    ...
    public void renderTick(int xResolution, int yResolution) {
        ...
        this.overlays.entrySet().removeIf(entry -> ((OverlayManager.Overlay) entry.getValue()).render(xResolution, yResolution));
    }
    ...
    public abstract static class Overlay {
        ...
        public abstract boolean render(int var1, int var2);
    }
}