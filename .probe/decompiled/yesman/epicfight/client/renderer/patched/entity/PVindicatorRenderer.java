...
public class PVindicatorRenderer extends PIllagerRenderer<AbstractIllager, MobPatch<AbstractIllager>> {
    ...
    public PVindicatorRenderer() {
        this.addPatchedLayer(ItemInHandLayer.class, new PatchedItemInHandLayer<AbstractIllager, MobPatch<AbstractIllager>, IllagerModel<AbstractIllager>, HumanoidMesh>() {
