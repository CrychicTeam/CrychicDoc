    ...
    public static void registerItemProperties() {
        ItemProperties.register(EpicFightItems.SKILLBOOK.get(), new ResourceLocation("skill"), (itemstack, level, entity, i) -> {
            ...
            if (skill != null) {
                ...
                if (skill.getCategory() == SkillCategories.PASSIVE) {
                    return 2.0F;
                }
                if (skill.getCategory() == SkillCategories.DODGE) {
                    return 3.0F;
                }
                if (skill.getCategory() == SkillCategories.IDENTITY) {
                    return 4.0F;
                }
                if (skill.getCategory() == SkillCategories.MOVER) {
                    return 5.0F;
                }
            }
            return 0.0F;
