    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        if (this.shouldRender()) {
            ...
            if (isEditor()) {
                ...
                graphics.drawCenteredString(font, line1, getScreenWidth() / 2, 4 + 0 * (9 + 1), RenderingUtils.replaceAlphaInColor(DrawableColor.WHITE.getColorInt(), this.opacity));
                ...
                graphics.drawCenteredString(font, line2, getScreenWidth() / 2, 4 + 1 * (9 + 1), RenderingUtils.replaceAlphaInColor(DrawableColor.WHITE.getColorInt(), this.opacity));
