...
public class PlayerEntityPoseScreen extends CellScreen {
    ...
    protected void initCells() {
        ...
        this.addCell(new PlayerEntityPoseScreen.RotationCell("body_x_rot", () -> this.bodyXRot, s -> this.bodyXRot = s, () -> this.bodyXRotAdvancedMode, aBoolean -> this.bodyXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("body_y_rot", () -> this.bodyYRot, s -> this.bodyYRot = s, () -> this.bodyYRotAdvancedMode, aBoolean -> this.bodyYRotAdvancedMode = aBoolean));
        this.addLabelCell(Component.translatable("fancymenu.editor.elements.player_entity.pose.head"));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("head_x_rot", () -> this.headXRot, s -> this.headXRot = s, () -> this.headXRotAdvancedMode, aBoolean -> this.headXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("head_y_rot", () -> this.headYRot, s -> this.headYRot = s, () -> this.headYRotAdvancedMode, aBoolean -> this.headYRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("head_z_rot", () -> this.headZRot, s -> this.headZRot = s, () -> this.headZRotAdvancedMode, aBoolean -> this.headZRotAdvancedMode = aBoolean));
        this.addLabelCell(Component.translatable("fancymenu.editor.elements.player_entity.pose.left_arm"));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_arm_x_rot", () -> this.leftArmXRot, s -> this.leftArmXRot = s, () -> this.leftArmXRotAdvancedMode, aBoolean -> this.leftArmXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_arm_y_rot", () -> this.leftArmYRot, s -> this.leftArmYRot = s, () -> this.leftArmYRotAdvancedMode, aBoolean -> this.leftArmYRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_arm_z_rot", () -> this.leftArmZRot, s -> this.leftArmZRot = s, () -> this.leftArmZRotAdvancedMode, aBoolean -> this.leftArmZRotAdvancedMode = aBoolean));
        this.addLabelCell(Component.translatable("fancymenu.editor.elements.player_entity.pose.right_arm"));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_arm_x_rot", () -> this.rightArmXRot, s -> this.rightArmXRot = s, () -> this.rightArmXRotAdvancedMode, aBoolean -> this.rightArmXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_arm_y_rot", () -> this.rightArmYRot, s -> this.rightArmYRot = s, () -> this.rightArmYRotAdvancedMode, aBoolean -> this.rightArmYRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_arm_z_rot", () -> this.rightArmZRot, s -> this.rightArmZRot = s, () -> this.rightArmZRotAdvancedMode, aBoolean -> this.rightArmZRotAdvancedMode = aBoolean));
        this.addLabelCell(Component.translatable("fancymenu.editor.elements.player_entity.pose.left_leg"));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_leg_x_rot", () -> this.leftLegXRot, s -> this.leftLegXRot = s, () -> this.leftLegXRotAdvancedMode, aBoolean -> this.leftLegXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_leg_y_rot", () -> this.leftLegYRot, s -> this.leftLegYRot = s, () -> this.leftLegYRotAdvancedMode, aBoolean -> this.leftLegYRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("left_leg_z_rot", () -> this.leftLegZRot, s -> this.leftLegZRot = s, () -> this.leftLegZRotAdvancedMode, aBoolean -> this.leftLegZRotAdvancedMode = aBoolean));
        this.addLabelCell(Component.translatable("fancymenu.editor.elements.player_entity.pose.right_leg"));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_leg_x_rot", () -> this.rightLegXRot, s -> this.rightLegXRot = s, () -> this.rightLegXRotAdvancedMode, aBoolean -> this.rightLegXRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_leg_y_rot", () -> this.rightLegYRot, s -> this.rightLegYRot = s, () -> this.rightLegYRotAdvancedMode, aBoolean -> this.rightLegYRotAdvancedMode = aBoolean));
        this.addCell(new PlayerEntityPoseScreen.RotationCell("right_leg_z_rot", () -> this.rightLegZRot, s -> this.rightLegZRot = s, () -> this.rightLegZRotAdvancedMode, aBoolean -> this.rightLegZRotAdvancedMode = aBoolean));
        this.addSpacerCell(20);
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        int entityX = this.f_96543_ - 20 - this.getRightSideWidgetWidth() / 2 - (int) (this.element.getActiveEntityProperties().getDimensions().width * 110.0F) / 2;
    ...
    public class RotationCell extends CellScreen.RenderCell {
        ...
        public RotationCell(@NotNull final String localizationKeySuffix, @NotNull Supplier<String> rotationValueGetter, @NotNull Consumer<String> rotationValueSetter, @NotNull Supplier<Boolean> advancedModeGetter, @NotNull Consumer<Boolean> advancedModeSetter) {
            this.toggleModeButton = new CycleButton<>(0, 0, 20, 20, CommonCycles.cycleEnabledDisabled("fancymenu.editor.elements.player_entity.pose.advanced", (Boolean) advancedModeGetter.get()), (value, button) -> {
                advancedModeSetter.accept(value.getAsBoolean());
                if (this.activeWidget != null) {
                    this.m_6702_().remove(this.activeWidget);
                }
                this.activeWidget = (AbstractWidget) (value.getAsBoolean() ? this.rotationStringButton : this.rotationSlider);
                this.m_6702_().add(this.activeWidget);
            });
            ...
            this.rotationStringButton = new ExtendedButton(0, 0, 20, 20, Component.translatable("fancymenu.editor.elements.player_entity.pose.advanced." + localizationKeySuffix), button -> {
                ...
                s.setText((String) rotationValueGetter.get());
                Minecraft.getInstance().setScreen(s);
            });
            UIBase.applyDefaultWidgetSkinTo(this.rotationStringButton);
            this.rotationSlider = new RangeSliderButton(0, 0, 20, 20, false, -180.0, 180.0, (double) PlayerEntityPoseScreen.stringToFloat((String) rotationValueGetter.get()), slider -> {
                if (!(Boolean) advancedModeGetter.get()) {
                    rotationValueSetter.accept((float) ((RangeSliderButton) slider).getSelectedRangeDoubleValue() + "");
                }
            }) {
            ...
            this.activeWidget = (AbstractWidget) (advancedModeGetter.get() ? this.rotationStringButton : this.rotationSlider);
            this.m_6702_().add(this.activeWidget);
            this.m_6702_().add(this.toggleModeButton);
        }
        ...
        public void renderCell(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
            ...
            this.toggleModeButton.m_252865_(this.getX() + this.getWidth() - toggleModeButtonWidth);
            this.toggleModeButton.m_253211_(this.getY());
            this.toggleModeButton.m_93674_(toggleModeButtonWidth);
        }
    }
}