...
import de.keksuccino.fancymenu.customization.element.elements.text.v1.TextElementBuilder;
...
public class Elements {
    ...
    @Deprecated
    public static final SliderElementBuilder SLIDER_V1 = new SliderElementBuilder();

    public static final de.keksuccino.fancymenu.customization.element.elements.slider.v2.SliderElementBuilder SLIDER_V2 = new de.keksuccino.fancymenu.customization.element.elements.slider.v2.SliderElementBuilder();

    @Deprecated
    public static final TextElementBuilder TEXT_V1 = new TextElementBuilder();
