...
public class WidgetMeta {
    ...
    public String getUniversalIdentifier() {
        if (this.widget instanceof UniqueWidget u && u.getWidgetIdentifierFancyMenu() != null) {
    ...
    public String getIdentifier() {
        return this.getUniversalIdentifier() != null ? this.getUniversalIdentifier() : this.getLongIdentifier() + "";
    }
