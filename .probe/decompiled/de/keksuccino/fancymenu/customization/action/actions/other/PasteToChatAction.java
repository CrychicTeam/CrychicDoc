...
public class PasteToChatAction extends Action {
    ...
    public void editValue(@NotNull Screen parentScreen, @NotNull ActionInstance instance) {
        PasteToChatAction.PasteToChatActionValueScreen s = new PasteToChatAction.PasteToChatActionValueScreen((String) Objects.requireNonNullElse(instance.value, this.getValueExample()), value -> {
            if (value != null) {
    ...
    public static class PasteToChatActionValueScreen extends StringBuilderScreen {
        ...
        protected void initCells() {
            ...
            this.addWidgetCell(new CycleButton<>(0, 0, 20, 20, CommonCycles.cycleEnabledDisabled("fancymenu.editor.actions.paste_to_chat.append", this.append), (value, button) -> this.append = value.getAsBoolean()).setTooltip(Tooltip.of(LocalizationUtils.splitLocalizedLines("fancymenu.editor.actions.paste_to_chat.append.desc"))), true);
            this.addSpacerCell(20);
        }
