        ...
        if (value != null) {
            ...
            if (value.equals(CreateWorldScreen.class.getName())) {
                ...
                if (s != null) {
                    ...
                    Minecraft.getInstance().setScreen(NotificationScreen.error(aBoolean -> Minecraft.getInstance().setScreen(current), LocalizationUtils.splitLocalizedLines("fancymenu.actions.open_screen.error")));
                }
            }
        }
    }
