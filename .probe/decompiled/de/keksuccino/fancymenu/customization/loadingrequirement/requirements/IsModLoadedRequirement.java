...
public class IsModLoadedRequirement extends LoadingRequirement {
        ...
        if (value != null) {
            ...
            if (!l.isEmpty()) {
                for (String s : l) {
                    ...
                    } else if (!Services.PLATFORM.isModLoaded(s)) {
                        return false;
                    }
                }
                return true;
    ...
    public void editValue(@NotNull Screen parentScreen, @NotNull LoadingRequirementInstance requirementInstance) {
        IsModLoadedRequirement.IsModLoadedValueConfigScreen s = new IsModLoadedRequirement.IsModLoadedValueConfigScreen((String) Objects.requireNonNullElse(requirementInstance.value, ""), callback -> {
            if (callback != null) {
    ...
    public static class IsModLoadedValueConfigScreen extends StringBuilderScreen {
        ...
        protected void initCells() {
            ...
            this.modIdCell.editBox.m_94151_(s -> this.modIdSuggestions.updateCommandInfo());
            this.addSpacerCell(20);
        }
        ...
        public boolean keyPressed(int $$0, int $$1, int $$2) {
            return this.modIdSuggestions.keyPressed($$0, $$1, $$2) ? true : super.m_7933_($$0, $$1, $$2);
        }

        @Override
        public boolean mouseScrolled(double $$0, double $$1, double $$2) {
            return this.modIdSuggestions.mouseScrolled($$2) ? true : super.m_6050_($$0, $$1, $$2);
        }

        @Override
        public boolean mouseClicked(double $$0, double $$1, int $$2) {
            return this.modIdSuggestions.mouseClicked($$0, $$1, $$2) ? true : super.m_6375_($$0, $$1, $$2);
        }
        ...
        protected String getModIdString() {
            return this.modIdCell != null ? this.modIdCell.getText() : this.modId;
        }
    }
}