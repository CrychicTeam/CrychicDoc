...
public class FileTypes {
    ...
    public static final FileType<Object> UNKNOWN = new FileType<Object>(FileCodec.empty(Object.class)) {
    ...
    public static final ImageFileType JPEG_IMAGE = new ImageFileType(FileCodec.advanced(ITexture.class, SimpleTexture::of, SimpleTexture::location, SimpleTexture::local, SimpleTexture::web), "image/jpeg", "jpg", "jpeg");

    public static final ImageFileType PNG_IMAGE = new ImageFileType(FileCodec.advanced(ITexture.class, SimpleTexture::of, SimpleTexture::location, SimpleTexture::local, SimpleTexture::web), "image/png", "png");
    ...
    public static final ImageFileType APNG_IMAGE = new ImageFileType(FileCodec.advanced(ITexture.class, ApngTexture::of, ApngTexture::location, ApngTexture::local, ApngTexture::web), "image/apng", "apng").setCustomDisplayName(Component.translatable("fancymenu.file_types.apng")).setAnimated(true);

    public static final ImageFileType FMA_IMAGE = new ImageFileType(FileCodec.advanced(ITexture.class, FmaTexture::of, FmaTexture::location, FmaTexture::local, FmaTexture::web), "image/fma", "fma").setCustomDisplayName(Component.translatable("fancymenu.file_types.fma")).setAnimated(true);
    ...
    public static List<ImageFileType> getAllImageFileTypes() {
        ...
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type instanceof ImageFileType i) {
                types.add(i);
            }
        }
        return types;
    ...
    public static List<ImageFileType> getAllAnimatedImageFileTypes() {
        ...
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type instanceof ImageFileType) {
                ImageFileType i = (ImageFileType) type;
                if (i.isAnimated()) {
                    types.add(i);
                }
            }
    ...
    public static List<AudioFileType> getAllAudioFileTypes() {
        ...
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type instanceof AudioFileType a) {
                types.add(a);
            }
        }
        return types;
    ...
    public static List<VideoFileType> getAllVideoFileTypes() {
        ...
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type instanceof VideoFileType v) {
                types.add(v);
            }
        }
        return types;
    ...
    public static List<TextFileType> getAllTextFileTypes() {
        ...
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type instanceof TextFileType t) {
                types.add(t);
            }
        }
        return types;
    ...
    public static FileType<?> getWebType(@NotNull String fileUrl, boolean doAdvancedWebChecks) {
        for (FileType<?> type : FileTypeRegistry.getFileTypes()) {
            if (type.isFileTypeWeb(fileUrl)) {
                return type;
            }
        }
        if (doAdvancedWebChecks) {
            for (FileType<?> typex : FileTypeRegistry.getFileTypes()) {
                if (typex.isFileTypeWebAdvanced(fileUrl)) {
                    return typex;
                }
            }
        }
