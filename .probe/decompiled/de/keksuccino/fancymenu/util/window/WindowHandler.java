...
public class WindowHandler {
    ...
    public static void handleForceFullscreen() {
        try {
            if (FancyMenu.getOptions().forceFullscreen.getValue() && !Minecraft.getInstance().getWindow().isFullscreen()) {
    ...
    public static File getCustomWindowIcon16() {
        ...
        return !path.replace(" ", "").isEmpty() ? new File(GameDirectoryUtils.getAbsoluteGameDirectoryPath(path)) : null;
    }
