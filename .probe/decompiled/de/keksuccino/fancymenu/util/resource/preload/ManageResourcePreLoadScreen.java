...
public class ManageResourcePreLoadScreen extends CellScreen {
    ...
    protected void initCells() {
        ...
        for (ResourceSource source : ResourcePreLoader.getRegisteredResourceSources(this.cachedSerialized)) {
            ...
            this.addLabelCell(Component.literal(sourceString).setStyle(Style.EMPTY.withColor(UIBase.getUIColorTheme().element_label_color_normal.getColorInt()))).putMemoryValue("source", source.getSerializationSource()).setSelectable(true);
        }
    ...
    protected String getSelectedSource() {
        ...
        return cell != null ? cell.getMemoryValue("source") : null;
    }
