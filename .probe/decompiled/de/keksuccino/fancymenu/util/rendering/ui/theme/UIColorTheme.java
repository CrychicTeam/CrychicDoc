...
public class UIColorTheme {
    ...
    public void setUITextureShaderColor(GuiGraphics graphics, float alpha) {
        UIBase.setShaderColor(graphics, this.ui_texture_color, alpha);
    }
    ...
    public Component getDisplayName() {
        return this.display_name.startsWith("fancymenu.ui.themes.") ? Component.translatable(this.display_name) : Component.literal(this.display_name);
    }
}