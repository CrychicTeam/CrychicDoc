...
public class ComponentWidget extends AbstractWidget implements NavigatableWidget {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        this.f_93618_ = this.getWidth();
        this.f_93619_ = this.getHeight();
    ...
    public void renderWidget(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partial) {
        ...
        this.endX = this.m_252754_();
        this.endX = graphics.drawString(this.font, this.getText(), this.m_252754_(), this.m_252907_(), this.getBaseColor().getColorInt(), this.shadow);
        for (ComponentWidget c : this.children) {
            c.m_252865_(this.endX);
            c.m_253211_(this.m_252907_());
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.f_93623_ && this.f_93624_ && this.m_198029_() && button == 0) {
            for (ComponentWidget w : this.children) {
    ...
    public void setMessage(@NotNull Component content) {
        if (content instanceof MutableComponent m) {
