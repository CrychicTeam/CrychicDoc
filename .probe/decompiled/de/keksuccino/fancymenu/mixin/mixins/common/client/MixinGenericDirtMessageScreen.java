...
public class MixinGenericDirtMessageScreen extends Screen {
    ...
    @Override
    protected void init() {
        ((TextWidget) this.m_142416_(TextWidget.of(this.m_96636_(), 0, 70, 200))).centerWidget(this).setTextAlignment(TextWidget.TextAlignment.CENTER).setWidgetIdentifierFancyMenu("message");
    }
