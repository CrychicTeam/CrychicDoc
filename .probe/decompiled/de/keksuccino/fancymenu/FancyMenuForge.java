...
public class FancyMenuForge {
    ...
    public void onSetup(FMLCommonSetupEvent e) {
        ...
        } else if (Compat.isVideoExtensionLoaded() || Services.PLATFORM.isModLoaded("fmextension_video")) {
