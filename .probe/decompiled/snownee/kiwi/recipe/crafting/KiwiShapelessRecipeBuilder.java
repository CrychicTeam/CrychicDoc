...
public class KiwiShapelessRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation resourceLocation) {
        ...
        this.advancement.parent(f_236353_).addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(resourceLocation)).rewards(AdvancementRewards.Builder.recipe(resourceLocation)).requirements(RequirementsStrategy.OR);
        consumer.accept(new KiwiShapelessRecipeBuilder.Result(resourceLocation, this.result, this.count, this.group == null ? "" : this.group, m_245179_(this.category), this.ingredients, this.advancement, resourceLocation.withPrefix("recipes/" + this.category.getFolderName() + "/"), this.noContainers));
    }
