...
public class KBlockComponents extends AbstractModule {
    ...
    public static KBlockComponent getSimpleInstance(KBlockComponent.Type<?> type) {
        if (SIMPLE_INSTANCES == null) {
            Builder<KBlockComponent.Type<?>, KBlockComponent> builder = ImmutableMap.builder();
        ...
        return (KBlockComponent) Objects.requireNonNull((KBlockComponent) SIMPLE_INSTANCES.get(type), () -> "No simple instance for " + type);
    }
}