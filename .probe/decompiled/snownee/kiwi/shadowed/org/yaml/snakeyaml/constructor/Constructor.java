...
import snownee.kiwi.shadowed.org.yaml.snakeyaml.introspector.Property;
...
import snownee.kiwi.shadowed.org.yaml.snakeyaml.util.EnumUtils;
...
public class Constructor extends SafeConstructor {
    ...
    protected Class<?> getClassForNode(Node node) {
        Class<? extends Object> classForTag = (Class<? extends Object>) this.typeTags.get(node.getTag());
        if (classForTag == null) {
    ...
    protected class ConstructScalar extends AbstractConstruct {
            ...
            if (instance != BaseConstructor.NOT_INSTANTIATED_OBJECT) {
                ...
                if (!type.isPrimitive() && type != String.class && !Number.class.isAssignableFrom(type) && type != Boolean.class && !Date.class.isAssignableFrom(type) && type != Character.class && type != BigInteger.class && type != BigDecimal.class && !Enum.class.isAssignableFrom(type) && !Tag.BINARY.equals(node.getTag()) && !Calendar.class.isAssignableFrom(type) && type != UUID.class) {
                    ...
                    try {
                        ...
                        throw new ConstructorException(null, null, "Can't construct a java object for scalar " + node.getTag() + "; exception=" + var13.getMessage(), node.getStartMark(), var13);
                    }
                } else {
        ...
        private Object constructStandardJavaInstance(Class type, ScalarNode node) {
            ...
            if (type == String.class) {
                ...
                if (type == Byte.class || type == Short.class || type == Integer.class || type == Long.class || type == BigInteger.class || type == byte.class || type == short.class || type == int.class || type == long.class) {
    ...
    protected class ConstructYamlObject implements Construct {
        ...
        public Object construct(Node node) {
            try {
                ...
                throw new ConstructorException(null, null, "Can't construct a java object for " + node.getTag() + "; exception=" + var4.getMessage(), node.getStartMark(), var4);
            }
        }
        ...
        public void construct2ndStep(Node node, Object object) {
            try {
                ...
                throw new ConstructorException(null, null, "Can't construct a second step for a java object for " + node.getTag() + "; exception=" + var4.getMessage(), node.getStartMark(), var4);
            }
        }
    }
}