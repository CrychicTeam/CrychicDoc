...
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.AliasEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.CommentEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.DocumentEndEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.DocumentStartEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.Event;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.ImplicitTuple;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.MappingEndEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.MappingStartEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.ScalarEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.SequenceEndEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.SequenceStartEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.StreamEndEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.events.StreamStartEvent;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.reader.StreamReader;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.scanner.Scanner;
import snownee.kiwi.shadowed.org.yaml.snakeyaml.scanner.ScannerImpl;
    ...
    private VersionTagsTuple processDirectives() {
        ...
        while (this.scanner.checkToken(Token.ID.Directive)) {
            ...
            if (token.getName().equals("YAML")) {
                ...
                String handle = (String) valuex.get(0);
                String prefix = (String) valuex.get(1);
