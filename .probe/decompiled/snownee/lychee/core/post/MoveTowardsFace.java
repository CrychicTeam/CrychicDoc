...
public class MoveTowardsFace extends PostAction {
    ...
    protected void apply(ILycheeRecipe<?> recipe, LycheeContext ctx, int times) {
        ...
        Vec3 vec = new Vec3(ctx.getParam(LycheeLootContextParams.DIRECTION).step()).scale((double) this.factor);
    ...
    public static class Type extends PostActionType<MoveTowardsFace> {
        ...
        public MoveTowardsFace fromJson(JsonObject o) {
            return new MoveTowardsFace(GsonHelper.getAsFloat(o, "factor", 1.0F));
        }
