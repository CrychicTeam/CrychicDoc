...
public class CraftingRecipeCategoryExtension implements ICraftingCategoryExtension {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ICraftingGridHelper craftingGridHelper, IFocusGroup focuses) {
        ...
        List<List<ItemStack>> inputs = craftingRecipe.m_7527_().stream().map(ingredient -> List.of(ingredient.getItems())).toList();
        ItemStack resultItem = craftingRecipe.m_8043_(Minecraft.getInstance().level.m_9598_());
    ...
    public ResourceLocation getRegistryName() {
        return ((Recipe) this.recipe).getId();
    }

    @Override
    public int getHeight() {
        return this.recipe instanceof ShapedRecipe shaped ? shaped.getHeight() : 0;
    }

    @Override
    public int getWidth() {
        return this.recipe instanceof ShapedRecipe shaped ? shaped.getWidth() : 0;
    }
}