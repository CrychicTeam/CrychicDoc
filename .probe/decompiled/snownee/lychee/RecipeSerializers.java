...
public final class RecipeSerializers {
    ...
    public static final LycheeRecipe.Serializer<BlockClickingRecipe> BLOCK_CLICKING = register("block_clicking", new BlockInteractingRecipe.Serializer<>(BlockClickingRecipe::new));
    ...
    public static <T extends RecipeSerializer<?>> T register(String name, T t) {
        ForgeRegistries.RECIPE_SERIALIZERS.register(new ResourceLocation("lychee", name), t);
        return t;
    }
}