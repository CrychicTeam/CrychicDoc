...
public class StringConfigEntry extends ConfigEntry<String> {
    ...
    public boolean isValidValue(Object value) {
        return value.getClass() == String.class && this.validator.test((String) value);
    }

    @Override
    public OptionValue<?> createUI(OptionsList options, String optionName) {
        return options.input(optionName, this.getValue(), s -> PluginConfig.INSTANCE.set(this.id, s), this.validator);
    }
}