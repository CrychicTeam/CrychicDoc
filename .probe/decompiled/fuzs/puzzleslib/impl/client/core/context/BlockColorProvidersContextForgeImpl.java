...
public record BlockColorProvidersContextForgeImpl(BiConsumer<BlockColor, Block> consumer, BlockColors blockColors) implements ColorProvidersContext<Block, BlockColor> {
    ...
    public BlockColor getProvider(Block block) {
        return (BlockColor) ((BlockColorsForgeAccessor) this.blockColors).puzzleslib$getBlockColors().get(ForgeRegistries.BLOCKS.getDelegateOrThrow(block));
    }
}