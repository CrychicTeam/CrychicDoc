...
public abstract class RegistryManagerV2Impl implements RegistryManager {
    ...
    @Override
    public final <T> RegistryReference<T> register(ResourceKey<? extends Registry<? super T>> registryKey, String path, Supplier<T> supplier) {
    ...
    protected abstract <T> RegistryReference<T> actuallyRegister(ResourceKey<? extends Registry<? super T>> var1, String var2, Supplier<T> var3);
}