...
public class DataProviderContext {
    ...
    public static DataProviderContext fromModId(String modId) {
        return new DataProviderContext(modId, new PackOutput(Path.of("")), Suppliers.memoize(() -> CompletableFuture.supplyAsync(VanillaRegistries::m_255371_, Util.backgroundExecutor())));
    }
    ...
    public CompletableFuture<HolderLookup.Provider> getLookupProvider() {
        return (CompletableFuture<HolderLookup.Provider>) this.lookupProvider.get();
    }
