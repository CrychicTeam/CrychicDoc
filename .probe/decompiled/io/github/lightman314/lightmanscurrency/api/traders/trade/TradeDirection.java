...
public enum TradeDirection {
    ...
    SALE(0), PURCHASE(1), BARTER(2), OTHER(-1);
    ...
    public final MutableComponent getName() {
        return LCText.GUI_TRADE_DIRECTION.get(this).get();
    }

    public final MutableComponent getActionPhrase() {
        return LCText.GUI_TRADE_DIRECTION_ACTION.get(this).get();
    }
}