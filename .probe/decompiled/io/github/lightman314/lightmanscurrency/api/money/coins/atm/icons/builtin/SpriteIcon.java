...
public class SpriteIcon extends ATMIconData {
    ...
    public SpriteIcon(JsonObject data) throws JsonSyntaxException, ResourceLocationException {
        super(data);
        this.sprite = Sprite.SimpleSprite(new ResourceLocation(GsonHelper.getAsString(data, "texture")), GsonHelper.getAsInt(data, "u"), GsonHelper.getAsInt(data, "v"), GsonHelper.getAsInt(data, "width"), GsonHelper.getAsInt(data, "height"));
    }
    ...
    public void render(@Nonnull ATMExchangeButton button, @Nonnull EasyGuiGraphics gui, boolean isHovered) {
        gui.blitSprite(this.sprite, this.xPos, this.yPos);
    }
}