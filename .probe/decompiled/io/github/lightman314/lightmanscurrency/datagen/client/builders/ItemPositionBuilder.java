...
public final class ItemPositionBuilder {
    ...
    private final List<ItemPositionBuilder.PositionEntryBuilder> entries = new ArrayList();
    ...
    public ItemPositionBuilder withEntry(@Nonnull Vector3f position) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, 0, null, false, 0.0F, null));
        return this;
    }

    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, float scale) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, 0, null, true, scale, null));
        return this;
    }

    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, @Nonnull String rotationType) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, 0, null, false, 0.0F, rotationType));
        return this;
    }

    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, float scale, @Nonnull String rotationType) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, 0, null, true, scale, rotationType));
        return this;
    }

    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, int extraCount, @Nonnull Vector3f extraOffset) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, extraCount, extraOffset, false, 0.0F, null));
        return this;
    }

    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, int extraCount, @Nonnull Vector3f extraOffset, float scale) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, extraCount, extraOffset, true, scale, null));
        return this;
    }
    ...
    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, int extraCount, @Nonnull Vector3f extraOffset, @Nonnull String rotationType) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, extraCount, extraOffset, false, 0.0F, rotationType));
        return this;
    }
    ...
    public ItemPositionBuilder withEntry(@Nonnull Vector3f position, int extraCount, @Nonnull Vector3f extraOffset, float scale, @Nonnull String rotationType) {
        this.entries.add(new ItemPositionBuilder.PositionEntryBuilder(position, extraCount, extraOffset, true, scale, rotationType));
        return this;
    }
    ...
    public JsonObject write() {
        ...
        for (ItemPositionBuilder.PositionEntryBuilder entry : this.entries) {
    ...
    private static record PositionEntryBuilder(Vector3f position, int extraCount, Vector3f extraOffset, boolean hasCustomScale, float scale, String rotationType) {
    }
}