...
public class EnglishProvider extends TranslationProvider {
    ...
    public EnglishProvider(PackOutput output) {
        super(output, "lightmanscurrency", "en_us");
    }
    ...
    protected void addTranslations() {
        ...
        this.translate(LCText.TOOLTIP_UPGRADE_TEMPLATE, new String[] { "Lightman's Currency Upgrade Template" });
        ...
        this.translate(LCText.TOOLTIP_ITEM_TRADER, new String[] { "Item Trader:", "Trades: %s", "Can be used to Sell, Purchase, or Barter items with other players" });
        this.translate(LCText.TOOLTIP_ITEM_TRADER_ARMOR, new String[] { "Armor Trader:", "Trades: %s", "Can be used to Sell, Purchase, or Barter armor pieces with other players" });
        this.translate(LCText.TOOLTIP_ITEM_TRADER_TICKET, new String[] { "Ticket Trader:", "Trades: %s", "Can be used to Sell, Purchase, or Barter tickets and ticket materials with other players", "A master ticket is required in order to sell tickets", "Tickets being sold can consume ticket materials from storage to print a new ticket for the customer" });
        this.translate(LCText.TOOLTIP_ITEM_TRADER_BOOK, new String[] { "Book Trader:", "Trades: %s", "Can be used to Sell, Purchase, or Barter books with other players" });
        this.translate(LCText.TOOLTIP_ITEM_TRADER_NETWORK, new String[] { "Item Network Trader:", "Trades: %s", "Can be used to Sell, Purchase, or Barter items with other players", "Accessible from any location via the Trading Terminal" });
        this.translate(LCText.TOOLTIP_SLOT_MACHINE, new String[] { "Slot Machine:", "Can be used to Sell owner-defined random Items or Money to other players", "with owner-defined odds of receiving each loot pool" });
        this.translate(LCText.TOOLTIP_PAYGATE, new String[] { "Paygate:", "Can be used to trigger a redstone signal for a price", "Can be linked to a ticket for easier customer interactions" });
        this.translate(LCText.TOOLTIP_TERMINAL, new String[] { "Can access Network Traders remotely from any location" });
        this.translate(LCText.TOOLTIP_INTERFACE_ITEM, new String[] { "Item Trader Interface Terminal:", "Can be used to automatically purchase or sell items from any network item trader", "Can be used to automatically drain or restock items remotely to/from any item trader you have access to" });
        this.translate(LCText.TOOLTIP_TAX_COLLECTOR, new String[] { "Tax Collector:", "Can be placed and used to collect taxes from trader sales within an area" });
        this.translate(LCText.TOOLTIP_TAX_COLLECTOR_ADMIN_ONLY, "Can only be activated by an admin!");
        this.translate(LCText.TOOLTIP_ATM, new String[] { "Can exchange coins for other coins of higher or lower values", "Can deposit or withdraw coins from any bank account you have access to", "Can transfer money from your account to another player or teams account" });
        ...
        this.translate(LCText.TOOLTIP_TICKET_STATION, new String[] { "Can be used to print unique Master and Slave tickets", "Tickets can be used with the Paygate, or used was coupons for barter trades" });
        this.translate(LCText.TOOLTIP_CASH_REGISTER, new String[] { "Can be used to linke and interact with multiple local traders from the same menu" });
        this.translate(LCText.TOOLTIP_COIN_JAR, new String[] { "Coin Jar:", "When placed, up to 64 coins can be inserted by interacting with the jar while holding a coin", "If mined with silk touch the jar will drop with the coins still inside", "If mined without silk touch the jar will break and its contents will be dropped instead" });
        ...
        this.translate(LCText.TOOLTIP_UPGRADE_SECURITY, new String[] { "Allows the Money Chest to be protected from destruction by other players", "Also blocks container access from other players", "Requires set-up, will not have an owner defined automatically" });
        ...
        this.translate(LCText.TOOLTIP_OWNER_TEAM, new String[] { "Team: %1$s", "%2$s members" });
        ...
        this.translate(LCText.TOOLTIP_SLOT_MACHINE_ROLL_ONCE, new String[] { "Try your luck!", "Costs %2$s" });
        this.translate(LCText.TOOLTIP_SLOT_MACHINE_ROLL_MULTI, new String[] { "Try your luck %1$s times!", "Costs %2$s per roll" });
        ...
        this.translate(LCText.GUI_INTERFACE_INTERACTION_TYPE.get(TraderInterfaceBlockEntity.InteractionType.RESTOCK_AND_DRAIN), "Restock & Drain");
        this.translate(LCText.GUI_INTERFACE_INTERACTION_TYPE.get(TraderInterfaceBlockEntity.InteractionType.RESTOCK), "Restock");
        this.translate(LCText.GUI_INTERFACE_INTERACTION_TYPE.get(TraderInterfaceBlockEntity.InteractionType.DRAIN), "Drain");
        this.translate(LCText.GUI_INTERFACE_INTERACTION_TYPE.get(TraderInterfaceBlockEntity.InteractionType.TRADE), "Trade");
        this.translate(LCText.GUI_INTERFACE_ACTIVE_MODE.get(TraderInterfaceBlockEntity.ActiveMode.DISABLED), "Disabled");
        this.translate(LCText.GUI_INTERFACE_ACTIVE_MODE.get(TraderInterfaceBlockEntity.ActiveMode.REDSTONE_OFF), "No Redstone Signal");
        this.translate(LCText.GUI_INTERFACE_ACTIVE_MODE.get(TraderInterfaceBlockEntity.ActiveMode.REDSTONE_ONLY), "Redstone Signal");
        this.translate(LCText.GUI_INTERFACE_ACTIVE_MODE.get(TraderInterfaceBlockEntity.ActiveMode.ALWAYS_ON), "Always Active");
