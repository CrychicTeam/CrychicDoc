...
public class TicketRecipeBuilder implements RecipeBuilder {
    ...
    public TicketRecipeBuilder withMasterTicket(@Nonnull TagKey<Item> tag) {
        this.masterIngredient = Ingredient.of(tag);
        return this;
    }

    @Nonnull
    public TicketRecipeBuilder withMasterTicket(@Nonnull ItemLike item) {
        this.masterIngredient = Ingredient.of(item);
        return this;
    }
    ...
    public void save(@Nonnull Consumer<FinishedRecipe> consumer, @Nonnull ResourceLocation id) {
        ...
        consumer.accept(new TicketRecipeBuilder.Result(id, this.masterIngredient, this.ingredient, this.result, this.advancement, id.withPrefix("recipes/ticket_machine/")));
    }
    ...
    private void ensureValid(ResourceLocation id) {
        ...
        } else if (this.masterIngredient == null) {
