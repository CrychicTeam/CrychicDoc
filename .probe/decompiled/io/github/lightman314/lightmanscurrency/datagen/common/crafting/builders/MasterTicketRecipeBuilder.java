...
public class MasterTicketRecipeBuilder implements RecipeBuilder {
    ...
    @Nonnull
    public MasterTicketRecipeBuilder withResult(@Nonnull RegistryObject<? extends ItemLike> result) {
    ...
    @Nonnull
    public MasterTicketRecipeBuilder unlockedBy(@Nonnull String name, @Nonnull CriterionTriggerInstance criteria) {
    ...
    public void save(@Nonnull Consumer<FinishedRecipe> consumer, @Nonnull ResourceLocation id) {
        ...
        consumer.accept(new MasterTicketRecipeBuilder.Result(id, this.ingredient, this.result, this.advancement, id.withPrefix("recipes/ticket_machine/")));
    }
