...
public class CPacketCreativeWalletEdit extends ClientToServerPacket {
    ...
    public static final CustomPacket.Handler<CPacketCreativeWalletEdit> HANDLER = new CPacketCreativeWalletEdit.H();
    ...
    public void encode(@Nonnull FriendlyByteBuf buffer) {
        buffer.writeItemStack(this.newWallet, false);
    }

    private static class H extends CustomPacket.Handler<CPacketCreativeWalletEdit> {

        @Nonnull
        public CPacketCreativeWalletEdit decode(@Nonnull FriendlyByteBuf buffer) {
            return new CPacketCreativeWalletEdit(buffer.readItem());
        }
