...
public interface IDumpable {
    ...
    List<ItemStack> getContents(Level var1, BlockPos var2, BlockState var3, boolean var4);

    MutableComponent getName();

    OwnerData getOwner();

    static IDumpable preCollected(List<ItemStack> contents, Component name, OwnerData owner) {
        return new IDumpable.LazyDumpable(contents, name, owner);
    }
