...
public final class ChocolateEventCoins {
    ...
    public static final ILootModifier LOOT_MODIFIER = new ChocolateEventCoins.ChocolateLootModifier();
    ...
    public static boolean shouldModifyLoot() {
        return LCConfig.COMMON.chocolateEventCoinLootDrops.get() && (CHRISTMAS.isActive() || VALENTINES.isActive());
    }

    public static ChainData getChainData() {
        if (CHAIN_DATA == null) {
            CHAIN_DATA = ChainData.builder("chocolate_coins", LCText.COIN_CHAIN_CHOCOLATE).withCoreChain(ModItems.COIN_CHOCOLATE_COPPER).withCoin(ModItems.COIN_CHOCOLATE_IRON, 10).withCoin(ModItems.COIN_CHOCOLATE_GOLD, 10).withCoin(ModItems.COIN_CHOCOLATE_EMERALD, 10).withCoin(ModItems.COIN_CHOCOLATE_DIAMOND, 10).withCoin(ModItems.COIN_CHOCOLATE_NETHERITE, 10).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_COPPER, 9, ModItems.COIN_CHOCOLATE_COPPER).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_COPPER, 4).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_IRON, 9, ModItems.COIN_CHOCOLATE_IRON).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_IRON, 4).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_GOLD, 9, ModItems.COIN_CHOCOLATE_GOLD).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_GOLD, 4).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_EMERALD, 9, ModItems.COIN_CHOCOLATE_EMERALD).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_EMERALD, 4).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_DIAMOND, 9, ModItems.COIN_CHOCOLATE_DIAMOND).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_DIAMOND, 4).back().withSideChain(ModBlocks.COINPILE_CHOCOLATE_NETHERITE, 9, ModItems.COIN_CHOCOLATE_NETHERITE).withCoin(ModBlocks.COINBLOCK_CHOCOLATE_NETHERITE, 4).back().atmBuilder().accept(ATMExchangeButtonData::generateChocolate).back().withDisplay(new NumberDisplay(LCText.COIN_CHAIN_CHOCOLATE_DISPLAY, LCText.COIN_CHAIN_CHOCOLATE_DISPLAY_WORDY, ModItems.COIN_CHOCOLATE_COPPER.get())).withInputType(CoinInputType.TEXT).asEvent().build();
        }
        return CHAIN_DATA;
    }
    ...
    public static void registerChain(@Nonnull ChainDataReloadedEvent.Pre event) {
        if (LCConfig.COMMON.chocolateEventCoins.get() && !event.chainExists("chocolate_coins")) {
    ...
    private static class ChocolateLootModifier extends SimpleLootModifier {
        ...
        protected double getSuccessChance() {
            return LCConfig.COMMON.chocolateCoinDropRate.get();
        }
