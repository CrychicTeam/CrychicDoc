...
public final class TextEntry {
    ...
    public static TextEntry sound(@Nonnull String modid, @Nonnull String name) {
        return new TextEntry("subtitle." + modid + "." + name);
    }
    ...
    public static TextEntry notification(@Nonnull ResourceLocation type) {
        return new TextEntry("notification." + type.getNamespace() + "." + type.getPath());
    }

    public static TextEntry notification(@Nonnull NotificationType<?> type, @Nonnull String extra) {
        return notification(type.type, extra);
    }

    public static TextEntry notification(@Nonnull ResourceLocation type, @Nonnull String extra) {
        return new TextEntry("notification." + type.getNamespace() + "." + type.getPath() + "." + extra);
    }

    public static TextEntry permission(@Nonnull String permission) {
        return new TextEntry("permission.lightmanscurrency." + permission);
    }
    ...
    public static TextEntry resourcePack(@Nonnull String modid, @Nonnull String name) {
        return new TextEntry("resourcepack." + modid + "." + name);
    }
    ...
    public static TextEntry extend(@Nonnull TextEntry parent, @Nonnull String extra) {
        return new TextEntry((Supplier<String>) (() -> parent.getKey() + "." + extra));
    }
}