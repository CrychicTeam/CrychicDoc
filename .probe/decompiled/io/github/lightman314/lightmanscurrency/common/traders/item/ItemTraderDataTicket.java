...
public class ItemTraderDataTicket extends ItemTraderData {
    ...
    public static final TraderType<ItemTraderDataTicket> TYPE = new TraderType<>(new ResourceLocation("lightmanscurrency", "item_trader_ticket"), ItemTraderDataTicket::new);

    private ItemTraderDataTicket() {
        super(TYPE);
    }

    public ItemTraderDataTicket(int tradeCount, Level level, BlockPos pos) {
