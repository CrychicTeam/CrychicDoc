...
public abstract class WalletEnchantment extends Enchantment {
    ...
    protected WalletEnchantment(Enchantment.Rarity rarity, EnchantmentCategory cat, EquipmentSlot[] slot) {
        super(rarity, cat, slot);
    }

    public abstract void addWalletTooltips(List<Component> var1, int var2, ItemStack var3);
