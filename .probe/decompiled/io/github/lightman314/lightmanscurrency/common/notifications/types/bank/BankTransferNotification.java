...
public class BankTransferNotification extends Notification {
    ...
    protected boolean canMerge(@Nonnull Notification other) {
        return !(other instanceof BankTransferNotification n) ? false : n.player.is(this.player) && n.amount.equals(this.amount) && n.accountName.equals(this.accountName) && n.otherAccount.equals(this.otherAccount) && n.wasReceived == this.wasReceived;
    }
}