...
public class TextNotification extends Notification {
    ...
    public static final NotificationType<TextNotification> TYPE = new NotificationType<>(new ResourceLocation("lightmanscurrency", "text"), TextNotification::new);
    ...
    public static NonNullSupplier<Notification> create(MutableComponent text) {
        return () -> new TextNotification(text);
    }

    public static NonNullSupplier<Notification> create(MutableComponent text, NotificationCategory category) {
    ...
    protected boolean canMerge(@Nonnull Notification other) {
        return !(other instanceof TextNotification otherText) ? false : otherText.text.getString().equals(this.text.getString()) && otherText.category.matches(this.category);
    }
}