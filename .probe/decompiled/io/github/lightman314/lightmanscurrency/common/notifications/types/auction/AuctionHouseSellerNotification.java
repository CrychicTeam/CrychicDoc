...
public class AuctionHouseSellerNotification extends AuctionHouseNotification {
    ...
    public static final NotificationType<AuctionHouseSellerNotification> TYPE = new NotificationType<>(new ResourceLocation("lightmanscurrency", "auction_house_seller"), AuctionHouseSellerNotification::new);
