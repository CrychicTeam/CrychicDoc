...
public class ChangeAllyPermissionNotification extends Notification {
    ...
    public MutableComponent getMessage() {
        return this.oldValue == 0 ? LCText.NOTIFICATION_SETTINGS_CHANGE_ALLY_PERMISSIONS_SIMPLE.get(this.player.getName(true), this.permission, this.newValue) : LCText.NOTIFICATION_SETTINGS_CHANGE_ALLY_PERMISSIONS.get(this.player.getName(true), this.permission, this.oldValue, this.newValue);
    }
    ...
    protected boolean canMerge(@Nonnull Notification other) {
        return !(other instanceof ChangeAllyPermissionNotification n) ? false : n.player.is(this.player) && n.permission.equals(this.permission) && n.newValue == this.newValue && n.oldValue == this.oldValue;
    }
}