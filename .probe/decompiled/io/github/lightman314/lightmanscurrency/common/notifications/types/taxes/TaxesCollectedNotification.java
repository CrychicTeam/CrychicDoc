...
public class TaxesCollectedNotification extends Notification {
    ...
    protected boolean canMerge(@Nonnull Notification other) {
        return !(other instanceof TaxesCollectedNotification tcn) ? false : tcn.taxedName.getString().equals(this.taxedName.getString()) && tcn.amount.equals(this.amount) && tcn.category.matches(this.category);
    }
}