...
public class AddRemoveAllyNotification extends Notification {
    ...
    public static final NotificationType<AddRemoveAllyNotification> TYPE = new NotificationType<>(new ResourceLocation("lightmanscurrency", "add_remove_ally"), AddRemoveAllyNotification::new);
    ...
    protected boolean canMerge(@Nonnull Notification other) {
        return !(other instanceof AddRemoveAllyNotification n) ? false : n.player.is(this.player) && n.isAdd == this.isAdd && n.ally.is(this.ally);
    }
}