...
public class TicketSlot extends Slot {
    ...
    public static final ResourceLocation EMPTY_TICKET_SLOT = new ResourceLocation("lightmanscurrency", "item/empty_ticket_slot");
    ...
    public boolean mayPlace(@NotNull ItemStack stack) {
        return InventoryUtil.ItemHasTag(stack, LCTags.Items.TICKETS);
    }
