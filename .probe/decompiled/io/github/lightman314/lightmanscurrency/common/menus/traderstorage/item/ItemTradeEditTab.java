...
public class ItemTradeEditTab extends TraderStorageTab {
    ...
    public ItemTradeEditTab(@Nonnull ITraderStorageMenu menu) {
        super(menu);
    }
    ...
    public void setCustomName(int selectedSlot, String customName) {
        ...
        if (trade != null) {
            ...
            this.menu.getTrader().markTradesDirty();
            if (this.menu.isClient()) {
                this.menu.SendMessage(LazyPacketData.builder().setInt("Slot", selectedSlot).setString("CustomName", customName));
            }
        }
    }
    ...
    public void setSelectedItem(int selectedSlot, ItemStack stack) {
        ...
        if (trade != null) {
            ...
            this.menu.getTrader().markTradesDirty();
            if (this.menu.isClient()) {
                this.menu.SendMessage(LazyPacketData.builder().setInt("Slot", selectedSlot).setCompound("NewItem", stack.save(new CompoundTag())));
            }
        }
    }
    ...
    public void setNBTEnforced(int selectedSlot, boolean newValue) {
        ...
        if (trade != null) {
            ...
            this.menu.getTrader().markTradesDirty();
            if (this.menu.isClient()) {
                this.menu.SendMessage(LazyPacketData.builder().setInt("Slot", selectedSlot).setBoolean("EnforceNBT", newValue));
            }
        }
    }
    ...
    public void defaultInteraction(int slotIndex, ItemStack heldStack, int mouseButton) {
        ...
        if (trade != null) {
            ...
            if (this.menu.isClient()) {
                this.menu.SendMessage(LazyPacketData.builder().setInt("Interaction", slotIndex).setInt("Button", mouseButton).setCompound("Item", heldStack.save(new CompoundTag())));
            }
        }
    }
