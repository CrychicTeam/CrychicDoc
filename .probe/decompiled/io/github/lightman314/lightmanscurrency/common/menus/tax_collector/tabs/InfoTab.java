...
public class InfoTab extends TaxCollectorTab {
    ...
    public InfoTab(TaxCollectorMenu menu) {
        super(menu);
    }
    ...
    public boolean CanClearCache(TaxEntry entry) {
        return entry != null && (entry.isServerEntry() || entry.getOwner().isAdmin(this.menu.player));
    }
