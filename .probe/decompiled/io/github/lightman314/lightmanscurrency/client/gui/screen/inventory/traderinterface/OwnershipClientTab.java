...
public class OwnershipClientTab extends TraderInterfaceClientTab<OwnershipTab> {
    ...
    public void initialize(ScreenArea screenArea, boolean firstOpen) {
        ...
        this.playerOwnerButton = this.addChild(new EasyTextButton(screenArea.pos.offset(23, 47), 160, 20, LCText.BUTTON_OWNER_SET_PLAYER.get(), this::SetOwnerPlayer).withAddons(EasyAddonHelper.tooltip(LCText.TOOLTIP_WARNING_CANT_BE_UNDONE.getWithStyle(ChatFormatting.YELLOW, ChatFormatting.BOLD))));
    ...
    public void renderBG(@Nonnull EasyGuiGraphics gui) {
        if (this.menu.getBE() != null) {
            gui.drawString(TextRenderUtil.fitString(LCText.GUI_OWNER_CURRENT.get(this.menu.getBE().getOwnerName()), this.screen.getXSize() - 20), 10, 10, 4210752);
        }
    }
