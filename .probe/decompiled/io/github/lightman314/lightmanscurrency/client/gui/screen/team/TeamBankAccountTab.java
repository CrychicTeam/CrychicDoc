...
public class TeamBankAccountTab extends TeamTab {
    ...
    public TeamBankAccountTab(TeamManagerScreen screen) {
        super(screen);
    }
    ...
    public MutableComponent getTooltip() {
        return LCText.TOOLTIP_TEAM_BANK.get();
    }
    ...
    public void renderBG(@Nonnull EasyGuiGraphics gui) {
        if (this.getActiveTeam() != null) {
            if (this.getActiveTeam() != null && this.getActiveTeam().hasBankAccount()) {
                ...
                if (account != null) {
                    gui.drawString(account.getBalanceText(), 20, 46, 4210752);
                }
            }
        }
    }
    ...
    private void updateBankLimitText() {
        ...
        this.buttonToggleAccountLimit.m_93666_(message);
    }
}