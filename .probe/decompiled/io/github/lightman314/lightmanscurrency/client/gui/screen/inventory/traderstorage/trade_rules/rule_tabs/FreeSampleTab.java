...
public class FreeSampleTab extends TradeRuleSubTab<FreeSample> {
    ...
    public void initialize(ScreenArea screenArea, boolean firstOpen) {
        this.buttonClearMemory = this.addChild(new EasyTextButton(screenArea.pos.offset(10, 60), screenArea.width - 20, 20, LCText.BUTTON_FREE_SAMPLE_RESET.get(), this::PressClearMemoryButton).withAddons(EasyAddonHelper.tooltip(LCText.TOOLTIP_FREE_SAMPLE_RESET)));
    }
    ...
    public void renderBG(@Nonnull EasyGuiGraphics gui) {
        ...
        if (rule != null) {
            TextRenderUtil.drawCenteredMultilineText(gui, LCText.GUI_FREE_SAMPLE_PLAYER_COUNT.get(rule.getSampleCount()), 10, this.screen.getXSize() - 20, 20, 4210752);
        }
    }
