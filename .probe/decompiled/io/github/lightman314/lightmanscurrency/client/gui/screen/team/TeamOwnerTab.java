...
public class TeamOwnerTab extends TeamTab {
    ...
    public MutableComponent getTooltip() {
        return LCText.TOOLTIP_TEAM_OWNER.get();
    }
    ...
    public void initialize(ScreenArea screenArea, boolean firstOpen) {
        if (this.getActiveTeam() == null) {
            ...
            this.buttonChangeOwner = this.addChild(new EasyTextButton(screenArea.pos.offset(20, 45), 160, 20, LCText.BUTTON_OWNER_SET_PLAYER.get(), this::setNewOwner).withAddons(EasyAddonHelper.tooltip(LCText.TOOLTIP_WARNING_CANT_BE_UNDONE.getWithStyle(ChatFormatting.BOLD, ChatFormatting.YELLOW))));
            this.buttonChangeOwner.f_93623_ = false;
            this.buttonDisbandTeam = this.addChild(new EasyTextButton(screenArea.pos.offset(20, 160), 160, 20, LCText.BUTTON_TEAM_DISBAND.get(), this::disbandTeam).withAddons(EasyAddonHelper.tooltip(LCText.TOOLTIP_WARNING_CANT_BE_UNDONE.getWithStyle(ChatFormatting.BOLD, ChatFormatting.YELLOW))));
        }
    }
    ...
    public void renderBG(@Nonnull EasyGuiGraphics gui) {
        ...
        if (team != null) {
            gui.drawString(LCText.GUI_OWNER_CURRENT.get(team.getOwner().getName(true)), 20, 10, 4210752);
            TextRenderUtil.drawCenteredText(gui, LCText.GUI_TEAM_ID.get(team.getID()), this.screen.getXSize() / 2, 184, 4210752);
        }
    }
    ...
    public void tick() {
        ...
        this.buttonChangeOwner.f_93623_ = !this.newOwnerName.getValue().isBlank();
    }
