...
public class SparkParticleOptions implements ParticleOptions {
    ...
    public static final Codec<SparkParticleOptions> CODEC = RecordCodecBuilder.create(p_175793_ -> p_175793_.group(ExtraCodecs.VECTOR3F.fieldOf("color").forGetter(p_175797_ -> p_175797_.color)).apply(p_175793_, SparkParticleOptions::new));
