...
public class WitherSkullSpell extends AbstractSpell {
    ...
    private final ResourceLocation spellId = new ResourceLocation("irons_spellbooks", "wither_skull");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        float speed = (float) (8 + spellLevel) * 0.01F;
        ...
        skull.m_7678_(spawn.x, spawn.y - skull.m_20191_().getYsize() / 2.0, spawn.z, entity.m_146908_() + 180.0F, entity.m_146909_());
        level.m_7967_(skull);
