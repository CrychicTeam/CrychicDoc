...
public class CommonSetup {
    ...
    public static void onAttributeCreate(EntityAttributeCreationEvent event) {
        ...
        event.put(EntityRegistry.SUMMONED_VEX.get(), SummonedVex.m_34040_().build());
        event.put(EntityRegistry.SUMMONED_ZOMBIE.get(), SummonedZombie.m_34328_().build());
        event.put(EntityRegistry.SUMMONED_SKELETON.get(), SummonedSkeleton.m_32166_().build());
        ...
        event.put(EntityRegistry.SCULK_TENTACLE.get(), VoidTentacle.m_21183_().build());
        event.put(EntityRegistry.CRYOMANCER.get(), CryomancerEntity.prepareAttributes().build());
        event.put(EntityRegistry.ROOT.get(), RootEntity.m_21183_().build());
