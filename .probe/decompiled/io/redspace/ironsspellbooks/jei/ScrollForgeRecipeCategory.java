...
public class ScrollForgeRecipeCategory implements IRecipeCategory<ScrollForgeRecipe> {
    ...
    public static final RecipeType<ScrollForgeRecipe> SCROLL_FORGE_RECIPE_RECIPE_TYPE = RecipeType.create("irons_spellbooks", "scroll_forge", ScrollForgeRecipe.class);
    ...
    public ScrollForgeRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableItemStack(new ItemStack(BlockRegistry.SCROLL_FORGE_BLOCK.get()));
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, ScrollForgeRecipe recipe, IFocusGroup focuses) {
        ...
        IRecipeSlotBuilder inkInputSlot = builder.addSlot(RecipeIngredientRole.INPUT, 1, 1).addItemStacks(inkInputs).setSlotName("inkSlot");
        IRecipeSlotBuilder paperInputSlot = builder.addSlot(RecipeIngredientRole.INPUT, 24, 1).addItemStack(paperInput).setSlotName("paperSlot");
        IRecipeSlotBuilder focusInputSlot = builder.addSlot(RecipeIngredientRole.INPUT, 47, 1).addItemStack(focusInput).setSlotName("focusSlot");
        IRecipeSlotBuilder outputSlot = builder.addSlot(RecipeIngredientRole.OUTPUT, 24, 31).addItemStacks(outputs).setSlotName("outputSlot");
