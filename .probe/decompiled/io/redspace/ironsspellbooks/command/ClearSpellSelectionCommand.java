...
public class ClearSpellSelectionCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        LiteralCommandNode<CommandSourceStack> command = dispatcher.register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("clearSpellSelection").requires(p -> p.hasPermission(2))).executes(context -> clearCooldowns((CommandSourceStack) context.getSource())));
    }
