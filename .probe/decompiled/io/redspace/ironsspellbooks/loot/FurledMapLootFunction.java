...
public class FurledMapLootFunction extends LootItemConditionalFunction {
    ...
    public static LootItemConditionalFunction.Builder<?> create(String destination, String translation) {
        return m_80683_(functions -> new FurledMapLootFunction(functions, destination, translation));
    }

    @Override
    protected ItemStack run(ItemStack itemStack, LootContext lootContext) {
        return itemStack.getItem() instanceof FurledMapItem ? FurledMapItem.of(new ResourceLocation(this.destination), Component.translatable(this.translation)) : itemStack;
    }
