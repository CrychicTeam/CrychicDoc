...
public class AttributeRegistry {
    ...
    private static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, "irons_spellbooks");

    public static final RegistryObject<Attribute> MAX_MANA = ATTRIBUTES.register("max_mana", () -> new MagicRangedAttribute("attribute.irons_spellbooks.max_mana", 100.0, 0.0, 1000000.0).m_22084_(true));

    public static final RegistryObject<Attribute> MANA_REGEN = ATTRIBUTES.register("mana_regen", () -> new MagicRangedAttribute("attribute.irons_spellbooks.mana_regen", 1.0, 0.0, 100.0).m_22084_(true));

    public static final RegistryObject<Attribute> COOLDOWN_REDUCTION = ATTRIBUTES.register("cooldown_reduction", () -> new MagicRangedAttribute("attribute.irons_spellbooks.cooldown_reduction", 1.0, -100.0, 100.0).m_22084_(true));

    public static final RegistryObject<Attribute> SPELL_POWER = ATTRIBUTES.register("spell_power", () -> new MagicRangedAttribute("attribute.irons_spellbooks.spell_power", 1.0, -100.0, 100.0).m_22084_(true));

    public static final RegistryObject<Attribute> SPELL_RESIST = ATTRIBUTES.register("spell_resist", () -> new MagicRangedAttribute("attribute.irons_spellbooks.spell_resist", 1.0, -100.0, 100.0).m_22084_(true));

    public static final RegistryObject<Attribute> CAST_TIME_REDUCTION = ATTRIBUTES.register("cast_time_reduction", () -> new MagicRangedAttribute("attribute.irons_spellbooks.cast_time_reduction", 1.0, -100.0, 100.0).m_22084_(true));

    public static final RegistryObject<Attribute> SUMMON_DAMAGE = ATTRIBUTES.register("summon_damage", () -> new MagicRangedAttribute("attribute.irons_spellbooks.summon_damage", 1.0, -100.0, 100.0).m_22084_(true));
    ...
    private static RegistryObject<Attribute> newResistanceAttribute(String id) {
        return ATTRIBUTES.register(id + "_magic_resist", () -> new MagicRangedAttribute("attribute.irons_spellbooks." + id + "_magic_resist", 1.0, -100.0, 100.0).m_22084_(true));
    }

    private static RegistryObject<Attribute> newPowerAttribute(String id) {
        return ATTRIBUTES.register(id + "_spell_power", () -> new MagicRangedAttribute("attribute.irons_spellbooks." + id + "_spell_power", 1.0, -100.0, 100.0).m_22084_(true));
    }
}