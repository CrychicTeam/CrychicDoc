...
public class ConfigHelper {
    ...
    public static <T> ConfigHelper.ConfigObject<T> defineObject(ForgeConfigSpec.Builder builder, String name, Codec<T> codec, T defaultObject) {
        DataResult<Object> encodeResult = codec.encodeStart(ConfigHelper.TomlConfigOps.INSTANCE, defaultObject);
        ...
        return new ConfigHelper.ConfigObject<>(value, codec, defaultObject, encodedObject);
    }
