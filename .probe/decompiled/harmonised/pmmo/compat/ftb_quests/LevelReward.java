...
public class LevelReward extends Reward {
    ...
    public void fillConfigGroup(ConfigGroup config) {
        ...
        config.addInt("amount", this.amount, input -> this.amount = input, 1, -Config.MAX_LEVEL.get(), Config.MAX_LEVEL.get());
    }

    @Override
    public void claim(ServerPlayer player, boolean notify) {
        Core.get(player.m_9236_()).getData().changePlayerSkillLevel(this.skill, player.m_20148_(), this.amount);
    }
