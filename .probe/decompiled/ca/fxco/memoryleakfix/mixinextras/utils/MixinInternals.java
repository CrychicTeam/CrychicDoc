...
public class MixinInternals {
    ...
    private static final InternalField<InjectionInfo, Map<Target, List<InjectionNode>>> INJECTION_INFO_TARGET_NODES = InternalField.of(InjectionInfo.class, "targetNodes");

    private static final InternalField<InjectionNode, Map<String, Object>> INJECTION_NODE_DECORATIONS = InternalField.of(InjectionNode.class, "decorations");
    ...
    private static final InternalField<InjectionInfo, Class<? extends Annotation>[]> INJECTION_INFO_REGISTERED_ANNOTATIONS = InternalField.of(InjectionInfo.class, "registeredAnnotations");
    ...
    public static void registerExtension(IExtension extension, boolean isPriority) {
        ...
        List<IExtension> activeExtensions = new ArrayList((Collection) ACTIVE_EXTENSIONS.get(extensions));
    ...
    private static void bakeInjectionInfoArray(Map<String, Object> registry) {
        ...
        INJECTION_INFO_REGISTERED_ANNOTATIONS.set(null, (Class<? extends Annotation>[]) annotations.toArray(new Class[0]));
    }
}