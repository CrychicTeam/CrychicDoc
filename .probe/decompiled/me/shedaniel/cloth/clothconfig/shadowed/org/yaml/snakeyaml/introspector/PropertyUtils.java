...
import me.shedaniel.cloth.clothconfig.shadowed.org.yaml.snakeyaml.util.PlatformFeatureDetector;
                ...
                case FIELD:
                    for (Class<?> c = type; c != null; c = c.getSuperclass()) {
                        for (Field fieldx : c.getDeclaredFields()) {
                            ...
                            if (!Modifier.isStatic(modifiers) && !Modifier.isTransient(modifiers) && !properties.containsKey(fieldx.getName())) {
