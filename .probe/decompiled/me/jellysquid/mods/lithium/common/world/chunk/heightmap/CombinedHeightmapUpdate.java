...
public class CombinedHeightmapUpdate {
    ...
    public static void updateHeightmaps(Heightmap heightmap0, Heightmap heightmap1, Heightmap heightmap2, Heightmap heightmap3, LevelChunk worldChunk, int x, int y, int z, BlockState state) {
        ...
        if (heightmapsToUpdate != 0) {
            Predicate<BlockState> blockPredicate0 = heightmap0 == null ? null : (Predicate) Objects.requireNonNull(((HeightmapAccessor) heightmap0).getBlockPredicate());
            Predicate<BlockState> blockPredicate1 = heightmap1 == null ? null : (Predicate) Objects.requireNonNull(((HeightmapAccessor) heightmap1).getBlockPredicate());
            Predicate<BlockState> blockPredicate2 = heightmap2 == null ? null : (Predicate) Objects.requireNonNull(((HeightmapAccessor) heightmap2).getBlockPredicate());
            Predicate<BlockState> blockPredicate3 = heightmap3 == null ? null : (Predicate) Objects.requireNonNull(((HeightmapAccessor) heightmap3).getBlockPredicate());
            if (heightmap0 != null) {
            ...
            if (heightmapsToUpdate != 0) {
                ...
                int bottomY = worldChunk.m_141937_();
