...
public class SharedQuadIndexBuffer {
    ...
    private void grow(CommandList commandList, int primitiveCount) {
        ...
        commandList.allocateStorage(this.buffer, (long) bufferSize, GlBufferUsage.STATIC_DRAW);
        GlBufferMapping mapped = commandList.mapBuffer(this.buffer, 0L, (long) bufferSize, EnumBitField.of(GlBufferMapFlags.INVALIDATE_BUFFER, GlBufferMapFlags.WRITE, GlBufferMapFlags.UNSYNCHRONIZED));
