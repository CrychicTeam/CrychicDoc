...
public class SliderControl implements Control<Integer> {
    ...
    private static class Button extends ControlElement<Integer> {
        ...
        public void render(GuiGraphics drawContext, int mouseX, int mouseY, float delta) {
            ...
            if (!this.option.isAvailable() || !this.hovered && !this.m_93696_()) {
        ...
        private void renderSlider(GuiGraphics drawContext) {
            ...
            double thumbOffset = Mth.clamp((double) (this.getIntValue() - this.min) / (double) this.range * (double) sliderWidth, 0.0, (double) sliderWidth);
