...
final class Utf8 {
    ...
    private static final Utf8.Processor processor = (Utf8.Processor) (Utf8.UnsafeProcessor.isAvailable() && !Android.isOnAndroidDevice() ? new Utf8.UnsafeProcessor() : new Utf8.SafeProcessor());
        ...
        final int partialIsValidUtf8Default(int state, ByteBuffer buffer, int index, int limit) {
            if (state != 0) {
                ...
                if (byte1 < -32) {
                    ...
                    byte byte2x = (byte) (~(state >> 8));
                    byte byte3 = 0;
                    if (byte2x == 0) {
                        byte2x = buffer.get(index++);
                        if (index >= limit) {
                            return Utf8.incompleteStateFor(byte1, byte2x);
                        }
                    } else {
                        byte3 = (byte) (state >> 16);
                    }
                    if (byte3 == 0) {
                        ...
                        if (index >= limit) {
                            return Utf8.incompleteStateFor(byte1, byte2x, byte3);
                        }
                    }
                    if (byte2x > -65 || (byte1 << 28) + (byte2x - -112) >> 30 != 0 || byte3 > -65 || buffer.get(index++) > -65) {
                        return -1;
                    }
                }
            }
        ...
        int partialIsValidUtf8(int state, byte[] bytes, int index, int limit) {
            if (state != 0) {
                ...
                if (byte1 < -32) {
                    ...
                    if (byte2x > -65 || (byte1 << 28) + (byte2x - -112) >> 30 != 0 || byte3 > -65 || bytes[index++] > -65) {
                        return -1;
                    }
                }
            }
            ...
            if ((index | limit | bytes.length - limit) < 0) {
                ...
                if (state != 0) {
                    ...
                    if (byte1 < -32) {
                        ...
                        int byte3 = 0;
                        if (byte2x == 0) {
                            byte2x = UnsafeUtil.getByte(bytes, offset++);
                            if (offset >= offsetLimit) {
                                return Utf8.incompleteStateFor(byte1, byte2x);
                            }
                        } else {
                        ...
                        if (byte2x > -65 || (byte1 << 28) + (byte2x - -112) >> 30 != 0 || byte3 > -65 || UnsafeUtil.getByte(bytes, offset++) > -65) {
                            return -1;
                        }
                    }
                }
            ...
            if ((index | limit | buffer.limit() - limit) < 0) {
                ...
                if (state != 0) {
                    ...
                    if (byte1 < -32) {
                        ...
                        int byte3 = 0;
                        if (byte2x == 0) {
                            byte2x = UnsafeUtil.getByte(address++);
                            if (address >= addressLimit) {
                                return Utf8.incompleteStateFor(byte1, byte2x);
                            }
                        } else {
                        ...
                        if (byte2x > -65 || (byte1 << 28) + (byte2x - -112) >> 30 != 0 || byte3 > -65 || UnsafeUtil.getByte(address++) > -65) {
                            return -1;
                        }
                    }
                }
