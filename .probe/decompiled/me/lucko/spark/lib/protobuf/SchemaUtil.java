...
final class SchemaUtil {
    ...
    private static UnknownFieldSchema<?, ?> getUnknownFieldSetSchema(boolean proto3) {
        try {
            ...
            return clz == null ? null : (UnknownFieldSchema) clz.getConstructor(boolean.class).newInstance(proto3);
    ...
    private static Class<?> getGeneratedMessageClass() {
        try {
            return Class.forName("me.lucko.spark.lib.protobuf.GeneratedMessageV3");
    ...
    private static Class<?> getUnknownFieldSetSchemaClass() {
        try {
            return Class.forName("me.lucko.spark.lib.protobuf.UnknownFieldSetSchema");
        } catch (Throwable var1) {
            return null;
        }
    }
