...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    public T newInstance() {
        return (T) (this.defaultInstance instanceof GeneratedMessageLite ? ((GeneratedMessageLite) this.defaultInstance).newMutableInstance() : this.defaultInstance.newBuilderForType().buildPartial());
    }
