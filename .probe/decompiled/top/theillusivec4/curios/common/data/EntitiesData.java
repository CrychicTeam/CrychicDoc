...
public class EntitiesData implements IEntitiesData {
    ...
    public EntitiesData addPlayer() {
        return this.addEntities(EntityType.PLAYER);
    }
    ...
    public JsonObject serialize() {
        ...
        if (!this.entities.isEmpty()) {
            ...
            this.entities.forEach(entityType -> arr.add(((ResourceLocation) Objects.requireNonNull(ForgeRegistries.ENTITY_TYPES.getKey(entityType))).toString()));
