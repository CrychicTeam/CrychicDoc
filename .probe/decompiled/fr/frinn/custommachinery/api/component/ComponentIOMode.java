...
public enum ComponentIOMode {
    ...
    INPUT(true, false, SideConfig.Template.DEFAULT_ALL_INPUT), OUTPUT(false, true, SideConfig.Template.DEFAULT_ALL_OUTPUT), BOTH(true, true, SideConfig.Template.DEFAULT_ALL_BOTH), NONE(false, false, SideConfig.Template.DEFAULT_ALL_NONE);
    ...
    private ComponentIOMode(boolean isInput, boolean isOutput, SideConfig.Template baseConfig) {
