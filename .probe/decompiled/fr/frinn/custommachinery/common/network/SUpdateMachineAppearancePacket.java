...
public class SUpdateMachineAppearancePacket extends BaseS2CMessage {
    ...
    public static SUpdateMachineAppearancePacket read(FriendlyByteBuf buf) {
        ...
        return buf.readBoolean() ? new SUpdateMachineAppearancePacket(pos, null) : new SUpdateMachineAppearancePacket(pos, new MachineAppearance(MachineAppearance.CODEC.fromNetwork(buf)));
    }
