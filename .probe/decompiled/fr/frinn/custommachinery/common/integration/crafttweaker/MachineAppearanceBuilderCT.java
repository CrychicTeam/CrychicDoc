...
@ZenRegister
@Name("mods.custommachinery.AppearanceBuilder")
public class MachineAppearanceBuilderCT {
    ...
    public MachineAppearanceBuilderCT block(String block) {
        this.put((MachineAppearanceProperty<MachineModelLocation>) Registration.BLOCK_MODEL_PROPERTY.get(), MachineModelLocation.of(block));
        return this;
    }
    ...
    public MachineAppearanceBuilderCT item(String item) {
        this.put((MachineAppearanceProperty<MachineModelLocation>) Registration.ITEM_MODEL_PROPERTY.get(), MachineModelLocation.of(item));
        return this;
    }
