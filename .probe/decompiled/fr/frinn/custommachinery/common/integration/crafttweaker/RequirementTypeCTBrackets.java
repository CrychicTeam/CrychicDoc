...
public class RequirementTypeCTBrackets {
    ...
    public static RequirementTypeCTBrackets.CTRequirementType parseBracket(String bracket) {
        return new RequirementTypeCTBrackets.CTRequirementType(Registration.REQUIREMENT_TYPE_REGISTRY.get(new ResourceLocation(bracket)));
    }
    ...
    public static boolean validateBracket(String bracket) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Invalid Requirement Type bracket: " + bracket, var3);
        }
    ...
    public static class CTRequirementType implements CommandStringDisplayable {
        ...
        public String getCommandString() {
            return "<requirementtype:" + Registration.REQUIREMENT_TYPE_REGISTRY.getId((RequirementType<? extends IRequirement<?>>) this.type) + ">";
        }
    }
}