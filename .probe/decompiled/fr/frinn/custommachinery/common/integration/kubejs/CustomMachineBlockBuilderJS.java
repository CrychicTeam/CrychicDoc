...
public class CustomMachineBlockBuilderJS extends BuilderBase<Block> {
    ...
    private ResourceLocation machineID = this.id;

    private String renderType = "translucent";
    ...
    public Block createObject() {
        ...
        if (Platform.isFabric()) {
            ((BlockEntityType) Registration.CUSTOM_MACHINE_TILE.get()).validBlocks.add(block);
        }
        return block;
    }
