...
public class CustomMachineryKubeJSPlugin extends KubeJSPlugin {
    ...
    public static final EventHandler UPGRADES = CM_EVENTS.server("upgrades", () -> CustomMachineUpgradeJSBuilder.UpgradeEvent.class);

    @Override
    public void init() {
        RegistryInfo.BLOCK.addType("custommachinery", CustomMachineBlockBuilderJS.class, CustomMachineBlockBuilderJS::new);
    }
    ...
    public void registerBindings(BindingsEvent event) {
        ...
        event.add("TooltipPredicate", IDisplayInfo.TooltipPredicate.class);
    }
