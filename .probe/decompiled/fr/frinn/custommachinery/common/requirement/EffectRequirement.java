...
public class EffectRequirement extends AbstractDelayedChanceableRequirement<EffectMachineComponent> implements ITickableRequirement<EffectMachineComponent>, IDisplayInfoRequirement {
    ...
    public RequirementType<EffectRequirement> getType() {
        return (RequirementType<EffectRequirement>) Registration.EFFECT_REQUIREMENT.get();
    }
    ...
    public CraftingResult processEnd(EffectMachineComponent component, ICraftingContext context) {
        if (this.applyAtEnd && this.getDelay() == 0.0) {
            int time = (int) context.getIntegerModifiedValue((double) this.time, this, "time");
            int level = Mth.clamp((int) context.getIntegerModifiedValue((double) this.level, this, "level") - 1, 0, 255);
    ...
    public CraftingResult processTick(EffectMachineComponent component, ICraftingContext context) {
        if (!this.applyAtEnd && this.getDelay() == 0.0) {
            int time = (int) context.getPerTickIntegerModifiedValue((double) this.time, this, "time");
            int level = Mth.clamp((int) context.getPerTickIntegerModifiedValue((double) this.level, this, "level") - 1, 0, 255);
            int radius = (int) context.getPerTickIntegerModifiedValue((double) this.radius, this, "radius");
