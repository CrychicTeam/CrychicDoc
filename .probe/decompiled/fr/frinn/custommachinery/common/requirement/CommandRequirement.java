...
public class CommandRequirement extends AbstractDelayedChanceableRequirement<CommandMachineComponent> implements ITickableRequirement<CommandMachineComponent>, IDisplayInfoRequirement {
    ...
    public RequirementType<CommandRequirement> getType() {
        return (RequirementType<CommandRequirement>) Registration.COMMAND_REQUIREMENT.get();
    }
    ...
    public void getDisplayInfo(IDisplayInfo info) {
        ...
        if (!this.isDelayed()) {
            ...
            info.addTooltip(Component.translatable("custommachinery.requirements.command.delay", Component.literal(this.command).withStyle(ChatFormatting.AQUA), (int) (this.getDelay() * 100.0) + "%"));
        }
    }
}