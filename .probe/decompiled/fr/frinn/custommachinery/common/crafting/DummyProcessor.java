...
public class DummyProcessor implements IProcessor {
    ...
    public ProcessorType<DummyProcessor> getType() {
        return (ProcessorType<DummyProcessor>) Registration.DUMMY_PROCESSOR.get();
    }
    ...
    public static class Template implements IProcessorTemplate<DummyProcessor> {
        ...
        public static final NamedCodec<DummyProcessor.Template> CODEC = NamedCodec.unit(DummyProcessor.Template::new, "Dummy processor");
