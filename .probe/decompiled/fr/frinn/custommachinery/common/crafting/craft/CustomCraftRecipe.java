...
public class CustomCraftRecipe implements Recipe<Container>, IMachineRecipe {
    ...
    public static final List<RequirementType<?>> FORBIDDEN_REQUIREMENTS = Lists.newArrayList(new RequirementType[] { (RequirementType) Registration.ENERGY_PER_TICK_REQUIREMENT.get(), (RequirementType) Registration.FLUID_PER_TICK_REQUIREMENT.get(), (RequirementType) Registration.EXPERIENCE_PER_TICK_REQUIREMENT.get() });
    ...
    public RecipeChecker<CustomCraftRecipe> checker() {
        return (RecipeChecker<CustomCraftRecipe>) this.checker.get();
    }
