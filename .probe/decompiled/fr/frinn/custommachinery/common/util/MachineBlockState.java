...
public class MachineBlockState extends BlockState {
    ...
    public static final LoadingCache<MachineAppearance, MachineBlockState> CACHE = CacheBuilder.newBuilder().maximumSize(20L).build(new CacheLoader<MachineAppearance, MachineBlockState>() {
    ...
    public MachineBlockState(MachineAppearance appearance) {
        super((Block) Registration.CUSTOM_MACHINE_BLOCK.get(), ImmutableMap.of(), null);
