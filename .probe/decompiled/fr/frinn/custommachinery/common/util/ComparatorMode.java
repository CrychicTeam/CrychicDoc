...
public enum ComparatorMode {
    ...
    GREATER(">>"), GREATER_OR_EQUALS(">="), EQUALS("=="), LESSER_OR_EQUALS("<="), LESSER("<<");
    ...
    public String getTranslationKey() {
        return switch(this) {
            case GREATER ->
                "custommachinery.comparator.greater";
            case GREATER_OR_EQUALS ->
                "custommachinery.comparator.greater_or_equals";
            case EQUALS ->
                "custommachinery.comparator.equals";
            case LESSER_OR_EQUALS ->
                "custommachinery.comparator.lesser_or_equals";
            case LESSER ->
                "custommachinery.comparator.lesser";
        };
    }
    ...
    public static ComparatorMode value(String value) {
        try {
            ...
            return (ComparatorMode) Stream.of(values()).filter(comparatorMode -> comparatorMode.prefix.equals(value)).findFirst().orElseThrow(() -> new IllegalArgumentException("Invalid Comparator Mode: " + value));
        }
    }
}