...
public class SlotItemComponent extends Slot {
    ...
    public boolean mayPlace(ItemStack stack) {
        if (this.component.isLocked()) {
            ...
            return this.component.getVariant() != DefaultItemComponentVariant.INSTANCE ? this.component.isItemValid(stack) : this.component.getMode().isInput() && this.component.isItemValid(stack);
        }
    }
