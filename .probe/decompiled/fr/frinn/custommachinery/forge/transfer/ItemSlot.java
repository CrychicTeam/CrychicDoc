...
public class ItemSlot implements IItemHandler {
    ...
    public ItemStack insertItem(int index, @NotNull ItemStack stack, boolean simulate) {
        if (this.side != null && !this.component.getConfig().getSideMode(this.side).isInput()) {
            return stack;
        } else if (!this.component.isItemValid(stack)) {
            return stack;
        } else {
            ...
            if (inserted == 0) {
                ...
                return inserted == stack.getCount() ? ItemStack.EMPTY : Utils.makeItemStack(stack.getItem(), stack.getCount() - inserted, stack.getTag());
            }
        }
    }
    ...
    public ItemStack extractItem(int index, int amount, boolean simulate) {
        return this.side != null && !this.component.getConfig().getSideMode(this.side).isOutput() ? ItemStack.EMPTY : this.component.extract(amount, simulate);
    }
