...
public class MachineComponentListWidget extends ListWidget<MachineComponentListWidget.MachineComponentEntry> {
    ...
    public void setup(CustomMachineBuilder builder) {
        ...
        for (IMachineComponentTemplate<?> template : builder.getComponents()) {
            ...
            if (componentBuilder != null) {
                this.addEntry(new MachineComponentListWidget.MachineComponentEntry(template, componentBuilder));
            }
        }
    }
    ...
    public class MachineComponentEntry extends ListWidget.Entry {
        ...
        public void render(GuiGraphics graphics, int index, int x, int y, int width, int height, int mouseX, int mouseY, float partialTick) {
            ((IMachineComponentBuilder<?, IMachineComponentTemplate<?>>) this.builder).render(graphics, x, y, width, height, this.template);
        }
