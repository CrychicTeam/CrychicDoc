...
public class DeleteMachinePopup extends ConfirmPopup {
    ...
    public DeleteMachinePopup(BaseScreen parent, CustomMachine machine) {
        ...
        this.text(new Component[] { Component.translatable("custommachinery.gui.creation.delete.popup"), Component.empty(), Component.empty() });
    }
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.m_5953_((double) mouseX, (double) mouseY) && mouseX >= itemX && mouseX <= itemX + 16 && mouseY >= itemY && mouseY <= itemY + 16) {
