...
public class ComponentTab extends MachineEditTab {
    ...
    public ComponentTab(MachineEditScreen parent) {
        ...
        this.f_267367_.rowSpacing(5).columnSpacing(10);
        this.f_267367_.defaultCellSetting().paddingTop(5);
        GridLayout.RowHelper row = this.f_267367_.createRowHelper(3);
    ...
    public void edit() {
        ...
        if (entry != null) {
            PopupScreen componentEditPopup = this.getComponentEditPopup(entry.getTemplate(), entry);
    ...
    private <C extends IMachineComponent, T extends IMachineComponentTemplate<C>> PopupScreen getComponentEditPopup(T template, MachineComponentListWidget.MachineComponentEntry entry) {
        ...
        return builder == null ? null : builder.makePopup(this.parent, template, t -> {
            entry.setTemplate(t);
            this.parent.setChanged();
        });
    }
