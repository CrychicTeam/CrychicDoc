...
public class ColoredBufferSource implements MultiBufferSource {
    ...
    public VertexConsumer getBuffer(RenderType renderType) {
        return renderType == RenderType.glintDirect() ? new ColoredBufferSource.ColoredVertexConsumer(this.wrapped.getBuffer(renderType), this.color) : new ColoredBufferSource.ColoredVertexConsumer(this.wrapped.getBuffer(RenderType.entityTranslucentCull(InventoryMenu.BLOCK_ATLAS)), this.color);
    }
    ...
    public static class ColoredVertexConsumer implements VertexConsumer {
        ...
        public VertexConsumer color(int r, int g, int b, int a) {
            this.wrapped.color(r * this.red / 255, g * this.green / 255, b * this.blue / 255, a * this.alpha / 255);
            return this;
        }
        ...
        public void defaultColor(int r, int g, int b, int a) {
            this.wrapped.defaultColor(r * this.red / 255, g * this.green / 255, b * this.blue / 255, a * this.alpha / 255);
        }
